...
# Governance Alignment (Law of Consistency)

- **Summit Readiness Assertion:** Work proceeds under the readiness contract in
  `docs/SUMMIT_READINESS_ASSERTION.md` and inherits its enforcement standards.
- **Authority files:** Definitions and policy authority are anchored in
  `docs/governance/CONSTITUTION.md`, `docs/governance/META_GOVERNANCE.md`, and
  `docs/governance/AGENT_MANDATES.md`.
- **GA hardening:** Verification expectations and legacy guardrails are defined in
  `docs/ga/TESTING-STRATEGY.md` and `docs/ga/LEGACY-MODE.md`.
