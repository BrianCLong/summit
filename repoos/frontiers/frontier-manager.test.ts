...
test("FrontierManager processes patches and groups by concern", (t) => {
  ...
  assert.strictEqual(
    stateData.frontiers.security.patches.length,
    1,
    "Security concern should have 1 patch"
  );
  assert.strictEqual(
    stateData.frontiers.runtime.patches.length,
    0,
    "Runtime concern should have 0 patches"
  );
