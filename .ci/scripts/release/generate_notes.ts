...
function categorizeCommits(commits: Commit[]): ReleaseNotes['breaking' | 'features' | 'fixes' | 'migrations' | 'security' | 'performance' | 'other'][] {
...
function generateMarkdown(notes: ReleaseNotes, bumpType: string): string {
  ...
  lines.push('```');
  lines.push('');
  lines.push('For detailed rollback procedures, see [RUNBOOKS/release-captain.md](../RUNBOOKS/release-captain.md).');
  lines.push('');
