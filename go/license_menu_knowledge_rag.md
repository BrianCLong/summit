...
- **Enterprise Subscription**
  - Managed platform with SLAs, governance controls, and compliance add-ons.
  - Licensed per-tenant and per-throughput (requests per minute + storage tiers).
  - Includes security updates, telemetry dashboards, and support.
- **Domain Pack Add-ons**
  - Vertical-specific corpora/graphs with tuned retrieval configs and evaluation harnesses.
  - Optional regulatory overlays (HIPAA-ready, FINRA-aligned) where applicable.
- **OEM / Platform Embed**
  - Rights to embed the retrieval API, knowledge schemas, and telemetry hooks in third-party platforms.
