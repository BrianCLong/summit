...
exports.default = FactMarkets;
function FactMarkets() {
    return (<div className="max-w-4xl mx-auto p-8">
      ...
      <div className="mt-8">
        <a href="mailto:you@summit.ai?subject=FactMarkets Demo Request" className="bg-blue-600 text-white px-6 py-3 rounded">
          Request Demo
        </a>
      </div>
    </div>);
