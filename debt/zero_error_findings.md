...
_Note: Discrepancy in counts suggests strictly defined markers vs loose text search._
...
- **Untracked Debt (The Gap)**: **5,302 items**
  - _These are "Errors" in the process—work items that exist in code but are invisible to the governance system._
- **Stale Registry Entries**: **13,289 items**
  - _These point to file locations that no longer contain the marker, indicating the registry is out of sync with reality._
