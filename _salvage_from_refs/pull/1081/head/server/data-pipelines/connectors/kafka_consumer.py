...
class KafkaConnector(BaseConnector):
    ...
    def __init__(self, name: str, config: dict[str, Any]):
        if not KAFKA_AVAILABLE:
            raise ImportError(
                "aiokafka is required for Kafka connector. Install with: pip install aiokafka"
            )
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # Create consumer
            self._consumer = AIOKafkaConsumer(*topics_to_consume, **consumer_config)
    ...
    async def extract_data(
        self, max_messages: int | None = None, timeout_seconds: int | None = None, **kwargs
        ...
        try:
            ...
            try:
                while self._consuming:
                    ...
                    # Poll for messages
                    message_batch = await self._consumer.getmany(timeout_ms=self.batch_timeout_ms)
    ...
    def _deserialize_key(self, key_bytes: bytes | None) -> Any:
        """
    ...
    def _deserialize_value(self, value_bytes: bytes | None) -> Any:
        """
