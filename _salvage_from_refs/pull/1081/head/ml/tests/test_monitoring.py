...
class TestMetricsTracking:
    ...
    def test_track_http_request(self):
        ...
        track_http_request(method="GET", endpoint="/test", status_code=200, duration=0.5)
    ...
    def test_track_ml_prediction(self):
        ...
        track_ml_prediction(model_type="entity_resolver", duration=2.5, status="success")
    ...
    def test_track_task_processing(self):
        ...
        track_task_processing(task_type="nlp_entities", duration=10.0, status="success")
    ...
    def test_track_entity_extraction(self):
        ...
        track_entity_extraction(source="spacy", entity_type="PERSON", confidence=0.95)
    ...
    def test_track_error(self):
        """Test error tracking"""
        track_error(module="test_module", error_type="ValueError", severity="error")
