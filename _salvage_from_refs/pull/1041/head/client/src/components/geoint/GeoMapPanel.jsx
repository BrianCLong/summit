        ...
        {showHeat ? (
          ...
          locs.map((n, i) => (
            <CircleMarker
              ...
              radius={highlightId === n.id ? 10 : 6}
              pathOptions={{
                color: highlightId === n.id ? "#ff5722" : "rgba(255,99,71,0.4)",
                fillColor:
                  highlightId === n.id ? "#ff5722" : "rgba(255,99,71,0.25)",
                fillOpacity: highlightId === n.id ? 0.6 : 0.25,
              }}
            />
          ))
        )}
