...
describe('Integration Service - P2 Priority', () => {
  ...
  describe('Connection Testing', () => {
    ...
    test('should handle connection test failures', async () => {
      ...
      integrationService.makeRequest = jest.fn().mockRejectedValue(
  ...
  describe('Sync Job Management', () => {
    test('should create sync jobs', async () => {
      ...
      integrationService.calculateNextRun = jest.fn().mockReturnValue(
    ...
    test('should handle sync job failures', async () => {
      ...
      integrationService.executeSyncOperation = jest.fn().mockRejectedValue(
  ...
  describe('Webhook Management', () => {
    ...
    test('should handle webhook delivery failures with retry', async () => {
      ...
      integrationService.makeWebhookRequest = jest.fn().mockRejectedValue(
