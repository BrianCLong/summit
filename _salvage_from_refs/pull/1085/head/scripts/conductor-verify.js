...
async function runVerification() {
  ...
  const obsChecks = [
    ...
    ['server/src/conductor/observability/prometheus.ts', 'conductorRouterDecisionsTotal', 'Router decisions metric'],
    ['server/src/conductor/observability/prometheus.ts', 'conductorExpertLatencySeconds', 'Expert latency metric']
  ];
