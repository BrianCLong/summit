...
export class IdempotentQueue {
  ...
  constructor(queueName: string, dedupeWindowMs: number = 300000) { // 5 min default
  ...
  private async checkPoisonPill(item: QueueItem): Promise<{ quarantine: boolean; reason?: string }> {
