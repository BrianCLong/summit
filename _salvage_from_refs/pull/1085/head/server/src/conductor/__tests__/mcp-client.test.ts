...
describe('MCPServerRegistry', () => {
  ...
  test('finds servers with specific tools', () => {
    const server1Config = {
      ...mockServerConfig,
      tools: [{ name: 'tool1', description: '', schema: { type: 'object' as const, properties: {} } }]
    };
    const server2Config = {
      ...mockServerConfig,
      tools: [{ name: 'tool2', description: '', schema: { type: 'object' as const, properties: {} } }]
    };
