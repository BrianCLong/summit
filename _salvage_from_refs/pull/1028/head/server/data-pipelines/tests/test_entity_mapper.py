...
from transformations.entity_mapper import (
    EntityMapper, EntityMappingRule,
    normalize_name, normalize_address,
    normalize_email, clean_phone_number, normalize_country
)
...
class TestEntityMapper(unittest.TestCase):
    ...
    def test_generate_entity_id_with_normalizations(self):
        ...
        id1 = mapper._generate_entity_id(record1, person_rule.id_fields, person_rule.entity_type, person_rule.id_field_normalizations)
        id2 = mapper._generate_entity_id(record2, person_rule.id_fields, person_rule.entity_type, person_rule.id_field_normalizations)
        id3 = mapper._generate_entity_id(record3, person_rule.id_fields, person_rule.entity_type, person_rule.id_field_normalizations)
        ...
        org_id1 = mapper._generate_entity_id(org_record1, org_rule.id_fields, org_rule.entity_type, org_rule.id_field_normalizations)
        org_id2 = mapper._generate_entity_id(org_record2, org_rule.id_fields, org_rule.entity_type, org_rule.id_field_normalizations)
        ...
        uuid_id = mapper._generate_entity_id(empty_record, person_rule.id_fields, person_rule.entity_type, person_rule.id_field_normalizations)
