...
class GNNService {
    ...
    async classifyNodes(params) {
        ...
        return (0, middleware_js_1.trackGraphOperation)('gnn_node_classification', investigationId, async () => {
            try {
                const payload = {
                    job_id: jobId,
                ...
                const response = await (0, node_fetch_1.default)(`${this.mlServiceUrl}/gnn/node_classification`, {
                    method: 'POST',
                    headers: {
                ...
                logger_js_1.default.info('GNN node classification initiated', {
                    investigationId,
                    jobId,
                ...
                (0, middleware_js_1.trackError)('gnn_service', 'NodeClassificationError');
                logger_js_1.default.error('GNN node classification failed', {
                    investigationId,
                    jobId,
                    error: error.message
                });
    ...
    async predictLinks(params) {
        ...
        const jobId = (0, uuid_1.v4)();
        return (0, middleware_js_1.trackGraphOperation)('gnn_link_prediction', investigationId, async () => {
            try {
                const payload = {
                    job_id: jobId,
                    graph_data: graphData,
                ...
                const response = await (0, node_fetch_1.default)(`${this.mlServiceUrl}/gnn/link_prediction`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${options.token || ''}`
                ...
                const result = await response.json();
                logger_js_1.default.info('GNN link prediction initiated', {
                    investigationId,
                    jobId,
                    taskId: result.task_id,
                    taskMode,
                ...
                (0, middleware_js_1.trackError)('gnn_service', 'LinkPredictionError');
                logger_js_1.default.error('GNN link prediction failed', {
                    investigationId,
                    jobId,
                    error: error.message
                });
    ...
    async classifyGraphs(params) {
        ...
        const jobId = (0, uuid_1.v4)();
        return (0, middleware_js_1.trackGraphOperation)('gnn_graph_classification', investigationId, async () => {
            try {
                const payload = {
                    job_id: jobId,
                    graphs: graphs,
                ...
                const response = await (0, node_fetch_1.default)(`${this.mlServiceUrl}/gnn/graph_classification`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${options.token || ''}`
                ...
                const result = await response.json();
                logger_js_1.default.info('GNN graph classification initiated', {
                    investigationId,
                    jobId,
                    taskId: result.task_id,
                    taskMode,
                ...
                (0, middleware_js_1.trackError)('gnn_service', 'GraphClassificationError');
                logger_js_1.default.error('GNN graph classification failed', {
                    investigationId,
                    jobId,
                    error: error.message
                });
    ...
    async detectAnomalies(params) {
        ...
        const jobId = (0, uuid_1.v4)();
        return (0, middleware_js_1.trackGraphOperation)('gnn_anomaly_detection', investigationId, async () => {
            try {
                const payload = {
                    job_id: jobId,
                    graph_data: graphData,
                ...
                const response = await (0, node_fetch_1.default)(`${this.mlServiceUrl}/gnn/anomaly_detection`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${options.token || ''}`
                ...
                const result = await response.json();
                logger_js_1.default.info('GNN anomaly detection initiated', {
                    investigationId,
                    jobId,
                    taskId: result.task_id,
                    taskMode,
                ...
                (0, middleware_js_1.trackError)('gnn_service', 'AnomalyDetectionError');
                logger_js_1.default.error('GNN anomaly detection failed', {
                    investigationId,
                    jobId,
                    error: error.message
                });
    ...
    async generateEmbeddings(params) {
        ...
        const jobId = (0, uuid_1.v4)();
        return (0, middleware_js_1.trackGraphOperation)('gnn_generate_embeddings', investigationId, async () => {
            try {
                const payload = {
                    job_id: jobId,
                    graph_data: graphData,
                ...
                const response = await (0, node_fetch_1.default)(`${this.mlServiceUrl}/gnn/generate_embeddings`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${options.token || ''}`
                ...
                const result = await response.json();
                logger_js_1.default.info('GNN embedding generation initiated', {
                    investigationId,
                    jobId,
                    taskId: result.task_id,
                    modelName,
                ...
                (0, middleware_js_1.trackError)('gnn_service', 'EmbeddingGenerationError');
                logger_js_1.default.error('GNN embedding generation failed', {
                    investigationId,
                    jobId,
                    error: error.message
                });
    ...
    async listModels(options = {}) {
        try {
            const response = await (0, node_fetch_1.default)(`${this.mlServiceUrl}/gnn/models`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${options.token || ''}`
                },
            ...
            const result = await response.json();
            logger_js_1.default.info('GNN models listed', {
            ...
            (0, middleware_js_1.trackError)('gnn_service', 'ListModelsError');
            logger_js_1.default.error('Failed to list GNN models', {
                error: error.message
            });
            return {
                success: false,
    ...
    async getModelInfo(modelName, options = {}) {
        try {
            const response = await (0, node_fetch_1.default)(`${this.mlServiceUrl}/gnn/models/${modelName}`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${options.token || ''}`
                },
            ...
            const result = await response.json();
            logger_js_1.default.info('GNN model info retrieved', {
                modelName,
            ...
            (0, middleware_js_1.trackError)('gnn_service', 'GetModelInfoError');
            logger_js_1.default.error('Failed to get GNN model info', {
                modelName,
                error: error.message
            });
            return {
    ...
    async deleteModel(modelName, options = {}) {
        try {
            ...
            const result = await response.json();
            logger_js_1.default.info('GNN model deleted', {
                modelName
            });
            return {
                success: true,
            ...
            (0, middleware_js_1.trackError)('gnn_service', 'DeleteModelError');
            logger_js_1.default.error('Failed to delete GNN model', {
                modelName,
                error: error.message
            });
            return {
    ...
    convertGraphData(graphData, format = 'auto') {
        try {
            ...
            logger_js_1.default.error('Failed to convert graph data', {
                error: error.message,
                format
            });
    ...
    async healthCheck() {
        try {
            const response = await (0, node_fetch_1.default)(`${this.mlServiceUrl}/health`, {
                method: 'GET',
                timeout: 5000
            });
            return {
...
exports.default = new GNNService();
