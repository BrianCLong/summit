...
exports.aiAnalysisResolvers = {
    Query: {
        ...
        extractEntities: async (_, { text, extractRelationships = false, confidenceThreshold = 0.7 }, context) => {
            ...
            const result = await aiAnalysis_js_1.aiAnalysisService.extractEntities(text, {
        ...
        analyzeRelationships: async (_, { entities, text }, context) => {
            ...
            const relationships = await aiAnalysis_js_1.aiAnalysisService.analyzeRelationships(entities, text);
        ...
        generateEntityInsights: async (_, { entityId, entityType, properties = {} }, context) => {
            ...
            const insights = await aiAnalysis_js_1.aiAnalysisService.generateEntityInsights(entityId, entityType, properties);
            return {
                entityId,
        ...
        analyzeSentiment: async (_, { text }, context) => {
            ...
            const result = await aiAnalysis_js_1.aiAnalysisService.analyzeSentiment(text);
            return {
        ...
        getDataQualityInsights: async (_, { graphId }, context) => {
            (0, auth_js_1.requireAuth)(context);
...
exports.default = exports.aiAnalysisResolvers;
