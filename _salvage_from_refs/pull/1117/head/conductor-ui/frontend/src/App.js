    ...
    children: [
      (title || right) &&
        _jsxs('div', {
          ...
          children: [
            _jsx('div', { className: 'text-sm font-semibold', children: title }),
  ...
  return _jsxs('div', {
    children: [
      _jsx('div', {
        ...
        children: _jsx('div', { style: { width: `${w}%` }, className: 'h-full bg-indigo-600' }),
      }),
      caption && _jsx('div', { className: 'text-xs text-gray-600 mt-1', children: caption }),
    ],
  });
}
...
function Header({ store }) {
  const { ENV } = store;
  return _jsxs('div', {
    className: 'flex items-center gap-3 p-3 border-b bg-white sticky top-0 z-10',
    children: [
      _jsx('div', { className: 'text-lg font-semibold', children: '\uD83C\uDFBC Symphony' }),
      _jsxs('div', {
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx(StatChip, { ok: store.services.federation, label: 'Federation' }),
        ],
      }),
      _jsx('div', {
        className: 'text-[10px] text-gray-500 ml-3',
        children: ENV.PROXY_BASE ? `Proxy: ${ENV.PROXY_BASE}` : 'Proxy: (not set)',
      }),
    ],
  });
}
function Sidebar({ active, setActive }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', { className: 'p-3 text-sm text-gray-500', children: 'Navigation' }),
      _jsx('nav', {
  ...
  return _jsxs('div', {
    ...
    children: [
        ...
        children: !h
          ...
          : _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  children: [
                    _jsx('span', { className: 'font-semibold', children: 'ENV:' }),
                    ' ',
                    store.env,
                  ],
                }),
                _jsxs('div', {
                  children: [
                    _jsx('span', { className: 'font-semibold', children: 'LOA:' }),
                    ' ',
                    store.loa,
                  ],
                }),
                _jsxs('div', {
                  children: [
                    _jsx('span', { className: 'font-semibold', children: 'Kill:' }),
                    ' ',
                    store.kill ? 'ON' : 'OFF',
                  ],
                }),
                _jsxs('div', {
                  children: [
                    _jsx('span', { className: 'font-semibold', children: 'Clock:' }),
                    ' ',
      ...
      _jsx(Card, {
        ...
        children: _jsx('div', {
          className: 'text-sm text-gray-600',
          children: 'Hook to your queue depth & error rate metrics if available.',
        }),
      }),
      _jsx('div', {
      ...
      _jsx(Card, { title: 'Recent Logs (tail)', children: _jsx(LogsTailMini, { store: store }) }),
    ],
  });
}
function ModelWindow({ win, burndown }) {
  ...
  if (!W) return _jsx('div', { className: 'text-sm text-gray-500', children: 'No data.' });
  ...
  return _jsxs('div', {
    children: [
      ...
      _jsxs('div', {
        ...
        children: [
          names.length === 0 &&
            _jsx('div', { className: 'text-sm text-gray-500', children: 'No data.' }),
          names.map((m) => {
            const v = per[m];
            ...
            return _jsxs(
              'div',
              {
                children: [
                  ...
                  _jsx(ProgressBar, { value: v.req || 0, max: cap || 100, caption: caption }),
                ],
              },
              m,
            );
...
function LogsTailMini({ store }) {
  ...
  return _jsxs('div', {
    children: [
      ...
      _jsx('pre', {
        className: 'text-xs whitespace-pre-wrap min-h-[140px] max-h-[220px] overflow-auto',
    ...
    children: [
      _jsx(Card, {
        ...
        right: _jsxs('div', {
          ...
          children: [
            ...
            _jsx('button', {
              onClick: doExec,
              className: 'px-3 py-1.5 rounded-xl bg-indigo-600 text-white disabled:opacity-50',
        ...
        children: _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              children: [
                _jsx('label', { className: 'text-xs text-gray-600', children: 'Task' }),
                _jsxs('select', {
                  value: task,
            ...
            _jsxs('div', {
              children: [
                _jsx('label', { className: 'text-xs text-gray-600', children: 'Model Candidates' }),
                _jsx('div', {
                  className: 'text-xs text-gray-800 border rounded-xl p-2 h-[40px] overflow-auto',
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('label', { className: 'text-xs text-gray-600', children: 'Input' }),
                _jsx('textarea', {
                  value: input,
      ...
      _jsx(Card, {
        ...
        children: !plan
          ...
          : plan.error
            ? _jsx('div', { className: 'text-sm text-red-600', children: String(plan.error) })
            : _jsxs('div', {
                className: 'text-sm space-y-2',
                children: [
                  _jsxs('div', {
                    children: [
                      _jsx('span', { className: 'font-medium', children: 'Decision:' }),
                      ' ',
                      plan.decision?.model,
                      ' \u00B7 Conf ',
                  ...
                  _jsxs('div', {
                    children: [
                      ...
                      _jsx('pre', {
                        className: 'text-xs bg-gray-50 border rounded-xl p-2 whitespace-pre-wrap',
      ...
      _jsx('div', {
        ...
        children: _jsx(Card, {
          ...
          children: !res
            ...
            : res.error
              ? _jsx('div', { className: 'text-sm text-red-600', children: String(res.error) })
              : _jsxs('div', {
                  className: 'grid grid-cols-1 md:grid-cols-3 gap-3 text-sm',
                  children: [
                    _jsxs('div', {
                      children: [
                        _jsx('span', { className: 'font-medium', children: 'Audit:' }),
                        ' ',
                        res.audit_id || '—',
                      ],
                    }),
                    _jsxs('div', {
                      children: [
                        _jsx('span', { className: 'font-medium', children: 'Latency:' }),
                        ' ',
                    ...
                    _jsxs('div', {
                      children: [
                        _jsx('span', { className: 'font-medium', children: 'Cost:' }),
                        ' ',
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('div', { className: 'text-xs text-gray-600', children: 'Output' }),
                        _jsx('pre', {
                          className: 'text-xs bg-gray-50 border rounded-xl p-3 whitespace-pre-wrap',
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx(Card, {
        title: 'Answer',
        children: !ans
          ? _jsx('div', { className: 'text-sm text-gray-500', children: 'No answer yet.' })
          : ans.error
            ? _jsx('div', { className: 'text-sm text-red-600', children: String(ans.error) })
            : _jsxs('div', {
                children: [
                  ans._no_rag &&
                    _jsx('div', {
                  ...
                  _jsx('div', { className: 'text-sm whitespace-pre-wrap', children: ans.answer }),
                  _jsxs('div', {
                    className: 'mt-3',
                    children: [
                      _jsx('div', { className: 'text-xs font-semibold', children: 'Citations' }),
                      (ans.cites || []).length
                        ? _jsx('ol', {
                        ...
                        : _jsx('div', { className: 'text-xs text-gray-500', children: '(none)' }),
                    ],
                  }),
                ],
              }),
    ...
    children: [
      _jsxs(Card, {
        ...
        children: [
          ...
          store.kill === 1 &&
            _jsx('div', {
              className: 'text-xs text-red-700 bg-red-50 border border-red-200 rounded-lg p-2 mt-2',
              children: 'Kill switch is ON. Actions are disabled.',
            }),
          _jsxs('div', { className: 'text-xs text-gray-500 mt-2', children: ['Status: ', status] }),
          run &&
            _jsxs('div', {
              className: 'text-xs text-gray-500',
      ...
      _jsx(Card, {
        title: 'Console',
        children: _jsx('pre', {
          className: 'text-xs whitespace-pre-wrap min-h-[260px] max-h-[380px] overflow-auto',
...
function Budgets({ store }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx(Card, { title: 'Hour Window', children: _jsx(ModelWindow, { win: 'h1', burndown: b }) }),
      _jsx('div', {
        className: 'xl:col-span-2',
        children: _jsx(Card, {
          title: 'Daily Window',
                      ...
                      'div',
                      {
                        children: [
                          _jsxs('div', {
                            className: 'flex items-center justify-between text-sm',
                            children: [
                              _jsx('div', { className: 'font-medium', children: p }),
                              _jsxs('div', {
                                className: 'text-xs text-gray-500',
  ...
  return _jsx('div', {
    ...
    children: _jsxs(Card, {
      ...
      right: _jsxs('div', {
        ...
        children: [
          _jsx('div', { className: 'text-slate-500 text-sm', children: details }),
          _jsx('button', {
            onClick: save,
            disabled: busy || !store.ENV.PROXY_BASE,
            className: 'px-3 py-1.5 rounded-xl bg-slate-900 text-white disabled:opacity-50',
            children: 'Save',
          }),
        ],
      }),
      children: [
        ...
        _jsx('div', { className: 'text-xs mt-2 text-slate-500', children: busy ? 'Working…' : '' }),
      ],
    }),
  });
}
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx(Card, {
        ...
        children: _jsx('div', {
          className: 'text-sm text-gray-600',
          children: 'Commands must be allow-listed by the proxy. LOA/Kill gates apply.',
        }),
      }),
    ],
  });
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsxs('ul', {
        ...
        children: [
          _jsx('li', { children: 'Onboarding: how to configure LiteLLM, Ollama, and the Proxy.' }),
          _jsx('li', {
            children:
              'Incident Playbooks: rate-limit storms, provider outages, policy regressions.',
          }),
          _jsx('li', {
            children: 'Release Checklist: smoke tests, policy diff, LOA audit, rollback plan.',
          }),
        ],
      }),
      _jsx('p', {
