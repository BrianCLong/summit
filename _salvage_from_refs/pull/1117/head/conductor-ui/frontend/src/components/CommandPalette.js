...
export function CommandPalette() {
  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(Box, {
      sx: { p: 2 },
      children: [
        _jsx(Typography, { variant: 'h6', gutterBottom: true, children: 'Command Palette' }),
        _jsx('form', {
        ...
        output &&
          _jsxs(Box, {
            ...
            children: [
              ...
              _jsx(Typography, { variant: 'body2', component: 'pre', children: output }),
            ],
          }),
        error &&
          _jsxs(Box, {
            ...
            children: [
              _jsx(Typography, { variant: 'body2', color: 'error', children: 'Error:' }),
              _jsx(Typography, {
                variant: 'body2',
                component: 'pre',
                color: 'error',
