  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('h2', { className: 'text-lg font-semibold', children: 'Secrets & Connections' }),
          _jsx('button', {
      ...
      showNewSecretForm &&
        _jsxs('div', {
          ...
          children: [
            _jsx('h3', { className: 'font-medium text-slate-900', children: 'Create New Secret' }),
            _jsxs('div', {
                ...
                _jsxs('div', {
                  children: [
                    ...
                    _jsxs('select', {
                      ...
                      className: 'mt-1 w-full px-3 py-2 border border-slate-200 rounded-md',
                      children: [
                        _jsx('option', { value: 'vault', children: 'HashiCorp Vault' }),
                        _jsx('option', { value: 'aws-kms', children: 'AWS KMS' }),
                        _jsx('option', { value: 'azure-kv', children: 'Azure Key Vault' }),
                        _jsx('option', { value: 'gcp-sm', children: 'Google Secret Manager' }),
                      ],
                    }),
                  ],
                }),
          ...
          _jsxs('table', {
            ...
            children: [
              _jsx('thead', {
                ...
                children: _jsxs('tr', {
                  children: [
                    _jsx('th', { className: 'px-4 py-3', children: 'Reference' }),
                    _jsx('th', { className: 'px-4 py-3', children: 'Provider' }),
                    _jsx('th', { className: 'px-4 py-3', children: 'Last Access' }),
                    _jsx('th', { className: 'px-4 py-3', children: 'Rotation Due' }),
                ...
                children: items.map((s) =>
                  _jsxs(
                    'tr',
                    {
                      ...
                      children: [
                        _jsx('td', { className: 'px-4 py-3 font-mono text-xs', children: s.ref }),
                        _jsx('td', {
                          className: 'px-4 py-3',
                          children: _jsx('span', {
                            className:
                ...
                children: providers.map((p) =>
                  _jsxs(
                    'tr',
                    {
                      className: 'border-t hover:bg-slate-50',
                      children: [
                        _jsx('td', { className: 'px-4 py-3 font-medium', children: p.name }),
                        _jsx('td', {
                          className: 'px-4 py-3',
                          children: _jsx('span', {
