  ...
  return _jsxs('section', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('label', { htmlFor: 'win', className: 'text-sm', children: 'Window' }),
          _jsxs('select', {
            id: 'win',
      ...
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            children: [
              _jsx('div', { className: 'text-sm text-gray-500', children: 'Total spend' }),
              _jsxs('div', {
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('div', { className: 'mb-2 text-sm text-gray-600', children: 'Spend over time' }),
          _jsx('div', {
            style: { height: 220 },
      ...
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            className: 'rounded-2xl border p-3',
            children: [
              _jsx('div', { className: 'mb-2 text-sm text-gray-600', children: 'By pipeline' }),
              _jsxs('table', {
                  ...
                  _jsxs(
                    'tr',
                    {
                      children: [
                        ...
                        _jsx('td', { children: r.pipeline }),
                        _jsx('td', { children: new Date(r.startedAt).toLocaleString() }),
                        _jsxs('td', { children: [Math.round(r.durationMs / 1000), 's'] }),
