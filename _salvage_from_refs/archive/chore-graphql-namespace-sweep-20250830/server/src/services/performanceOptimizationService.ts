...
export class PerformanceOptimizationService extends EventEmitter {
  ...
  public recordMetric(endpoint: string, responseTime: number, status: 'success' | 'error' | 'timeout'): void {
  ...
  public async optimizeQuery(queryType: 'graphql' | 'cypher' | 'sql', query: string): Promise<QueryOptimization> {
