    ...
    <Card elevation={1} sx={{ p: 1, borderRadius: 3 }}>
      <CardContent>
        ...
        <Stack direction="row" spacing={2}>
          <Button href={grafana} target="_blank" rel="noreferrer" variant="contained">Open Grafana</Button>
          <Button href={jaeger} target="_blank" rel="noreferrer" variant="outlined">Open Jaeger</Button>
        </Stack>
      </CardContent>
    </Card>
  );
