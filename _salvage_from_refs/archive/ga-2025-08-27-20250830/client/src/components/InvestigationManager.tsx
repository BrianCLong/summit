...
function InvestigationManager({ onInvestigationSelect, currentInvestigationId }: InvestigationManagerProps) {
      ...
      <div className="panel" style={{ padding: '24px', marginBottom: '20px' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
            ...
            >
              {(createLoading || updateLoading) ? '⏳ Saving...' : (investigation ? 'Update' : 'Create')}
            </button>
          </div>
        </form>
      </div>
    ...
    <div style={{ padding: '24px' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          <div style={{ display: 'flex', border: '1px solid var(--hairline)', borderRadius: '4px' }}>
            <button
      ...
      {error && (
        <div className="panel" style={{ 
          ...
          <div style={{ color: '#dc2626', marginBottom: '8px' }}>❌ Failed to load investigations</div>
              ...
              {investigations.map((investigation: Investigation) => (
                ...
                >
                  ...
                  <div style={{ 
                    ...
                    <div>
                      <strong>Created:</strong> {new Date(investigation.createdAt).toLocaleDateString()}
                    </div>
                    <div>
                      <strong>Updated:</strong> {new Date(investigation.updatedAt).toLocaleDateString()}
                    </div>
                  </div>
