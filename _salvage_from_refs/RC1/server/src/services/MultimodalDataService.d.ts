import { Driver } from 'neo4j-driver';
  ...
  declare class MultimodalDataService {
    ...
    findCrossModalMatches(entityId: string, targetMediaTypes: string[]): Promise<any[]>;
    ...
    findDuplicateEntities(args: { investigationId?: string; similarity?: number; limit?: number }): Promise<any[]>;
    ...
    createMultimodalEntity(entityData: CreateMultimodalEntityInput, userId: string): Promise<any>;
    updateMultimodalEntity(id: string, input: CreateMultimodalEntityInput, userId: string): Promise<any>;
    verifyMultimodalEntity(id: string, verified: boolean, userId: string): Promise<any>;
    mergeMultimodalEntities(primaryId: string, secondaryIds: string[], userId: string): Promise<any>;
    createMultimodalRelationship(relationshipData: CreateMultimodalRelationshipInput, userId: string): Promise<any>;
    updateMultimodalRelationship(id: string, input: CreateMultimodalRelationshipInput, userId: string): Promise<any>;
    verifyMultimodalRelationship(id: string, verified: boolean, userId: string): Promise<any>;
    ...
    computeSemanticClusters(investigationId: string, algorithm?: string): Promise<any>;
    validateExtractionResults(jobId: string): Promise<any>;
    cleanupDuplicateEntities(investigationId: string, similarity?: number, autoMerge?: boolean, userId?: string): Promise<any>;
  }
