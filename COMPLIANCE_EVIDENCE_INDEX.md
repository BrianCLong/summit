...
| **SEC-004**  | Agent action gateway chokepoint with attribution, policy, and audit | AI, SOC             | [docs/security/agent-action-gateway.md](docs/security/agent-action-gateway.md); tests at `packages/agent-lab/__tests__/agent-action-gateway.test.ts` |
