...
function addContribution(contributions, id, category, weight, reason) {
    contributions.push({ id, category, weight, reason });
}
function scoreCode(inputs, weights) {
    const contributions = [];
...
function scoreCi(inputs, weights) {
    const contributions = [];
...
function scoreAgent(inputs, weights) {
    const contributions = [];
...
function scoreGovernance(inputs, weights) {
    const contributions = [];
...
function assembleRecommendations(band, weights) {
...
function scoreChange() {
    ...
    const inputData = loadJsonFile(input);
