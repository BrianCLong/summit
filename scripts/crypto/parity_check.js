...
const index_1 = require("../../services/crypto/index");
const pool = new pg_1.Pool({ connectionString: process.env.DATABASE_URL });
async function checkParity() {
    const primaryKms = new index_1.AwsKmsProvider('alias/conductor/stage/mrk');
    const secondaryKms = new index_1.AwsKmsProvider('alias/conductor/stage/mrk'); // Assuming same alias, different regions configured in SDK
