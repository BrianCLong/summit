...
def main() -> int:
    ...
    for p in EVID.rglob("*"):
        ...
        try:
            ...
            # Refined timestamp detection: look for ISO-like strings (YYYY-MM-DDTHH:MM)
            # This avoids false positives from Evidence IDs like EVD-20260202...
