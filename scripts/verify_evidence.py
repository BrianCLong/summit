...
def main() -> int:
    ...
    , "metrics.json", "report.json", "governed_exceptions.json", "forbidden_timestamp.json", "report.timestamp.json", "stamp.ok.json"}
    IGNORE_DIRS = {"EVD-INTSUM-2026-THREAT-HORIZON-001", "EVD-NARRATIVE_IOPS_20260129-FRAMES-001", "EVD-BLACKBIRD-RAV3N-EXEC-REP-001", "EVD-POSTIZ-GATE-004", "HONO-ERRBOUNDARY-XSS", "EVD-POSTIZ-COMPLY-002", "EVD-CTA-LEADERS-2026-01-INGEST-001", "EVD-POSTIZ-PROD-003", "EVD-2601-20245-SKILL-001", "reports", "TELETOK-2025", "ai-influence-ops", "EVD-POSTIZ-GROWTH-001", "ga", "bundles", "schemas", "ecosystem", "jules", "project19", "governance", "azure-turin-v7", "ci", "context", "mcp", "mcp-apps", "runs", "runtime", "subsumption", "out", "cognitive", "model_ti", "DISINFO-NEWS-ECOSYSTEM-2026", "EVID-NARINT-SMOKE", "eval-repro", "EVD-IOB20260202-AIAGENT-001", "EVD-IOB20260202-SUPPLYCHAIN-001", "EVID-IOPS-20260208-v2-schema-gitsha7", "moltbook-relay-surface-001", "EVD-IOB20260202-FIMI-001", "forbes-2026-trends", "osintplatint_20260201_transform_search_ea8aba4", "EVD-IOB20260202-WIRELESS-001", "EVD-IOB20260202-ALLYRISK-001", "EVD-IOB20260202-HUMINT-001", "EVD-IOB20260202-ECONESP-001", "EVD-COGWAR-2026-EVENT-002", "pppt-501608", "FORBES-AGENTIC-AI-2026", "EVID-20260131-ufar-0001", "audit", "EVD-COGWAR-2026-EVENT-003", "portal-kombat-venezuela", "EVD-NARRATIVE-CI-METRICS-001", "EVD-IOB20260202-CAPACITY-001", "policy", "EVD-COGWAR-2026-EVENT-001", "fixtures"}
