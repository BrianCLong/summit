...
def main() -> int:
    ...
    IGNORE_DIRS = {"schemas", "ecosystem", "jules", "project19", "governance", "azure-turin-v7", "ci", "context", "mcp", "mcp-apps", "runs", "runtime", "subsumption", "out",
                   ...
                   "EVD-POSTIZ-GROWTH-001", "EVD-POSTIZ-PROD-003", "EVD-POSTIZ-GATE-004", "EVD-2601-20245-SKILL-001",
                   "EVD-CTA-LEADERS-2026-01-INGEST-001", "EVD-BLACKBIRD-RAV3N-EXEC-REP-001",
                   "EVD-NARRATIVE_IOPS_20260129-FRAMES-001", "EVD-POSTIZ-COMPLY-002"}
