...
def main() -> int:
    ...
    IGNORE_DIRS = {
        ...
        "EVD-IOB20260202-ECONESP-001", "EVD-IOB20260202-CAPACITY-001",
        "DISINFO-NEWS-ECOSYSTEM-2026", "EVID-NARINT-SMOKE", "eval-repro",
        "moltbook-relay-surface-001", "forbes-2026-trends", "osintplatint_20260201_transform_search_ea8aba4",
        "EVD-COGWAR-2026-EVENT-002", "EVD-COGWAR-2026-EVENT-003", "EVD-COGWAR-2026-EVENT-001",
        "FORBES-AGENTIC-AI-2026", "EVID-20260131-ufar-0001", "portal-kombat-venezuela", "audit", "policy",
        "EVID-IOPS-20260208-v2-schema-gitsha7", "EVD-NARRATIVE-CI-METRICS-001", "fixtures", "pppt-501608"
    }
