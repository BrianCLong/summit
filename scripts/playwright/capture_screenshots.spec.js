...
(0, test_1.test)('capture UI screenshots with interactions', async ({ page }) => {
    ...
    try {
        ...
        if (await admin.count()) {
            ...
            const toggle = page
                .getByRole('button', { name: /Toggle demo-mode/i })
                .first();
