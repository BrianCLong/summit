...
function ensureDecisionArtifact(pr) {
    const artifactPath = node_path_1.default.resolve(process.cwd(), `artifacts/risk-decisions/${pr}.json`);
    return node_fs_1.default.existsSync(artifactPath);
}
function requireEnv(name, allowed) {
