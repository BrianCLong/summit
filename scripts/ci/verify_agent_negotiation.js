...
const simulator_ts_1 = require("../../packages/agent-negotiation/src/simulator.ts");
...
try {
    const simulator = new simulator_ts_1.NegotiationSimulator([infraAgent, reliabilityAgent, finopsAgent]);
    ...
    if (!result1.approved)
        throw new Error("Scenario 1 should have been approved");
    ...
    if (result2.approved)
        throw new Error("Scenario 2 should have been rejected by FinOps");
