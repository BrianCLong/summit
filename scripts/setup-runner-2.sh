#!/bin/bash
# Setup script for Summit Runner 2 (Test Runner)
# Run this on Computer 2

set -e

echo "========================================"
echo "Summit Runner 2 - Test Runner Setup"
echo "========================================"
echo ""

# Configuration
RUNNER_NAME="summit-runner-2"
RUNNER_DIR="$HOME/actions-runner-2"
RUNNER_VERSION="2.331.0"
RUNNER_LABELS="self-hosted,linux,x64,summit-test"
...
echo ""
echo "========================================"
echo "✓ Summit Runner 2 Setup Complete!"
echo "========================================"
echo ""
echo "Runner Details:"
