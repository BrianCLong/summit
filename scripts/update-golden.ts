...
import { buildSamplePolicyDecision, buildSampleReceipt } from "../test/fixtures/golden/samples.js";
...
writeFileSync(path.join(fixtureDir, "policy_decision_v0_1.json"), `${serializedDecision}\n`);
