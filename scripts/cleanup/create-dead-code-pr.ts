...
function buildPrBody(candidates: DeadCodeCandidate[], report: DeadCodeReport, reportPath: string): string {
...
function executeCleanup(branchName: string, candidates: DeadCodeCandidate[], maxDeletes: number): void {
