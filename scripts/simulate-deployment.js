...
const blue_green_deployer_js_1 = require("../server/lib/deployment/blue-green-deployer.js");
const nginx_adapter_js_1 = require("../server/lib/deployment/adapters/nginx-adapter.js");
const rollback_engine_js_1 = require("../server/lib/deployment/rollback-engine.js");
...
async function runSuccessfulDeployment() {
    ...
    const lb = new nginx_adapter_js_1.NginxLoadBalancerAdapter('/etc/nginx/conf.d/upstream.conf', true);
    const monitor = new blue_green_deployer_js_1.MockMonitoringService();
    const rollback = new rollback_engine_js_1.RollbackEngine();
    const deployer = new blue_green_deployer_js_1.BlueGreenDeployer({
        serviceName,
        stableVersion,
        newVersion,
