...
function writeSnapshot(data) {
    const jsonPath = node_path_1.default.join(OUTPUT_DIR, 'slo_snapshot.json');
    node_fs_1.default.writeFileSync(jsonPath, JSON.stringify(data, null, 2));
    console.log(`Wrote JSON snapshot to ${jsonPath}`);
    // Generate MD
    const mdPath = node_path_1.default.join(OUTPUT_DIR, 'slo_snapshot.md');
    ...
    node_fs_1.default.writeFileSync(mdPath, mdContent);
