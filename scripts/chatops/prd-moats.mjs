...
const prd = `# Product Requirements Document: ChatOps Moats
...
fs.writeFileSync(path.join(docsDir, 'prd-moats.md'), prd);
console.log('✅ Generated PRD -> docs/chatops/prd-moats.md');
