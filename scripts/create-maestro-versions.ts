...
function generateConductorTemplate(versionInfo: any, versionNumber: number): string {
...
function generateIndexTemplate(versionInfo: any, versionNumber: number): string {
  return `// Maestro Conductor v${versionInfo.version} - ${versionInfo.codename}
// ${versionInfo.description}
