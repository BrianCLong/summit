#!/bin/bash
# Setup script for Summit Runner 3 (Deploy Runner)
# Run this on Computer 3

set -e

echo "========================================"
echo "Summit Runner 3 - Deploy Runner Setup"
echo "========================================"
echo ""

# Configuration
RUNNER_NAME="summit-runner-3"
RUNNER_DIR="$HOME/actions-runner-3"
RUNNER_VERSION="2.331.0"
RUNNER_LABELS="self-hosted,linux,x64,summit-deploy"
...
echo ""
echo "========================================"
echo "✓ Summit Runner 3 Setup Complete!"
echo "========================================"
echo ""
echo "Runner Details:"
