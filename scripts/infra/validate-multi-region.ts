...
const regions: RegionConfig[] = [
  {
    ...
    endpoint: "https://us-east-1.api.example.com/health",
  },
  {
    id: "eu-west-1",
    name: "EU West (Ireland)",
    endpoint: "https://eu-west-1.api.example.com/health",
  },
  {
    id: "ap-northeast-1",
    name: "Asia Pacific (Tokyo)",
    endpoint: "https://ap-northeast-1.api.example.com/health",
  },
];
...
async function main() {
  ...
  const monitor = new AutoRollbackMonitor("payment-service", rollbackEngine, prober, {
