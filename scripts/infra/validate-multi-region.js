...
exports.main = main;
const index_js_1 = require("../../server/src/lib/deployment/index.js");
...
async function main() {
    ...
    const prober = new index_js_1.MultiRegionProber(regions, mockAxiosInstance);
    ...
    console.log('\n--- 2. Region Skew Detection ---');
    const skewDetector = new index_js_1.RegionSkewDetector(200); // 200ms threshold
    ...
    const failoverValidator = new index_js_1.FailoverValidator(prober, 'us-east-1');
    ...
    const rollbackEngine = new index_js_1.RollbackEngine();
    const monitor = new index_js_1.AutoRollbackMonitor('payment-service', rollbackEngine, prober, { errorRateThreshold: 0.05, latencyThresholdMs: 500, consecutiveFailures: 1 });
    // Trigger a check
