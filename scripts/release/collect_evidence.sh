...
#
# Usage:
#   ./scripts/release/collect_evidence.sh [OPTIONS]
#
# Options:
...
generate_summary() {
...

  {
    ...
    echo "---"
    echo ""
    echo "_Generated by collect_evidence.sh_"
...
update_evidence_index() {
  ...
  local entry="| $RUN_DATE | Evidence Collection $RUN_ID | [Summary]($OUTPUT_DIR/evidence-summary-$RUN_ID.md) | collect_evidence.sh |"
