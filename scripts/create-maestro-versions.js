...
const maestroVersions = [
    {
        ...
        description: 'Multi-tenant isolation, resource quotas, and advanced governance',
    },
    {
        version: '0.7.0',
...
for (let i = 6; i <= 20; i++) {
    ...
    fs_1.default.writeFileSync(path_1.default.join(versionDir, 'conductor.ts'), conductorContent);
    // Create index.ts
    const indexContent = generateIndexTemplate(versionInfo, i);
    fs_1.default.writeFileSync(path_1.default.join(versionDir, 'index.ts'), indexContent);
}
