...
- **Integrity:** The file is a mutable artifact. It can be edited, shared, or altered without a tamper-evident audit trail of _who_ changed _what_ and _when_.
...
- **Provenance:** Every node and edge creation/modification is a signed transaction. We know _exactly_ which agent (human or AI), policy, and source authorized the change.
