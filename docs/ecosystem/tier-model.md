# Ecosystem Layer Model (Canonical)

Summit exposes **three concentric ecosystem layers**, each with different rights.

```
┌──────────────────────────────┐
│  Insight & Intelligence      │  ← Read-only value creation (Tier 1)
├──────────────────────────────┤
│  Recommendation & Analysis   │  ← Propose, never decide (Tier 2)
├──────────────────────────────┤
│  Authority & Execution       │  ← Summit-only (sealed)
└──────────────────────────────┘
```

Only Summit occupies the bottom layer.
