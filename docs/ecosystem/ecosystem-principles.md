...
## Ecosystem Non-Negotiables (Hard Constraints)

Before anything else, these must be explicit and enforced:

1. **No external actor may execute decisions**
2. **No plugin may bypass evidence or policy**
3. **No extension may claim authority**
4. **No partner may weaken refusal semantics**
5. **All ecosystem value must be auditable**

If an ecosystem design violates any of these, it is rejected.

## The Summit Ecosystem Manifesto
...
4. Refusal is not failure.
5. Economic incentives must not distort judgment.

We welcome partners who increase clarity.
We reject those who seek control.
