...
*   **Source:** *Constitutional AI: Harmlessness from AI Feedback* (Bai et al., 2022) / *RLAIF* (Lee et al., 2023)
...
*   **Source:** *Not what you’ve signed up for: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection* (Greshake et al., 2023)
