...
- **Intel quality:** κ **≥ 0.87**; Brier **≤ 0.11**; override rate **≤ 5.9%**; trust reliability slope ≤ 1.1; **90% federation** stable (guarded).  
  *Verify:* Eval reports; trust dashboard; drift monitors.
