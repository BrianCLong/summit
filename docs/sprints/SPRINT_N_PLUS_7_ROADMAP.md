...
*Goal: Air-gapped capable, RAG-enhanced copilot.*
...
*Goal: Multi-source OSINT fusion.*
  ...
  "initiatives": [
    {
      ...
      "epics": [
        { "id": "A1", "status": "pending|in-progress|done", "owner": "Agent-X" }
      ]
    }
  ]
}
