...
| A    | `ci-validator: block uncataloged datasets`            | `epic-a`, `ci`, `blocker`         | Dataset diff strategy defined; failure messaging drafted.                                        | Validator runs in CI; failing/ passing cases stored in `.evidence/sprint-28/data-catalog/ci-validation.log`.                                     |
