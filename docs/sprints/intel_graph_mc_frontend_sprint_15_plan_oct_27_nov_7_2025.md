...
**Should**
7) Profile & Tokens (masked) panel; copy token id; last‑used metadata.
8) Saved audit filters + shareable deep links.

**Could**
9) Region status widget (read‑only) on Control Hub.
10) Guided tour tooltips for Admin & Audit screens.
