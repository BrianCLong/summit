...
- **Decisive idea:** run **six parallel workstreams** with one shared spine: _initiative map → priority bets → controls/telemetry → narrative cover → policy surface → scorecard/tripwires_.
...
- **JS-1: Initiative Space Map v1**
  - Deliverable: 1-page map of _choke points, standards, incentives, coalitions, architecture moves_.
