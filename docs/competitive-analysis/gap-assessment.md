...
## Related Competitive Artifacts

- **[Competitive Scorecard](competitive-scorecard.md):** A one-page comparison of Summit against key market categories.
- **[Epic Backlog](../backlog/epic-backlog.md):** Detailed epics, acceptance tests, and receipt requirements to achieve competitive parity.
