...
- [ ] Advance or demote stages based on criteria; flag risks (no champion, budget unclear, security stall).
...
- **Monday**
  ...
  - [ ] Plan sequences and offers for each active deal.
- **Wednesday**
  - [ ] Check pilot/proof progress; unblock data/identity/security access.
  - [ ] Prepare materials for any reviews (security, commercial, partner).
- **Friday**
  - [ ] Run the pipeline report from `summit-crm-pipeline.md` and share.
  - [ ] At-risk review: deals with no next step, no sponsor, or security lagging.
...
- Block time for prospecting and follow-up daily; protect 90 minutes for deep research weekly.
