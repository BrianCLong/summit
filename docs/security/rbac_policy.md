...
**Notes:** 3. Analysts can only update evidence they added 4. Analysts can only update findings they created; verification requires LEAD+
...
**Notes:** 5. Analysts can export investigations they created or are assigned to; exports are k-anonymized (k≥5) 6. Full exports include all PII, evidence metadata, and audit trails; requires reason and legal basis
