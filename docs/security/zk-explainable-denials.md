...
*   **Body:**
    ...
    ```
    *   *Note:* The `checked_against_count` is rounded to significant digits to prevent cardinality leakage.
...
*   **Body:**
    ...
    ```
    *   *Why:* If you query too many times with slight variations, you can isolate specific items. This error stops that.
