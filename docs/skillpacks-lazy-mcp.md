...
Skillpacks declare shards (for example: `default`, `deep`, `ci`). The router chooses a shard based on task type, governance mode, repo focus, and context budget. This keeps tool payloads minimal and deterministic.
