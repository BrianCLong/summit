...
```json
{
  ...
  "panels": [
    ...
    },
    {
      ...
      "type": "timeseries",
      "targets": [
        {"expr": "sum(rate(maestro_run_total[5m]))", "legendFormat": "Runs/sec"}
      ]
    },
    {
      ...
      "type": "timeseries",
      "targets": [
        {"expr": "sum(rate(maestro_cost_usd_total[5m]))", "legendFormat": "USD/min"}
      ]
    },
    {
      ...
      "type": "timeseries",
      "targets": [
        {"expr": "sum(rate(maestro_safety_blocks_total[5m]))", "legendFormat": "Blocks/min"},
        {"expr": "sum(rate(maestro_safety_warnings_total[5m]))", "legendFormat": "Warnings/min"}
      ]
    }
  ]
}
  ...
  "panels": [
    {
      ...
      "type": "piechart",
      "targets": [
        {"expr": "sum by (state) (maestro_saga_states)"}
      ]
    },
    {
      ...
      "type": "timeseries",
      "targets": [
        {"expr": "sum(rate(maestro_fl_rounds_total[5m]))", "legendFormat": "Rounds/min"},
        {"expr": "sum(rate(maestro_fl_byzantine_detected_total[5m]))", "legendFormat": "Byzantine/min"}
      ]
    },
    {
      ...
      "type": "bargauge",
      "targets": [
        {"expr": "sum by (region) (rate(maestro_run_total[5m]))"}
      ]
    },
    {
      ...
      "type": "timeseries",
      "targets": [
        {"expr": "histogram_quantile(0.95, sum(rate(maestro_event_store_append_duration_bucket[5m])) by (le))", "legendFormat": "p95 append"},
        {"expr": "histogram_quantile(0.95, sum(rate(maestro_event_store_query_duration_bucket[5m])) by (le))", "legendFormat": "p95 query"}
      ]
    }
  ]
}
  ...
  "panels": [
    {
      ...
      "type": "timeseries",
      "targets": [
        {"expr": "predict_linear(sum(rate(maestro_run_total[2h]))[7d:1h], 7*24*3600)", "legendFormat": "7-day prediction"},
        {"expr": "sum(rate(maestro_run_total[2h]))", "legendFormat": "Current rate"}
      ]
    },
    {
    ...
    },
    {
      ...
      "type": "timeseries",
      "targets": [
        {"expr": "maestro:cost_per_success:5m"}
      ]
    }
  ]
}
