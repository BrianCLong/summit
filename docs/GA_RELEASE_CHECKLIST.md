...
**Readiness Snapshot (Authoritative):**

- Source of truth: `docs/roadmap/STATUS.json` for epic-level GA blockers and readiness aggregation.
- Compliance anchor: `docs/SUMMIT_READINESS_ASSERTION.md` governs readiness assertions and must be cited in executive communications.
- Release gate: GA promotion is blocked until the GA blocker list is empty and all CRITICAL items are complete.
