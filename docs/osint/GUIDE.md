...
For Summit's intelligence model split between verified reality and narrative perception, see
[`ONTOLOGY_PHENOMENOLOGY_DIVERGENCE.md`](./ONTOLOGY_PHENOMENOLOGY_DIVERGENCE.md).
