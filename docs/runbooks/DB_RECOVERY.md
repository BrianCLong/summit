...
2.  **Identify Restore Point:**
    Find the timestamp _before_ the corruption occurred (e.g., `2023-10-27T14:30:00Z`).
...
4.  **Switch Traffic:**
    - Update the `db-credentials` secret in Kubernetes to point to the _new_ DB host.
