...
1. **Partner Workspace Templates** — _5 pts_
...
2. **Onboarding Health Checks (preflight)** — _5 pts_
...
3. **Guided “First Success” Flow** — _8 pts_
...
4. **NL→Cypher Guardrails v1.1** — _5 pts_
...
5. **Audit Log v1.1 (Retention + Search UX)** — _5 pts_
...
6. **Usage & Quota Telemetry (Partner Insights)** — _5 pts_
...
7. **Performance & Scale: Hot Path Hardening** — _6 pts_
...
8. **Support Runbooks & In-Product Diagnostics** — _3 pts_
...
**Stretch (time-boxed):** 9) **Invite/SSO (SCIM-lite)** — _3 pts_
Minimal SCIM-like import for users/roles; manual override path.

_Total forecast: 42 pts (stretch optional)._
...
- Unit + contract tests; one recorded E2E from _net-new_ tenant to export.
...
8. _(Stretch)_ Import users/roles via **Invite/SSO (SCIM-lite)**.
...
| SCAL-181 | Invite/SSO (SCIM-lite) _(Stretch)_     | BE     |   3 | —            | Import users/roles; manual override path          |
