...
| **OPERATOR** | workflow:_, task:_, evidence:_, serving:_                 | Workflow execution & management |
| **ANALYST**  | workflow:read/exec, task:read/exec, evidence:_, serving:_ | Analysis execution              |
