...
1. **PCA Manifests in Export Pipeline** — _8 pts_
...
2. **License Registry v1 (Overrides & Audit Trail)** — _5 pts_
...
3. **Role & Tenant Permissions** — _8 pts_
...
4. **NL→Cypher Quality Gate v1** — _5 pts_
...
5. **Authority Compiler (MVP)** — _8 pts_
...
6. **Report Studio v1 Polish** — _3 pts_
...
7. **Graph Query Perf Pass** — _3 pts_
