...
- **Evidence packager**: Bundles trace snapshots, receipts, and redaction reports for release evidence.
...
6. Export evidence artifacts to the provenance ledger with prompt hashes and task spec references.
