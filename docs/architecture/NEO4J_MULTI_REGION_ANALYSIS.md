...
*Note: The current Terraform establishes the compute (EKS) and application (Helm), but the actual data synchronization channel between regions for Neo4j is **NOT** configured.*
