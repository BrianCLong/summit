...
- **Resilience & isolation:** [`docs/architecture/blast-radius-model.md`](./blast-radius-model.md), [`docs/architecture/TENANT_HIERARCHY_MODEL.md`](./TENANT_HIERARCHY_MODEL.md), [`docs/architecture/cache-policy.md`](./cache-policy.md)
