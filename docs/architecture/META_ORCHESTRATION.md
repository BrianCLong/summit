...
The Meta-Orchestrator is a higher-order system designed to coordinate multiple autonomous AI agents. Unlike standard orchestration (e.g., Maestro) which executes predefined pipelines, the Meta-Orchestrator manages *negotiation*, *delegation*, and *lifecycle* of autonomous agents that may have conflicting goals or require consensus.
