...
A model for tracking the _flow_ of a specific narrative across the graph, treating information as a systemic risk factor. It measures velocity, acceleration, and cross-domain hops.
