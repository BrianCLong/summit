# Adobe Firefly Foundry vs Summit (Executive Comparison)

This comparison is directional and focuses on strategic posture and system boundaries.

## Summary

Adobe Firefly Foundry: enterprise creative generation with IP-safe positioning, embedded in creative workflows.

Summit: governed intelligence production across domains (creative, analytic, compliance, operational) with evidence-grade provenance, policy enforcement, and auditable attestations.
...
Summit positions the “foundry” as a general governance substrate:

- Any model, any agent, any tool, any domain
- Uniform evidence contracts across all outputs
- Policy and provenance treated as first-class artifacts

This enables Summit to subsume creative foundries as a single specialization rather than the top-level platform.
