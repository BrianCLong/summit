...
- Adapter identifiers are normalized to lowercase and common aliases (`rank-1`, `ln-only`, `ia3`) before evaluation.
- Overrides are logged as governed exceptions for auditability.
