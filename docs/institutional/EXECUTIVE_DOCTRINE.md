# Executive Summary: Institutional Intelligence Operating Doctrine

**Status:** Directive
**Target:** Executive Leadership, Board, Stakeholders

---

## The Core Mandate

We are building **governed infrastructure**, not an experimentation platform.
...
- **Tier 1 (Human-in-Loop):** System acts only with explicit human approval per action.
- **Tier 2 (Bounded):** System acts within strict, pre-approved envelopes (e.g., +/- 5% budget).
- **Tier 3 (Strategic):** Exceptional, board-authorized, single-use actions.
...
1.  **Quarterly Optimization Cycle (QOC):**
    - Focus: Making the system _better_, not _bigger_.
    - Limit: Max 3 changes/quarter.
    - Requirement: Must improve measurable metrics with zero regression.

2.  **Annual Re-Certification Cycle (ARC):**
    - Focus: Re-earning the right to operate.
    - Requirement: Every autonomy tier, certification, and budget must be re-justified.
...
**Final Executive Assertion:**

> We do not fund "AI projects." We fund **governed capabilities** that can explain themselves, bound themselves, and be shut down safely.
