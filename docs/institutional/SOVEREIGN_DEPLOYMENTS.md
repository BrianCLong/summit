...
*   **Zero-Internet Dependency:** The installation process must not require *any* outbound network connection. All dependencies (containers, models, databases, libraries) must be bundled in a single "Summit Artifact Bundle" (SAB).
