...
*   **Depreciation:** None. Unlike code, well-indexed decision history grows *more* valuable as the dataset expands.
...
*   **Metric:** `Cost Avoided per Decision Class` = (Time to investigate * Hourly Rate) * Reuse Count.
...
Competitors sell tools that help you make decisions *now*. Summit sells a platform where *past* decisions pay for *future* speed.
