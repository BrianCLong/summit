...
**Note:** "Cost" in dollars is a derived metric, not a control primitive. We control the *drivers* of cost (tokens, compute), not the currency itself.
...
| **Tier-4** | *Custom* (e.g. 5M) | 4 hours | 100 | Unlimited | 99 |
