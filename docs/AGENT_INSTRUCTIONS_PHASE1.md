...
This playbook is phase-specific and does not override governance or root agent rules. If it
conflicts with higher-order instructions, follow `docs/governance/CONSTITUTION.md` →
