...
```
GITHUB_TOKEN=<token> npx tsx scripts/triage/generate-closure-comments.ts --repo <owner/name> [--state open|all] [--since 2024-12-01T00:00:00Z]
```
...
- Sorts output by issue number for deterministic paste order.
