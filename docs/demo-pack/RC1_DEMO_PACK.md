...
1.  **Ingest (2 min):**
    ...
    - _Talk Track:_ "Notice how we don't just dump data; we resolve entities against the existing knowledge graph immediately."
...
2.  **Graph Exploration (3 min):**
    ...
    - _Talk Track:_ "We provide three synchronized views: Map, Graph, and Timeline. Context is preserved across all three."
...
3.  **Findings & Export (2 min):**
    ...
    - _Talk Track:_ "The report is cryptographically signed. You can hand this to a court or an auditor knowing the chain of custody is intact."
...
1.  **Policy Guardrails (1 min):**
    ...
    - _Talk Track:_ "Security is not an afterthought; it's policy-as-code baked into the query layer."
...
3.  **Cost & Usage (1 min):**
    ...
    - _Talk Track:_ "We track every LLM token and API call. You can set hard caps per team or per project."
