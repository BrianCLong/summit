...
LongHorizon evidence and policy gating are aligned to the Summit Readiness Assertion and governance authority files (see `docs/SUMMIT_READINESS_ASSERTION.md`).
