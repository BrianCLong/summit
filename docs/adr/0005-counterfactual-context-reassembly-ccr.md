...
variants (removal, trust attenuation, and reorder) and compare model outputs across variants. Divergent
outputs attributable to a single segment constitute a poisoning indicator and feed enforcement logic.
