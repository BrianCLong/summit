...
```jsonc
{
  ...
  "features": {
    ...
    "automations.trigger": { "monthly_limit": 250000, "overage_rate": 0.0004, "enforcement": "billable_overage" },
    "workflows.run": { "monthly_limit": 20000, "enforcement": "grace" },
    "ai.inference": { "monthly_compute_credits": 5000, "overage_rate": 0.08, "enforcement": "billable_overage" },
...
```jsonc
{
  ...
  "features": {
    ...
    "automations.trigger": { "monthly_limit": 5000000, "overage_rate": 0.00025, "enforcement": "billable_overage" },
    "workflows.run": { "monthly_limit": 100000, "enforcement": "billable_overage" },
    "ai.inference": { "monthly_compute_credits": 50000, "overage_rate": 0.05, "enforcement": "billable_overage" },
