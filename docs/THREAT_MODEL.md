...
Supply chain, insider, and third-party coverage is expanded in
[`docs/security/threat-models/supply-chain-insider-third-party.md`](./security/threat-models/supply-chain-insider-third-party.md)
and enforced through the design and control automation gates.
...
Insertion or alteration of code and artifacts through dependency or build pipeline tampering (e.g., typosquatting packages,
unsigned base images).

### Third-Party Connector Abuse

Vendor integrations or connectors leaking or exfiltrating data through over-scoped permissions or webhook abuse.

### Insider Misuse

Authorized operators bypassing required reviews, approvals, or logging to deploy or modify production systems without oversight.
