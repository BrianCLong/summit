...
Summit serves as the **institutional memory** of the organization. It records not just _what_ happened, but _why_ decisions were made, preserving the context for future learning.
...
- _"Why did you break production?"_
  to:
- _"Why did the system allow a destructive action in this context?"_
