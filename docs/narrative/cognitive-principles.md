...
> _This document defines the immutable cognitive doctrine of Summit. These principles are not suggestions; they are the axioms upon which the platform's user experience and automation logic are built._
...
_This doctrine is locked. Amendments require approval from the Architecture Council._
