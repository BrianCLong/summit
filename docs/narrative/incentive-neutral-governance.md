...
Traditional governance often relies on a fragile assumption: *that people will act against their own incentives for the greater good.*
...
Summit does not ban unsafe behavior; it adds *friction* and *attribution* to it.

*   **Scenario:** A developer wants to bypass a security check.
*   **Traditional:** They turn it off and hope no one notices.
*   **Summit:** They *can* bypass it (to preserve autonomy), but they must:
...
The *cost* of the shortcut (social friction + accountability) now outweighs the *benefit*. The incentives have shifted.
...
Compliance becomes a *accelerator*, not a blocker.
