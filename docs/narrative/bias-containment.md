...
| **Confirmation Bias** | Seeking data that supports our hunch and ignoring data that disproves it.                                         | **Devil's Advocate View:** The "Counter-Evidence" pane explicitly highlights data that _contradicts_ the leading hypothesis.                                                 |
