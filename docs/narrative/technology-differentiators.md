...
- **Topology Encoding**: We encode the graph structure (relationships, centrality) into the prompt, allowing the LLM to understand the _structural_ context of the intel.
