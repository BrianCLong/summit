...
Many systems are built _for_ a specific framework (e.g., "We built this for GDPR"). This creates rigidity. When a new regulation arrives (e.g., EU AI Act), the system must be patched or rebuilt.
...
- **The View (Projections):**
  - **SOC 2 View:** Maps "Log every read access" to _CC6.1 (Security System Monitoring)_.
  - **GDPR View:** Maps "Isolate tenants by ID" to _Article 5 (Purpose Limitation)_.
  - **HIPAA View:** Maps "Hash every mutation" to _integrity controls_.
...
3.  **The Signal:**
    ...
    - **Mismatch Detected.**
4.  **The Impact:**
    - **SOC 2 View:** Flagged as _Non-Compliant_ (CC5.3).
