...
By focusing only on the properties that matter for safety and governance, Summit allows immense variation in _how_ work gets done, as long as the _result_ is compliant. It absorbs the complexity of "how" so the organization can focus on the "what."
