...
await addRepeatableJob(QueueName.ANALYTICS, "daily-cleanup", {}, "0 2 * * *");

// Hourly analytics
await addRepeatableJob(QueueName.ANALYTICS, "hourly-stats", {}, "0 * * * *");

// Weekly report every Monday at 9 AM
await addRepeatableJob(QueueName.ANALYTICS, "weekly-report", {}, "0 9 * * 1");
```
