...
**Tier 2 (Leverages Tier 1):**
7. NEXUS - Can leverage EXPLAINABILITY for attribution (optional)
8. COMPLIANCE-CORE - Can leverage EXPLAINABILITY + MERKLE-GRAPH for richer evidence (optional)
