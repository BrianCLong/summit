...
- **Docs:** `docs/CONDUCTOR_EVOLUTION_STRATEGY.md` describes *Conductor → Symphony Maestro* and Phase‑2 “Web Interface Orchestrator”.
...
- **Create:** `apps/web/src/pages/MaestroPage.tsx` (layout with Tabs: *Routing*, *Web*, *Budgets*, *Policy*, *Logs*). Use `KPIStrip` at top.
...
---
## Risks & Mitigations
- **Backend variance:** Endpoints may not exist. *Mitigation:* ship MSW mocks + env‑based adapter fallbacks.
- **Performance:** Parallel orchestration UI may stutter. *Mitigation:* virtualization, suspense + skeletons, debounce inputs.
