...
- **Empty:** guidance + sample actions (e.g., “Try a prompt: _show transactions between X and Y_”).
...
- **NL Prompt placeholder:** “Ask in natural language… _show ties between Org A and Person B since 2022_”
