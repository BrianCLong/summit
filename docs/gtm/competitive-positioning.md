...
**Category:** Company OS / AI-Powered Work Platform
...
- Require audit trail and provenance
...
- Need deep integrations with existing SaaS stack
...
- Need broader agent capabilities
...
- Extensibility (SDK, connectors, agents)
...
- Partner program
- Operating Model Packs (pre-built vertical solutions)
...
- **Operating Model Packs** for common use cases (RevOps, People, Finance)
...
For regulated industries, self-hosted is **non-negotiable** (Notion doesn't offer it).
...
- **Pain Points:**
  ...
  - Approval bottlenecks slowing down velocity
  - No single source of truth
- **Budget:** $50K-$150K/year for tools/operations
- **Decision Maker:** VP Engineering, CTO, COO
...
- **Budget:** $100K-$500K/year for compliance/ops tools
- **Decision Maker:** CISO, CTO, Compliance Officer
...
- **Pain Points:**
  ...
  - Clients want self-hosted for data sovereignty
- **Budget:** $100K-$500K/year (base) + per-tenant fees
- **Decision Maker:** CEO, VP Partnerships, CTO
- **Buying Process:** Partnership agreement, co-selling
...
- "One Platform, All Your Tools, AI-Powered"
...
- "We need something right now" (Hosted SaaS not available yet)
