...
Summit's partner program is designed to accelerate go-to-market in government, defense, and regulated enterprise segments by leveraging partner relationships, delivery capabilities, and market presence.
...
1. **Register** — Partner submits opportunity via portal within 14 days of intro
2. **Review** — Summit validates opportunity (48 hours)
3. **Approve** — Deal registration confirmed; protection period begins
4. **Pursue** — Joint or partner-led pursuit
5. **Close** — Commission/margin paid upon customer payment
...
4. Marketing activities (completed, planned)
5. Product feedback (customer asks, competitive intel)
...
**Upgrade:** Meet requirements for 2 consecutive quarters
**Downgrade:** Fail to meet requirements for 2 consecutive quarters
**Probation:** 1 quarter warning before downgrade
