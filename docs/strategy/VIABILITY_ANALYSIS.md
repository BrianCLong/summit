...
*   **Cost Envelope:**
    ...
    *   **Compute:** High (Agent inference costs). *Mitigation:* Pass-through pricing or BYO-Key models.
...
*   **Cost Envelope:**
    ...
    *   **Storage:** High (Long-term log retention). *Mitigation:* Tiered storage (Hot/Cold/Glacier).
*   **Revenue Potential:**
