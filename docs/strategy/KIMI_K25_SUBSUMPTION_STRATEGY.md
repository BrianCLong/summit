...
| **Agent Swarm Execution**     | **Swarm Runtime Primitives**: First-class _Planner -> Shard -> Execute -> Merge_ primitive with explicit OPA-controlled budgets and step caps.          | **Auditability**: Every swarm step is recorded in the Provenance Ledger, unlike black-box swarms.        |
