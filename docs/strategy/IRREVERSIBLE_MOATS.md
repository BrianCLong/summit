...
- **The Lock:** Auditors and Security Teams become dependent on the ability to mathematically prove _who_ did _what_ and _when_.
...
- **The Regression:** "Standard" agents are often black boxes. Moving away from Summit means losing the ability to audit _why_ an agent made a decision or to mechanically stop it.
