...
- **Why it sticks:** Regulators and Enterprises need _auditable_ answers, not just better guesses.
...
- **Moat:** Trust. By _refusing_ to attribute without high confidence, we become the "System of Record" for truth. When Summit speaks, markets move because we are rarely wrong.
...
- **Moat:** Network Effect. By being the best _integrator_ of these standards, we become the hub of the ecosystem (like the "DISINFOX" paper implies).
...
We will open-source the _schemas_ (allow others to write to our format) but keep the _inference engine_ (the thing that validates the schemas) proprietary. This encourages an ecosystem where everyone sends data to Summit.
