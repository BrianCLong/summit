...
| **Virality/Spike Alerts** | `BaselineDrift`      | **Drift Analytics Engine**: We monitor the _second derivative_ of discourse baseline over rolling 30-90 day windows to detect "slow-burn" operations.                            |
...
- **New Actor Attribute:** `role`
  ...
  - _Initiator_: Zero-delay, high-novelty.
  - _Validator_: Short-delay, high-authority.
  - _Amplifier_: Variable-delay, high-volume.
...
| **Governance** | **Drift-Based Risk Policy**: Governance gates that trigger on _structural drift_ rather than keyword hits, allowing us to flag "safe" content that serves a hostile frame. | Medium   |
