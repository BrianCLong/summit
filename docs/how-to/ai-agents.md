---
title: AI Agent Collaboration Guidelines
summary: Guidelines for AI agents and human partners working together.
version: v2.0.0
...
- **Follow existing patterns:** Read `docs/` for conventions.
