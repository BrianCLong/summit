...
If you want, the next strongest artifact is a **Summit Product Requirements Framework v1** that translates this vision into pillars, must-have surfaces, v1 scope, v1.5 scope, and explicit non-goals.
