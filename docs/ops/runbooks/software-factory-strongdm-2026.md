...
- Workflow: `.github/workflows/software-factory-strongdm-2026-drift.yml`.
- Cadence: weekly (`0 4 * * 1`) with manual dispatch support.
- Artifact: `artifacts/drift/report.json` uploaded as CI evidence.
