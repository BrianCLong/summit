...
**Crucial:** A `TempoLink` represents an _association_ (e.g., a narrative surge window occurring 3-6 hours after a kinetic strike), not necessarily verified _causation_.
