...
2. Smoke spec run
   - `SUMMIT_ENABLE_PLAYWRIGHT_CLI=1 node scripts/summit-playwright-cli.mjs run-spec specs/playwright/todomvc.smoke.json`
3. Evidence verification
   - `node scripts/evidence/verify_evidence_bundle.mjs artifacts/playwright-cli/<run_id>`
