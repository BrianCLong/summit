...
## 1. Executive Summary
*A concise summary of what happened, the impact, and the root cause. (Target audience: Executives)*
...
*How was the issue fixed? Was it a temporary patch or permanent fix?*
...
## 8. Evidence
*Link to snapshots, logs, and dashboards.*
