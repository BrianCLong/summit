...
We have a specialized runtime script `server/scripts/detect_runtime_drift.ts` that probes the _live_ application to verify that critical controls are active.
