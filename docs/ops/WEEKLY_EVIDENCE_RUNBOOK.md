...
- Inputs:
  ...
  - `attach_to_release` (default: `false`): set to `true` only if a prior release adjunct exists.
...
1. Copy the JSON snippet emitted in the workflow output (`evidence_index_entry`).
