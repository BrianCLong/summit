...
- **Metric Coverage**: While we have `rateLimitExceededTotal`, we need to ensure our _Provenance_ health is directly observable via a metric, rather than just an HTTP status check.
