...
- [ ] **Scope Validation**: The handler validates that the actor has permission _for the specific target tenant_ (no IDOR).
...
- [ ] **Confirmation**: The UI clearly displays the _impact_ of the action (e.g., "This will affect 50 users").
