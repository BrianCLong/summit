...
2.  **Semantic Scoring**: When the window approaches capacity, the system scores every previous message block based on its semantic similarity to the _current_ active goal.
