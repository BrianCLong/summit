...
- `client/`: (Legacy) The 'Summit' web client. _Target for migration to `apps/web`._
...
- **Source Files (TS/JS)**:
  ...
  - _Constraint_: New files SHOULD use `PascalCase` for files exporting a primary class/component, and `camelCase` for functional modules.
