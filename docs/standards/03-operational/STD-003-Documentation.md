...
Significant architectural choices MUST be recorded in `docs/ADR/` (or `docs/adr/`, to be standardized to `docs/ADR/` per STD-001 if chosen, but currently mixed. _Standard: `docs/ADR/`_).
