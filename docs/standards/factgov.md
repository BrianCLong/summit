...
- Timestamps in artifacts must be separated into a `runtime_meta` field or file, not embedded in the hashable content (isolated to `stamp.json` in audit packs).
