...
We are importing the _spirit_ of the [ramziddin/solid-skills](https://github.com/ramziddin/solid-skills) agent skill into Summit to operationalize "senior engineer" quality heuristics into our CI pipeline.
...
- **Not a Linter Replacement:** We still use ESLint/Ruff for syntax. Solid Gate focuses on _engineering practices_ (TDD, architectural safety).
