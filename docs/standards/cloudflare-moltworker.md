...
The repository now includes an experimental in-process sandbox runtime used for deterministic validation:

- `src/runtime/sandbox/inProcessSandboxRuntime.ts`
- `src/runtime/sandbox/objectStoreStatePersister.ts`
- `src/runtime/sandbox/inMemoryObjectStore.ts`
- `src/runtime/sandbox/evidenceWriter.ts`

Validation tests:

- `tests/runtime/sandbox_runtime_smoke.test.ts`
- `tests/runtime/egress_deny_default.test.ts`
- `tests/runtime/state_namespace_isolation.test.ts`
