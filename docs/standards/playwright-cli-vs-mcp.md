...
## Summit Command Surface

- Doctor: `node scripts/summit-playwright-cli.mjs doctor`
- Run spec: `SUMMIT_ENABLE_PLAYWRIGHT_CLI=1 node scripts/summit-playwright-cli.mjs run-spec specs/playwright/todomvc.smoke.json`
- NPM alias: `pnpm summit:playwright-cli -- doctor|run-spec <spec>`
