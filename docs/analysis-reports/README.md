...
This directory contains automated analysis reports for the Summit repository.
...
To regenerate these reports, the analysis scripts can be run from Claude Code or similar automation tools.
