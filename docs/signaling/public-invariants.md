# Public Invariants Charter

**Principle**: Predictability Is the Strongest Form of Trust
...
- **Non-tactical**: Don't reveal exploitable implementation details
...
- Demonstrating seriousness through constraint

> "What never changes is more credible than what is promised."

## Summit's Public Invariants

### Invariant 1: Evidence Discipline
...
### Invariant 2: Refusal Under Uncertainty
...
### Invariant 3: Independent Oversight
...
### Invariant 5: Appeal and Review Rights
...
### Invariant 6: Transparency of Governance Changes
...
### Invariant 7: No Retroactive Punishment
...
Invariants are **deliberately hard to change** to maintain credibility:

1. **Public Proposal**: Changes must be proposed with full rationale
2. **Notice Period**: Minimum 90 days for comment and review
3. **Independent Review**: External oversight must assess proposed change
4. **Threshold for Adoption**: Requires executive and board approval
5. **Audit Trail**: Full documentation of decision process

### When Invariants Can Be Suspended

Invariants are **not absolute**—suspension is possible but transparent:

- **Emergency Exception**: Defined threat requiring temporary deviation
- **Limited Duration**: Clear sunset for exception
- **Public Notification**: Exception and rationale disclosed
- **Post-Incident Review**: Independent assessment of whether exception was justified

### Verification Mechanisms

Invariants must be **verifiable**, not just stated:

- **Behavioral Audit**: Regular review of decision outputs against invariants
- **Third-Party Testing**: External parties can probe for invariant violations
- **Public Incident Reporting**: Alleged violations trigger investigation and response
- **Transparency Reports**: Periodic publication of invariant compliance metrics (abstracted)
...
**Fix**: If it's truly invariant, make it public (within security boundaries)
...
- **Incident responses**: Cite invariants when explaining decisions

## Success Metrics

Public invariants are effective when:

- ✅ External parties reference invariants in evaluating Summit
- ✅ Regulators ask fewer clarifying questions (invariants provide stable foundation)
- ✅ Partners plan long-term integration with confidence
- ✅ Adversaries stop probing invariant boundaries (recognized as non-negotiable)
- ✅ Internal teams treat invariants as constraints, not suggestions

## Related Documents

- [Selective Transparency](selective-transparency.md) - What to disclose vs. protect
- [Calm Under Stress](calm-under-stress.md) - Maintaining invariants during incidents
- [Signaling Governance](signaling-governance.md) - Managing external commitments
