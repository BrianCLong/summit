...
To ensure that edits, deletions, and corrections are captured as additive history rather than destructive updates. This prevents "memory holing" and allows analysis of _evolution_.
...
- **Privacy Compliance:** GDPR "Right to be Forgotten" conflicts. Requires a mechanism to "Hard Delete" specific chains while retaining the _fact_ of deletion if legally permissible (or scrubbing content but keeping metadata).
