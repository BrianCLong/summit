...
| :--- | :--- | :--- | :--- | :--- |
| `DEC-000` | TBD | **Initiate Legacy Doctrine** | Council of Solvers | *Pending* |
| `DEC-001` | TBD | **Lock Write Access (Global)** | System Admin | *Pending* |
| `DEC-002` | TBD | **Initiate Key Destruction Ceremony** | Security Steward | *Pending* |
| `DEC-003` | TBD | **Publish Canonical Archive** | Archive Agent | *Pending* |
| `DEC-004` | TBD | **Final Shutdown** | Orchestrator | *Pending* |
