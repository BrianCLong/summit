...
- **RUNBOOKS/INDEX.md** – Operational guides and incident playbooks.
- **RUNBOOKS/dev-bootstrap.md** – Local stack bring-up with verification steps.
- **RUNBOOKS/schema-migration-playbook.md** – Safe database migration procedures.
...
- **ROADMAP.md** – Current objectives and sequencing (historical plans live under `docs/archived/`).
