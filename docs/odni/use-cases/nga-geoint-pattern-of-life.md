...
The National Geospatial-Intelligence Agency (NGA) provides world-class geospatial intelligence. The challenge is moving beyond static imagery analysis to dynamic "Activity-Based Intelligence" (ABI) that incorporates non-spatial data to explain _why_ activity is occurring.

## Challenge

- **Data Overload:** Too many sensors, too few eyes. Analysts cannot watch every pixel 24/7.
- **Context Gap:** Imagery shows a truck moving; it doesn't say _who_ is in it or _what_ mission they are on.
