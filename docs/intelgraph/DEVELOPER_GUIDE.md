...
_Note: There is a known, pre-existing issue with the Jest configuration that may cause tests to fail. A fix for this is planned as part of the hardening process._
...
_(Note: The `k6/intelgraph.js` script will be created as part of the hardening process.)_
