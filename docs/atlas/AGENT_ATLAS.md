...
This document is descriptive and does not override operational guidance. For binding instructions,
follow `docs/governance/CONSTITUTION.md` → `docs/governance/AGENT_MANDATES.md` → `AGENTS.md` →
