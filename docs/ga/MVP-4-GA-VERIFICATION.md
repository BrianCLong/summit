...
| CAS Integrity & Artifacts        | `scripts/ci/verify_cas_integrity.mjs` (CAS digest + run manifest validation)                                                | B    | `pnpm ci:cas:verify`      | Ensures evidence artifacts are immutable and content-addressed.                                               |
