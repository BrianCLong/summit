...
| GA Evidence Map Verification     | `scripts/ci/verify_evidence_map.mjs` (evidence map + manifest verification)                                                  | B    | `make ga-verify`          | Verifies GA evidence artifacts, hashes, freshness, and provenance linkage.                                    |
