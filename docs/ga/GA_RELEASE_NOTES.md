...
The repository contains **conflicting readiness assertions** that must be resolved through governance sign-off:
...
These conflicts are **Governed Exceptions**. Final GA status is **Deferred pending governance reconciliation** across the authoritative readiness artifacts.
...
- Where evidence conflicts, the claim is **downgraded** to **conditional** and tagged as a **Governed Exception**.
