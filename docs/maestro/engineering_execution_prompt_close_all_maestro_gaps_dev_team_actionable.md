...
**Context:** Maestro is the _standalone conductor_ that builds Intelgraph (Maestro ≠ Intelgraph). The UI and core platform are near‑GA. This prompt instructs the dev team to **close every gap** listed below to hit GA with audit‑ready evidence.
