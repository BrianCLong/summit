...
- **Anonymization is Required:** In the rare and exceptional case where production-derived data is deemed essential for a research objective, it must be fully and irreversibly anonymized _before_ it enters the research environment.
