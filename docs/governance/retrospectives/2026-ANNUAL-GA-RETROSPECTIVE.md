...
1.  **Fix Evidence Freshness Signal**
    - _Rationale:_ We are flying blind on evidence latency.
    - _Owner:_ Release Captain / Ops
2.  **Cap & Burndown Exception Register**
    - _Rationale:_ 1110 exceptions is unsustainable. We must enforce a hard cap and a burndown plan (e.g., reduce by 50% in Q1).
    - _Owner:_ Governance Lead

### Tier 2: Should-do (Efficiency)

1.  **Automate Merge Train Triage**
    - _Rationale:_ Reduce maintainer toil and speed up PR throughput.
    - _Owner:_ Infra Team

### Tier 3: Explore (Experimental)

1.  **AI-Driven Drift Remediation**
    - _Rationale:_ Use agents to automatically propose fixes for `eslint-disable` and simple `ts-ignore` cases.
    - _Owner:_ AI Team
