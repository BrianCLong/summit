...
*   Mozilla Public License 2.0 (MPL-2.0) - *Check for file-level requirements*

### ❌ Denied Licenses (Red List)
*   GPL (any version) - *Copyleft risk*
*   AGPL (any version) - *Network copyleft risk*
*   LGPL (any version) - *Requires careful linking*
