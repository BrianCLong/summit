...
**Status:** Active | **Source:** `docs/governance/GOVERNANCE_RULES.md` (Migrated) | **Last Reviewed:** 2025-05-12
...
2.  **Missing Evidence:** PRs labeled `compliance` must include updates to `EVIDENCE.md` (formerly `EVIDENCE_INDEX.md`).
3.  **Governance Drift:** Modifying `POLICIES.md` without `CODEOWNERS` approval.
