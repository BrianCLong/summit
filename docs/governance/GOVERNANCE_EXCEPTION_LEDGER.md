...
This ledger tracks temporary deviations from the Governance Gate Policies and [Green CI Contract](./GREEN_CI_CONTRACT.md). All exceptions must be explicitly approved, time-bound, and tracked to closure.
