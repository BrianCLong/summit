...
We do not just absorb code; we absorb *context*.
...
2.  **Triage**:
    *   *Keep*: Valuable, current info. -> **Migrate**.
    *   *Archive*: Historical context. -> **Store in `docs/archive/`**.
    *   *Discard*: Obsolete or duplicate. -> **Delete**.
