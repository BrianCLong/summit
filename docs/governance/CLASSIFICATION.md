...
- **DataClassification**: Focuses on the *content type* (PII, PHI, Financial) to drive specific governance policies like retention schedules and redaction patterns.
