...
`make smoke` reports a healthy UI at `http://localhost:3000` and gateway health at `http://localhost:8080/health`. These checks come from the Makefile and curl validations baked into the smoke target.
