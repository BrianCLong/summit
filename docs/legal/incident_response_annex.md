...
4.  **External Experts:** Forensics firms must be engaged *by Outside Counsel*, not directly by the IT/Security team, to extend privilege.
...
*   Standard Term: Notify within **24-48-72 hours** of *confirmed* breach.
