...
If you’re open to a 15-minute executive demo, I’ll show the workflow-to-evidence path and the readiness rails that make security say yes.

Are you available {{TwoTimes}}?
...
We ship a standard paid pilot with hard gates: 3 workflows live, SLOs met, provenance verified, security review passed, and one connector validated. The output is a customer-ready evidence pack.

If you want the pilot one-pager, I can send it or walk through it live.
...
We’re opening a limited number of paid pilots this quarter. The format is fixed so you can predict outcomes: 6–8 weeks, success criteria, evidence pack, and expansion quote.

If this is relevant, reply “pilot” and I’ll send the scope sheet and schedule the alignment call.
