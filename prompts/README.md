...
### Marketing & Narrative Prompts

| File                        | Persona                   | Purpose                                                                                                                   |
| --------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `marketing-pitch-system.md` | Chief Marketing Architect | Two-layer prompt system for generating and refining investor-grade, enterprise-credible Summit marketing and pitch assets |
