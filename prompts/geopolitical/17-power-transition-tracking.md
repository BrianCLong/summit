...
1. **Military Capability**
   - Defense spending (absolute and % GDP)
   - Force modernization
...
4. **Diplomatic Influence**
   - Alliance networks
   - International institution leadership
   - Soft power and attraction
   - Development assistance
   - Voting alignment in UN, etc.
...
- Escape routes through accommodation
...
- Climate and resource pressures shape power
...
- Shared transnational challenges (climate, pandemic)
- Track record of accommodation
...
- Protect smaller states' interests
