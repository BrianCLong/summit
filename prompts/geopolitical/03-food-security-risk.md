...
4. **Agricultural Production**: Seasonal forecasts, climate impacts
5. **Supply Chain Status**: Transportation, storage, distribution capacity
...
Food Security Risk = f(
  grain_reserves_days,
  food_price_inflation_rate,
  import_dependence_percentage,
  agricultural_production_index,
  supply_chain_disruption_score,
  economic_accessibility_index
)
```
...
- Harvest failures affecting >20% of production
