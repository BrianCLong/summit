...
### Sanctions Assessment Dimensions

1. **Economic Impact**
   - GDP and trade effects
   - Sectoral impacts
...
2. **Political Effectiveness**
   ...
   - Regime stability impacts
   - Domestic political dynamics
   - International isolation degree

3. **Humanitarian Consequences**
   - Civilian population impacts
   - Access to medicines and essentials
   - Vulnerable group effects
   - Healthcare system functioning
   - Food security impacts

4. **Evasion Capabilities**
   - Alternative trade routes identified
   - Third-party intermediaries
   - Cryptocurrency and informal finance
...
- **Evasion Success**: Target's mitigation effectiveness
...
- Sanctions-busting technologies
...
- Multilateral coordination improvements
...
- Academic research on economic statecraft
