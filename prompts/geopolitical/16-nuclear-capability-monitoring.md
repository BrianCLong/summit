...
1. **Declared Nuclear States (NPT recognized)**
...
2. **States Outside NPT with Nuclear Weapons**
   - India, Pakistan, North Korea, Israel (undeclared)
   - Capability estimates
   - Regional security implications
   - Proliferation risks
   - Dialogue and engagement opportunities

3. **States with Civilian Nuclear Programs**
   ...
   - Dual-use equipment concerns

4. **States of Proliferation Concern**
   - Suspected weaponization intent
...
- Delivery system development (missiles, aircraft)
...
- Procurement attempts (dual-use items)
...
- Estimated time to first weapon (months)

**Important Ethical Note:**
This analysis supports diplomatic prevention and verification, NOT military targeting or preemptive action planning. Focus is on creating space for negotiation and peaceful resolution.
...
- Technical cooperation alternatives
...
- Further US-Russia reductions
- Multilateral arms control (China, others)
