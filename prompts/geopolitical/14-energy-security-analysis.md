...
1. **Availability**
   ...
   - Import sources and reliability
...
2. **Affordability**
   ...
   - Subsidy levels and sustainability
   - Energy poverty extent

3. **Accessibility**
   - Physical infrastructure coverage
   - Grid reliability and quality
...
- **Geopolitical Leverage**: Adversary or unreliable supplier dependence
...
- **Aging Infrastructure**: Maintenance and upgrade needs
- **Redundancy**: Alternative supply routes and sources
...
- Supply chain for new technologies
