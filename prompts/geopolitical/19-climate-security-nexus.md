...
### Climate Change Security Pathways

1. **Resource Scarcity and Competition**
   - Water stress and transboundary conflicts
   - Agricultural land degradation
   - Fisheries depletion and disputes
   - Energy transition resource competition

2. **Mass Migration and Displacement**
   - Sea level rise displacing coastal populations
   - Drought and desertification driving rural-urban migration
   - Cross-border migration pressures
   - Climate refugee policy and protection gaps

3. **State Fragility and Instability**
   - Economic stress from climate impacts
   - Governance capacity overwhelmed
   - Legitimacy erosion from disaster response failures
   - Conflict and violence increase

4. **Infrastructure and Critical Systems**
   - Military installation vulnerabilities
   - Port and naval base climate exposure
   - Supply chain disruption
   - Energy infrastructure risk

5. **Geopolitical Shifts**
   - Arctic opening and competition
   - New shipping routes
   - Resource access changes
   - Regional power dynamics altered
...
- **Central America**: Drought, hurricanes, migration
- **Middle East/North Africa**: Water scarcity, heat extremes, instability
...
- Security risks (conflict, migration, state failure)
- Current trajectory (improving/deteriorating)
...
- Contextual factors (governance, inequality, history)
...
- Just transition social pressures
...
- Fair burden-sharing on mitigation and adaptation
...
- Academic research on climate security
