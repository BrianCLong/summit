...
- Produce a structured explicitation artifact with fields: explicit_query, intent, domain_guess, entities, visual_evidence, assumptions, unknown_slots, retrieval_plan, answer_style, imputed_intentions (23 levels), confidence, clarifying_question.
