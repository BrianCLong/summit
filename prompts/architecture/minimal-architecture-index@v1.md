...
and queryable: a machine-readable system index, a human-readable system index, and a canonical
Summit graph schema. Update roadmap status metadata to record the change.

## Scope

- Create `docs/architecture/system-index.json` and `docs/architecture/system-index.md`.
