...
Locate the relevant PR or issue, read through the description, comments, and any linked docs.
...
Agent skill or prompt registration (prompts/registry.yaml, agents/examples/*.json).
...
Roadmap or STATUS entries if the work completes or moves an initiative.
...
Respect any sandbox or worktree boundaries and do not touch repositories or directories outside the scope Codex Desktop has mounted.
