...
**Workstream ID:** ws-claude-20260103-01
...
## Instructions
1. Checkout branch `autopilot/claude/ws-claude-20260103-01`.
2. Analyze the failures above.
3. Fix the issues within the boundaries.
4. Run verification commands:
   - `pnpm build`
   - `pnpm test`
5. Update `workstreams/Claude/ws-claude-20260103-01.yml` evidence section.