 ...
 */
export const WorkflowStatusV1 = z.enum([
  "pending",
  "running",
  "completed",
  "failed",
  ...
  options: z
    .object({
      maxNetworkSize: z
        ...
        .max(1000)
        .optional()
        .describe("Maximum network size to analyze"),
      relationshipTypes: z
        .array(
          z.enum([
            "colleague",
  ...
  insights: z
    .object({
      clusterCount: z
        ...
        .nonnegative()
        .optional()
        .describe("Number of network clusters"),
      strongConnections: z
        .number()
        .int()
        .nonnegative()
        .optional()
        .describe("Count of strong connections (>0.7)"),
      weakConnections: z
        .number()
        .int()
        .nonnegative()
        .optional()
        .describe("Count of weak connections (<0.3)"),
...
export type StartPersonNetworkWorkflowRequestV1 = z.infer<
  typeof StartPersonNetworkWorkflowRequestV1
>;
  ...
  metadata: z
    .object({
      ...
      completedSteps: z
        ...
        .nonnegative()
        .optional()
        .describe("Number of completed steps"),
...
export type GetPersonNetworkWorkflowStatusResponseV1 = z.infer<
  typeof GetPersonNetworkWorkflowStatusResponseV1
>;
