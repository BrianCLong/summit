 ...
 * Insight types
 */
const InsightTypeV1Schema = z.enum([
  'person-network',
...
export const InsightTypeV1 = InsightTypeV1Schema
export type InsightTypeV1 = z.infer<typeof InsightTypeV1Schema>

/**
 * Insight status
 */
const InsightStatusV1Schema = z.enum(['pending', 'generating', 'completed', 'failed'])

export const InsightStatusV1 = InsightStatusV1Schema
export type InsightStatusV1 = z.infer<typeof InsightStatusV1Schema>

/**
 * Create Person Network Insight Request
 */
const CreatePersonNetworkInsightRequestV1Schema = z.object({
...
export const CreatePersonNetworkInsightRequestV1 = CreatePersonNetworkInsightRequestV1Schema
export type CreatePersonNetworkInsightRequestV1 = z.infer<typeof CreatePersonNetworkInsightRequestV1Schema>

/**
 * Person Network Insight Data
 */
const PersonNetworkInsightDataV1Schema = z.object({
...
export const PersonNetworkInsightDataV1 = PersonNetworkInsightDataV1Schema
 ...
 */
const CreatePersonNetworkInsightResponseV1Schema = z.object({
  version: z.literal('v1').describe('API version'),
...
export const CreatePersonNetworkInsightResponseV1 = CreatePersonNetworkInsightResponseV1Schema
export type CreatePersonNetworkInsightResponseV1 = z.infer<typeof CreatePersonNetworkInsightResponseV1Schema>

/**
 * Get Insight Request
 */
const GetInsightRequestV1Schema = z.object({
  version: z.literal('v1').describe('API version'),
  insightId: z.string().uuid().describe('Insight ID'),
})

export const GetInsightRequestV1 = GetInsightRequestV1Schema
export type GetInsightRequestV1 = z.infer<typeof GetInsightRequestV1Schema>

/**
 * Get Insight Response (generic)
 */
const GetInsightResponseV1Schema = z.object({
  version: z.literal('v1').describe('API version'),
  insightId: z.string().uuid().describe('Insight ID'),
...
export const GetInsightResponseV1 = GetInsightResponseV1Schema
export type GetInsightResponseV1 = z.infer<typeof GetInsightResponseV1Schema>

/**
 * Get Person Network Insight Response
 */
const GetPersonNetworkInsightResponseV1Schema = z.object({
  version: z.literal('v1').describe('API version'),
  insightId: z.string().uuid().describe('Insight ID'),
  type: z.literal('person-network').describe('Insight type'),
  status: InsightStatusV1.describe('Insight status'),
...
export const GetPersonNetworkInsightResponseV1 = GetPersonNetworkInsightResponseV1Schema
export type GetPersonNetworkInsightResponseV1 = z.infer<typeof GetPersonNetworkInsightResponseV1Schema>

/**
 * List Insights Request
 */
const ListInsightsRequestV1Schema = z.object({
  version: z.literal('v1').describe('API version'),
  filters: z
    .object({
...
export const InsightSummaryV1 = InsightSummaryV1Schema
export type InsightSummaryV1 = z.infer<typeof InsightSummaryV1Schema>

/**
 * List Insights Response
 */
const ListInsightsResponseV1Schema = z.object({
  version: z.literal('v1').describe('API version'),
...
export const DeleteInsightResponseV1 = DeleteInsightResponseV1Schema
