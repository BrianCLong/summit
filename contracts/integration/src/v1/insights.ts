...
export type CreatePersonNetworkInsightRequestV1 = z.infer<
  typeof CreatePersonNetworkInsightRequestV1
>;
    ...
    clusters: z
      .array(
        z.object({
          ...
          dominantRelationshipType: z
            .string()
            .optional()
            .describe("Most common relationship type in cluster"),
        })
      )
      .optional()
  ...
  insights: z
    .object({
      strongConnections: z
        ...
        .nonnegative()
        .optional()
        .describe("Count of strong connections"),
      weakConnections: z
        .number()
        .int()
        .nonnegative()
        .optional()
        .describe("Count of weak connections"),
      keyConnectors: z
        .array(
          z.object({
...
export type CreatePersonNetworkInsightResponseV1 = z.infer<
  typeof CreatePersonNetworkInsightResponseV1
>;
