...
export const GetPersonNetworkResponseV1 = z.object({
  ...
  metadata: z.object({
    ...
    totalCount: z
      ...
      .nonnegative()
      .optional()
      .describe("Total associations (if limited by maxResults)"),
...
export const GetEntityRequestV1 = z.object({
  ...
  entityType: z
    ...
    .optional()
    .describe("Expected entity type (for validation)"),
  includeMetadata: z.boolean().default(true).describe("Whether to include full metadata"),
});
...
export const GetEntityContextResponseV1 = z.object({
  ...
  metadata: z.object({
    ...
    relatedEntityCount: z
      .number()
      .int()
      .nonnegative()
      .describe("Number of related entities returned"),
  }),
});
