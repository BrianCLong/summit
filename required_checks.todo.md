...
## Current status
✅ COMPLETED: GitHub Actions currently executes many checks, but we need to verify their exact names as reported to the GitHub Status API to ensure our "Always Required" and "Conditional Required" policies match exactly what GitHub expects.
...
Once official names are known, we will alias these jobs or rename them in the workflow files to match the branch protection rules. ✅ COMPLETED.
