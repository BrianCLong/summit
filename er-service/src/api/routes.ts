...
export function createRoutes(engine: EREngine): Router {
   ...
   */
  router.post("/merge/:mergeId/revert", (req: Request, res: Response, next: NextFunction) => {
    try {
   ...
   */
  router.get("/explain/:mergeId", (req: Request, res: Response, next: NextFunction) => {
    try {
      const { mergeId } = req.params;
   ...
   */
  router.get("/merge/:mergeId/export", (req: Request, res: Response, next: NextFunction) => {
    try {
      const { mergeId } = req.params;
   ...
   */
  router.get("/merge/:mergeId", (req: Request, res: Response, next: NextFunction) => {
    try {
      const { mergeId } = req.params;
   ...
   */
  router.get("/split/:splitId", (req: Request, res: Response, next: NextFunction) => {
    try {
   ...
   */
  router.get("/entities/:id", (req: Request, res: Response, next: NextFunction) => {
    try {
