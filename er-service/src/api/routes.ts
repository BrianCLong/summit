...
export function createRoutes(engine: EREngine): Router {
   ...
   */
  router.post("/merge/:mergeId/revert", async (req: Request, res: Response, next: NextFunction) => {
    try {
   ...
   */
  router.get("/explain/:mergeId", async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { mergeId } = req.params;
   ...
   */
  router.get("/merge/:mergeId/export", async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { mergeId } = req.params;
   ...
   */
  router.get("/merge/:mergeId", async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { mergeId } = req.params;
   ...
   */
  router.get("/split/:splitId", async (req: Request, res: Response, next: NextFunction) => {
    try {
