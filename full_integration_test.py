...
def test_full_integration():
    ...
    try:
        ...
        print(
            f"   System overview: {bias_report['system_overview']['total_agents']} agents, {bias_report['system_overview']['total_bias_detections']} detections"
        )
        ...
        if analysis_result["metacognitive_reflection"]["improvement_suggestions"]:
            ...
            for i, suggestion in enumerate(
                analysis_result["metacognitive_reflection"]["improvement_suggestions"][:3]
            ):
        ...
        print("   - Enhanced IntelGraph with cognitive bias detection capabilities")
        print("   - Integrated evidence-based debiasing strategies")
        print("   - Added metacognitive awareness functions")
        print("   - Provided comprehensive analysis and reporting")
        print("   - Maintained compatibility with existing workflows")
