...
st.warning(
    "Ethical Guidelines: The data presented in this module is for research and defensive purposes only. Do not attempt to access the sources directly. Do not engage with the actors. All data is collected passively and legally."
)
