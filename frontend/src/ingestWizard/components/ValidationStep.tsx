    ...
    <section className="iw-section">
      <header>
        ...
        <p className="description">
          Run automated checks to confirm licensing, schema alignment, and privacy posture before
        ...
        <section className="iw-validation-card">
          ...
          <dl className="iw-summary-grid">
            ...
            <div>
              <dt>Retention</dt>
              <dd>
                {dataSource.retention_period
                  ? `${dataSource.retention_period} days`
                  : "Default (30 days)"}
              </dd>
            </div>
          </dl>
          ...
          <div className="iw-validation-issues">
            ...
            {validation.issues.map((issue) => (
              <article key={issue.id} className={`iw-issue ${issue.severity}`}>
                ...
                >
                  <h4 style={{ margin: 0, fontWeight: 600, textTransform: "capitalize" }}>
                    {issue.severity}
                  </h4>
                  {issue.field && (
                    <span
                ...
                {issue.suggestion && (
                  <p style={{ margin: 0, fontSize: "0.75rem", color: "#486581" }}>
