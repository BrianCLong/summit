...
**Deliverable**
- `release/ga-launch/required-checks.manifest.json` as source of truth and CI comparison target.
...
**Deliverable**
- `release/ga-launch/ci-trigger-matrix.json` documenting allowed events by workflow class.
...
- Validator: `scripts/ci/validate-ga-launch-artifacts.mjs`
- Validation command: `node scripts/ci/validate-ga-launch-artifacts.mjs`
- Enforcement policy: validator failure is release-blocking until branch protection and workflow triggers are realigned to manifests.
