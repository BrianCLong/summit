...
exports.entityReferenceResolver = exports.investigationsSubgraphTypeDefs = exports.aiSubgraphTypeDefs = exports.coreSubgraphTypeDefs = void 0;
exports.createSubgraphSchema = createSubgraphSchema;
exports.addFederationDirectives = addFederationDirectives;
 ...
 */
function createSubgraphSchema(typeDefs, resolvers) {
    const typeDefsDoc = typeof typeDefs === 'string' ? (0, graphql_1.parse)(typeDefs) : typeDefs;
 ...
 */
exports.investigationsSubgraphTypeDefs = `
  extend schema
    @link(url: "https://specs.apollo.dev/federation/v2.0", import: ["@key", "@shareable"])
 ...
 */
exports.entityReferenceResolver = {
 ...
 */
function addFederationDirectives(typeDefs) {
 ...
 */
function createEntityReference(fetchById) {
    return {
