...
exports.defaultSubgraphs = void 0;
exports.createFederatedGateway = createFederatedGateway;
exports.createFederatedServer = createFederatedServer;
 ...
 */
async function createFederatedGateway(config) {
 ...
 */
async function createFederatedServer(config) {
 ...
 */
function buildFederatedContext(req, res) {
 ...
 */
async function gatewayHealthCheck(gateway) {
