...
async function runTests() {
    ...
    try {
        ...
        const output1 = (0, child_process_1.execSync)(`${gateScript} ${file1}`).toString();
        ...
        const output2 = (0, child_process_1.execSync)(`${gateScript} ${file2}`).toString();
        ...
        try {
            (0, child_process_1.execSync)(`${gateScript} ${file3}`);
        ...
        try {
            (0, child_process_1.execSync)(`${gateScript} ${file4}`);
        ...
        const output5 = (0, child_process_1.execSync)(`${gateScript} ${file5}`).toString();
        ...
        try {
            (0, child_process_1.execSync)(`${gateScript} ${file6}`);
        ...
        try {
            (0, child_process_1.execSync)(`${gateScript} ${file7}`);
        ...
        const output8 = (0, child_process_1.execSync)(`${validateScript} ${validUfarFile} ${ufarSchema}`).toString();
        ...
        try {
            (0, child_process_1.execSync)(`${validateScript} ${invalidUfarFile} ${ufarSchema}`);
