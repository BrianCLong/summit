 ...
 */
test_1.test.describe('Golden Path Guardrails - Negative & Chaos Tests', () => {
    // 3. Inconsistent Session States
    (0, test_1.test)('should redirect to login when session is invalid', async ({ page }) => {
    ...
    (0, test_1.test)('should handle extremely long AI inputs gracefully', async ({ page }) => {
        ...
        await (0, test_1.expect)(crashIndicator).not.toBeVisible();
    });
});
