...
test_1.test.describe('Graph Visualization', () => {
    ...
    (0, test_1.test)('should display graph canvas', async ({ page }) => {
        const canvas = page.locator('canvas, svg');
        await (0, test_1.expect)(canvas).toBeVisible();
    });
    (0, test_1.test)('should render nodes and edges', async ({ page }) => {
        // Wait for graph to load
        await page.waitForTimeout(2000);
        // Check for graph elements
        const nodes = page.locator('[data-node-id], .node, circle.node');
        const nodeCount = await nodes.count();
        (0, test_1.expect)(nodeCount).toBeGreaterThan(0);
    });
    (0, test_1.test)('should zoom in and out', async ({ page }) => {
    ...
    (0, test_1.test)('should pan the graph', async ({ page }) => {
        const canvas = page.locator('canvas, svg').first();
    ...
    (0, test_1.test)('should select a node on click', async ({ page }) => {
        await page.waitForTimeout(2000);
        ...
        if (await node.isVisible()) {
            ...
            await (0, test_1.expect)(detailsPanel).toBeVisible({ timeout: 3000 });
        }
    });
    (0, test_1.test)('should show node tooltip on hover', async ({ page }) => {
        await page.waitForTimeout(2000);
        const node = page.locator('[data-node-id], .node, circle.node').first();
        if (await node.isVisible()) {
            await node.hover();
            ...
            await (0, test_1.expect)(tooltip).toBeVisible({ timeout: 3000 });
        }
    });
    (0, test_1.test)('should filter nodes by type', async ({ page }) => {
    ...
    (0, test_1.test)('should search for nodes', async ({ page }) => {
    ...
    (0, test_1.test)('should expand node connections', async ({ page }) => {
        await page.waitForTimeout(2000);
        const node = page.locator('[data-node-id], .node, circle.node').first();
        if (await node.isVisible()) {
    ...
    (0, test_1.test)('should change graph layout', async ({ page }) => {
...
test_1.test.describe('Graph Interactions', () => {
    test_1.test.beforeEach(async ({ page }) => {
        await page.goto('/login');
        await page.fill('input[name="email"]', 'test@example.com');
        await page.fill('input[name="password"]', 'TestPassword123!');
    ...
    (0, test_1.test)('should multi-select nodes', async ({ page }) => {
        await page.waitForTimeout(2000);
        const nodes = page.locator('[data-node-id], .node, circle.node');
        const nodeCount = await nodes.count();
        if (nodeCount >= 2) {
    ...
    (0, test_1.test)('should create new relationship', async ({ page }) => {
    ...
    (0, test_1.test)('should delete node', async ({ page }) => {
        await page.waitForTimeout(2000);
        const node = page.locator('[data-node-id], .node, circle.node').first();
        if (await node.isVisible()) {
            await node.click({ button: 'right' });
...
test_1.test.describe('Graph Performance', () => {
    (0, test_1.test)('should handle large graphs', async ({ page }) => {
        await page.goto('/login');
        await page.fill('input[name="email"]', 'test@example.com');
        await page.fill('input[name="password"]', 'TestPassword123!');
        await page.click('button[type="submit"]');
    ...
    (0, test_1.test)('should render graph without lag', async ({ page }) => {
        await page.goto('/login');
        await page.fill('input[name="email"]', 'test@example.com');
        await page.fill('input[name="password"]', 'TestPassword123!');
        await page.click('button[type="submit"]');
