...
class IntelGraphReporter {
    ...
    onEnd(result) {
        ...
        const outputPath = path_1.default.join('test-results', 'intelgraph-summary.json');
    ...
    getPerformanceMetrics() {
        const performanceTests = this.results.filter((r) => r.test
            .titlePath()
    ...
    getAccessibilityMetrics() {
        const a11yTests = this.results.filter((r) => r.test
            .titlePath()
    ...
    async sendPrometheusMetrics(summary) {
...
exports.default = IntelGraphReporter;
