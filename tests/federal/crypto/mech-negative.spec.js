...
const hsm_enforcement_1 = require("../../../server/src/federal/hsm-enforcement");
describe('Crypto Mechanism Negative Tests', () => {
    ...
    beforeAll(() => {
        ...
        enforcement = new hsm_enforcement_1.HSMEnforcement({
            enforceHSM: true,
    ...
    describe('FIPS mode validation', () => {
        it('should require FIPS mode to be enabled', () => {
            const nonFipsEnforcement = new hsm_enforcement_1.HSMEnforcement({
                fipsMode: false,
