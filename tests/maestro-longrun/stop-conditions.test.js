...
const budget_js_1 = require("../../libs/maestro/longrun/budget.js");
const stop_conditions_js_1 = require("../../libs/maestro/longrun/stop-conditions.js");
...
const createBudget = () => new budget_js_1.BudgetTracker(budgets, Date.now());
describe('evaluateStopConditions', () => {
    it('detects stalls after configured iterations', () => {
        const state = (0, stop_conditions_js_1.initialStopState)();
        const budget = createBudget();
        const first = (0, stop_conditions_js_1.evaluateStopConditions)({
            iteration: {
                iteration: 1,
        ...
        const second = (0, stop_conditions_js_1.evaluateStopConditions)({
            iteration: {
                iteration: 2,
                diffSummary: { meaningful: false },
            },
