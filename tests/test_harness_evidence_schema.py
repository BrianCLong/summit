...
SCHEMA_DIR = Path("evidence/schema/summit_harness")
...
def test_harness_evidence_matches_schema(filename):
...
def test_harness_evidence_determinism():
...
def test_harness_stamp_has_timestamp():
