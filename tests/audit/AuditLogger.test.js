...
describe('AdvancedAuditLogger validation', () => {
    const logger = new AuditLogger_1.AdvancedAuditLogger({
        retention_days: 30,
    ...
    it('rejects missing action', async () => {
        await expect(logger.logEvent({ resource: 'RESOURCE_ONLY', details: {} })).rejects.toThrow('audit.action is required');
    });
