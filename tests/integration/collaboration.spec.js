...
const operationalTransform_1 = require("../../server/src/collaboration/operationalTransform");
describe('Operational Transformation', () => {
    test('transform insert/insert', () => {
        ...
        // @ts-ignore
        const [opA_prime, opB_prime] = operationalTransform_1.OperationalTransform.transform(opA, opB);
