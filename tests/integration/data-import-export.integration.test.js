...
entity-2,entity-3,WORKS_WITH`;
    ...
    describe('CSV Export', () => {
        it('should export entities to CSV', async () => {
            const entities = [
                (0, entityFactory_1.entityFactory)({ type: 'person', name: 'John Doe' }),
                (0, entityFactory_1.entityFactory)({ type: 'person', name: 'Jane Smith' }),
            ];
            const csvLines = [
                'id,type,name',
        ...
        it('should export relationships to CSV', async () => {
            const relationships = [
                (0, relationshipFactory_1.relationshipFactory)({ type: 'KNOWS' }),
                (0, relationshipFactory_1.relationshipFactory)({ type: 'WORKS_WITH' }),
            ];
            const csvLines = [
    ...
    describe('JSON Import', () => {
        it('should import graph from JSON', async () => {
            const graph = (0, graphFactory_1.graphFactory)({ nodeCount: 5, relationshipDensity: 0.3 });
    ...
    describe('JSON Export', () => {
        it('should export graph to JSON', async () => {
            const graph = (0, graphFactory_1.graphFactory)({ nodeCount: 3, relationshipDensity: 0.5 });
            const exported = {
                version: '1.0',
        ...
        it('should include metadata in export', async () => {
            const context = (0, contextFactory_1.authenticatedContextFactory)();
            const graph = (0, graphFactory_1.graphFactory)({ nodeCount: 5 });
            const exported = {
                metadata: {
  ...
  <graph id="G" edgedefault="directed">
    ...
    describe('Data Validation', () => {
        ...
        it('should check for duplicate IDs', async () => {
            const entities = [
                (0, entityFactory_1.entityFactory)({ id: 'duplicate-id' }),
                (0, entityFactory_1.entityFactory)({ id: 'duplicate-id' }),
            ];
    ...
    describe('Performance', () => {
        it('should handle large exports efficiently', async () => {
            const largeGraph = (0, graphFactory_1.graphFactory)({ nodeCount: 1000, relationshipDensity: 0.1 });
