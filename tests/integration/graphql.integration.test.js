...
const investigationFactory_1 = require("../factories/investigationFactory");
describe('GraphQL Integration Tests', () => {
    describe('Query Execution', () => {
        it('should execute a simple entity query', async () => {
            const context = (0, contextFactory_1.authenticatedContextFactory)();
            const entity = (0, entityFactory_1.entityFactory)({ type: 'person' });
            const query = `
      ...
      `;
        ...
        it('should execute a complex nested query', async () => {
            const context = (0, contextFactory_1.authenticatedContextFactory)();
            const investigation = (0, investigationFactory_1.investigationFactory)();
            const query = `
    ...
    describe('Authorization', () => {
        it('should enforce authentication on protected queries', async () => {
            const context = (0, contextFactory_1.contextFactory)({ user: null });
            const query = `
