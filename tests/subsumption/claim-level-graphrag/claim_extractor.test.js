...
const claim_extractor_1 = require("../../../src/subsumption/claim_level/claim_extractor");
describe('Claim Extractor', () => {
    test('should split text into sentences', () => {
        const text = "The sky is blue. The grass is green.";
        const claims = (0, claim_extractor_1.extractClaims)(text);
    ...
    test('should handle empty input', () => {
        expect((0, claim_extractor_1.extractClaims)("")).toEqual([]);
    });
});
