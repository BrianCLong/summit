...
describe('GraphQL Schema Validation', () => {
    let schema;
    beforeAll(() => {
        const schemaPath = (0, path_1.join)(__dirname, '../../graphql/schema.graphql');
        const schemaString = (0, fs_1.readFileSync)(schemaPath, 'utf8');
        schema = (0, graphql_1.buildSchema)(schemaString);
    });
    ...
    describe('Query type arguments', () => {
        ...
        it('runbooks query should have after argument', () => {
            const runbooksField = queryType.getFields().runbooks;
            const afterArg = runbooksField.args.find((arg) => arg.name === 'after');
        ...
        it('run query should have id argument with ID! type', () => {
            ...
            const idArg = runField.args.find((arg) => arg.name === 'id');
    ...
    describe('Mutation type arguments', () => {
        ...
        it('launchRun mutation should have input argument with LaunchRunInput! type', () => {
            ...
            const inputArg = launchRunField.args.find((arg) => arg.name === 'input');
        ...
        it('abortRun mutation should have id argument with ID! type', () => {
            ...
            const idArg = abortRunField.args.find((arg) => arg.name === 'id');
            expect(idArg).toBeDefined();
            expect(idArg.type.toString()).toBe('ID!');
        });
