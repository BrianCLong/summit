...
export function registerApi(
  ...
  app.post('/v1/session', async (req, reply) => {
    const body = z
      ...
      .parse(req.body);
    const context = requestContext(req.headers, body.caps, true);
  ...
  app.post('/v1/session/:id/invoke', async (req, reply) => {
    ...
    const context = requestContext(req.headers, undefined, false);
  ...
  app.post('/jsonrpc', async (req, reply) => {
    ...
    const context = requestContext(req.headers, invokePayload.caps, true);
