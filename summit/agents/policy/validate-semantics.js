        ...
        if (allowsHighRisk) {
            ...
            if (!isGovernanceOnly) {
                errors.push({
                    ...
                    message: 'High-risk skill enabled in prod requires governance role + approvals annotation.',
                    rule_id: rule.id,
                });
            }
            ...
            if (hasWildcardSkill) {
                errors.push({
                    ...
                    message: 'High-risk prod allow rules must include only release.approve or explicitly listed high-risk skills from registry.',
                    rule_id: rule.id,
                });
            }
