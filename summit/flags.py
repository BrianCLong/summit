...
SUMMIT_VIND_HYBRID_ENABLED = is_feature_enabled("SUMMIT_VIND_HYBRID_ENABLED", default=False)
SUMMIT_VIND_SNAPSHOTS_ENABLED = is_feature_enabled("SUMMIT_VIND_SNAPSHOTS_ENABLED", default=False)
