...
exports.resolvers = {
    Query: {
        ...
        provenanceChain: async (_, args, context) => {
        ...
        contradictions: async (_, args, context) => {
        ...
        disclosureBundle: async (_, args, context) => {
        ...
        exportManifest: async (_, __, context) => {
    ...
    Mutation: {
        ...
        parseClaim: async (_, args, context) => {
