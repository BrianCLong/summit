...
| **CC3.2 Change Management**      | `CICD-001`, `CICD-002`, `CICD-003`, `CICD-004` | All changes to the production environment are managed through a formal process, enforced by a CI/CD pipeline that includes automated testing, quality gates, commit message validation, and evidence bundle verification (SBOM + provenance). |
