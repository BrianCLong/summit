...
`,
      ...
      const secret = secretsManager.createSecret("critical-api-key", "critical-secret-value", {
    ...
    it("should enforce tenant isolation for secrets using OPA policies", async () => {
      ...
      const secret1 = secretsManager.createSecret("tenant1-secret", "value1", {
        tenant_id: "tenant-1",
      });

      const secret2 = secretsManager.createSecret("tenant2-secret", "value2", {
        tenant_id: "tenant-2",
      });
