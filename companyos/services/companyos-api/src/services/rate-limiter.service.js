...
exports.getRateLimiterService = getRateLimiterService;
...
class RateLimiterService {
    ...
    constructor(config) {
        this.config = {
            ...
            tenantLimits: {
                [tenant_js_1.TenantTier.STARTER]: { windowMs: 60000, maxRequests: 100 },
                [tenant_js_1.TenantTier.BRONZE]: { windowMs: 60000, maxRequests: 500 },
                [tenant_js_1.TenantTier.SILVER]: { windowMs: 60000, maxRequests: 1000 },
                [tenant_js_1.TenantTier.GOLD]: { windowMs: 60000, maxRequests: 5000 },
                [tenant_js_1.TenantTier.ENTERPRISE]: { windowMs: 60000, maxRequests: 10000 },
            },
            endpointLimits: {
                // Specific endpoint overrides
                'graphql:mutation': {
                    [tenant_js_1.TenantTier.STARTER]: { windowMs: 60000, maxRequests: 50 },
                    [tenant_js_1.TenantTier.BRONZE]: { windowMs: 60000, maxRequests: 200 },
                    [tenant_js_1.TenantTier.SILVER]: { windowMs: 60000, maxRequests: 500 },
                    [tenant_js_1.TenantTier.GOLD]: { windowMs: 60000, maxRequests: 2000 },
                    [tenant_js_1.TenantTier.ENTERPRISE]: { windowMs: 60000, maxRequests: 5000 },
                },
                'export:bulk': {
                    [tenant_js_1.TenantTier.STARTER]: { windowMs: 3600000, maxRequests: 5 },
                    [tenant_js_1.TenantTier.BRONZE]: { windowMs: 3600000, maxRequests: 20 },
                    [tenant_js_1.TenantTier.SILVER]: { windowMs: 3600000, maxRequests: 50 },
                    [tenant_js_1.TenantTier.GOLD]: { windowMs: 3600000, maxRequests: 200 },
                    [tenant_js_1.TenantTier.ENTERPRISE]: { windowMs: 3600000, maxRequests: 1000 },
                },
                'copilot:query': {
                    [tenant_js_1.TenantTier.STARTER]: { windowMs: 60000, maxRequests: 10 },
                    [tenant_js_1.TenantTier.BRONZE]: { windowMs: 60000, maxRequests: 50 },
                    [tenant_js_1.TenantTier.SILVER]: { windowMs: 60000, maxRequests: 100 },
                    [tenant_js_1.TenantTier.GOLD]: { windowMs: 60000, maxRequests: 500 },
                    [tenant_js_1.TenantTier.ENTERPRISE]: { windowMs: 60000, maxRequests: 1000 },
                },
            },
            ...config,
        };
     ...
     */
    async checkLimit(tenantId, endpoint, tier, userRoles) {
     ...
     */
    async checkMultipleLimits(tenantId, endpoints, tier, userRoles) {
     ...
     */
    async resetLimit(tenantId, endpoint) {
        if (endpoint) {
     ...
     */
    async getStatus(tenantId, endpoint, tier) {
        const config = this.getConfigForEndpoint(endpoint, tier);
        const bucketKey = this.getBucketKey(tenantId, endpoint);
     ...
     */
    updateEndpointLimit(endpoint, tier, config) {
    ...
    // Private Methods
    // ============================================================================
    getConfigForEndpoint(endpoint, tier) {
    ...
    getBucketKey(tenantId, endpoint) {
    ...
    updateMetrics(tenantId, endpoint, allowed) {
        const key = this.getBucketKey(tenantId, endpoint);
    ...
    emitBlockedMetric(tenantId, endpoint) {
...
function getRateLimiterService(config) {
