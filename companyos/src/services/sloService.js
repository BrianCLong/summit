...
class SLOService {
    ...
    async listViolations(serviceName, fromDate, limit = 25, offset = 0) {
    ...
    async getComplianceSummary(serviceName, days = 28) {
    ...
    async linkToIncident(violationId, incidentId) {
        const query = `
      UPDATE maestro.slo_violations
