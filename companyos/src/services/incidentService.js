...
class IncidentService {
    ...
    async listIncidents(filter, limit = 25, offset = 0) {
    ...
    async acknowledgeIncident(id, acknowledgedBy) {
        const query = `
      UPDATE maestro.incidents
    ...
    async resolveIncident(id, rootCause) {
        const query = `
      UPDATE maestro.incidents
    ...
    async linkToGithub(id, githubIssueUrl, githubIssueNumber) {
        const query = `
      UPDATE maestro.incidents
