...
const sampleProvenanceV1: SLSAProvenanceV1 = {
  ...
  predicate: {
    buildDefinition: {
      buildType:
        "https://github.com/slsa-framework/slsa-github-generator/.github/workflows/builder_container_slsa3.yml@refs/tags/v1.9.0",
      externalParameters: {
...
describe("SLSA3Verifier", () => {
  ...
  describe("verifyProvenance", () => {
    it("should verify image with valid SLSA L3 provenance", async () => {
      ...
      mockSpawn.mockReturnValueOnce(createMockProcess(attestationEnvelope, "", 0) as any);
    ...
    it("should reject image without provenance", async () => {
      ...
      mockSpawn.mockReturnValueOnce(createMockProcess("", "no attestations found", 1) as any);
      mockSpawn.mockReturnValueOnce(createMockProcess("", "no attestations found", 1) as any);
    ...
    it("should identify SLSA level correctly based on builder", async () => {
      ...
      for (const testCase of testCases) {
        ...
        mockSpawn.mockReturnValueOnce(createMockProcess(envelope, "", 0) as any);
  ...
  describe("SLSA v0.2 compatibility", () => {
    it("should convert SLSA v0.2 provenance to v1 format", async () => {
      ...
      // v1 fails first
      mockSpawn.mockReturnValueOnce(createMockProcess("", "no v1 attestation", 1) as any);
...
describe("CombinedVerifier", () => {
  ...
  it("should collect errors from failed verifications", async () => {
    ...
    mockSpawn.mockReturnValueOnce(createMockProcess("", "failed", 1) as any);
    mockSpawn.mockReturnValueOnce(createMockProcess("", "failed", 1) as any);
