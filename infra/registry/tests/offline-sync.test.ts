  ...
  describe("exportImages", () => {
    it("should export verified images successfully", async () => {
      ...
      mockSpawn.mockReturnValueOnce(
        createMockProcess(
          JSON.stringify({ predicate: { runDetails: { builder: { id: "slsa3" } } } }),
          "",
          0
        ) as any
      );
    ...
    it("should block images with insufficient SLSA level", async () => {
      ...
      mockSpawn.mockReturnValueOnce(
        createMockProcess(
          JSON.stringify({ predicate: { runDetails: { builder: { id: "slsa1" } } } }),
          "",
          0
        ) as any
      );
    ...
    it("should block images with critical vulnerabilities", async () => {
      ...
      mockSpawn.mockReturnValueOnce(createMockProcess(JSON.stringify(trivyOutput), "", 0) as any);
