...
describe("CosignVerifier", () => {
  ...
  describe("verifyImage", () => {
    it("should verify a properly signed image", async () => {
      ...
      // Mock crane digest
      mockSpawn.mockReturnValueOnce(createMockProcess("sha256:abc123def456", "", 0) as any);

      // Mock cosign verify
      mockSpawn.mockReturnValueOnce(createMockProcess(signatureOutput, "", 0) as any);
    ...
    it("should reject unsigned images when signatures required", async () => {
      ...
      mockSpawn.mockReturnValueOnce(createMockProcess("", "no signatures found", 1) as any);
    ...
    it("should handle digest resolution failure", async () => {
      ...
      mockSpawn.mockReturnValueOnce(createMockProcess("", "image not found", 1) as any);
    ...
    it("should cache successful verification results", async () => {
      ...
      mockSpawn.mockReturnValueOnce(createMockProcess("sha256:abc123", "", 0) as any);
    ...
    it("should extract signature information correctly", async () => {
      ...
      mockSpawn.mockReturnValueOnce(createMockProcess("sha256:def456", "", 0) as any);
      mockSpawn.mockReturnValueOnce(createMockProcess(signatureOutput, "", 0) as any);
    ...
    it("should fall back to managed key verification and persist Rekor UUIDs", async () => {
      ...
      mockSpawn.mockReturnValueOnce(createMockProcess("sha256:fallback", "", 0) as any);
      mockSpawn.mockReturnValueOnce(createMockProcess("", "keyless failed", 1) as any);
      mockSpawn.mockReturnValueOnce(createMockProcess(managedSignatureOutput, "", 0) as any);
      ...
      expect(result.errors.some((error) => error.code === "KEYLESS_FALLBACK_USED")).toBe(true);
  ...
  describe("verifyImage with custom policy", () => {
    it("should respect trusted issuers configuration", async () => {
      ...
      expect(mockSpawn).toHaveBeenCalledWith(
        expect.any(String),
        expect.arrayContaining([expect.stringContaining("--certificate-oidc-issuer")]),
        expect.any(Object)
      );
    });
  });
...
describe("CosignAdmissionController", () => {
  ...
  describe("review", () => {
    it("should allow pods with verified images", async () => {
      // Mock successful verification
      mockSpawn.mockReturnValue(createMockProcess("sha256:abc123", "", 0) as any);
    ...
    it("should deny pods with unverified images", async () => {
      ...
      mockSpawn.mockReturnValueOnce(createMockProcess("sha256:abc123", "", 0) as any);
      mockSpawn.mockReturnValueOnce(createMockProcess("", "verification failed", 1) as any);
      ...
      const request = {
        ...
        object: {
          spec: {
            ...
            containers: [{ image: "main/image:v1" }, { image: "sidecar/image:v1" }],
          },
        },
      };
...
describe("Integration scenarios", () => {
  ...
  it("should handle real-world GitHub Actions signed image", async () => {
    ...
    mockSpawn.mockReturnValueOnce(createMockProcess("sha256:fedcba987654", "", 0) as any);
    mockSpawn.mockReturnValueOnce(createMockProcess(ghActionSignature, "", 0) as any);
  ...
  it("should reject image with wrong issuer", async () => {
    ...
    mockSpawn.mockReturnValueOnce(createMockProcess("sha256:evil123", "", 0) as any);
    mockSpawn.mockReturnValueOnce(createMockProcess("", "issuer mismatch", 1) as any);
