...
test.describe('Provenance & Policy Acceptance (S-OS-08)', () => {
  ...
  test.skip('Acceptance 1: Create -> Approve -> Execute -> Receipt -> Replay', async ({ request }) => {
    ...
    expect(simulation.obligations).toContainEqual(expect.objectContaining({ type: 'require_approval' }));
