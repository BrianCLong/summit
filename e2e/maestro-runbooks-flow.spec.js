...
test_1.test.describe('Maestro Runbooks flow', () => {
    (0, test_1.test)('author → validate → simulate → run', async ({ page }) => {
        ...
        await (0, test_1.expect)(page.getByText('Valid runbook')).toBeVisible();
        await page.getByRole('button', { name: 'Simulate Cost' }).click();
        await (0, test_1.expect)(page.getByText('Estimated cost: $0.0421')).toBeVisible();
        await page.getByRole('button', { name: 'Run Now' }).click();
        await (0, test_1.expect)(page.getByText('Run queued')).toBeVisible();
        await (0, test_1.expect)(page.getByText('run-123')).toBeVisible();
    });
});
