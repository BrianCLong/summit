...
test.describe("Investigation real-time updates", () => {
  test("creates investigation and syncs entity and relationship events", async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="entity-alpha-node"]')).toBeVisible();
    await expect(page.locator('[data-testid="entity-beta-node"]')).toBeVisible();
    ...
    await expect(page.locator('[data-testid="relationship-alpha-node-beta-node"]')).toBeVisible();
