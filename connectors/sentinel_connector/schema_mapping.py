...
def map_sentinel_to_intelgraph(sentinel_json_file_path):
    ...
    """
    entities = []
    with open(sentinel_json_file_path, mode='r', encoding='utf-8') as jsonfile:
        ...
        for log_entry in logs:
            ...
            if log_entry.get('CommandLine'):
                entities.append({
                    'type': 'Process',
                    'properties': {
                        'command_line': log_entry['CommandLine']
                    }
                })
