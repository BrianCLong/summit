...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../sentinel_connector')))
...
class TestSentinelConnector(unittest.TestCase):
    ...
    def setUp(self):
        self.sample_json_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../sentinel_connector/sample.json'))
