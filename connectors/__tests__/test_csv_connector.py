...
from simulated_ingestion.ingestion_pipeline import run_ingestion_pipeline, MockGraphDBClient

class TestCsvConnector(unittest.TestCase):

    def setUp(self):
        self.csv_connector_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../csv_connector'))
