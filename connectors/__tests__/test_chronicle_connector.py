...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../chronicle_connector')))
...
class TestChronicleConnector(unittest.TestCase):
    ...
    def setUp(self):
        self.sample_json_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../chronicle_connector/sample.json'))
