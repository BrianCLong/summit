...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../elasticsearch_connector')))
...
class TestElasticsearchConnector(unittest.TestCase):
    ...
    def setUp(self):
        self.sample_json_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../elasticsearch_connector/sample.json'))
