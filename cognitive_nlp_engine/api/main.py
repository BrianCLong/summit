...
from ..knowledge_graph.interface import GraphQuery, knowledge_graph
...
async def parse_query(request: ParseQueryRequest):
    ...
    try:
        ...
        if request.conversation_id:
            ...
            conversation_id = dialogue_manager.start_dialogue(request.user_id or str(uuid.uuid4()))

        # Process dialogue turn
        turn = dialogue_manager.process_turn(conversation_id, request.query, parsed.__dict__)
