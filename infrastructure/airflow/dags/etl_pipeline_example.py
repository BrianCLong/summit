...
enrich_task = PythonOperator(task_id="enrich", python_callable=enrich_data, dag=dag)

load_task = PythonOperator(task_id="load", python_callable=load_data, dag=dag)

lineage_task = PythonOperator(task_id="track_lineage", python_callable=track_lineage, dag=dag)

metrics_task = PythonOperator(task_id="send_metrics", python_callable=send_metrics, dag=dag)
