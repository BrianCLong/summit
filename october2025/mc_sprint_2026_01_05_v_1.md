...
- name: Verify SLSA provenance
  run: cosign verify-attestation --use-signed-timestamps --type slsaprovenance ghcr.io/${ORG}/mc-api:${{ inputs.version }}
- name: Verify OPA bundles provenance
  run: cosign verify-attestation --use-signed-timestamps --type slsaprovenance gs://$BUNDLE_BUCKET/bundles/${{ inputs.version }}.tar
```
