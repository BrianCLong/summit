...
## 31) Next Actions to Operationalize
...
## 39) Definitions of Ready/Done (DoR/DoD) — Checklists
...
## 41) Disclosure Pack — Manifest Schema (v1)
```json
{
  "version": "1.0",
  "run_id": "RUN-xxxx",
...
## 49) Next Ready Steps (no dependencies left)
