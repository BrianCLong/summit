...
```json
{
  ...
  "contract": {
    "purpose": "customer_support",
    "fields": {"include": ["email_hash","ticket_text"], "exclude": ["ssn","raw_email"]}
  },
  "object": {"email_hash": "deadbeefdeadbeefdeadbeefdeadbeef", "text": "user cannot login"},
...
```json
{
  ...
  "contract": {"purpose": "customer_support", "fields": {"include": ["email_hash"], "exclude": ["ssn","raw_email"]}},
  "object": {"email_hash": "cafebabecafebabecafebabecafebabe"},
  "consent": {"gdpr_basis": "none"}
}
```

## `policy-fuzzer/seeds/purpose_mismatch.json`
```json
{
  "name": "purpose_mismatch",
  "contract": {"purpose": "marketing", "fields": {"include": ["email_hash"], "exclude": ["ssn","raw_email"]}},
...
## Violations
A violation occurs when the fuzzer predicts a *deny* (purpose mismatch or excluded field) but the evaluator returns *allow*.
```
