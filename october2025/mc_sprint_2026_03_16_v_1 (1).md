...
{ "title": "MC Privacy & DLP", "panels": [
  {"type":"stat","title":"Services with inventory","targets":[{"expr":"100 * mc_services_inventory / mc_services_total"}]},
  {"type":"graph","title":"Privacy Gate Violations","targets":[{"expr":"rate(mc_privacy_violations_total[1d])"}]},
  {"type":"table","title":"Unapproved Destinations","targets":[{"expr":"mc_privacy_unapproved_destinations"}]},
  {"type":"stat","title":"Redaction Coverage %","targets":[{"expr":"100 * mc_redaction_enabled_services / mc_services_pii"}]}
]}
```
