...
- **MC‑TEN‑1601**: *Tenant create/migrate APIs*  
...
- **MC‑TEN‑1602**: *Onboarding runbook & checks*  
...
```json
{"type":"object","required":["id","ts","type","severity","signals"],"properties":{"id":{"type":"string"},"ts":{"type":"string","format":"date-time"},"type":{"type":"string","enum":["mc.incident.open","mc.incident.update","mc.incident.close"]},"severity":{"type":"string","enum":["sev1","sev2","sev3"]},"signals":{"type":"array","items":{"type":"object"}}}}
```
