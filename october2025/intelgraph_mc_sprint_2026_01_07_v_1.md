...
```json
{
  ...
  "properties": {
    ...
    "license": {"enum":["MIT-OK","Open-Data-OK","Restricted-TOS","Proprietary-Client","Embargoed"]},
    "purpose": {"type":"array","items":{"type":"string"}},
    "retention": {"enum":["ephemeral-7d","short-30d","standard-365d","long-1825d","legal-hold"]},
    "sla": {"type":"object","properties":{
...
```graphql
type DataContract { id: ID!, datasetId: ID!, version: String!, license: String!, purpose: [String!]!, retention: String!, sla: SLA! }

type SLA { ingestLatencyMs: Int, completenessPct: Float, dedupe: Boolean }

type TemporalPath { nodes: [ID!]!, edges: [String!]!, from: DateTime!, to: DateTime! }

type Query {
  contract(datasetId: ID!, version: String!): DataContract @auth(abac: "contract.read")
  temporalPath(entityId: ID!, from: DateTime!, to: DateTime!, maxHops: Int = 2): TemporalPath @auth(abac: "analytics.read")
}
...
```json
{ "id":"temporalPath:v1", "hash":"sha256-...", "abac":["analytics.read"], "ttl":"1m" }
```
