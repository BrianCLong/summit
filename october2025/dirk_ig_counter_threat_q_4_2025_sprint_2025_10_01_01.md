...
```json
{
  ...
  "properties": {
    ...
    "policy_decision": {"type":"string","enum":["allow","deny"],"nullable":true},
...
*Prepared by DIRK IG (Directorate K++). This document is auditable and designed for immediate sprint execution.*
