...
- **MC‑PROV‑302**: _Cosign signing of receipts_  
  **AC:** Receipts signed; `cosign verify --use-signed-timestamps --certificate-identity` passes.
...
cosign verify-blob --use-signed-timestamps --signature receipt.sig receipt.json
