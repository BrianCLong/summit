...
{ "title": "MC Compliance", "panels": [
  {"type":"table","title":"Releases","targets":[{"expr":"mc_release_status"}]},
  {"type":"graph","title":"Gate Failures (dedup)","targets":[{"expr":"rate(mc_gate_failures_dedup_total[10m])"}]}
]}
```

```json
// file: dashboards/mc-cost.json
{ "title": "MC Cost", "panels": [
  {"type":"graph","title":"CI Minutes","targets":[{"expr":"sum(rate(mc_ci_minutes_total[1d]))"}]},
  {"type":"table","title":"Top Repos by Spend","targets":[{"expr":"topk(10, mc_ci_minutes_total)"}]}
]}
```
