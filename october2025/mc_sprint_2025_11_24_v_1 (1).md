...
{ "title": "MC DR", "panels": [
  {"type":"stat","title":"DR RTO (last)","targets":[{"expr":"mc_dr_rto_seconds_last"}]},
  {"type":"stat","title":"DR RPO (last)","targets":[{"expr":"mc_dr_rpo_seconds_last"}]},
  {"type":"graph","title":"Mirror Verify Success","targets":[{"expr":"rate(mc_verify_mirror_success_total[1h])"}]},
  {"type":"table","title":"Bypass Events","targets":[{"expr":"mc_bypass_events_total"}]}
]}
```
