...
**GraphQL — ER APIs**
```graphql
type ERCluster { id: ID!, status: String!, entities: [EntityScore!]! }

type EntityScore { entityId: ID!, score: Float!, decision: String! }

type Query { erCluster(id: ID!): ERCluster }
...
export default function(){
  const res = http.post('https://router.stg/graphql', JSON.stringify({id:'getEntityById:v1', vars:{id:'1'}}));
