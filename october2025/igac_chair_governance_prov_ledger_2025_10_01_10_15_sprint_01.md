...
- **🛡 Foster**: **High** ethics risk if _Reason‑for‑Access_ prompts and **Proof‑of‑Non‑Collection** logs are not end‑to‑end for the new flows.
...
Ship a **clean, green, functional** vertical slice that makes _governed analytics verifiable by default_:
