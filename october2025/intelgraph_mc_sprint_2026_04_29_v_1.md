...
type Attestation { kind: String!, createdAt: DateTime!, uri: String! }

type Query { attestations: [Attestation!]! @auth(abac: "trust.read") }
...
```ts
export function breaker(cfg){ /* rolling window & half-open */ }
```
