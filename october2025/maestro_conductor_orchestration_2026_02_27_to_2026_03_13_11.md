...
```json
{ "ts":"2026-03-02T12:00:00Z","actor":"op:sre1","tenant":"alpha","action":"read:asset","purpose":"support","warrant":"TKT-123","hash":"..." }
```

**Incident Manifest**
```json
{ "id":"INC-204","severity":"P1","artifacts":["alerts.json","traces.json","aca.json","residency.json","masking.json","git-diff.txt"],"sha256":"...","signature":"cosign:..." }
```
