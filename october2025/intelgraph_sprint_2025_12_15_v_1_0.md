...
- _Acceptance:_ 100 runs produce identical verifier results; tolerance bounds documented.

**B2. Side‑Channel Checklist & Mitigations**

- Review timing/memory channels; constant‑time hotspots; logging hygiene. (5 pts)
- _Acceptance:_ Checklist signed; alerts on risky configs.

**B3. Perf Guardrails**

- Budget p95 verify < 450ms aggregate; batch sizes tuned; cache priming. (3 pts)
- _Acceptance:_ Stage soak meets budgets; regressions page.
...
- _Acceptance:_ PDFs pass legibility + provenance checks; diffs explain changes.

**C2. Task Workflows & SLAs**

- States (ToDo/In Prog/Blocked/Review/Done), assignees, due, SLA timers; bulk ops. (5 pts)
- _Acceptance:_ Burndown visible; SLA breach alerts; bulk edit audited.

**C3. Disclosure Cross‑Links**

- Narrative sections link to disclosure artifacts; redaction awareness. (3 pts)
- _Acceptance:_ Broken link detector; export refuses if link invalid.
...
- _Trust Fabric:_ ZK recursion stability, perf guardrails, notarization anchors
- _Gov/Ops:_ federation tenant GA (caps, compensation, contention), audit parity, cost v1.3
- _Graph Core:_ narrative export, task workflows, disclosure cross‑links
- _Copilot/UX:_ governance panel, denial explainers, viewer verify UX
- _QA/Release:_ stability suites, chaos, audit replay
