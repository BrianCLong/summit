...
- _Trust Fabric:_ ZK‑TX pilot, PCQ hook, policy feasibility annotations
- _Gov/Ops:_ federation adapters, RO executor, cost guards, disclosure beacons
- _Graph Core:_ timelines, evidence graph, advanced approvals
- _Copilot/UX:_ plan explainer, evidence‑link helper
- _QA/Release:_ scenario scripts, replay proofs, cost gates
