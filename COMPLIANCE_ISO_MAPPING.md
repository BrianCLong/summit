...
| **A.14.2.1 Secure Development Policy**      | `CICD-001`, `SEC-001`, `SEC-003` | A secure development policy is enforced through an automated CI/CD pipeline that includes static analysis, secret scanning, and vulnerability checks. |
