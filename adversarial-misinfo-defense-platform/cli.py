...
def create_parser() -> argparse.ArgumentParser:
    ...
    validate_parser.add_argument("--output", "-o", help="Output file for results (JSON format)")
    ...
    train_parser.add_argument("--data", "-d", help="Training data file (JSON format)")
    train_parser.add_argument(
        "--epochs", "-e", type=int, default=10, help="Number of training epochs (default: 10)"
    )

    # Exercise subcommand
    exercise_parser = subparsers.add_parser("exercise", help="Manage red/blue team exercises")
    exercise_parser.add_argument("--list", action="store_true", help="List available scenarios")
