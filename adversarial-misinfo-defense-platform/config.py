...
class Config:
    ...
    def __init__(self):
        ...
        # Model settings
        self.TEXT_MODEL_NAME = os.environ.get('AMD_TEXT_MODEL', 'distilbert-base-uncased-finetuned-sst-2-english')
        ...
        self.ADVERSARIAL_TRAINING_ENABLED = os.environ.get('AMD_ADV_TRAINING_ENABLED', 'true').lower() == 'true'
        ...
        self.CONTENT_FILTER_ENABLED = os.environ.get('AMD_CONTENT_FILTER_ENABLED', 'true').lower() == 'true'
        ...
        # Exercise settings
        self.EXERCISE_DEFAULT_DURATION = int(os.environ.get('AMD_EXERCISE_DURATION', '60'))  # minutes
    ...
    def get_validation_config(self) -> Dict[str, Any]:
        ...
        """
        return {
            'benchmark': self.VALIDATION_BENCHMARK,
