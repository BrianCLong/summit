...
from adversarial_misinfo_defense.main_detector import AdversarialMisinfoDetector
...
def create_cli_parser() -> argparse.ArgumentParser:
    ...
    evolve_parser.add_argument(
        ...
        type=int,
        default=5,
        help='Number of evolution cycles to run (default: 5)'
    )
    evolve_parser.add_argument(
        '--actors',
        '-a',
...
def run_detection(args: argparse.Namespace, platform: dict) -> int:
    ...
    try:
        ...
        for i, result in enumerate(results):
            ...
            print(f"  Classification: {'MISINFORMATION' if result.get('is_misinfo', False) else 'LEGITIMATE'}")
