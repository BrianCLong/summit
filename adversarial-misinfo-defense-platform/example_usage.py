...
def example_audio_detection(platform):
    ...
    try:
        ...
        sample_audio = [
            ...
            "/path/to/sample/real_recording.mp3"
        ]
        ...
        print("\nDetection Results:")
        for i, (audio_path, result) in enumerate(zip(sample_audio, results)):
            misinfo_score = result.get('misinfo_score', 0.0)
            confidence = result.get('confidence', 0.0)
...
def example_tactic_evolution(platform):
    ...
    try:
        ...
        from adversarial_misinfo_defense.tactic_evolution import ThreatActorProfile, TacticType
        ...
        print(f"✓ Generated threat actor report")
