...
class ImageDetector:
    ...
    def generate_adversarial_samples(self, base_images: List[Image.Image], num_samples: int = 5) -> List[Image.Image]:
        """
    ...
    def update_model(self, training_images: List[Image.Image], labels: List[int]):
        ...
        print(f"Updated model with {len(training_images)} training images and {len(adversarial_images)} adversarial samples")