...
class Reviewer {
            ...
            for (const chunk of file.chunks) {
                for (const change of chunk.changes) {
                    if (change.type === 'add') {
                        ...
                        const secretFinding = (0, secret_scanner_1.scanForSecrets)(content, file.to, lineNum);
                        if (secretFinding) {
    ...
    checkErrorHandling(content, file, line) {
    ...
    checkPagination(content, file, line) {
