...
- **Database (Graph):** Self-Hosted Neo4j 5 Enterprise on EKS (via Helm) with persistent volume claims (EBS/EFS). _Note: Chosen over Neptune to ensure full Cypher compatibility with existing `nl2cypher` logic._
