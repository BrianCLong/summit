...
| ---- | ------------------------------------------------------------------------------- | --------------- | -------- | -------------------------------------------------------------------------------------------------------- |
| 1    | Enforce PR secret scanning (warn-only Gitleaks workflow)                        | Secret scanning | High     | Converted to blocking with required tracked baseline and enforced failure gate in this branch.           |
