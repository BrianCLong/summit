...
**Should**
6) Run detail view: steps, artifacts, attestations, trace link.
7) Minimal evidence bundle export (JSON) for a run.

**Could**
8) Dark mode & theme tokens; persisted filters; basic i18n scaffolding.
