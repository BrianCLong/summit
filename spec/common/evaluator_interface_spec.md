...
- **Result retrieval**: Metric outputs, intermediate artifact references, and conformance verdicts returned via strongly typed schemas (OpenAPI/IDL aligned with `integration/intelgraph/api/*_openapi.yaml`).
