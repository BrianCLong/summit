...
describe("AuditService", () => {
  ...
  describe("governance controls", () => {
    ...
    it("should update governance control status", () => {
      ...
      if (controls.length > 0) {
        ...
        const updated = auditService.getGovernanceControls().find((c) => c.id === controls[0].id);
  ...
  describe("incident management", () => {
    ...
    it("should close incidents", () => {
      ...
      const success = auditService.closeIncident(incidentId, "analyst-1", "Issue resolved", [
        "Document findings",
        "Update playbook",
      ]);
