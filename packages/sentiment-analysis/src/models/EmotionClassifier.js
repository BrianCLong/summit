...
exports.EmotionClassifier = void 0;
...
class EmotionClassifier {
    ...
    async initialize() {
        ...
        try {
            this.pipeline = await (0, transformers_1.pipeline)('text-classification', this.config.modelName, {
    ...
    transformToEmotionScore(result) {
        const emotions = {
            anger: 0,
            fear: 0,
            joy: 0,
...
exports.EmotionClassifier = EmotionClassifier;
