...
exports.createGAN = createGAN;
exports.createVAE = createVAE;
exports.createDiffusionModel = createDiffusionModel;
function createGAN(config) {
    const generator = {
        name: 'Generator',
        type: 'convolutional',
        layers: [
...
// Diffusion model
function createDiffusionModel(config) {
    return {
        name: 'DiffusionModel',
        type: 'convolutional',
        layers: [
