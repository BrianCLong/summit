...
exports.ProvenanceAuditorAgent = void 0;
const Agent_js_1 = require("../Agent.js");
/**
 * ProvenanceAuditorAgent ensures the integrity and completeness of provenance records.
 */
class ProvenanceAuditorAgent extends Agent_js_1.BaseAgent {
    getDescriptor() {
        return {
    ...
    async auditTask(auditTaskId, targetTaskId, depth = 'shallow', services, startTime) {
    ...
    checkTemporalContinuity(records) {
        const findings = [];
    ...
    async deepAnalysis(records, services) {
...
If no issues: { "findings": [] }`;
    ...
    async verifyIntegrity(auditTaskId, targetTaskId, services, startTime) {
        const records = await services.provenance.query(targetTaskId);
        const findings = [];
    ...
    async generateRecommendations(findings, services) {
...
exports.ProvenanceAuditorAgent = ProvenanceAuditorAgent;
