...
exports.PolicyGuardianAgent = void 0;
const Agent_js_1 = require("../Agent.js");
/**
 * PolicyGuardianAgent evaluates actions and content against organizational policies.
 */
class PolicyGuardianAgent extends Agent_js_1.BaseAgent {
    ...
    policies = [
        ...
        },
        {
            ...
            severity: 'critical',
            check: (_content) => true, // Would use content classifier
        },
        {
            id: 'CODE-001',
    ...
    async evaluate(taskId, payload, services, startTime) {
    ...
    async modelBasedEvaluation(payload, services) {
...
If no violations: { "violations": [] }`;
    ...
    generateRedactions(violations, _content) {
    ...
    async audit(taskId, payload, services, startTime) {
    ...
    async explain(taskId, payload, services, startTime) {
...
exports.PolicyGuardianAgent = PolicyGuardianAgent;
