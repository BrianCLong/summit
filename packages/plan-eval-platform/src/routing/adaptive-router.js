...
exports.AdaptiveRouter = void 0;
exports.createAdaptiveRouter = createAdaptiveRouter;
const base_router_js_1 = require("./base-router.js");
const greedy_cost_router_js_1 = require("./greedy-cost-router.js");
/**
 ...
 */
class AdaptiveRouter extends base_router_js_1.BaseRouter {
    baseRouter;
    toolWeights = new Map();
    ...
    constructor(config) {
        ...
        this.baseRouter = new greedy_cost_router_js_1.GreedyCostRouter(this.config);
    }
    /**
     ...
     */
    adaptiveScore(candidate, category) {
     ...
     */
    recordEvalOutcome(toolId, category, success, cost, latencyMs, qualityScore) {
        // Record in history
     ...
     */
    buildAdaptiveReasoning(selected, score, category) {
    ...
    getLearnedWeights() {
        return {
            ...
            categoryWeights: new Map(Array.from(this.categoryWeights.entries()).map(([k, v]) => [
                k,
                new Map(v),
            ])),
    ...
    exportModel() {
        return JSON.stringify({
            ...
            categoryWeights: Object.fromEntries(Array.from(this.categoryWeights.entries()).map(([k, v]) => [
                k,
 ...
 */
function createAdaptiveRouter(config) {
