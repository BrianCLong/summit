...
export { GreedyCostRouter, createGreedyCostRouter } from "./greedy-cost-router.js";
 ...
 */
export function createRouter(type: RouterType, config?: Partial<RoutingConfig>): BaseRouter {
  switch (type) {
    case "random":
