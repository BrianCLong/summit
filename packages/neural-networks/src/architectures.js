...
exports.createVGG16 = createVGG16;
exports.createInceptionV3 = createInceptionV3;
exports.createMobileNetV2 = createMobileNetV2;
exports.createEfficientNetB0 = createEfficientNetB0;
/**
 * VGG-16 architecture
 */
function createVGG16(inputShape, numClasses) {
    const layers = [
 ...
 * Inception module
 */
function createInceptionV3(inputShape, numClasses) {
    const layers = [
        { type: 'input', name: 'input', config: { shape: inputShape } },
        // Stem
 ...
 */
function createMobileNetV2(inputShape, numClasses) {
    const layers = [
        { type: 'input', name: 'input', config: { shape: inputShape } },
        // Initial conv
 ...
 */
function createEfficientNetB0(inputShape, numClasses) {
    const layers = [
        { type: 'input', name: 'input', config: { shape: inputShape } },
        // Stem
