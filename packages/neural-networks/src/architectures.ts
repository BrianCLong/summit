...
export function createVGG16(
  ...
  const layers: Layer[] = [
    ...
    // Block 1
    {
      type: "conv2d",
      name: "block1_conv1",
      config: { filters: 64, kernelSize: 3, padding: "same", activation: "relu" },
    },
    {
      type: "conv2d",
      name: "block1_conv2",
    ...
    // Block 2
    {
      type: "conv2d",
      name: "block2_conv1",
      config: { filters: 128, kernelSize: 3, padding: "same", activation: "relu" },
    },
    {
      type: "conv2d",
      name: "block2_conv2",
    ...
    // Block 3
    {
      type: "conv2d",
      name: "block3_conv1",
      config: { filters: 256, kernelSize: 3, padding: "same", activation: "relu" },
    },
    {
      type: "conv2d",
      name: "block3_conv2",
    ...
    // Block 4
    {
      type: "conv2d",
      name: "block4_conv1",
      config: { filters: 512, kernelSize: 3, padding: "same", activation: "relu" },
    },
    {
      type: "conv2d",
      name: "block4_conv2",
 ...
 * Inception module
 */
export function createInceptionV3(
  inputShape: [number, number, number],
  numClasses: number
): NeuralNetworkArchitecture {
  const layers: Layer[] = [
    ...
    // Stem
    {
      type: "conv2d",
      name: "stem_conv1",
      config: { filters: 32, kernelSize: 3, strides: 2, padding: "valid", activation: "relu" },
    },
    {
      type: "conv2d",
      name: "stem_conv2",
      config: { filters: 32, kernelSize: 3, padding: "valid", activation: "relu" },
    },
    {
      type: "conv2d",
      name: "stem_conv3",
    ...
    // Simplified representation - in production would include full inception modules
    {
      type: "conv2d",
      name: "conv_out",
      config: { filters: 2048, kernelSize: 1, activation: "relu" },
    },
 ...
 */
export function createMobileNetV2(
  inputShape: [number, number, number],
  numClasses: number
): NeuralNetworkArchitecture {
  const layers: Layer[] = [
    ...
    // Initial conv
    {
      type: "conv2d",
      name: "conv_init",
      config: { filters: 32, kernelSize: 3, strides: 2, padding: "same", activation: "relu" },
    },
    ...
    // Inverted residual blocks (simplified)
    {
      ...
      name: "dw_conv1",
      config: { kernelSize: 3, padding: "same", activation: "relu" },
    },
    {
      type: "conv2d",
      name: "pw_conv1",
      config: { filters: 64, kernelSize: 1, activation: "relu" },
    },

    {
      type: "depthwise_conv2d",
      name: "dw_conv2",
      config: { kernelSize: 3, strides: 2, padding: "same", activation: "relu" },
    },
    {
      type: "conv2d",
      name: "pw_conv2",
      config: { filters: 128, kernelSize: 1, activation: "relu" },
    },
    ...
    // Final layers
    {
      type: "conv2d",
      name: "conv_out",
      config: { filters: 1280, kernelSize: 1, activation: "relu" },
    },
    { type: "global_average_pooling2d", name: "global_pool", config: {} },
    { type: "dense", name: "output", config: { units: numClasses, activation: "softmax" } },
  ];
 ...
 */
export function createEfficientNetB0(
  inputShape: [number, number, number],
  numClasses: number
): NeuralNetworkArchitecture {
  const layers: Layer[] = [
    ...
    // Stem
    {
      type: "conv2d",
      name: "stem_conv",
      config: { filters: 32, kernelSize: 3, strides: 2, padding: "same", activation: "swish" },
    },
    ...
    // MBConv blocks (simplified)
    {
      type: "conv2d",
      name: "block1_expand",
      config: { filters: 96, kernelSize: 1, activation: "swish" },
    },
    {
      type: "depthwise_conv2d",
      name: "block1_dw",
      config: { kernelSize: 3, padding: "same", activation: "swish" },
    },
    ...
    // Head
    {
      type: "conv2d",
      name: "head_conv",
      config: { filters: 1280, kernelSize: 1, activation: "swish" },
    },
