...
export function HelpSidebar({ className = "", onClose }: HelpSidebarProps): JSX.Element | null {
  ...
  const articlesToDisplay =
    searchResults.length > 0 ? searchResults : contextualHelp?.articles || [];
      ...
      >
        ...
        <div style={contentStyles}>
          {currentArticle ? (
            ...
            <>
              <HelpSearch onResultSelect={(article) => setCurrentArticle(article)} />
              ...
              {isLoading ? (
                ...
                <>
                  ...
                  {contextualHelp?.suggestedSearches &&
                    contextualHelp.suggestedSearches.length > 0 && (
                      <>
        ...
        >
          Press <kbd style={{ background: "#eee", padding: "2px 6px", borderRadius: "3px" }}>?</kbd>{" "}
          to toggle help
        </footer>
      </aside>
    </>
