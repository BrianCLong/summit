...
export class CovertOpsManager {
  ...
  assessOperationRisk(operationId: string): {
    ...
    const factors = [
      {
        factor: "Compromise risk",
        risk: op.riskAssessment.compromiseRisk,
        mitigation: "Compartmentalization",
      },
      {
        factor: "Diplomatic risk",
        risk: op.riskAssessment.diplomaticRisk,
        mitigation: "Deniability measures",
      },
      {
        factor: "Physical risk",
        risk: op.riskAssessment.physicalRisk,
        mitigation: "Security protocols",
      },
    ];
  ...
  conductSecurityAudit(): {
    ...
    return {
      ...
      expiredCovers: Array.from(this.covers.values()).filter(
  ...
  getCover(id: string): Cover | undefined {
    return this.covers.get(id);
  }
  getDeadDrop(id: string): DeadDrop | undefined {
