...
class PhaseTransitionDetector {
     ...
     */
    detectEarlyWarnings(timeSeries) {
        const signals = [];
     ...
     */
    estimateDistanceToTransition(signals) {
     ...
     */
    classifyTransition(signals, contextIndicators) {
        ...
        const hasTrustIndicators = contextIndicators.some((c) => c.type === 'INSTITUTIONAL_TRUST' && c.value < 0.3);
        const hasMobilizationIndicators = contextIndicators.some((c) => c.type === 'MOBILIZATION_ACTIVITY');
