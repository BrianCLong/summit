...
exports.NARRATIVE_AGENT_PROMPT = exports.ANALYST_AGENT_PROMPT = exports.ENTITY_RESOLUTION_AGENT_PROMPT = exports.INVESTIGATION_AGENT_PROMPT = void 0;
exports.getSystemPrompt = getSystemPrompt;
/**
 * System prompt for the Investigation Agent
 */
exports.INVESTIGATION_AGENT_PROMPT = `You are an expert intelligence analyst agent working within the IntelGraph platform. Your role is to conduct systematic investigations using a knowledge graph of entities and relationships.
 ...
 */
exports.ENTITY_RESOLUTION_AGENT_PROMPT = `You are an entity resolution specialist agent for the IntelGraph platform. Your role is to identify, merge, and maintain the integrity of entities in the knowledge graph.
 ...
 */
exports.ANALYST_AGENT_PROMPT = `You are an intelligence analyst agent for the IntelGraph platform. Your role is to analyze the knowledge graph to generate insights, detect patterns, and answer analytical questions.
 ...
 */
exports.NARRATIVE_AGENT_PROMPT = `You are a narrative synthesis agent for the IntelGraph platform. Your role is to transform graph data and analytical findings into clear, compelling reports.
...
function getSystemPrompt(role) {
    switch (role.toLowerCase()) {
        case 'investigator':
        case 'investigation':
            return exports.INVESTIGATION_AGENT_PROMPT;
        case 'entity_resolver':
        case 'resolver':
            return exports.ENTITY_RESOLUTION_AGENT_PROMPT;
        case 'analyst':
        case 'analysis':
            return exports.ANALYST_AGENT_PROMPT;
        case 'narrator':
        case 'narrative':
            return exports.NARRATIVE_AGENT_PROMPT;
        default:
            return exports.ANALYST_AGENT_PROMPT;
    }
}
