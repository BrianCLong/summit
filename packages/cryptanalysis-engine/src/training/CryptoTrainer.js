...
class CryptoTrainer {
     ...
     * Submit an answer
     */
    submitAnswer(lessonId, exerciseId, answer) {
        ...
        if (correct) {
            ...
            const allCompleted = lesson.exercises.every(e => this.progress.exercisesCompleted.get(e.id));
     ...
     */
    generatePracticeScenario(topic) {
        const scenarios = {
            'tls_analysis': {
