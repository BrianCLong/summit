...
export class CryptoTrainer {
        ...
        exercises: [
          {
            id: "sym-1",
            question:
              "Which mode of operation should NEVER be used for encrypting multiple blocks?",
            type: "multiple_choice",
            options: ["ECB", "CBC", "CTR", "GCM"],
            correctAnswer: 0,
            explanation:
              "ECB (Electronic Codebook) encrypts each block independently, causing identical plaintext blocks to produce identical ciphertext blocks, revealing patterns.",
        ...
        exercises: [
          {
            id: "asym-1",
            question:
              "In RSA, which key is used for encryption when sending a confidential message?",
            type: "multiple_choice",
            options: [
            ...
            correctAnswer: 3,
            explanation:
              "To encrypt a message for confidentiality, you use the recipient's public key. Only the recipient's private key can decrypt it.",
        ...
        exercises: [
          {
            ...
            correctAnswer: 2,
            explanation:
              "ECDHE (Elliptic Curve Diffie-Hellman Ephemeral) generates new key pairs for each session, so compromising the server's private key doesn't compromise past sessions.",
          ...
          },
          {
            ...
            correctAnswer: 1,
            explanation:
              "TLS 1.3 reduces the handshake to 1 round-trip time (1-RTT) compared to TLS 1.2's 2-RTT, improving latency.",
        ...
        exercises: [
          {
            ...
            correctAnswer: 2,
            explanation:
              "Packet sizes, timing, and patterns can reveal information about the type of activity even without decryption.",
        ...
        exercises: [
          {
            ...
            correctAnswer: 2,
            explanation:
              "MD5 has known collision vulnerabilities and should not be used for security purposes. Use SHA-256 or better.",
          ...
          },
          {
            ...
            correctAnswer: 2,
            explanation:
              "2048 bits is the minimum recommended RSA key size. 1024-bit RSA is considered weak.",
  ...
  submitAnswer(
    ...
    if (correct) {
      ...
      const allCompleted = lesson.exercises.every((e) =>
        this.progress.exercisesCompleted.get(e.id)
      );
  ...
  generatePracticeScenario(topic: string): {
    ...
    const scenarios: Record<
      string,
      { scenario: string; questions: string[]; resources: string[] }
    > = {
      tls_analysis: {
        scenario:
          "You have captured a TLS 1.2 handshake. The server selected TLS_RSA_WITH_AES_128_CBC_SHA. Analyze the security implications.",
        questions: [
        ...
        resources: ["RFC 5246 - TLS 1.2", "RFC 8446 - TLS 1.3", "NIST SP 800-52 Rev 2"],
      },
      certificate_analysis: {
        scenario:
          "A server presents a certificate signed with SHA-1 and has a 1024-bit RSA key. Evaluate the security.",
        questions: [
        ...
        resources: ["NIST SP 800-57", "CA/Browser Forum Baseline Requirements", "RFC 6979"],
      },
      traffic_patterns: {
        scenario:
          "You observe encrypted traffic with packets of exactly 160 bytes sent every 20ms. Identify the likely application.",
        questions: [
