  ...
  Contract: {
    ...
    transitions: [
      ...
      { from: "PendingApproval", to: "Negotiation", requires_approval: false },
      {
        ...
        approvers: ["Legal", "AuthorizedSignatory"],
      },
  ...
  Policy: {
    ...
    transitions: [
      ...
      { from: "PendingApproval", to: "Review", requires_approval: false },
      {
        ...
        to: "Approved",
        requires_approval: true,
        approvers: ["PolicyOwner", "ExecutiveSponsor"],
      },
  ...
  Record: {
    ...
    transitions: [
      ...
      { from: "Closed", to: "Archived", requires_approval: false },
      {
        ...
        to: "Destroyed",
        requires_approval: true,
        approvers: ["RecordsManager", "Legal"],
      },
    ],
  },
  Versioned: {
    ...
    transitions: [
      {
        ...
        to: "Finalized",
        requires_approval: true,
        approvers: ["BoardChair", "Secretary"],
      },
...
export class LifecycleEngine {
   ...
   */
  async requestTransition(request: TransitionRequest, userId: string): Promise<TransitionResult> {
    const session = this.driver.session();
    try {
