...
import { RelationshipTypeIdSchema, DocumentRelationshipSchema } from "../src/types/relationship.js";

import { TransitionRequestSchema, TransitionResultSchema } from "../src/types/lifecycle.js";

import { ComplianceCheckResultSchema, RiskScoreSchema } from "../src/types/compliance.js";

import { AIProvenanceMetadataSchema, CreationSourceSchema } from "../src/types/provenance.js";
  ...
  describe("RiskScoreSchema", () => {
    it("should validate a risk score", () => {
      const score = {
        ...
        weighted_score: 6.25,
        risk_level: "High",
        modifiers_applied: [{ name: "Classification Level", value: 0.5, reason: "Confidential" }],
        factors: [],
      };
