...
class KAnonymity {
     ...
     */
    applyAnonymization(data, equivalenceClasses) {
     ...
     */
    generalizeValue(value, columnName) {
     ...
     */
    verifyTCloseness(anonymized, original) {
        if (!this.config.sensitiveAttributes || this.config.sensitiveAttributes.length === 0) {
            return 0;
        }
     ...
     */
    earthMoversDistance(dist1, dist2) {
     ...
     * Compute information loss
     */
    computeInformationLoss(original, anonymized) {
