...
const RelationshipExtractor_1 = require("../src/extraction/RelationshipExtractor");
describe('RelationshipExtractor', () => {
    ...
    beforeEach(() => {
        ...
        extractor = new RelationshipExtractor_1.RelationshipExtractor(mockDriver);
    });
    ...
    describe('detectCausalRelationships', () => {
        it('should create a causal relationship', async () => {
            const relationship = await extractor.detectCausalRelationships('entity1', 'entity2', ['evidence1', 'evidence2']);
