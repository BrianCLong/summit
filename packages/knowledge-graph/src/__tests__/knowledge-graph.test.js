...
const VersionManager_js_1 = require("../versioning/VersionManager.js");
const GraphIndexer_js_1 = require("../indexing/GraphIndexer.js");
describe('VersionManager', () => {
    let versionManager;
    beforeEach(() => {
        versionManager = new VersionManager_js_1.VersionManager();
    });
...
describe('GraphIndexer', () => {
    let indexer;
    beforeEach(() => {
        indexer = new GraphIndexer_js_1.GraphIndexer();
    });
