...
__exportStar(require("./facial/facial-detector"), exports);
__exportStar(require("./voice/voice-detector"), exports);
__exportStar(require("./video/video-analyzer"), exports);
__exportStar(require("./neural/fingerprinting-engine"), exports);
__exportStar(require("./adversarial/adversarial-detector"), exports);
__exportStar(require("./streaming/streaming-engine"), exports);
__exportStar(require("./explainable/explainable-ai"), exports);
__exportStar(require("./ensemble/meta-learner"), exports);
__exportStar(require("./multimodal/fusion-engine"), exports);
__exportStar(require("./zero-shot/zero-shot-detector"), exports);
__exportStar(require("./active-learning/active-learner"), exports);
__exportStar(require("./federated/federated-learning"), exports);
const facial_detector_1 = require("./facial/facial-detector");
const voice_detector_1 = require("./voice/voice-detector");
const video_analyzer_1 = require("./video/video-analyzer");
class DeepfakeDetector {
    facialDetector;
    voiceDetector;
    videoAnalyzer;
    constructor() {
        this.facialDetector = new facial_detector_1.FacialDeepfakeDetector();
        this.voiceDetector = new voice_detector_1.VoiceDeepfakeDetector();
        this.videoAnalyzer = new video_analyzer_1.VideoDeepfakeAnalyzer();
    }
    /**
    ...
    async detectDeepfake(media) {
        ...
        switch (media.type) {
            case 'image':
                const imageResult = await this.detectImageDeepfake(media.buffer);
                ...
                break;
            case 'video':
                const videoResult = await this.detectVideoDeepfake(media.buffer, media.metadata);
                ...
                break;
            case 'audio':
                const audioResult = await this.detectAudioDeepfake(media.buffer);
     ...
     */
    async detectImageDeepfake(buffer) {
     ...
     */
    async detectVideoDeepfake(frames, metadata) {
     ...
     */
    async detectAudioDeepfake(buffer) {
