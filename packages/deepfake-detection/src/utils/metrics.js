...
exports.calculateEER = calculateEER;
exports.calculateAUC = calculateAUC;
exports.calculatePSI = calculatePSI;
exports.calculateKLDivergence = calculateKLDivergence;
exports.calculateCalibrationError = calculateCalibrationError;
 ...
 */
function calculateEER(scores, labels) {
 ...
 */
function calculateAUC(scores, labels) {
    if (scores.length !== labels.length) {
        throw new Error('Scores and labels must have same length');
    }
    // Sort by score
...
function calculatePSI(baseline, current, numBins = 10) {
    ...
    for (let i = 0; i < numBins; i++) {
        ...
        const epsilon = 1e-10;
        const psiTerm = (currentPercent - baselinePercent) *
 ...
 */
function countInBins(data, binEdges) {
 ...
 */
function calculateCalibrationError(scores, labels, numBins = 10) {
    if (scores.length !== labels.length) {
        throw new Error('Scores and labels must have same length');
    }
