...
exports.ExplainableAI = exports.VisualizationType = void 0;
var VisualizationType;
(function (VisualizationType) {
    VisualizationType["HEATMAP"] = "heatmap";
    VisualizationType["ATTENTION_MAP"] = "attention_map";
    VisualizationType["SALIENCY_MAP"] = "saliency_map";
    VisualizationType["GRADIENT_CAM"] = "gradient_cam";
    VisualizationType["LIME_EXPLANATION"] = "lime";
    VisualizationType["SHAP_VALUES"] = "shap";
    VisualizationType["DECISION_TREE"] = "decision_tree";
    VisualizationType["FEATURE_IMPORTANCE_CHART"] = "feature_importance";
    VisualizationType["TEMPORAL_ANALYSIS"] = "temporal";
    VisualizationType["FREQUENCY_SPECTRUM"] = "frequency_spectrum";
    VisualizationType["DIFFERENCE_MAP"] = "difference_map";
    VisualizationType["ARTIFACT_OVERLAY"] = "artifact_overlay";
    VisualizationType["CONFIDENCE_DISTRIBUTION"] = "confidence_distribution";
    VisualizationType["EMBEDDING_PROJECTION"] = "embedding_projection";
...
class ExplainableAI {
     ...
     * Generate human-readable explanation
     */
    async generateHumanExplanation(detection) {
        const keyFindings = [];
        // Analyze key factors
    ...
    generateTechnicalDetails(detection) {
        const details = [];
     ...
     * Generate visualizations
     */
    async generateVisualizations(detection) {
    ...
    async generateSaliencyMap(input) {
    ...
    async generateArtifactOverlay(input) {
    ...
    async generateFrequencySpectrum(input) {
    ...
    async generateAudioSpectrogram(input) {
    ...
    async generateTokenImportance(input) {
    ...
    async generateFeatureImportanceChart(detection) {
    ...
    async generateConfidenceDistribution(detection) {
     ...
     */
    async calculateFeatureImportance(detection) {
        const contributions = [];
    ...
    generateFeatureExplanation(featureName, value, contribution) {
     ...
     * Build decision path
     */
    async buildDecisionPath(detection) {
     ...
     * Generate counterfactuals
     */
    async generateCounterfactuals(detection) {
     ...
     * Analyze uncertainty
     */
    async analyzeUncertainty(detection) {
     ...
     */
    async generateReport(explanation) {
...
exports.ExplainableAI = ExplainableAI;
