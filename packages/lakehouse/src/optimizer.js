...
exports.LakehouseOptimizer = void 0;
const pino_1 = __importDefault(require("pino"));
const logger = (0, pino_1.default)({ name: 'lakehouse-optimizer' });
class LakehouseOptimizer {
    async optimizeTable(table, strategy) {
    ...
    async generateOptimizationPlan(table) {
...
exports.LakehouseOptimizer = LakehouseOptimizer;
