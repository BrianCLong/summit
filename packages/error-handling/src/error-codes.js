...
exports.ErrorCodes = exports.ErrorCategory = void 0;
...
(function (ErrorCategory) {
    ...
    ErrorCategory["CIRCUIT_OPEN"] = "CIRCUIT_OPEN";
    // Database Errors
...
function isRetryableError(code) {
    return exports.ErrorCodes[code].retryable;
}
/**
 * Get HTTP status for error code
 */
function getHttpStatus(code) {
    return exports.ErrorCodes[code].httpStatus;
}
