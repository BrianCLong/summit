...
describe("Error Classes", () => {
  describe("AppError", () => {
    it("should create error with correct properties", () => {
      const error = new AppError("VALIDATION_FAILED", "Custom message", { field: "email" });
    ...
    it("should convert to response format", () => {
      const error = new AppError("VALIDATION_FAILED", "Test error", { field: "name" });
  ...
  describe("AuthorizationError", () => {
    it("should create authorization error", () => {
      const error = new AuthorizationError("INSUFFICIENT_PERMISSIONS", "Admin required", {
        userId: "123",
        requiredRole: "admin",
      });
  ...
  describe("ExternalServiceError", () => {
    it("should create external service error with service name", () => {
      const error = new ExternalServiceError("OPA_ERROR", "opa", "Policy engine unavailable", {
        status: 503,
      });
