...
import type { ContractConfig, TransactionReceipt, AccessGrant } from "../types.js";
...
export class AccessControlContract extends BaseContract {
  ...
  async grantAccess(
    ...
    return this.sendTransaction("grantAccess", [poolId, grantee, accessLevel, expiresAt]);
  }
  ...
  async checkAccess(poolId: string, user: string, requiredLevel: AccessLevel): Promise<boolean> {
