...
export function calculateOptimalLayout(widgets: Widget[], columns: number = 12): Widget[] {
...
export function mergeDashboards(target: Dashboard, source: Dashboard): Dashboard {
  return {
    ...target,
    pages: [
      ...target.pages,
