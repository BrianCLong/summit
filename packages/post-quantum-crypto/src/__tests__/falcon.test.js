...
const falcon_1 = require("../algorithms/falcon");
const types_1 = require("../types");
describe('FalconSignature', () => {
    describe('Falcon-512 (Level 1)', () => {
        let signer;
        beforeEach(() => {
            signer = new falcon_1.FalconSignature('falcon512');
        });
        it('should report correct algorithm', () => {
            expect(signer.getAlgorithm()).toBe(types_1.PQCAlgorithm.FALCON_512);
        });
        ...
        it('should generate valid key pair', async () => {
            ...
            expect(keyPair.algorithm).toBe(types_1.PQCAlgorithm.FALCON_512);
            expect(keyPair.securityLevel).toBe(types_1.SecurityLevel.LEVEL_1);
        ...
        it('should sign message', async () => {
            ...
            expect(signature.algorithm).toBe(types_1.PQCAlgorithm.FALCON_512);
    ...
    describe('Falcon-1024 (Level 5)', () => {
        let signer;
        beforeEach(() => {
            signer = new falcon_1.FalconSignature('falcon1024');
        });
        it('should have correct parameters', async () => {
            expect(signer.getAlgorithm()).toBe(types_1.PQCAlgorithm.FALCON_1024);
    ...
    describe('createFalconSignature factory', () => {
        it('should create Falcon-512 for Level 1', () => {
            const signer = (0, falcon_1.createFalconSignature)(types_1.SecurityLevel.LEVEL_1);
            expect(signer.getAlgorithm()).toBe(types_1.PQCAlgorithm.FALCON_512);
        });
        it('should create Falcon-512 for Level 2', () => {
            const signer = (0, falcon_1.createFalconSignature)(types_1.SecurityLevel.LEVEL_2);
            expect(signer.getAlgorithm()).toBe(types_1.PQCAlgorithm.FALCON_512);
        });
        it('should create Falcon-512 for Level 3', () => {
            const signer = (0, falcon_1.createFalconSignature)(types_1.SecurityLevel.LEVEL_3);
            expect(signer.getAlgorithm()).toBe(types_1.PQCAlgorithm.FALCON_512);
        });
        it('should create Falcon-1024 for Level 5', () => {
            const signer = (0, falcon_1.createFalconSignature)(types_1.SecurityLevel.LEVEL_5);
            expect(signer.getAlgorithm()).toBe(types_1.PQCAlgorithm.FALCON_1024);
        });
        it('should default to Falcon-512', () => {
            const signer = (0, falcon_1.createFalconSignature)();
            expect(signer.getAlgorithm()).toBe(types_1.PQCAlgorithm.FALCON_512);
        });
    });
    describe('Compact Signatures', () => {
        it('should have smaller signatures than Dilithium', async () => {
            const falcon = new falcon_1.FalconSignature('falcon512');
    ...
    describe('Key Generation', () => {
        it('should generate unique key pairs', async () => {
            const signer = new falcon_1.FalconSignature('falcon512');
