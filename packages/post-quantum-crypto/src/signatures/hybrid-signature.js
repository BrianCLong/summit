...
exports.HybridSignatureScheme = void 0;
exports.createHybridSignature = createHybridSignature;
...
class HybridSignatureScheme {
    ...
    quantumSigner;
    hybridScheme;
    constructor(classicalAlgorithm = 'ecdsa-p256', quantumSigner) {
        this.classicalAlgorithm = classicalAlgorithm;
        this.quantumSigner = quantumSigner || new dilithium_1.DilithiumSignature('dilithium3');
        this.hybridScheme = {
            classicalAlgorithm,
     ...
     */
    async verifyClassicalOnly(message, signature, publicKey) {
        try {
     ...
     */
    async verifyQuantumOnly(message, signature, publicKey) {
        try {
    ...
    async signClassical(message, privateKey) {
        // Hash the message
    ...
    async verifyClassical(message, signature, publicKey) {
        try {
            // Hash the message
            const messageHash = (0, sha256_1.sha256)(message);
    ...
    splitHybridSignature(signature) {
...
exports.HybridSignatureScheme = HybridSignatureScheme;
function createHybridSignature(classicalAlgorithm = 'ecdsa-p256', securityLevel = types_1.SecurityLevel.LEVEL_3) {
    let quantumSigner;
    switch (securityLevel) {
        case types_1.SecurityLevel.LEVEL_2:
            quantumSigner = new dilithium_1.DilithiumSignature('dilithium2');
            break;
        case types_1.SecurityLevel.LEVEL_3:
            quantumSigner = new dilithium_1.DilithiumSignature('dilithium3');
            break;
        case types_1.SecurityLevel.LEVEL_5:
            quantumSigner = new dilithium_1.DilithiumSignature('dilithium5');
            break;
        default:
            quantumSigner = new dilithium_1.DilithiumSignature('dilithium3');
    }
