...
exports.AstroturfingDetector = void 0;
class AstroturfingDetector {
    async detectAstroturfing(activities, topic) {
        const indicators = [];
    ...
    checkAccountProfiles(activities) {
    ...
    checkCoordinatedMessaging(activities) {
    ...
    checkArtificialAmplification(activities) {
    ...
    checkOrganicEngagement(activities) {
        let totalLikes = 0;
        let totalShares = 0;
        let totalComments = 0;
        for (const activity of activities) {
    ...
    calculateAstroturfingScore(indicators) {
...
exports.AstroturfingDetector = AstroturfingDetector;
