...
describe('TimeSeriesFeatureExtractor', () => {
    ...
    describe('extractStatisticalFeatures', () => {
        it('should extract basic statistical features', () => {
            ...
            const features = index_js_1.TimeSeriesFeatureExtractor.extractStatisticalFeatures(data);
    ...
    describe('extractTrendFeatures', () => {
        it('should detect positive trend', () => {
            ...
            const features = index_js_1.TimeSeriesFeatureExtractor.extractTrendFeatures(data);
    ...
    describe('extractSeasonalityFeatures', () => {
        it('should extract autocorrelation features', () => {
            const data = generateData(100);
            const features = index_js_1.TimeSeriesFeatureExtractor.extractSeasonalityFeatures(data);
    ...
    describe('extractComplexityFeatures', () => {
        it('should calculate entropy', () => {
            const data = generateData(100);
            const features = index_js_1.TimeSeriesFeatureExtractor.extractComplexityFeatures(data);
    ...
    describe('extractPeakFeatures', () => {
        it('should detect peaks in data', () => {
            ...
            const features = index_js_1.TimeSeriesFeatureExtractor.extractPeakFeatures(data);
    ...
    describe('extractFeatures', () => {
        it('should combine all features', () => {
            ...
            const features = index_js_1.TimeSeriesFeatureExtractor.extractFeatures(data, timestamps);
            expect(features.mean).toBeDefined();
            expect(features.std).toBeDefined();
