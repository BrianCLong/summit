import { Checklist, ControlMapping, RegionCriteria, RegionId, RegulatoryRequirement, SubprocessorEntry } from './types.js';
...
const regulatoryTable: Array<[
  RegulatoryRequirement['domain'],
