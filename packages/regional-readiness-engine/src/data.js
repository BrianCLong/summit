...
exports.forwardLookingEnhancements = exports.nonNegotiables = exports.tabletopScenarios = exports.launchGateControls = exports.supportModel = exports.subprocessorAvailability = exports.procurementChecklist = exports.localizationChecklist = exports.controlMappings = exports.regulatoryRequirements = exports.regionCriteria = void 0;
exports.regionCriteria = [
    {
        regionId: 'united-states',
        go: ['SOC2 + ISO27001 active', 'Data residency optional', 'Export screening live'],
        hold: ['Pending state-level privacy addenda (e.g., CCPA updates)', 'Partial subprocessor coverage'],
...
exports.regulatoryRequirements = regulatoryTable.flatMap(([domain, regionMap, controlOwner]) => Object.entries(regionMap).map(([regionId, requirement]) => ({
    domain,
    regionId,
    requirement,
    controlOwner,
})));
exports.controlMappings = [
    {
        name: 'Residency enforcement',
        description: 'Tenant home region, default-deny policy engine for cross-region calls, regional KMS keys, backups/restores validated in-region',
        owners: ['Platform Eng'],
        epics: ['Data Residency Platform', 'Regional Reliability & Performance'],
    },
    {
        name: 'Export controls & sanctions',
        description: 'Onboarding screening with re-screen cadence, geo/IP risk scoring, restricted-party escalation, stop-service playbook',
        owners: ['Legal', 'Security'],
        epics: ['Export Controls & Sanctions Guardrails'],
    },
    {
        name: 'Procurement',
        description: 'Standard packets (security/privacy/reliability), regional DPAs/SCCs, uptime/support SLAs aligned to real ops, contract metadata tracked',
        owners: ['Legal', 'RevOps'],
        epics: ['Regional Procurement Engine'],
    },
    {
        name: 'Localization',
        description: 'i18n pipeline, locale formats, time zone correctness, country feature flags for regulatory differences, glossary and fallbacks',
        owners: ['Product', 'Engineering'],
        epics: ['Localization & Language Ops'],
    },
    {
        name: 'Reliability & performance',
        description: 'RUM by region, CDN/edge caching, regional caches, load tests and SLO dashboards per region, dependency availability plans',
        owners: ['SRE'],
        epics: ['Regional Reliability & Performance'],
    },
    {
        name: 'Operations & support',
        description: 'Follow-the-sun coverage, routing by region/language/severity, region-aware comms, runbooks with addenda, proactive alerts',
        owners: ['Support', 'SRE'],
        epics: ['Regional Operations & Support'],
    },
];
exports.localizationChecklist = {
...
exports.subprocessorAvailability = [
    {
