...
export class AgencyTracker {
   ...
   */
  analyzeCooperation(data: Partial<CooperationRelationship>): CooperationRelationship {
  ...
  private calculateThreatLevel(agency: IntelligenceAgency): "CRITICAL" | "HIGH" | "MEDIUM" | "LOW" {
