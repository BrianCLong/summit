...
exports.TrajectoryEvaluator = exports.TrajectorySchema = exports.TrajectoryStepSchema = void 0;
const zod_1 = require("zod");
// Define the shape of a trajectory (run history)
exports.TrajectoryStepSchema = zod_1.z.object({
    id: zod_1.z.string(),
    type: zod_1.z.string(),
    status: zod_1.z.enum(['succeeded', 'failed', 'retried']),
    timestamp: zod_1.z.number(), // Unix ms
    metadata: zod_1.z.record(zod_1.z.any()).optional(),
});
exports.TrajectorySchema = zod_1.z.object({
    runId: zod_1.z.string(),
    steps: zod_1.z.array(exports.TrajectoryStepSchema),
    finalStatus: zod_1.z.enum(['succeeded', 'failed', 'killed']),
