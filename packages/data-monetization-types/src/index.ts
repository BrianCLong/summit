...
export const dataQualityLevels = ["RAW", "CLEANSED", "ENRICHED", "CURATED", "CERTIFIED"] as const;
...
export const accessLevels = ["PREVIEW", "SAMPLE", "FULL", "AGGREGATED", "ANONYMIZED"] as const;
