...
exports.COMPLIANCE_FRAMEWORKS = exports.UNSDG_FRAMEWORK = exports.CSRD_FRAMEWORK = exports.CDP_FRAMEWORK = exports.TCFD_FRAMEWORK = exports.SASB_FRAMEWORK = exports.GRI_FRAMEWORK = void 0;
exports.getFramework = getFramework;
exports.getAllFrameworks = getAllFrameworks;
exports.getFrameworksByCategory = getFrameworksByCategory;
exports.getRequirementsByMetric = getRequirementsByMetric;
exports.assessCompliance = assessCompliance;
// ============================================================================
// GRI Standards (Global Reporting Initiative)
// ============================================================================
exports.GRI_FRAMEWORK = {
    id: 'gri',
    name: 'GRI Standards',
    fullName: 'Global Reporting Initiative Standards',
    version: '2021',
    description: 'The most widely used standards for sustainability reporting, providing a comprehensive framework for organizations to report their impacts on the economy, environment, and society.',
    ...
    requirements: [
        // Environmental
        {
            id: 'gri-302',
            name: 'Energy',
            description: 'Energy consumption within and outside the organization, energy intensity, reduction of energy consumption',
            ...
            mandatory: true,
            guidance: 'Report in joules, watt-hours, or multiples. Include all fuel types.',
        },
        {
            id: 'gri-303',
        ...
        // Social
        {
            id: 'gri-401',
            name: 'Employment',
            description: 'New employee hires, employee turnover, benefits provided to full-time employees',
            category: 'social',
        ...
        },
        {
            ...
            description: 'Work-related injuries, ill health, hazard identification, worker training on health and safety',
            category: 'social',
        ...
        },
        {
            ...
            description: 'Average hours of training per employee, programs for upgrading employee skills',
            category: 'social',
        ...
        // Governance
        {
            ...
            description: 'Operations assessed for corruption risks, communication and training about anti-corruption',
            category: 'governance',
            subcategory: 'ethics',
            metrics: [
...
// ============================================================================
exports.SASB_FRAMEWORK = {
    id: 'sasb',
    name: 'SASB Standards',
    fullName: 'Sustainability Accounting Standards Board Standards',
    version: '2023',
    description: 'Industry-specific standards designed to identify financially material sustainability information for investor decision-making.',
    ...
    requirements: [
        ...
        },
        {
            ...
            description: 'Total energy consumed, percentage grid electricity, percentage renewable',
            category: 'environmental',
            subcategory: 'energy',
        ...
        },
        {
            ...
            description: 'Total water withdrawn, total water consumed, percentage in water-stressed regions',
            category: 'environmental',
            subcategory: 'water',
        ...
        },
        {
            ...
            description: 'Percentage of gender and racial/ethnic group representation for management and workforce',
            category: 'social',
            subcategory: 'diversity',
        ...
        // Governance
        {
            ...
            name: 'Data Security',
            description: 'Number of data breaches, percentage involving personally identifiable information',
            category: 'governance',
        ...
        },
        {
            ...
            description: 'Description of policies and procedures to ensure ethical conduct',
            category: 'governance',
            subcategory: 'ethics',
...
// ============================================================================
exports.TCFD_FRAMEWORK = {
    id: 'tcfd',
    name: 'TCFD',
    fullName: 'Task Force on Climate-related Financial Disclosures',
    version: '2021',
    description: 'Recommendations for climate-related financial disclosures organized around governance, strategy, risk management, and metrics & targets.',
    ...
    requirements: [
        // Governance
        {
            ...
            mandatory: true,
            guidance: 'Describe how the board monitors and oversees progress against goals and targets.',
        },
        {
            id: 'tcfd-gov-b',
            name: 'Management Role',
            description: "Management's role in assessing and managing climate-related risks and opportunities",
            category: 'governance',
        ...
        },
        {
            ...
            description: "Impact of climate-related risks and opportunities on organization's businesses, strategy, and financial planning",
            category: 'environmental',
        ...
        },
        {
            ...
            description: "Resilience of organization's strategy considering different climate-related scenarios",
            category: 'environmental',
...
// ============================================================================
exports.CDP_FRAMEWORK = {
    id: 'cdp',
    name: 'CDP',
    fullName: 'Carbon Disclosure Project',
    version: '2024',
    description: 'Global disclosure system for environmental impact covering climate change, water security, and deforestation.',
    ...
    requirements: [
        ...
        },
        {
            ...
            description: 'Climate-related risks and opportunities including financial implications',
            category: 'environmental',
            subcategory: 'climateRisk',
...
// ============================================================================
exports.CSRD_FRAMEWORK = {
    id: 'csrd',
    name: 'EU CSRD',
    fullName: 'EU Corporate Sustainability Reporting Directive',
    version: '2024',
    description: 'EU directive requiring companies to report on sustainability matters using European Sustainability Reporting Standards (ESRS).',
    ...
    requirements: [
        // ESRS E1 - Climate Change
        {
            id: 'esrs-e1',
            name: 'Climate Change',
            description: 'Climate change mitigation, adaptation, energy, and GHG emissions',
            category: 'environmental',
            subcategory: 'climate',
            metrics: [
                'scope1Emissions',
        ...
        // ESRS S1 - Own Workforce
        {
            id: 'esrs-s1',
            name: 'Own Workforce',
            description: 'Working conditions, equal treatment, and other work-related rights',
            category: 'social',
        ...
        // ESRS G1 - Business Conduct
        {
            ...
            description: 'Business ethics, corporate culture, anti-corruption, political engagement',
            category: 'governance',
            subcategory: 'ethics',
            metrics: [
                'antiCorruption',
...
// ============================================================================
exports.UNSDG_FRAMEWORK = {
    id: 'unsdg',
    name: 'UN SDGs',
    fullName: 'United Nations Sustainable Development Goals',
    version: '2030 Agenda',
    description: "17 interlinked global goals designed to be a 'blueprint to achieve a better and more sustainable future for all'.",
...
exports.COMPLIANCE_FRAMEWORKS = {
    gri: exports.GRI_FRAMEWORK,
    sasb: exports.SASB_FRAMEWORK,
    tcfd: exports.TCFD_FRAMEWORK,
    cdp: exports.CDP_FRAMEWORK,
    csrd: exports.CSRD_FRAMEWORK,
    unsdg: exports.UNSDG_FRAMEWORK,
};
function getFramework(id) {
    return exports.COMPLIANCE_FRAMEWORKS[id.toLowerCase()];
}
function getAllFrameworks() {
    return Object.values(exports.COMPLIANCE_FRAMEWORKS);
}
function getFrameworksByCategory(category) {
    return Object.values(exports.COMPLIANCE_FRAMEWORKS).filter((fw) => fw.categories.includes(category));
}
function getRequirementsByMetric(metricName) {
    const results = [];
    for (const [frameworkId, framework] of Object.entries(exports.COMPLIANCE_FRAMEWORKS)) {
...
function assessCompliance(frameworkId, reportedMetrics) {
    ...
    const compliancePercentage = framework.requirements.length > 0
        ? (metRequirements / framework.requirements.length) * 100
        : 0;
    const mandatoryCompliancePercentage = mandatoryRequirements.length > 0
