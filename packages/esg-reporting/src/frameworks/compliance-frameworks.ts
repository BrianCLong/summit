...
export const GRI_FRAMEWORK: ComplianceFramework = {
  ...
  requirements: [
    // Environmental
    {
      ...
      subcategory: "energy",
      metrics: ["totalEnergyConsumption", "renewableEnergy", "energyIntensity", "energyReduction"],
      mandatory: true,
    ...
    },
    {
      ...
      category: "environmental",
      subcategory: "water",
      metrics: ["waterWithdrawal", "waterDischarge", "waterConsumption", "waterRecycled"],
      mandatory: true,
    },
    {
      id: "gri-305",
    ...
    },
    {
      ...
      category: "environmental",
      subcategory: "waste",
      metrics: ["totalWaste", "hazardousWaste", "wasteRecycled", "wasteDiversionRate"],
      mandatory: true,
    },
    // Social
    {
    ...
    },
    {
      ...
      metrics: ["injuryRate", "lostTimeInjuryRate", "fatalities", "safetyTrainingHours"],
      mandatory: true,
    },
    {
      id: "gri-404",
    ...
    // Governance
    {
      ...
      category: "governance",
      subcategory: "ethics",
      metrics: ["corruptionRiskAssessments", "antiCorruptionTraining", "corruptionIncidents"],
      mandatory: true,
    },
    {
      id: "gri-206",
...
export const CSRD_FRAMEWORK: ComplianceFramework = {
  ...
  requirements: [
    ...
    // ESRS S1 - Own Workforce
    {
      ...
      metrics: ["employeeCount", "workingConditions", "equalTreatment", "healthSafety"],
      mandatory: true,
    },
    ...
    // ESRS G1 - Business Conduct
    {
      ...
      category: "governance",
      subcategory: "ethics",
      metrics: ["antiCorruption", "whistleblowing", "politicalEngagement", "paymentPractices"],
      mandatory: true,
    },
  ],
};
...
export function getFrameworksByCategory(category: ESGCategory): ComplianceFramework[] {
  return Object.values(COMPLIANCE_FRAMEWORKS).filter((fw) => fw.categories.includes(category));
}
...
export function assessCompliance(
  ...
  const compliancePercentage =
    framework.requirements.length > 0 ? (metRequirements / framework.requirements.length) * 100 : 0;

  const mandatoryCompliancePercentage =
    mandatoryRequirements.length > 0 ? (mandatoryMet / mandatoryRequirements.length) * 100 : 100;
