...
exports.CognitiveBattlespaceMap = void 0;
...
const CognitiveBattlespaceMap = ({ populations, narrative, signal, demographicSusceptibility = {}, }) => {
    const diffusionMap = (0, diffusionEngine_js_1.buildNarrativeDiffusionMap)({
        populations,
        narrative,
        signal,
        demographicSusceptibility,
    });
    return (<div className="cognitive-battlespace-map" style={{ padding: '20px', fontFamily: 'sans-serif' }}>
      ...
      <div className="anomaly-detection" style={{ marginBottom: '20px', padding: '15px', border: '1px solid #ffcc00', borderRadius: '5px', backgroundColor: '#fff9e6' }}>
        ...
        {signal.suspectedTranslation && (<p style={{ color: 'red', fontWeight: 'bold' }}>⚠️ Suspected Translation / Propaganda Anomaly Detected</p>)}
      </div>
      ...
      <div className="diffusion-heatmaps">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          {diffusionMap.map((result) => {
            ...
            return (<div key={result.populationId} className="population-card" style={{ border: '1px solid #ccc', padding: '15px', borderRadius: '8px' }}>
...
exports.CognitiveBattlespaceMap = CognitiveBattlespaceMap;
