...
export class SocialEngineeringEngine {
  ...
  generatePhishingCampaign(
    ...
    return {
      id: this.generateId(),
      type:
        customization === "highly-targeted"
          ? SocialEngineeringType.SPEAR_PHISHING
          : SocialEngineeringType.PHISHING,
      name,
   ...
   */
  analyzeCampaignResults(campaign: SocialEngineeringCampaign): {
