...
exports.AttackSurfaceMapper = void 0;
/**
...
class AttackSurfaceMapper {
    ...
    async performReconnaissance(target, options = {}) {
        const { includeSubdomains = true, includePorts = true, includeServices = true, includeCertificates = true } = options;
        const assets = [];
        const exposures = [];
     ...
     */
    async identifyExposures(assets) {
        const exposures = [];
        for (const asset of assets) {
            if (asset.type === 'service') {
                const port = asset.attributes['port'];
                const service = asset.attributes['service'];
     ...
     */
    async discoverCloudAssets(cloudProvider, config) {
...
exports.AttackSurfaceMapper = AttackSurfaceMapper;
