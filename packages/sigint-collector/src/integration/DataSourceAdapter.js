...
exports.DataSourceFactory =
  exports.ExerciseDataSource =
  exports.TrainingFeedSource =
  exports.FileDataSource =
...
class DataSourceAdapter extends eventemitter3_1.EventEmitter {
  ...
  validateAuthorization() {
    ...
    const allowedTypes = ["SIMULATION", "FILE", "TRAINING_FEED", "DEFENSIVE", "EXERCISE", "REPLAY"];
...
class ExerciseDataSource extends DataSourceAdapter {
  ...
  loadExerciseScenario() {
    ...
    const signalTypes = ["CELLULAR_4G", "WIFI", "RADAR", "SATELLITE", "VHF"];
    for (let i = 0; i < 100; i++) {
      const metadata = {
        id: (0, uuid_1.v4)(),
