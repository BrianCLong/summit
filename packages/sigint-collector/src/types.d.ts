 ...
 */
import { z } from 'zod';
export declare const ClassificationLevel: z.ZodEnum<["UNCLASSIFIED", "UNCLASSIFIED_FOUO", "CONFIDENTIAL", "SECRET", "TOP_SECRET", "TOP_SECRET_SCI"]>;
export type ClassificationLevel = z.infer<typeof ClassificationLevel>;
export declare const SignalType: z.ZodEnum<["RF_ANALOG", "RF_DIGITAL", "CELLULAR_2G", "CELLULAR_3G", "CELLULAR_4G", "CELLULAR_5G", "WIFI", "BLUETOOTH", "SATELLITE", "RADAR", "TELEMETRY", "NAVIGATION", "BROADCAST", "SHORTWAVE", "VHF", "UHF", "MICROWAVE", "UNKNOWN"]>;
export type SignalType = z.infer<typeof SignalType>;
export declare const IntelligenceCategory: z.ZodEnum<["COMINT", "ELINT", "FISINT", "MASINT", "TECHINT", "CYBER"]>;
export type IntelligenceCategory = z.infer<typeof IntelligenceCategory>;
export declare const ModulationType: z.ZodEnum<["AM", "FM", "PM", "SSB", "DSB", "ASK", "FSK", "PSK", "QAM", "OFDM", "BPSK", "QPSK", "8PSK", "16QAM", "64QAM", "GMSK", "MSK", "GFSK", "SPREAD_SPECTRUM", "FHSS", "DSSS", "CHIRP", "PULSE", "UNKNOWN"]>;
export type ModulationType = z.infer<typeof ModulationType>;
export declare const SignalMetadata: z.ZodObject<{
    id: z.ZodString;
    timestamp: z.ZodDate;
    signalType: z.ZodEnum<["RF_ANALOG", "RF_DIGITAL", "CELLULAR_2G", "CELLULAR_3G", "CELLULAR_4G", "CELLULAR_5G", "WIFI", "BLUETOOTH", "SATELLITE", "RADAR", "TELEMETRY", "NAVIGATION", "BROADCAST", "SHORTWAVE", "VHF", "UHF", "MICROWAVE", "UNKNOWN"]>;
    category: z.ZodEnum<["COMINT", "ELINT", "FISINT", "MASINT", "TECHINT", "CYBER"]>;
    classification: z.ZodEnum<["UNCLASSIFIED", "UNCLASSIFIED_FOUO", "CONFIDENTIAL", "SECRET", "TOP_SECRET", "TOP_SECRET_SCI"]>;
    ...
    modulation: z.ZodOptional<z.ZodEnum<["AM", "FM", "PM", "SSB", "DSB", "ASK", "FSK", "PSK", "QAM", "OFDM", "BPSK", "QPSK", "8PSK", "16QAM", "64QAM", "GMSK", "MSK", "GFSK", "SPREAD_SPECTRUM", "FHSS", "DSSS", "CHIRP", "PULSE", "UNKNOWN"]>>;
    ...
    id: string;
    timestamp: Date;
    signalType: "RF_ANALOG" | "RF_DIGITAL" | "CELLULAR_2G" | "CELLULAR_3G" | "CELLULAR_4G" | "CELLULAR_5G" | "WIFI" | "BLUETOOTH" | "SATELLITE" | "RADAR" | "TELEMETRY" | "NAVIGATION" | "BROADCAST" | "SHORTWAVE" | "VHF" | "UHF" | "MICROWAVE" | "UNKNOWN";
    category: "COMINT" | "ELINT" | "FISINT" | "MASINT" | "TECHINT" | "CYBER";
    classification: "UNCLASSIFIED" | "UNCLASSIFIED_FOUO" | "CONFIDENTIAL" | "SECRET" | "TOP_SECRET" | "TOP_SECRET_SCI";
    collectorId: string;
    processed: boolean;
    priority: number;
    minimized: boolean;
    ...
    modulation?: "UNKNOWN" | "AM" | "FM" | "PM" | "SSB" | "DSB" | "ASK" | "FSK" | "PSK" | "QAM" | "OFDM" | "BPSK" | "QPSK" | "8PSK" | "16QAM" | "64QAM" | "GMSK" | "MSK" | "GFSK" | "SPREAD_SPECTRUM" | "FHSS" | "DSSS" | "CHIRP" | "PULSE" | undefined;
    location?: {
        latitude: number;
        longitude: number;
        method: "TDOA" | "AOA" | "RSSI" | "GPS" | "CELL" | "HYBRID" | "SIMULATED";
...
export declare const RawSignal: z.ZodObject<{
    ...
    samples: z.ZodOptional<z.ZodType<Float32Array<ArrayBuffer>, z.ZodTypeDef, Float32Array<ArrayBuffer>>>;
    iqData: z.ZodOptional<z.ZodObject<{
    ...
    rawBytes: z.ZodOptional<z.ZodType<Uint8Array<ArrayBuffer>, z.ZodTypeDef, Uint8Array<ArrayBuffer>>>;
...
export declare const CollectionTask: z.ZodObject<{
    ...
    targetFrequencies: z.ZodArray<z.ZodObject<{
        center: z.ZodNumber;
    ...
    targetSignalTypes: z.ZodOptional<z.ZodArray<z.ZodEnum<["RF_ANALOG", "RF_DIGITAL", "CELLULAR_2G", "CELLULAR_3G", "CELLULAR_4G", "CELLULAR_5G", "WIFI", "BLUETOOTH", "SATELLITE", "RADAR", "TELEMETRY", "NAVIGATION", "BROADCAST", "SHORTWAVE", "VHF", "UHF", "MICROWAVE", "UNKNOWN"]>, "many">>;
    targetLocations: z.ZodOptional<z.ZodArray<z.ZodObject<{
        latitude: z.ZodNumber;
        longitude: z.ZodNumber;
        radius: z.ZodNumber;
    }, "strip", z.ZodTypeAny, {
    ...
    targetSignalTypes?: ("RF_ANALOG" | "RF_DIGITAL" | "CELLULAR_2G" | "CELLULAR_3G" | "CELLULAR_4G" | "CELLULAR_5G" | "WIFI" | "BLUETOOTH" | "SATELLITE" | "RADAR" | "TELEMETRY" | "NAVIGATION" | "BROADCAST" | "SHORTWAVE" | "VHF" | "UHF" | "MICROWAVE" | "UNKNOWN")[] | undefined;
    targetLocations?: {
        latitude: number;
        longitude: number;
        radius: number;
...
export declare const SpectrumData: z.ZodObject<{
    ...
    peakFrequencies: z.ZodArray<z.ZodObject<{
...
export declare const EmitterProfile: z.ZodObject<{
    ...
    frequency: z.ZodNumber;
    bandwidth: z.ZodNumber;
    modulation: z.ZodEnum<["AM", "FM", "PM", "SSB", "DSB", "ASK", "FSK", "PSK", "QAM", "OFDM", "BPSK", "QPSK", "8PSK", "16QAM", "64QAM", "GMSK", "MSK", "GFSK", "SPREAD_SPECTRUM", "FHSS", "DSSS", "CHIRP", "PULSE", "UNKNOWN"]>;
    power: z.ZodNumber;
    ...
    frequency: number;
    bandwidth: number;
    modulation: "UNKNOWN" | "AM" | "FM" | "PM" | "SSB" | "DSB" | "ASK" | "FSK" | "PSK" | "QAM" | "OFDM" | "BPSK" | "QPSK" | "8PSK" | "16QAM" | "64QAM" | "GMSK" | "MSK" | "GFSK" | "SPREAD_SPECTRUM" | "FHSS" | "DSSS" | "CHIRP" | "PULSE";
    isSimulated: boolean;
    power: number;
    fingerprint: {
        spectralSignature?: number[] | undefined;
...
export declare const COMINTMessage: z.ZodObject<{
    ...
    communicationType: z.ZodEnum<["VOICE", "SMS", "EMAIL", "VOIP", "RADIO", "SATELLITE", "DATA", "FAX", "TELETYPE", "UNKNOWN"]>;
    ...
    entities: z.ZodArray<z.ZodObject<{
        text: z.ZodString;
        type: z.ZodEnum<["PERSON", "ORGANIZATION", "LOCATION", "DATE", "PHONE", "EMAIL", "OTHER"]>;
    ...
    isSimulated: boolean;
    sourceSignal: string;
    communicationType: "SATELLITE" | "UNKNOWN" | "VOICE" | "SMS" | "EMAIL" | "VOIP" | "RADIO" | "DATA" | "FAX" | "TELETYPE";
    participants: {
        identifier: string;
        role: "SENDER" | "RECEIVER" | "CC" | "PARTICIPANT";
        location?: {
...
export declare const ELINTReport: z.ZodObject<{
    ...
    emitterType: z.ZodEnum<["RADAR_SEARCH", "RADAR_TRACK", "RADAR_FIRE_CONTROL", "RADAR_HEIGHT_FINDER", "RADAR_WEATHER", "RADAR_NAVIGATION", "IFF", "TACAN", "DATALINK", "JAMMER", "BEACON", "TELEMETRY", "UNKNOWN"]>;
    ...
    classification: "UNCLASSIFIED" | "UNCLASSIFIED_FOUO" | "CONFIDENTIAL" | "SECRET" | "TOP_SECRET" | "TOP_SECRET_SCI";
    isSimulated: boolean;
    emitterType: "TELEMETRY" | "UNKNOWN" | "RADAR_SEARCH" | "RADAR_TRACK" | "RADAR_FIRE_CONTROL" | "RADAR_HEIGHT_FINDER" | "RADAR_WEATHER" | "RADAR_NAVIGATION" | "IFF" | "TACAN" | "DATALINK" | "JAMMER" | "BEACON";
    platform: {
        type: "UNKNOWN" | "GROUND" | "AIRBORNE" | "NAVAL" | "SPACE";
        designation?: string | undefined;
        nationality?: string | undefined;
