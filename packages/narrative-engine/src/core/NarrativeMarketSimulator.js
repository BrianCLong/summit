...
exports.NarrativeMarketSimulator = void 0;
class NarrativeMarketSimulator {
    markets = new Map();
    clusters = new Map();
    alignments = new Map(); // NarrativeID -> Alignments
    narrativeShares = new Map(); // NarrativeID -> Share
    substitutionMatrix = new Map(); // NarrativeID -> { NarrativeID -> SubstitutionRate }
    constructor() { }
    configureMarket(market, clusters) {
    ...
    setSubstitution(fromNarrativeId, toNarrativeId, rate) {
    ...
    simulateMarketStep(marketId, timestamp) {
...
exports.NarrativeMarketSimulator = NarrativeMarketSimulator;
