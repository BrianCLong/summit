...
export class InterventionRecommender {
   ...
   */
  recommendBatch(predictions: WellbeingPrediction[]): Map<string, InterventionRecommendation[]> {
  ...
  private generateRationale(
    ...
    return (
      `${domain.replace("_", " ")} domain score of ${score}% indicates need for ${template.type.replace("_", " ")} intervention. ` +
