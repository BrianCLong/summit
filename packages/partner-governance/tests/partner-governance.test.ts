...
describe('integration certification and throttling', () => {
  ...
  it('applies adaptive throttling and enforcement ladder', () => {
    ...
    const action = enforcementLadder({ metric: 'abuse', value: 10, threshold: 5, partnerId: 'p1', observedAt: new Date() });
...
describe('risk, compliance, and monetization controls', () => {
  it('revokes expired access and detects leakage', () => {
    ...
    const leakage = detectLeakage({ partnerId: 'p1', apiQuotaPerMinute: 100, activeUsers: 10 }, { partnerId: 'p1', observedRate: 120, userCount: 5 });
