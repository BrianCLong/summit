 ...
 */
export function calculateRiskScore(probabilityScore: number, impactScore: number): number {
 ...
 */
export function adjustScoreForFalsePositives(score: number, falsePositiveRate: number): number {
