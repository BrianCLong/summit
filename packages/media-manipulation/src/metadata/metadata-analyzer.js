...
exports.MetadataAnalyzer = void 0;
class MetadataAnalyzer {
    /**
     * Analyze EXIF metadata for inconsistencies and tampering
     */
    async analyzeExif(imageBuffer) {
     ...
     */
    async detectInconsistencies(exifData) {
    ...
    checkCameraLensCompatibility(exifData) {
        const issues = [];
    ...
    validateExposureSettings(exifData) {
        const issues = [];
    ...
    async checkThumbnailConsistency(exifData) {
        const issues = [];
     ...
     */
    calculateTrustScore(exifData, inconsistencies) {
        let score = 1.0;
...
exports.MetadataAnalyzer = MetadataAnalyzer;
