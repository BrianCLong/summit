...
import type { SentinelConfig } from "../sentinels/signals.js";
import type {
  WriteSetEnvelope,
  WriteDecision,
  QuarantineReport,
...
import { runSentinels } from "../sentinels/index.js";
import { immuneGate } from "./immuneGate.js";
...
/**
 * Core immune engine:
 * 1. Run sentinels to collect signals.
 * 2. Gate to decide allow / allow_with_flags / quarantine.
 * 3. On quarantine: persist a QuarantineCase and return a QuarantineReport.
 *    Nothing is written to RG / BG / NG — that is the firewall guarantee.
 */
