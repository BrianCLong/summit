...
const random_forest_js_1 = require("../src/classifiers/random-forest.js");
const gradient_boosting_js_1 = require("../src/classifiers/gradient-boosting.js");
describe('RandomForestClassifier', () => {
    ...
    describe('fit', () => {
        it('should fit Random Forest model', () => {
            const model = new random_forest_js_1.RandomForestClassifier({ nEstimators: 10, maxDepth: 5 });
        ...
        it('should handle multi-class classification', () => {
            ...
            const model = new random_forest_js_1.RandomForestClassifier({ nEstimators: 20 });
            expect(() => model.fit({ features, labels })).not.toThrow();
        });
    });
    describe('predict', () => {
        it('should predict class labels', () => {
            const model = new random_forest_js_1.RandomForestClassifier({ nEstimators: 20, maxDepth: 5 });
    ...
    describe('evaluate', () => {
        it('should calculate performance metrics', () => {
            const model = new random_forest_js_1.RandomForestClassifier({ nEstimators: 30, maxDepth: 10 });
...
describe('GradientBoostingClassifier', () => {
    ...
    describe('fit', () => {
        it('should fit Gradient Boosting model', () => {
            const model = new gradient_boosting_js_1.GradientBoostingClassifier({
                nEstimators: 10,
                learningRate: 0.1,
                maxDepth: 3,
            });
