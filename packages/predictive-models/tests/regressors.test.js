...
const linear_regression_js_1 = require("../src/regressors/linear-regression.js");
describe('LinearRegression', () => {
    ...
    describe('fit', () => {
        it('should fit linear regression model', () => {
            const model = new linear_regression_js_1.LinearRegression();
            const dataset = generateDataset(100);
            expect(() => model.fit(dataset)).not.toThrow();
        });
        it('should fit with normalization', () => {
            const model = new linear_regression_js_1.LinearRegression({ normalize: true });
            const dataset = generateDataset(100);
            expect(() => model.fit(dataset)).not.toThrow();
        });
    });
...
describe('RidgeRegression', () => {
    ...
    describe('fit and predict', () => {
        it('should fit Ridge regression with regularization', () => {
            const model = new linear_regression_js_1.RidgeRegression(1.0);
            const dataset = generateDataset(100);
            model.fit(dataset);
        ...
        it('should produce more stable coefficients than OLS', () => {
            ...
            const ols = new linear_regression_js_1.LinearRegression();
            const ridge = new linear_regression_js_1.RidgeRegression(1.0);
...
describe('LassoRegression', () => {
    describe('fit and predict', () => {
        it('should fit Lasso regression with sparsity', () => {
            ...
            const model = new linear_regression_js_1.LassoRegression(0.5);
            model.fit({ features, labels });
        ...
        it('should produce sparse coefficients', () => {
            ...
            const model = new linear_regression_js_1.LassoRegression(1.0);
            model.fit({ features, labels });
