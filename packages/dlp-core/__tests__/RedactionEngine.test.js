...
const RedactionEngine_1 = require("../src/RedactionEngine");
describe('RedactionEngine', () => {
    let engine;
    beforeEach(() => {
        engine = new RedactionEngine_1.RedactionEngine();
    });
    ...
    describe('Tokenization', () => {
        ...
        it('should allow detokenization', () => {
            const tokenEngine = new RedactionEngine_1.RedactionEngine({ deterministicMode: true });
            const detections = [
                {
                    type: 'SSN',
                    pattern: 'SSN',
    ...
    describe('Token Management', () => {
        it('should track token count', () => {
            const tokenEngine = new RedactionEngine_1.RedactionEngine();
