...
const BarrierEnforcer_1 = require("../src/BarrierEnforcer");
describe('BarrierEnforcer', () => {
    let enforcer;
    beforeEach(() => {
        enforcer = new BarrierEnforcer_1.BarrierEnforcer({
    ...
    describe('Error Handling', () => {
        it('should fail closed in strict mode on OPA error', async () => {
            const failingEnforcer = new BarrierEnforcer_1.BarrierEnforcer({
