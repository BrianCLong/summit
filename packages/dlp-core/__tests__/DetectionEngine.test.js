...
const DetectionEngine_1 = require("../src/DetectionEngine");
describe('DetectionEngine', () => {
    let engine;
    beforeEach(() => {
        engine = new DetectionEngine_1.DetectionEngine();
    });
    describe('SSN Detection', () => {
        ...
        it('should boost confidence when context keywords present', async () => {
            ...
            expect(withContext.detections[0].confidence).toBeGreaterThan(withoutContext.detections[0].confidence);
        });
    });
    ...
    describe('Performance', () => {
        ...
        it('should respect maxDetections limit', async () => {
            const limitedEngine = new DetectionEngine_1.DetectionEngine({ maxDetections: 5 });
