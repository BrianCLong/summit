...
exports.TextSynthesizer = void 0;
/**
...
class TextSynthesizer {
     ...
     */
    async generate(numSamples, prompt) {
        const samples = [];
     ...
     */
    async generateWithSentiment(sentiment, numSamples) {
     ...
     * Paraphrase text
     */
    async paraphrase(text, numVariations = 3) {
        const paraphrases = [];
     ...
     */
    async generateConversation(numTurns, participants = ['User', 'Assistant']) {
        const turns = [];
     ...
     */
    async backTranslate(text, intermediateLanguage = 'es') {
    ...
    async generateTransformer(prompt) {
    ...
    async generateConversationTurn(speaker, previousTurns) {
...
exports.TextSynthesizer = TextSynthesizer;
exports.default = TextSynthesizer;
