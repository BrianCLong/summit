...
exports.selectShard = void 0;
const selectShard = (shards, context) => {
    const reasons = [];
    const available = new Set(Object.keys(shards));
    const pick = (shard, reason) => {
        reasons.push(reason);
    ...
    if (typeof context.contextBudgetTokens === 'number' &&
...
exports.selectShard = selectShard;
