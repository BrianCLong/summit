 ...
 */
export function getSignalTypesByCategory(category: SignalCategoryType): SignalTypeDefinition[] {
  return Object.values(SignalTypeRegistry).filter((def) => def.category === category);
}
