...
exports.AdvancedNormalizer = void 0;
class AdvancedNormalizer {
    ...
    normalizePhoneNumbers(text) {
        ...
        return text.replace(/\+?(\d{1,3})?[-.\s]?\(?(\d{3})\)?[-.\s]?(\d{3})[-.\s]?(\d{4})/g, (_, country, area, prefix, line) => {
...
exports.AdvancedNormalizer = AdvancedNormalizer;
