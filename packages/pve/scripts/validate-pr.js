...
const pull_request_validator_js_1 = require("../src/github/pull-request-validator.js");
...
async function main() {
    ...
    try {
        if (process.env.GITHUB_BASE_REF) {
            ...
            diffOutput = (0, node_child_process_1.execSync)(`git diff origin/${process.env.GITHUB_BASE_REF}...HEAD`, { encoding: 'utf-8', maxBuffer: 50 * 1024 * 1024 });
        }
        else {
            // Local: compare against main
            diffOutput = (0, node_child_process_1.execSync)('git diff main...HEAD', {
                encoding: 'utf-8',
    ...
    const validator = (0, pull_request_validator_js_1.createPRValidator)({
        githubToken,
