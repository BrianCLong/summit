...
describe("PIIDetection", () => {
  ...
  describe("detectPII", () => {
    ...
    it("should detect phone numbers", () => {
      const samples: SampleRecord[] = [{ phone: "555-123-4567" }, { phone: "555-987-6543" }];
    ...
    it("should detect SSN patterns", () => {
      const samples: SampleRecord[] = [{ ssn: "123-45-6789" }, { ssn: "987-65-4321" }];
    ...
    it("should provide redaction recommendations", () => {
      const samples: SampleRecord[] = [{ email: "user@example.com" }];
