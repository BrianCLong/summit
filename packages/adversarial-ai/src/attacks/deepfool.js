...
class DeepFoolAttack {
     ...
     */
    async generate(input, getLogits, getGradients, config) {
        ...
        return {
            ...
            confidence: 0,
            perturbationNorm,
            attackType: types_js_1.AdversarialAttackType.DEEPFOOL,
            metadata: {
                iterations: iter,
                overshoot,
                method: 'DeepFool',
     ...
     */
    async generateLInf(input, getLogits, getGradients, config) {
        const maxIterations = config.iterations || 50;
...
exports.DeepFoolAttack = DeepFoolAttack;
