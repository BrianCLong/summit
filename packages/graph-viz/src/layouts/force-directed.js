...
exports.computeForceDirectedLayout = computeForceDirectedLayout;
exports.computeHierarchicalLayout = computeHierarchicalLayout;
/**
...
function computeForceDirectedLayout(nodes, edges, options = {}) {
    ...
    const { width = 1000, height = 1000, iterations = 100, repulsionStrength = 100, attractionStrength = 0.01, damping = 0.9, centeringForce = 0.01, timeStep = 1.0, } = options;
...
function computeHierarchicalLayout(nodes, edges, options = {}) {
    const startTime = performance.now();
    const { width = 1000, height = 800, rootId, levelSeparation = 100, nodeSeparation = 50, } = options;
