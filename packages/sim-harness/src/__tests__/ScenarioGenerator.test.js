...
const ScenarioGenerator_1 = require("../generator/ScenarioGenerator");
describe('ScenarioGenerator', () => {
    describe('Built-in templates', () => {
        it('should have fraud-ring template', () => {
            const templates = (0, ScenarioGenerator_1.getBuiltInTemplates)();
    ...
    describe('Generation', () => {
        it('should generate deterministic scenario with fixed seed', async () => {
            const generator1 = new ScenarioGenerator_1.ScenarioGenerator({
                template: 'fraud-ring',
                params: { seed: 42 },
            });
            const generator2 = new ScenarioGenerator_1.ScenarioGenerator({
                template: 'fraud-ring',
                params: { seed: 42 },
            });
        ...
        it('should generate scenario with correct entity count', async () => {
            const generator = new ScenarioGenerator_1.ScenarioGenerator({
                template: 'fraud-ring',
                params: { seed: 42 },
            });
