...
const sample = {
    ...
    history: [
        ...
        {
            stream: 'history',
            content: 'Reasoning trace: gathered sources, deduplicated citations, and aligned policies.',
            source: 'history',
            provenance: 'cli',
    ...
    toolOutputs: [
        {
            stream: 'toolOutputs',
            content: 'Large tool output payload '.repeat(80),
            source: 'tool',
            provenance: 'cli',
            priority: 'low',
        },
...
const result = (0, context_engineer_js_1.buildContext)(sample);
