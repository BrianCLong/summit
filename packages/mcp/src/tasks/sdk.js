...
exports.callWithTask = callWithTask;
const node_crypto_1 = require("node:crypto");
const meta_1 = require("./meta");
const poll_1 = require("./poll");
async function callWithTask(client, taskClient, method, params, opts = {}) {
    ...
    const augmentedParams = (0, meta_1.withTaskMeta)(params, { taskId });
    ...
    const taskNotificationPromise = new Promise((resolve) => {
    ...
    if (taskCreated) {
        return (0, poll_1.pollUntilTerminal)({ tasks: taskClient, taskId, signal: controller.signal, ...opts });
    }
