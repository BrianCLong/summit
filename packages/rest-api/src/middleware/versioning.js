...
exports.VersionRegistry = void 0;
    ...
    return (req, res, next) => {
        ...
        switch (options.strategy) {
            ...
            case 'query':
                ...
                const queryVersion = req.query[queryName];
                if (queryVersion) {
            ...
            case 'accept':
                ...
                if (acceptHeader) {
                    ...
                    const acceptMatch = acceptHeader.match(new RegExp(`${prefix.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}(\\d+(?:\\.\\d+)?)`));
                    if (acceptMatch) {
