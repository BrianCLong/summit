...
const ensemble_js_1 = require("../src/models/ensemble.js");
const scenario_simulation_js_1 = require("../src/utils/scenario-simulation.js");
describe('EnsembleForecaster', () => {
    ...
    describe('fit and forecast', () => {
        it('should fit ensemble with multiple model types', () => {
            const ensemble = new ensemble_js_1.EnsembleForecaster({
                models: [
...
describe('MonteCarloSimulator', () => {
    ...
    describe('simulate', () => {
        it('should run Monte Carlo simulation', () => {
            const simulator = new scenario_simulation_js_1.MonteCarloSimulator(100);
        ...
        it('should calculate correct percentiles', () => {
            const simulator = new scenario_simulation_js_1.MonteCarloSimulator(1000);
            const baseForecast = createBaseForecast();
...
describe('ScenarioAnalyzer', () => {
    describe('compareScenarios', () => {
        it('should rank scenarios by impact', () => {
            const analyzer = new scenario_simulation_js_1.ScenarioAnalyzer();
            const scenarios = [
...
describe('Backtester', () => {
    ...
    describe('backtest', () => {
        it('should run backtesting on forecasting model', () => {
            const backtester = new scenario_simulation_js_1.Backtester();
            const data = generateTestData(100);
            const forecastFn = (trainData, horizon) => {
