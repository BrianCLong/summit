...
describe('MetricsExporter', () => {
    let metrics;
    beforeEach(() => {
        metrics = new index_1.MetricsExporter({
    ...
    describe('GraphQL Metrics', () => {
        ...
        it('should record failed GraphQL request', async () => {
            metrics.recordGraphQLRequest('createEntity', 'mutation', 0.5, false, 'VALIDATION_ERROR');
            const metricsOutput = await metrics.getMetrics();
    ...
    describe('Middleware', () => {
        it('should create metrics middleware', () => {
            const middleware = (0, index_1.createMetricsMiddleware)(metrics);
    ...
    describe('Configuration', () => {
        it('should use custom labels', async () => {
            const customMetrics = new index_1.MetricsExporter({
