...
describe("checkAnalysisCompliance", () => {
  ...
  it("should flag anonymous requests", () => {
    const result = checkAnalysisCompliance({ countries: ["US"] }, "anonymous", "Risk assessment");
...
describe("validatePurpose", () => {
  it("should validate legitimate humanitarian purpose", () => {
    const result = validatePurpose("Early warning system for humanitarian crisis preparedness");
  ...
  it("should validate risk assessment purpose", () => {
    const result = validatePurpose("Supply chain risk assessment for critical materials");
  ...
  it("should flag manipulation language", () => {
    const result = validatePurpose("Manipulate political situation to our advantage");
  ...
  it("should flag destabilization language", () => {
    const result = validatePurpose("Destabilize the regime through economic pressure");
