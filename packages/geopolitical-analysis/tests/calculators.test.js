...
describe('PoliticalStabilityCalculator', () => {
    const calculator = new src_1.PoliticalStabilityCalculator();
    it('should calculate high stability for strong indicators', () => {
        ...
        expect(result.riskLevel).toBe(types_1.RiskLevel.LOW);
    ...
    it('should calculate low stability for weak indicators', () => {
        ...
        expect(result.riskLevel).toBe(types_1.RiskLevel.CRITICAL);
...
describe('FoodSecurityCalculator', () => {
    const calculator = new src_1.FoodSecurityCalculator();
    ...
    it('should calculate high risk for insecure food situation', () => {
        ...
        expect(result.riskLevel).toBeOneOf([types_1.RiskLevel.HIGH, types_1.RiskLevel.CRITICAL]);
...
describe('SupplyChainCalculator', () => {
    const calculator = new src_1.SupplyChainCalculator();
    it('should calculate low vulnerability for diversified supply', () => {
        ...
        expect(result.riskLevel).toBeOneOf([types_1.RiskLevel.LOW, types_1.RiskLevel.MODERATE]);
    });
