...
describe('BULWARK implementation', () => {
    ...
    it('converts detections to sigma and validates synthetic traffic', () => {
        ...
        const detections = new index_1.DetectionEngineeringService(unifier);
        const rule = {
            id: 'rule-1',
    ...
    it('chains evidence and enforces containment-first playbooks', () => {
        const responder = new index_1.RapidResponseModernizer();
    ...
    it('scores identity tripwires and raises honeytoken risk', () => {
        const identity = new index_1.IdentityTripwireFramework();
    ...
    it('enforces infra hygiene and governance guardrails', () => {
        const infra = new index_1.InfrastructureHygieneManager();
        infra.registerAsset({
            id: 'web-1',
            environment: 'test',
            exposedPorts: [80, 443],
        ...
        const governance = new index_1.GovernanceGuardrails();
