...
const pattern_templates_1 = require("../pattern-templates");
describe('Pattern Mining Templates', () => {
    describe('detectCoTravelPatterns', () => {
        it('should detect co-travel pattern when entities are co-located', () => {
            ...
            const result = (0, pattern_templates_1.detectCoTravelPatterns)(graph, options);
    ...
    describe('detectFinancialStructuring', () => {
        it('should detect fan-out pattern', () => {
            ...
            const result = (0, pattern_templates_1.detectFinancialStructuring)(graph, options);
            expect(result.patterns.length).toBeGreaterThan(0);
    ...
    describe('detectCommunicationBursts', () => {
        it('should detect communication burst', () => {
            ...
            const result = (0, pattern_templates_1.detectCommunicationBursts)(graph, options);
