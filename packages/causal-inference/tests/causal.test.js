...
const propensity_score_matching_js_1 = require("../src/methods/propensity-score-matching.js");
const difference_in_differences_js_1 = require("../src/methods/difference-in-differences.js");
describe('PropensityScoreMatcher', () => {
    ...
    describe('estimateEffect', () => {
        it('should estimate treatment effect', () => {
            const matcher = new propensity_score_matching_js_1.PropensityScoreMatcher();
...
describe('DifferenceInDifferences', () => {
    describe('estimate', () => {
        it('should estimate DiD effect', () => {
            const did = new difference_in_differences_js_1.DifferenceInDifferences();
