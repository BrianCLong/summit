...
exports.haarTransform = haarTransform;
exports.reconstructFromHaar = reconstructFromHaar;
function haarTransform(signal, levels) {
    if (levels < 1) {
...
function reconstructFromHaar({ levels, residual }) {
