...
export class APTLibrary {
  ...
  private initializeActors(): void {
        ...
        c2Patterns: [
          {
            ...
            beaconInterval: 300,
            jitter: 20,
            description: "Standard HTTPS C2",
          },
        ],
        domains: [
          { pattern: "typosquat", tlds: ["com", "org"], registrationPattern: "privacy protected" },
        ],
      ...
      tools: [
        {
          ...
          type: "custom",
          category: "backdoor",
          description: "Custom .NET backdoor",
        ...
        },
        {
          ...
          type: "custom",
          category: "backdoor",
          description: "Email-based backdoor",
      ...
      malware: [
        {
          ...
          type: "backdoor",
          variants: [],
          capabilities: ["C2", "File Operations"],
        ...
        },
        {
          ...
          type: "loader",
          variants: [],
          capabilities: ["Memory-only execution"],
          techniques: ["T1055"],
        },
      ],
    ...
    this.addActor({
      ...
      infrastructure: {
        ...
        domains: [
          { pattern: "typosquat", tlds: ["com", "net"], registrationPattern: "bulk registration" },
        ],
      ...
      tools: [
        ...
        },
        {
          ...
          type: "custom",
          category: "utility",
          description: "Network tunneling tool",
          techniques: ["T1090"],
        },
      ],
      malware: [
        {
          ...
          type: "dropper",
          variants: [],
          capabilities: ["Reconnaissance", "Download"],
          techniques: [],
        },
        {
          name: "Zebrocy",
          type: "backdoor",
          variants: ["Delphi", "AutoIt", "Go"],
          capabilities: ["C2", "Screenshot"],
          techniques: [],
        },
      ],
    ...
    this.addActor({
      ...
      motivation: [
        ThreatActorMotivation.FINANCIAL,
        ThreatActorMotivation.ESPIONAGE,
        ThreatActorMotivation.DESTRUCTION,
      ],
      attribution: {
        country: "North Korea",
        confidence: "high",
      ...
      malware: [
        ...
        },
        {
          ...
          type: "ransomware",
          variants: [],
          capabilities: ["Encryption", "Propagation"],
          techniques: ["T1486"],
        },
      ],
  ...
  getActorByName(name: string): ThreatActorProfile | undefined {
    ...
    for (const actor of this.actors.values()) {
      if (
        actor.names.some((n) => n.toLowerCase() === nameLower) ||
...
export class EmulationPlanGenerator {
    ...
    return {
      ...
      timeline: {
        ...
        phases: phases.map((p, idx) => ({
          phaseId: p.id,
          start: new Date(
            startDate.getTime() + ((idx * scope.duration) / phases.length) * 24 * 60 * 60 * 1000
          ),
          end: new Date(
            startDate.getTime() +
              (((idx + 1) * scope.duration) / phases.length) * 24 * 60 * 60 * 1000
          ),
        })),
      },
      scope: {
  ...
  private buildTechniques(actor: ThreatActorProfile): EmulationTechnique[] {
    return actor.ttps.techniques.map((t) => ({
      ...
      name: t.name,
      procedure:
        actor.ttps.procedures.find((p) => p.techniqueId === t.techniqueId)?.description ||
        "Standard procedure",
      tools: t.tools,
  ...
  private createSafetyChecks(): Array<{
    id: string;
    description: string;
    condition: string;
