...
const logistic_risk_js_1 = require("../src/models/logistic-risk.js");
const psi_calculator_js_1 = require("../src/monitoring/psi-calculator.js");
describe('LogisticRiskScorer', () => {
    const generateTrainingData = (n) => {
        const features = [];
        const labels = [];
        for (let i = 0; i < n; i++) {
    ...
    describe('fit', () => {
        it('should fit logistic risk model', () => {
            const scorer = new logistic_risk_js_1.LogisticRiskScorer();
...
describe('PSICalculator', () => {
    describe('calculatePSI', () => {
        it('should calculate PSI between distributions', () => {
            const calculator = new psi_calculator_js_1.PSICalculator();
