...
exports.OutreachTracker = void 0;
...
class OutreachTracker {
    ...
    constructor() {
        ...
        this.driver = neo4j_driver_1.default.driver(process.env.NEO4J_URI || 'bolt://localhost:7687', neo4j_driver_1.default.auth.basic(process.env.NEO4J_USER || process.env.NEO4J_USERNAME || 'neo4j', process.env.NEO4J_PASSWORD || 'devpassword'));
    }
    /**
     * Logs an email open event.
     * Increments the open counter in Redis and creates a relationship in Neo4j.
     */
    async logOpen(campaignId, email) {
...
exports.OutreachTracker = OutreachTracker;
