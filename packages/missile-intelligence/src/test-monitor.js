...
exports.MissileTestMonitor = void 0;
class MissileTestMonitor {
    tests;
    constructor() {
        this.tests = new Map();
    }
    ...
    getTests(missileSystemId) {
        return this.tests.get(missileSystemId) || [];
    }
    calculateSuccessRate(missileSystemId) {
    ...
    detectNewCapabilities(missileSystemId) {
        const tests = this.getTests(missileSystemId)
...
exports.MissileTestMonitor = MissileTestMonitor;
