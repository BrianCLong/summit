...
describe('MissileTracker', () => {
    let tracker;
    beforeEach(() => {
        tracker = new src_1.MissileTracker();
    });
    test('should register and retrieve missiles', () => {
        tracker.registerMissile({
            ...
            name: 'Test ICBM',
            country: 'TestCountry',
            missile_type: src_1.MissileType.BALLISTIC_ICBM,
            classification: src_1.MissileClassification.STRATEGIC,
            range_km: 10000,
            payload_kg: 1000,
            propulsion: src_1.PropulsionType.SOLID_FUEL,
            ...
            mirv_capable: true,
            warhead_types: [src_1.WarheadType.NUCLEAR],
            operational_status: src_1.OperationalStatus.OPERATIONAL,
    ...
    test('should get strategic missiles', () => {
        ...
        tracker.registerMissile({
            ...
            name: 'Tactical SRBM',
            country: 'TestCountry',
            missile_type: src_1.MissileType.BALLISTIC_SRBM,
            classification: src_1.MissileClassification.TACTICAL,
            range_km: 300,
            payload_kg: 500,
            propulsion: src_1.PropulsionType.SOLID_FUEL,
            guidance_system: ['inertial'],
            ...
            submarine_launched: false,
            mirv_capable: false,
            warhead_types: [src_1.WarheadType.CONVENTIONAL],
            operational_status: src_1.OperationalStatus.OPERATIONAL,
    ...
    test('should assess hypersonic capability', () => {
        tracker.registerMissile({
            ...
            country: 'TestCountry',
            missile_type: src_1.MissileType.HYPERSONIC_GLIDE,
            classification: src_1.MissileClassification.STRATEGIC,
            range_km: 5000,
            payload_kg: 500,
            propulsion: src_1.PropulsionType.SCRAMJET,
            ...
            submarine_launched: false,
            mirv_capable: false,
            warhead_types: [src_1.WarheadType.NUCLEAR, src_1.WarheadType.CONVENTIONAL],
            operational_status: src_1.OperationalStatus.OPERATIONAL,
...
describe('MissileTestMonitor', () => {
    let monitor;
    beforeEach(() => {
        monitor = new src_1.MissileTestMonitor();
    });
    test('should record and analyze tests', () => {
        monitor.recordTest({
            ...
            test_type: src_1.TestType.FULL_RANGE,
            success: true,
...
describe('MissileCapabilityAssessor', () => {
    let assessor;
    beforeEach(() => {
        assessor = new src_1.MissileCapabilityAssessor();
    });
