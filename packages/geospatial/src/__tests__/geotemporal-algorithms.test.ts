...
describe("Trajectory Building", () => {
  it("should build trajectory from observations sorted by time", () => {
    ...
    const observations = [
      createObservation("E1", 40.7128, -74.006, new Date(baseTime.getTime() + 30 * 60 * 1000)),
      createObservation("E1", 40.758, -73.9855, new Date(baseTime.getTime() + 60 * 60 * 1000)),
      createObservation("E1", 40.7489, -73.968, baseTime),
    ];
    ...
    expect(trajectory[2].latitude).toBe(40.758);
  });
  ...
  it("should calculate total distance correctly", () => {
    ...
    const observations = [
      createObservation("E1", 40.7128, -74.006, baseTime),
...
describe("Stay-Point Detection", () => {
  it("should detect a stay point when entity remains in area", () => {
    ...
    const observations = [
      createObservation("E1", 40.7128, -74.006, baseTime, 15),
      ...
      createObservation("E1", 40.7128, -74.006, new Date(baseTime.getTime() + 45 * 60 * 1000), 15),
    ];
  ...
  it("should NOT detect stay point when entity moves outside radius", () => {
    ...
    const observations = [
      createObservation("E1", 40.7128, -74.006, baseTime, 10),
      createObservation("E1", 40.7129, -74.0061, new Date(baseTime.getTime() + 10 * 60 * 1000), 10),
      // Moves ~5km away
      createObservation("E1", 40.758, -73.9855, new Date(baseTime.getTime() + 20 * 60 * 1000), 10),
    ];
  ...
  it("should NOT detect stay point when duration is too short", () => {
    ...
    const observations = [
      createObservation("E1", 40.7128, -74.006, baseTime, 5),
  ...
  it("should detect multiple stay points", () => {
    ...
    const observations = [
      ...
      createObservation("E1", 40.7128, -74.006, baseTime, 20),
      createObservation("E1", 40.7129, -74.0061, new Date(baseTime.getTime() + 20 * 60 * 1000), 20),
      // Move to location B
      createObservation("E1", 40.758, -73.9855, new Date(baseTime.getTime() + 60 * 60 * 1000), 10),
...
describe("Co-Presence Detection", () => {
  it("should detect co-presence when entities are close in space and time", () => {
    ...
    const observations = [
      ...
      createObservation("E-A", 40.7128, -74.006, baseTime, 20),
  ...
  it("should NOT detect co-presence when entities are too far apart", () => {
    ...
    const observations = [
      ...
      createObservation("E-B", 40.758, -73.9855, baseTime, 20),
    ];
  ...
  it("should NOT detect co-presence when temporal overlap is too short", () => {
    ...
    const observations = [
      createObservation("E-A", 40.7128, -74.006, baseTime, 10),
...
describe("Convoy Detection", () => {
  it("should detect convoy when entities move together", () => {
    ...
    for (let step = 0; step < 4; step++) {
      ...
      const baseLon = -74.006 + step * 0.01;
...
describe("Speed Calculation", () => {
  it("should calculate average speed correctly", () => {
    ...
    const observations = [
      createObservation("E1", 40.7128, -74.006, baseTime, 30),
  ...
  it("should return 0 for single point trajectory", () => {
    const baseTime = new Date("2025-01-01T10:00:00Z");
    const observations = [createObservation("E1", 40.7128, -74.006, baseTime, 30)];
