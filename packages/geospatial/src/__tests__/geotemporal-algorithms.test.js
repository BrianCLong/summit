...
const geotemporal_algorithms_1 = require("../analytics/geotemporal-algorithms");
/**
...
describe('Trajectory Building', () => {
    it('should build trajectory from observations sorted by time', () => {
        ...
        const trajectory = (0, geotemporal_algorithms_1.buildTrajectory)(observations);
    ...
    it('should handle empty observations', () => {
        const trajectory = (0, geotemporal_algorithms_1.buildTrajectory)([]);
    ...
    it('should calculate total distance correctly', () => {
        ...
        const trajectory = (0, geotemporal_algorithms_1.buildTrajectory)(observations);
        const distance = (0, geotemporal_algorithms_1.calculateTrajectoryDistance)(trajectory);
...
describe('Stay-Point Detection', () => {
    it('should detect a stay point when entity remains in area', () => {
        ...
        const trajectory = (0, geotemporal_algorithms_1.buildTrajectory)(observations);
        const stayPoints = (0, geotemporal_algorithms_1.detectStayPoints)(trajectory, {
            radiusMeters: 100,
...
describe('Co-Presence Detection', () => {
    it('should detect co-presence when entities are close in space and time', () => {
        ...
        const intervals = (0, geotemporal_algorithms_1.detectCoPresence)(observations, {
...
describe('Convoy Detection', () => {
    it('should detect convoy when entities move together', () => {
        ...
        const convoys = (0, geotemporal_algorithms_1.detectConvoys)(observations, {
...
describe('Speed Calculation', () => {
    it('should calculate average speed correctly', () => {
        ...
        const trajectory = (0, geotemporal_algorithms_1.buildTrajectory)(observations);
        const speed = (0, geotemporal_algorithms_1.calculateAverageSpeed)(trajectory);
