...
exports.normalizePoint = exports.convertProjection = exports.mgrsToPoint = exports.toMGRS = exports.utmToLatLon = exports.toUTM = void 0;
...
const centralMeridian = (zone) => -183 + zone * 6;
const toUTM = (point) => {
...
const toMGRS = (point, precision = 5) => {
    const utm = (0, exports.toUTM)(point);
...
const mgrsToPoint = (mgrs) => {
    ...
    const hemisphere = band.toUpperCase() >= 'N' ? 'N' : 'S';
    const columnSet = COLUMN_SETS[(zone - 1) % 3];
    ...
    return (0, exports.utmToLatLon)(utm);
};
exports.mgrsToPoint = mgrsToPoint;
const convertProjection = (point, toCrs) => {
    if (toCrs === 'EPSG:4326')
        return (0, exports.normalizePoint)(point);
    if (toCrs.toLowerCase().startsWith('utm')) {
        ...
        const utm = (0, exports.toUTM)(point);
        return (0, exports.utmToLatLon)({ ...utm, zone: zone || utm.zone, hemisphere });
    }
    return (0, exports.normalizePoint)(point);
};
exports.convertProjection = convertProjection;
