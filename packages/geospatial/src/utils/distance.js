...
exports.centroidFromPoints = void 0;
 ...
 */
function destination(start, distance, bearingDeg) {
    ...
    const lon2 = lon1 +
        Math.atan2(Math.sin(bearingRad) * Math.sin(distance / EARTH_RADIUS_METERS) * Math.cos(lat1), Math.cos(distance / EARTH_RADIUS_METERS) - Math.sin(lat1) * Math.sin(lat2));
    return {
...
exports.centroidFromPoints = centroid;
/**
