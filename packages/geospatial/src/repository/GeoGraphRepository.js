...
exports.InMemoryGeoGraphRepository = exports.Neo4jGeoGraphRepository = void 0;
/**
...
class Neo4jGeoGraphRepository {
    ...
    async getObservationsForEntity(entityId, timeRange) {
        return this.getObservationsForEntities([entityId], timeRange);
    }
    async getObservationsForEntities(entityIds, timeRange) {
    ...
    async batchUpsertObservations(observations) {
        const session = this.getSession();
        try {
...
exports.Neo4jGeoGraphRepository = Neo4jGeoGraphRepository;
/**
 * In-memory implementation for testing
 */
class InMemoryGeoGraphRepository {
    observations = [];
    async getObservationsForEntity(entityId, timeRange) {
        return this.getObservationsForEntities([entityId], timeRange);
    }
    ...
    async queryObservations(options) {
        ...
        if (options.boundingBox) {
            ...
            filtered = filtered.filter((obs) => obs.location.latitude >= minLat &&
...
exports.InMemoryGeoGraphRepository = InMemoryGeoGraphRepository;
