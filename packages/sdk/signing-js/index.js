...
export function createSignerClient(baseUrl = DEFAULT_BASE_URL, defaults = {}) {
  return {
    ...
    issueAttestation: (attestation, opts = {}) => issueAttestation(attestation, { baseUrl, ...defaults, ...opts }),
    verifyAttestation: (envelope, opts = {}) => verifyAttestation(envelope, { baseUrl, ...defaults, ...opts }),
  };
}
