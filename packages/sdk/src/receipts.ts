...
type ReceiptSchema = {
  ...
  readonly properties: {
    readonly id: { readonly type: 'string'; readonly description: string; readonly pattern: string };
    readonly version: {
    ...
    readonly createdAt: { readonly type: 'string'; readonly format: 'date-time'; readonly description: string };
    readonly actor: {
      readonly type: 'object';
      readonly description: string;
      readonly additionalProperties: false;
    ...
    readonly payloadHash: { readonly type: 'string'; readonly description: string; readonly pattern: string };
    readonly signature: {
      readonly type: 'object';
      readonly description: string;
      readonly additionalProperties: false;
      readonly properties: {
        readonly algorithm: { readonly type: 'string'; readonly enum: readonly ['ed25519']; readonly description: string };
    ...
    readonly proofs: {
      ...
      readonly additionalProperties: false;
      readonly properties: {
        readonly receiptHash: { readonly type: 'string'; readonly pattern: string; readonly description: string };
        readonly manifestMerkleRoot: { readonly type: 'string'; readonly pattern: string; readonly description: string };
    ...
    readonly metadata: { readonly type: 'object'; readonly description: string; readonly additionalProperties: true };
    readonly redactions: {
      readonly type: 'array';
      readonly description: string;
      readonly items: {
