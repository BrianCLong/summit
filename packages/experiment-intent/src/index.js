...
exports.LearningValueCalculator = void 0;
class LearningValueCalculator {
    calculate(experiment) {
        ...
        let relevance = 1.0;
        if (experiment.target_metric === 'user_retention')
            relevance = 2.0;
        if (experiment.target_metric === 'latency')
            relevance = 1.5;
...
exports.LearningValueCalculator = LearningValueCalculator;
