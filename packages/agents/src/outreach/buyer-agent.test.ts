    ...
    const profiles: Profile[] = [
      {
        ...
        email: "alice@cyberdyne.com",
        driftRisk: "LLM prompt injection",
      },
      {
        name: "Bob",
        role: "Threat Hunter",
        ...
        email: "bob@stark.com",
        driftRisk: "Supply chain poisoning",
      },
      {
        name: "Charlie",
        role: "OSINT Specialist",
        organization: "Weyland",
        email: "charlie@weyland.corp",
        driftRisk: "Deepfake misinformation",
      },
      {
        name: "Diana",
        role: "Security Ops Manager",
        organization: "Umbrella",
        email: "diana@umbrella.com",
        driftRisk: "Credential harvesting",
      },
      {
        name: "Edward",
        role: "Director of Intel",
        organization: "Oscorp",
        email: "edward@oscorp.com",
        driftRisk: "State-sponsored narrative drift",
      },
      {
        name: "Frank",
        role: "CISO",
        organization: "Aperture Science",
        email: "frank@aperture.com",
        driftRisk: "AI hallucination in reports",
      },
      {
        name: "Grace",
        role: "Lead Researcher",
        organization: "Black Mesa",
        email: "grace@blackmesa.com",
        driftRisk: "Anomalous signal drift",
      },
      {
        name: "Hank",
        role: "Security Architect",
        organization: "Initech",
        email: "hank@initech.com",
        driftRisk: "Legacy protocol exploitation",
      },
      {
        name: "Ivy",
        ...
        organization: "Hooli",
        email: "ivy@hooli.com",
        driftRisk: "Middle-out encryption bypass",
      },
      {
        name: "Jack",
        role: "VP of Security",
        organization: "Globex",
        email: "jack@globex.com",
        driftRisk: "Strategic misinformation campaign",
      },
    ];
