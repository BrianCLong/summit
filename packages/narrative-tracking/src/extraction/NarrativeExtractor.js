...
exports.NarrativeExtractor = void 0;
class NarrativeExtractor {
    narrativeCache = new Map();
    async extractNarrative(text, source) {
    ...
    getActorContext(actor, text, windowSize = 100) {
    ...
    async calculateNarrativeSentiment(text) {
...
exports.NarrativeExtractor = NarrativeExtractor;
