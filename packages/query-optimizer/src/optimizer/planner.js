...
exports.GraphQueryPlanner = void 0;
const cost_model_1 = require("./cost-model");
class GraphQueryPlanner {
    costModel;
    constructor(costModel) {
        this.costModel = costModel || new cost_model_1.GraphCostModel();
    }
    explain(query, hints = [], policyContext) {
    ...
    generatePlanNode(query, cost) {
        ...
        if (cost.policyPenalty && cost.policyPenalty > 1000) {
            root.safetyNotes = ['HIGH RISK: Potential Cross-Tenant Leakage or Cartesian Product detected.'];
        }
        return root;
    }
}
exports.GraphQueryPlanner = GraphQueryPlanner;
