...
describe('flow governance guardrails', () => {
  ...
  it('tracks toil budgets and automation backlog', () => {
    ...
    const budget = enforceToilBudget(toilItems, { weeklyHoursPerEngineer: 40, budgetPercentage: 25 });
  ...
  it('summarizes cost and weekly throughput', () => {
    ...
    const weekly = buildWeeklyThroughputReport(flow, [{ reason: 'blocked-by-review' }], ['added reviewer rotation']);
