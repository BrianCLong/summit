...
exports.getHighestClearance = getHighestClearance;
exports.isExportAllowed = isExportAllowed;
exports.checkAccess = checkAccess;
exports.filterByAccess = filterByAccess;
exports.batchCheckAccess = batchCheckAccess;
exports.createDefaultUserContext = createDefaultUserContext;
exports.createAdminUserContext = createAdminUserContext;
 ...
 */
const SENSITIVITY_HIERARCHY = ['PUBLIC', 'INTERNAL', 'CONFIDENTIAL', 'SECRET'];
/**
 ...
 */
function hasSufficientClearance(clearance, sensitivity) {
 ...
 */
function getHighestClearance(clearances) {
 ...
 */
const LICENSE_REGISTRY = new Map([
 ...
 */
function isExportAllowed(licenseId, user) {
...
function checkAccess(input) {
    ...
    if (object.purpose && object.purpose.length > 0) {
        ...
        const hasMatchingPurpose = objectPurposes.some((objPurpose) => userPurposes.includes(objPurpose));
 ...
 * ```
 */
function filterByAccess(user, objects, operation) {
 ...
 */
function batchCheckAccess(user, objects, operation) {
 ...
 */
function createAdminUserContext(userId) {
    return {
        userId,
        roles: ['ADMIN'],
