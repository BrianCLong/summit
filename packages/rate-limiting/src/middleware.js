...
const logger = (0, logger_js_1.createLogger)('rate-limit-middleware');
function createRateLimitMiddleware(options) {
    const { limiter, keyGenerator = (req) => req.ip || 'unknown', skip = () => false, standardHeaders = true, legacyHeaders = false, } = options;
