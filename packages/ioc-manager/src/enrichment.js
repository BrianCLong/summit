...
exports.IOCEnrichmentService = void 0;
...
class IOCEnrichmentService {
     ...
     */
    async enrichWithProvider(ioc, provider) {
     ...
     */
    async enrichWithVirusTotal(ioc) {
     ...
     */
    async enrichWithAlienVaultOTX(ioc) {
     ...
     */
    mergeEnrichments(enrichments, type) {
        const merged = {};
        // GeoIP data
...
exports.IOCEnrichmentService = IOCEnrichmentService;
