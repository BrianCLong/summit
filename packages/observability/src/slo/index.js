...
exports.BURN_RATE_WINDOWS = exports.DEFAULT_SLO_TARGETS = void 0;
exports.createAvailabilitySlo = createAvailabilitySlo;
exports.createLatencySlo = createLatencySlo;
exports.createThroughputSlo = createThroughputSlo;
exports.createWorkerSlos = createWorkerSlos;
exports.calculateErrorBudget = calculateErrorBudget;
exports.timeToExhaustion = timeToExhaustion;
exports.generateRecordingRules = generateRecordingRules;
exports.generateAlertRules = generateAlertRules;
exports.generateSloConfig = generateSloConfig;
// =============================================================================
// SLO CONFIGURATION
// =============================================================================
/**
 ...
 */
function createAvailabilitySlo(serviceName, target = 99.9, window = 30) {
    return {
 ...
 */
function createLatencySlo(serviceName, thresholdMs, percentile = 99, target = 99, window = 30) {
 ...
 */
function createThroughputSlo(serviceName, minRequestsPerSecond, target = 99, window = 30) {
    return {
 ...
 */
function createWorkerSlos(serviceName, queueName, targets = {
    availability: 99.5,
 ...
 */
function calculateErrorBudget(sloTarget, windowDays, currentSuccessRate, elapsedDays) {
 ...
 */
function timeToExhaustion(sloTarget, windowDays, currentBurnRate) {
 ...
 */
function generateRecordingRules(slo) {
    const rules = [];
 ...
 */
function generateAlertRules(slo) {
    const rules = [];
    const safeName = slo.name.replace(/[^a-zA-Z0-9_]/g, '_');
 ...
 */
function generateSloConfig(serviceName, archetype) {
    const targets = exports.DEFAULT_SLO_TARGETS[archetype];
    const slos = [];
