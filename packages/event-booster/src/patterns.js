...
exports.defaultPatterns = exports.createNoisePattern = exports.createTemporalShiftPattern = exports.createAmplifyPattern = void 0;
...
const clonePayload = (event) => ({
    ...event.payload,
});
const createAmplifyPattern = (config = {}) => {
...
exports.createAmplifyPattern = createAmplifyPattern;
const createTemporalShiftPattern = (config = {}) => {
...
exports.createTemporalShiftPattern = createTemporalShiftPattern;
const createNoisePattern = (config = {}) => {
    const field = config.field ?? DEFAULT_FIELD;
...
exports.createNoisePattern = createNoisePattern;
const buildNoiseDerivatives = (event, context, field, maxNoise, patternName) => {
    const baseValue = ensureNumber(event.payload[field]);
    if (baseValue === undefined) {
        return [];
    }
...
exports.defaultPatterns = [
    (0, exports.createAmplifyPattern)(),
    (0, exports.createTemporalShiftPattern)(),
    (0, exports.createNoisePattern)(),
];
