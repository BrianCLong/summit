...
describe('SyntheticGenerators', () => {
    it('creates uniformly spaced events with jitter', () => {
        const events = (0, SyntheticGenerators_js_1.generateUniformEvents)(3, {
    ...
    it('builds burst sequences with idle gaps', () => {
        const events = (0, SyntheticGenerators_js_1.generateBurstEvents)({
            bursts: 2,
            burstSize: 2,
            startTimestamp: 0,
            intervalMs: 1_000,
    ...
    it('generates seasonal oscillations', () => {
        const events = (0, SyntheticGenerators_js_1.generateSeasonalEvents)({
            periods: 1,
            pointsPerPeriod: 4,
            startTimestamp: 0,
            intervalMs: 1_000,
        ...
        const signals = events.map((event) => event.payload.signal);
    ...
    it('injects anomalies at the configured rate', () => {
        const events = (0, SyntheticGenerators_js_1.generateAnomalyEvents)({
            count: 5,
            anomalyRate: 1,
            baselineSignal: 1,
            anomalySignal: 10,
