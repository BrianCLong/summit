...
const heuristicDifficultyScorer_1 = require("../daao/difficulty/heuristicDifficultyScorer");
const llmRouter_1 = require("../daao/routing/llmRouter");
const modelCatalog_1 = require("../daao/routing/modelCatalog");
const debateValidation_1 = require("../daao/collaboration/debateValidation");
class LiteLLMPlugin {
    name = 'litellm';
    client;
    config;
            ...
            if (daaoEnabled) {
                try {
                    ...
                    if (userPrompt) {
                        ...
                        const scorer = new heuristicDifficultyScorer_1.HeuristicDifficultyScorer();
                        difficultySignal = await scorer.estimate(userPrompt);
                        // 2. Routing
                        const catalog = new modelCatalog_1.DefaultModelCatalog();
                        const router = new llmRouter_1.CostAwareLLMRouter(catalog);
            ...
            if (daaoEnabled &&
                ...
                try {
                    if (result.type === 'text' && result.content) {
                        ...
                        const validator = new debateValidation_1.DebateValidator(runner);
