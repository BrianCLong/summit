...
exports.extractDifficultyFeatures = extractDifficultyFeatures;
exports.scoreDifficultyFromFeatures = scoreDifficultyFromFeatures;
exports.recommendedDepth = recommendedDepth;
...
function detectDomain(query, contextHint) {
...
function extractDifficultyFeatures(query) {
    const q = query ?? "";
...
function scoreDifficultyFromFeatures(f) {
...
function recommendedDepth(score) {
    // 1..6
    if (score < 0.20)
        return 1;
    if (score < 0.40)
