...
describe('NuclearFacilityTracker', () => {
    let tracker;
    beforeEach(() => {
        tracker = new src_1.NuclearFacilityTracker();
    });
    test('should register and retrieve a facility', () => {
        const facility = {
            id: 'facility-001',
            name: 'Test Enrichment Plant',
            type: src_1.FacilityType.ENRICHMENT_PLANT,
            location: { latitude: 35.0, longitude: 51.0 },
            country: 'TestCountry',
            status: src_1.FacilityStatus.OPERATIONAL,
            iaea_safeguards: true,
            declared: true,
            confidence_level: src_1.ConfidenceLevel.CONFIRMED,
            metadata: {},
        ...
        expect(retrieved?.type).toBe(src_1.FacilityType.ENRICHMENT_PLANT);
    });
    test('should get facilities by country', () => {
        ...
        tracker.registerFacility({
            id: 'f2',
            name: 'Facility 2',
            type: src_1.FacilityType.POWER_REACTOR,
    ...
    test('should identify undeclared facilities', () => {
        tracker.registerFacility({
            ...
            declared: false,
            confidence_level: src_1.ConfidenceLevel.HIGH,
            metadata: {},
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString()
        });
    ...
    test('should get country statistics', () => {
        ...
        tracker.registerFacility({
            ...
            location: { latitude: 36.0, longitude: 52.0 },
            country: 'TestCountry',
            status: src_1.FacilityStatus.UNDER_CONSTRUCTION,
            iaea_safeguards: true,
            declared: true,
            confidence_level: src_1.ConfidenceLevel.CONFIRMED,
            metadata: {},
...
describe('EnrichmentMonitor', () => {
    let monitor;
    beforeEach(() => {
        monitor = new src_1.EnrichmentMonitor();
    });
...
describe('NuclearTestingDetection', () => {
    let detector;
    beforeEach(() => {
        detector = new src_1.NuclearTestingDetection();
    });
...
describe('NuclearInfrastructureMonitor', () => {
    let monitor;
    beforeEach(() => {
        monitor = new src_1.NuclearInfrastructureMonitor();
    });
    test('should assess nuclear capability', () => {
        monitor.updateInfrastructure('AdvancedCountry', {
            ...
            total_facilities: 20,
            facilities_by_type: {
                [src_1.FacilityType.ENRICHMENT_PLANT]: 2,
                [src_1.FacilityType.REPROCESSING_PLANT]: 1,
                [src_1.FacilityType.POWER_REACTOR]: 10
            },
            indigenous_capability: true,
            fuel_cycle_stage: [
                src_1.FuelCycleStage.MINING,
                src_1.FuelCycleStage.CONVERSION,
                src_1.FuelCycleStage.ENRICHMENT,
                src_1.FuelCycleStage.FUEL_FABRICATION,
                src_1.FuelCycleStage.REACTOR_OPERATION,
                src_1.FuelCycleStage.REPROCESSING,
                src_1.FuelCycleStage.WASTE_MANAGEMENT
            ],
            technology_level: src_1.TechnologyLevel.ADVANCED,
