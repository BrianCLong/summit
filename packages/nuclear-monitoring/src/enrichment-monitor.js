...
exports.EnrichmentMonitor = void 0;
class EnrichmentMonitor {
    activities;
    WEAPONS_GRADE_THRESHOLD = 90.0; // % U-235
    HEU_THRESHOLD = 20.0; // Highly Enriched Uranium threshold
    constructor() {
     ...
     */
    estimateTimeToSQ(facilityId, targetEnrichment = 90) {
     ...
     */
    calculateSWUperKg(feed, product, tails) {
        const V = (p) => (2 * p - 1) * Math.log(p / (1 - p));
     ...
     */
    calculateMaterialBalance(feedRate, // kg/year
    feedAssay, // % U-235
    productAssay, // % U-235
    tailsAssay // % U-235
    ) {
...
exports.EnrichmentMonitor = EnrichmentMonitor;
