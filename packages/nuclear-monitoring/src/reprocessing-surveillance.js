...
exports.ReprocessingSurveillance = void 0;
class ReprocessingSurveillance {
    operations;
    SIGNIFICANT_QUANTITY_PU = 8; // kg of plutonium
    constructor() {
    ...
    getOperations(facilityId) {
        return this.operations.get(facilityId) || [];
    }
    estimateAnnualPlutoniumProduction(facilityId) {
    ...
    assessReprocessingCapability(facilityId) {
        const ops = this.getOperations(facilityId);
        if (ops.length === 0) {
    ...
    detectSuspiciousActivity(facilityId) {
        const ops = this.getOperations(facilityId);
        const suspicious = [];
        ops.forEach(op => {
...
exports.ReprocessingSurveillance = ReprocessingSurveillance;
