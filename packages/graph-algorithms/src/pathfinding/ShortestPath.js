...
exports.ShortestPathAlgorithms = void 0;
class ShortestPathAlgorithms {
     ...
     */
    aStar(sourceId, targetId, heuristic) {
     ...
     * K shortest paths
     */
    kShortestPaths(sourceId, targetId, k) {
        const paths = [];
        const candidates = [];
    ...
    reconstructPath(sourceId, targetId, previous) {
        const path = [];
...
exports.ShortestPathAlgorithms = ShortestPathAlgorithms;
