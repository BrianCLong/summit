...
\n\n# Repo Triage Notes\n\n## Structure\n- `server/` - Node/TypeScript Backend\n- `client/` - React Frontend\n- `intelgraph/` - Core Graph Data Model\n- `infra/` - Terraform configs\n- `helm/` - Helm charts\n- `k8s/` - Kubernetes manifests\n- `docker-compose.yml` - Local dev\n\n## CI/CD\n- GitHub Actions (`.github/workflows/`)\n\n## Tech Stack\n- Node.js, pnpm, TypeScript\n- React, Apollo GraphQL\n- Neo4j, Postgres, Redis\n- Python (test/services)\n- Playwright for E2E\n- OpenTelemetry\n\n## Deployment Method\n- Docker locally\n- Helm/K8s for production (indicated by `helm/`, `k8s/`, and docs/deployment mentions)\n\n## Needs\n- Ephemeral preview environments in CI\n- Make the core smoke path a single command\n- Stage promotion and migration gates\n- Prod canary and rollback\n- Observability and auditability dashboards/links
