...
exports.CoxProportionalHazards = void 0;
class CoxProportionalHazards {
    coefficients = [];
    baselineHazard = new Map();
    featureNames = [];
    fitted = false;
    /**
     * Fit Cox model using partial likelihood
     */
    fit(data, featureNames, maxIterations = 100, tolerance = 1e-6) {
     ...
     */
    predictSurvival(covariates, times) {
        if (!this.fitted) {
...
exports.CoxProportionalHazards = CoxProportionalHazards;
