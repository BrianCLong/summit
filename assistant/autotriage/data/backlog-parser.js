...
exports.parseBacklog = parseBacklog;
exports.parseBacklogWithDetails = parseBacklogWithDetails;
 ...
 * ```
 */
async function parseBacklog(backlogPath) {
 ...
 */
async function parseBacklogWithDetails(backlogPath) {
    const result = {
        items: [],
        errors: [],
        warnings: [],
