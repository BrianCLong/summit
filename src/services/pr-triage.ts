...
export interface PullRequest {
  ...
  reviews: Review[];
  requiresGovernanceSignoff: boolean;
  governanceApproved: boolean;
}

export interface Queues {
  'merge-ready': PullRequest[];
  'needs-conflict-resolution': PullRequest[];
  'needs-owner-review': PullRequest[];
  'needs-governance-signoff': PullRequest[];
}

// Mock data stores
const branchToPrMap = new Map<string, string>();
const prToOwnerMap = new Map<string, string>();

/**
 * Maps a branch name to a PR ID
 */
export function mapBranchToPr(branchName: string, prId: string): void {
 ...
 */
export function getPrForBranch(branchName: string): string | undefined {
 ...
 */
export function mapPrToOwner(prId: string, owner: string): void {
 ...
 */
export function getOwnerForPr(prId: string): string | undefined {
 ...
 */
export function triagePrs(prs: PullRequest[]): Queues {
  const queues: Queues = {
    'merge-ready': [],
 ...
 */
export function generateQueueDashboard(queues: Queues): string {
