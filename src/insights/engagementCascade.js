...
const computeBaselineLatency = (config) => {
...
const computeBaselineCompute = (baselineLatency, config) => {
...
const computeSpeculativeHitRate = (config) => {
...
const computeVerificationReuse = (config, hitRate) => {
...
const computeDraftLatency = (baselineLatency, config) => {
...
const computeVerifierLatency = (baselineLatency, verificationReuse) => {
...
const computeFallbackLatency = (baselineLatency, hitRate) => {
...
export function engagementCascade(config = {}) {
    ...
    const expectedLatency = draftLatency +
    ...
    const tiers = [
        {
            ...
            tokensPerSecond: toFixedNumber((512000 / draftLatency) * (1 + amplificationFactor * 0.4), 1),
        ...
        },
        {
            ...
            tokensPerSecond: toFixedNumber((256000 / verifierLatency) * (1 + verificationReuse * 0.5), 1),
    ...
    const guardrails = {
        ...
        abortConditions: [
            ...
            `Force fallback if speculative hit rate drops below ${toFixedNumber(speculativeHitRate * 0.65, 2)}.`,
        ],
    };
    ...
    const observability = {
        metrics: {
            ...
            tokensBuffered: Math.round(computePrefillTokens(speculativeHitRate, amplificationFactor)),
        },
        dashboards: [
...
//# sourceMappingURL=engagementCascade.js.map