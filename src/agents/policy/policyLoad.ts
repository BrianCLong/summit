...
const BANNED_SCHEMA = 'banned_patterns.schema.json';
...
export function loadPolicyBundle(
  ...
  const bannedSchemaPath = path.join(policyDir, BANNED_SCHEMA);
  ...
  validateSchema(bannedSchemaPath, bannedRegistry, 'banned_patterns');
