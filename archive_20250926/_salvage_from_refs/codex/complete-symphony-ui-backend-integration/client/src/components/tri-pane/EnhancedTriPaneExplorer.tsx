...
export const EnhancedTriPaneExplorer: React.FC = () => {
  ...
  const handleEntitySelection = useCallback(async (entity: EntitySelection, sourcePane: string) => {
        ...
        <div className="flex items-center space-x-4">
          ...
          <label className="flex items-center space-x-2">
            <input
              ...
              onChange={(e) => setState(prev => ({ ...prev, xaiOverlayEnabled: e.target.checked }))}
              className="w-4 h-4 text-blue-600 rounded"
            />
          ...
          <label className="flex items-center space-x-2">
            <input
              ...
              onChange={(e) => setState(prev => ({ ...prev, provenanceOverlayEnabled: e.target.checked }))}
              className="w-4 h-4 text-blue-600 rounded"
            />
              ...
              <div className="space-y-2">
                <div 
                  ...
                  onClick={() => handleEntitySelection({
                    id: 'location-1',
                    type: 'location',
                    properties: { lat: 40.7128, lng: -74.0060, name: 'NYC Office' },
                    confidence: 0.95,
                    source: 'map'
                  }, 'map')}
                >
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Confidence: {Math.round(selectedEntity.confidence * 100)}% | Source: {selectedEntity.source}
              </p>
            </div>
              ...
              {xaiData && (
                <div className="bg-purple-50 border border-purple-200 rounded px-3 py-2">
                  ...
                  <div className="text-xs text-purple-600">
                    Model: {xaiData.model_version} | Confidence: {Math.round(xaiData.confidence * 100)}%
                  </div>
                </div>
              )}
