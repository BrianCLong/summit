...
export class PrometheusConductorMetrics {
   ...
   */
  public recordRoutingDecision(expert: ExpertType, latencyMs: number, confidence: number, success: boolean): void {
   ...
   */
  public updateQuotaRemaining(expert: ExpertType, quotaType: string, userId: string, remaining: number): void {
