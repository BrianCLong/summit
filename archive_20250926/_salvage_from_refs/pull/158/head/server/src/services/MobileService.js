...
class MobileService extends EventEmitter {
  ...
  hasImportantChanges(changes) {
    return changes.investigations.length > 0 || 
  ...
  async getInvestigationChanges(userId, version) { return []; }
  async getEntityChanges(userId, version) { return []; }
  async getNotificationChanges(userId, version) { return []; }
  async getSettingsChanges(userId, version) { return []; }
  async createEntityFromMobile(data, client) { return { id: 'new-entity' }; }
  async updateEntityFromMobile(data, client) { return { success: true }; }
  async createRelationshipFromMobile(data, client) { return { id: 'new-rel' }; }
  async markNotificationReadFromMobile(data, client) { return { success: true }; }
}
