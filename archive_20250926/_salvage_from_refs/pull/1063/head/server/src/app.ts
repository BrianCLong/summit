...
import { typeDefs } from './graphql/schema.js'; // now TS file compiled to .js in dist
import moduleResolvers from './graphql/schema.js';
...
export const createApp = async () => {
  ...
  const schema = makeExecutableSchema({ typeDefs, resolvers: moduleResolvers });
