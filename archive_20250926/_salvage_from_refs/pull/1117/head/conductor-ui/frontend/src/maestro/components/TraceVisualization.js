          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('div', { className: `w-3 h-3 rounded mr-3 ${getStatusColor(node.status)}` }),
                _jsxs('div', {
              ...
              'div',
              {
                ...
                children: [
                  _jsx('div', {
                    ...
                    children: _jsx('span', { className: 'truncate', children: span.name }),
                  }),
      ...
      children: _jsx('div', {
        ...
        children: _jsxs('div', {
          ...
          children: [
            ...
            _jsx('p', { className: 'text-sm text-gray-600', children: 'Loading trace data...' }),
          ],
        }),
      }),
    });
    ...
    return _jsx('div', {
      ...
      children: _jsx('div', {
        ...
        children: _jsxs('div', {
          ...
          children: [
            _jsx('p', { className: 'font-medium', children: 'Error loading trace' }),
          ...
          traceMetrics &&
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  children: [
                    _jsx('div', { className: 'text-gray-500', children: 'Duration' }),
                    _jsx('div', {
                ...
                _jsxs('div', {
                  children: [
                    _jsx('div', { className: 'text-gray-500', children: 'Spans' }),
                    _jsx('div', { className: 'font-medium', children: traceMetrics.spanCount }),
                  ],
                }),
                _jsxs('div', {
                  children: [
                    _jsx('div', { className: 'text-gray-500', children: 'Services' }),
                    _jsx('div', { className: 'font-medium', children: traceMetrics.serviceCount }),
                  ],
                }),
                _jsxs('div', {
                  children: [
                    _jsx('div', { className: 'text-gray-500', children: 'Errors' }),
                    _jsx('div', {
                ...
                _jsxs('div', {
                  children: [
                    _jsx('div', { className: 'text-gray-500', children: 'Critical Path' }),
                    _jsxs('div', {
                      className: 'font-medium',
                          ...
                          children: selectedSpan.events.map((event, index) =>
                            _jsxs(
                              'div',
                              {
                                ...
                                children: [
                                  _jsx('div', { className: 'font-medium', children: event.name }),
                                  _jsx('div', {
