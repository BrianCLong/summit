  ...
  return _jsxs('section', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('h1', { className: 'text-xl font-semibold', children: 'Tenant Cost & SLO' }),
          _jsx('input', {
            'aria-label': 'Tenant',
          ...
          budgetPolicy &&
            _jsxs('span', {
              className: `inline-block rounded px-2 py-0.5 text-xs font-semibold ${budgetPolicy.type === 'hard' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800'}`,
              children: [
                'Budget: ',
      ...
      _jsxs('section', {
        ...
        children: [
          _jsx('div', { className: 'text-sm font-medium', children: 'Forecast alert routes' }),
          _jsxs('div', {
