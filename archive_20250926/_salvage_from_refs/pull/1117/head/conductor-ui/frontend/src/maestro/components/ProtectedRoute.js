    ...
    return _jsx('div', {
      ...
      children: _jsxs('div', {
        ...
        children: [
          ...
          _jsx('p', { className: 'mt-4 text-slate-600', children: 'Authenticating...' }),
        ],
      }),
    });
  }
        ...
        children: _jsxs('div', {
          ...
          children: [
            ...
            _jsx('p', {
              ...
              children: "You don't have the required role(s) to access this resource.",
            }),
            _jsxs('p', {
    ...
    return _jsx('div', {
      ...
      children: _jsxs('div', {
        ...
        children: [
          ...
          _jsxs('p', {
            className: 'text-sm text-slate-500',
            children: ['Your available tenants: ', user.tenants?.join(', ') || 'None'],
          }),
        ],
      }),
    });
