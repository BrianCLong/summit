  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('button', {
        ...
        children: [
          _jsx('div', {
            className: 'h-6 w-6 rounded-full bg-indigo-600 flex items-center justify-center',
            children: _jsx('span', {
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('div', { className: 'text-xs text-slate-500', children: currentTenant }),
            ],
          }),
          _jsx('svg', {
                ...
                children: [
                  ...
                  _jsxs('div', {
                    children: [
                      ...
                      _jsx('div', { className: 'text-sm text-slate-600', children: user.email }),
                      _jsx('div', {
                        className: 'text-xs text-slate-500',
                        children: 'via Mock Auth',
                      }),
                    ],
                  }),
                ],
              ...
              children: [
                ...
                showTenantSwitcher &&
                  ...
                  _jsx('div', {
                    ...
                    children: user.tenants.map((tenant) =>
                      _jsx(
                        'button',
                        {
                          onClick: () => {
