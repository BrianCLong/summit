    ...
    <div className="panel" style={{ 
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
        <span style={{ 
          ...
          height: '8px', 
          borderRadius: '50%', 
          backgroundColor: healthStatus === 'healthy' ? '#22c55e' : 
                           healthStatus === 'error' ? '#ef4444' : '#d1d5db',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
        <span style={{ 
          ...
          height: '8px', 
          borderRadius: '50%', 
          backgroundColor: graphqlStatus === 'healthy' ? '#22c55e' : 
                           graphqlStatus === 'error' ? '#ef4444' : '#d1d5db',
          display: 'inline-block'
        }}></span>
