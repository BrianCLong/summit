...
const aiInfluenceCampaignEnricher_1 = require("../../agents/ontology/aiInfluenceCampaignEnricher");
const fs = __importStar(require("fs"));
function normalizeFixtures(fixturePaths) {
    const enricher = new aiInfluenceCampaignEnricher_1.AiInfluenceCampaignEnricher();
