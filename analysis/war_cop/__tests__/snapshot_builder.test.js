...
const snapshot_builder_1 = require("../snapshot_builder");
(0, node_test_1.describe)('buildSnapshot', () => {
    (0, node_test_1.it)('builds a snapshot', () => {
        const snap = (0, snapshot_builder_1.buildSnapshot)('SNAP:WARCOP:202301010000', '2023-01-01T00:00:00Z', 10, 20);
