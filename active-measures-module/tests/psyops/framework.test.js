...
const framework_1 = require("../../src/psyops/framework");
describe('PsyOps Framework', () => {
    describe('generatePlaybook', () => {
        it('should generate a complete PsyOps framework with default parameters', () => {
            ...
            const playbook = (0, framework_1.generatePlaybook)(tuners);
        ...
        it('should generate appropriate objectives based on intensity level', () => {
            ...
            const lowIntensityPlaybook = (0, framework_1.generatePlaybook)(lowIntensityTuners);
            const highIntensityPlaybook = (0, framework_1.generatePlaybook)(highIntensityTuners);
            expect(lowIntensityPlaybook.strategic.objectives.length).toBeGreaterThanOrEqual(4);
            expect(highIntensityPlaybook.strategic.objectives.length).toBeGreaterThan(lowIntensityPlaybook.strategic.objectives.length);
        });
        it('should adapt narrative themes based on doctrine alignment', () => {
            ...
            const threeWarfaresPlaybook = (0, framework_1.generatePlaybook)(threeWarfaresTuners);
            const gerasimovPlaybook = (0, framework_1.generatePlaybook)(gerasimovTuners);
        ...
        it('should include more advanced techniques for high intensity operations', () => {
            ...
            const playbook = (0, framework_1.generatePlaybook)(highIntensityTuners);
            const advancedTechniques = playbook.tactical.techniques.filter((technique) => technique.name.includes('Behavioral') ||
    ...
    describe('validateOperation', () => {
        it('should validate a compliant operation', () => {
            ...
            const result = (0, framework_1.validateOperation)(operation, constraints);
        ...
        it('should warn about high attribution techniques when unattributability is required', () => {
            ...
            const result = (0, framework_1.validateOperation)(operation, constraints);
            expect(result.warnings).toContain('High attribution techniques may compromise unattributability requirement');
        });
    ...
    describe('Decision Matrix Generation', () => {
        it('should include escalated methods for high-intensity operations', () => {
            ...
            const playbook = (0, framework_1.generatePlaybook)(highIntensityTuners);
            const escalatedMethods = playbook.decisionMatrix.filter((decision) => decision.method.includes('Advanced') || decision.riskLevel > 0.7);
    ...
    describe('Resource Allocation', () => {
        it('should allocate resources proportionally based on constraints', () => {
            ...
            expect(playbook.operational.resourceAllocation.budgetDistribution.content +
                ...
                playbook.operational.resourceAllocation.budgetDistribution.analytics).toBeLessThanOrEqual(2000000);
        });
    });
