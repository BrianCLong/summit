...
exports.segmentAudience = segmentAudience;
exports.createVulnerabilityHeatmap = createVulnerabilityHeatmap;
var VulnerabilityType;
(function (VulnerabilityType) {
    VulnerabilityType["COGNITIVE_BIAS"] = "cognitive_bias";
    VulnerabilityType["EMOTIONAL_TRIGGER"] = "emotional_trigger";
    VulnerabilityType["SOCIAL_PRESSURE"] = "social_pressure";
    VulnerabilityType["INFORMATION_GAP"] = "information_gap";
    VulnerabilityType["TRUST_DEFICIT"] = "trust_deficit";
    VulnerabilityType["ECONOMIC_STRESS"] = "economic_stress";
    VulnerabilityType["IDENTITY_INSECURITY"] = "identity_insecurity";
    VulnerabilityType["AUTHORITY_DEFERENCE"] = "authority_deference";
 ...
 */
function segmentAudience(tuners, targetData) {
    const segments = [];
 ...
 */
function generateHighSusceptibilitySegment(tuners) {
    return {
 ...
 */
function generateModerateSusceptibilitySegment(tuners) {
    return {
 ...
 */
function generateLowSusceptibilitySegment(tuners) {
    return {
 ...
 */
function generateOceanBasedSegments(tuners) {
    return [
        {
            id: 'high_neuroticism',
 ...
 */
function generateVoterSegments(tuners) {
    return {
        id: 'swing_voters',
        name: 'Swing Voters',
        demographics: {
 ...
 */
function generateEconomicSegments(tuners) {
    return {
        id: 'economic_anxiety',
 ...
 */
function createVulnerabilityHeatmap(segments) {
    const heatmap = {
        segments: [],
