...
allow if {
    ...
    any_archetype_allowed
}

any_archetype_allowed if allow_chief_of_staff_read
any_archetype_allowed if allow_chief_of_staff_create
any_archetype_allowed if allow_coo_read_ops
any_archetype_allowed if allow_coo_triage_incident
any_archetype_allowed if allow_coo_create_incident
any_archetype_allowed if allow_coo_send_reminder
any_archetype_allowed if allow_coo_process_analysis
any_archetype_allowed if allow_revops_read_revenue
any_archetype_allowed if allow_revops_create_tasks
any_archetype_allowed if allow_revops_analytics
any_archetype_allowed if allow_revops_reports
