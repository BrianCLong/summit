...
any_agent_allow if { allow_chief_of_staff_read }
any_agent_allow if { allow_chief_of_staff_create }
any_agent_allow if { allow_coo_read_ops }
any_agent_allow if { allow_coo_triage_incident }
any_agent_allow if { allow_coo_create_incident }
any_agent_allow if { allow_coo_send_reminder }
any_agent_allow if { allow_coo_process_analysis }
any_agent_allow if { allow_revops_read_revenue }
any_agent_allow if { allow_revops_create_tasks }
any_agent_allow if { allow_revops_analytics }
any_agent_allow if { allow_revops_reports }
