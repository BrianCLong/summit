...
requires_step_up {
  input.bundle.sensitivity == ["Sensitive", "Restricted"][_]
}
...
decision := {
  ...
  allow_effective := would_allow_or_simulate
}


would_allow_or_simulate { would_allow }
would_allow_or_simulate { simulate }
else = false
