...
*From `/planning/CRITICAL_COMPANY_SUCCESS_ROADMAP_ITEMS.md`*
...
*From `/90_DAY_WAR_ROOM_BACKLOG.md`*
...
*From `/docs/competitive-analysis/gap-assessment.md`*
...
*From `/docs/architecture/ADR_INDEX.md`*
