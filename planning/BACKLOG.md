...
* [x] **EP01-T01** Stakeholder map & RACI; identify decision owners.
* [x] **EP01-T02** Problem statements & objectives per stakeholder persona.
...
* [x] **EP01-T10** Dependency graph across epics; identify critical path.
* [ ] **EP01-T11** Acceptance Criteria template & verification steps standard.
* [x] **EP01-T12** Evidence template & provenance manifest fields.
...
* [x] **EP02-T01** C4 Context diagram; external systems & trust boundaries.
* [x] **EP02-T02** C4 Container diagram; services, data stores, queues, gateways.
...
* [x] **EP03-T01** Canonical entity/edge inventory; taxonomy & synonyms.
...
* [x] **EP04-T01** GraphQL SDL for core types/queries/mutations/subscriptions.
...
* [x] **EP05-T01** S3/CSV connector MVP (schema mapping, dedupe, provenance attach).
...
* [x] **EP06-T01** Data classification policy; tagging implementation.
...
* [x] **EP07-T01** Provenance ledger design (append‑only, hash‑chained).
...
* [x] **EP08-T01** Design tokens & theme (light/dark); accessibility baseline.
...
* [x] **EP09-T01** Embedding/feature strategy; formats and dims.
...
* [x] **EP10-T01** Repo scaffolding; language/toolchain baselines.
* [x] **EP10-T02** Branch protection rules; PR templates; CODEOWNERS.
...
* [x] **EP11-T01** OpenTelemetry instrumentation plan (services/UI/DB/queues).
