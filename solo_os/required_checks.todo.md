...
- [x] `solo_os_verify`: Runs `bash solo_os/ci/verify_solo_os.sh`.
- [x] `solo_os_gate_tests`: Runs `python3 -m unittest solo_os/eval/test_gate_fixtures.py`.
- [x] `solo_os_schema_validation`: Validates all generated evidence against schemas in `solo_os/evidence/*.schema.json`.
