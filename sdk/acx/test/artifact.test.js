...
describe('Consent artifacts', () => {
    ...
    it('signs and verifies artifacts offline', () => {
        ...
        expect(sdk_js_1.AdaptiveConsentSDK.verifyArtifact(artifact, PUBLIC_KEY)).toBe(true);
    });
    it('fails verification when payload is altered', () => {
        ...
        expect(sdk_js_1.AdaptiveConsentSDK.verifyArtifact(tampered, PUBLIC_KEY)).toBe(false);
    });
});
