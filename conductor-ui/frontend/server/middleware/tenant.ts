...
export function setTenant(req: TenantRequest, _res: Response, next: NextFunction): void {
  ...
  req.db.query("SELECT set_config('app.tenant_id', $1, false)", [tenant]).catch((error: Error) => {
