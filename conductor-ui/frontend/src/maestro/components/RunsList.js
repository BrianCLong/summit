    ...
    children: [
        ...
        children: [
          ...
          isExpanded &&
            ...
            _jsxs("div", {
              ...
              children: [
                _jsxs("div", {
                  children: ["Started: ", new Date(run.startedAt).toLocaleString()],
                }),
                run.endedAt &&
                  _jsxs("div", {
                    children: ["Ended: ", new Date(run.endedAt).toLocaleString()],
                  }),
                run.traceId && _jsxs("div", { children: ["Trace: ", run.traceId] }),
                _jsxs("div", {
      ...
      _jsxs("td", {
        ...
        children: [
          _jsx("div", {
            className: "text-sm",
            children: run.durationMs ? `${Math.round(run.durationMs / 1000)}s` : "—",
          }),
          isExpanded &&
            run.status === "running" &&
            _jsxs("div", {
...
export default function RunsList({
  ...
  useEffect(() => {
    ...
    eventSource.addEventListener("run_progress", (event) => {
      ...
      setRuns((prev) =>
        prev.map((run) => (run.id === updatedRun.id ? { ...run, ...updatedRun } : run))
      );
    });
    eventSource.addEventListener("run_completed", (event) => {
      ...
      setRuns((prev) =>
        prev.map((run) => (run.id === completedRun.id ? { ...run, ...completedRun } : run))
      );
    });
    return () => {
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      showFilters && _jsx(RunsFilters, { filters: filters, onChange: setFilters }),
      _jsxs("div", {
      ...
      _jsx("div", {
        ...
        children: _jsxs("table", {
          ...
          children: [
            ...
            _jsxs("tbody", {
              children: [
                filteredRuns.map((run) => _jsx(RunRow, { run: run, compact: compact }, run.id)),
