        ...
        children: [
          ...
          !selectedNode
            ? _jsx("div", {
                ...
                children: "Select a step from the DAG to inspect its details, metrics, and logs.",
              })
          ...
          metrics &&
            _jsxs("div", {
              ...
              children: [
                ...
                _jsxs("div", {
                  children: ["CPU: ", metrics.cpuPct, "% \u2022 Memory: ", metrics.memMB, "MB"],
                }),
                _jsxs("div", {
                  children: ["Tokens: ", metrics.tokens, " \u2022 Cost: $", metrics.cost],
                }),
          ...
          children: [
            ...
            _jsxs("div", {
              ...
              children: [
                ...
                _jsxs("div", {
                  children: ["Policy: ", routing.policy?.allow ? "Allow" : "Deny"],
                }),
...
function LogsViewer({ runId }) {
  ...
  return _jsxs("div", {
    ...
    children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("span", {
                    ...
                    children: connected ? "Connected" : error ? "Disconnected" : "Connecting...",
                  }),
                ],
              }),
            ],
      ...
      error &&
        _jsxs("div", {
          className: "border-b border-red-200 bg-red-50 p-2 text-sm text-red-800",
              ...
              "div",
              {
                ...
                children: [
                  _jsx("span", {
                    ...
                    children: new Date(logLine.ts).toISOString().split("T")[1].slice(0, -1),
                  }),
                  " ",
                  logLine.text,
                ],
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("button", {
                ...
                children: generating ? "Generating..." : "Generate Evidence Bundle",
              }),
            ],
          }),
          evidenceBundle
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        children: [
                          ...
                          _jsxs("span", {
                            className: "font-mono",
                            children: [evidenceBundle.signature.slice(0, 32), "..."],
                          }),
                        ],
                      }),
                    ],
                      ...
                      _jsxs("div", {
                        children: [
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              _jsx("div", {
                                children: "\uD83D\uDD12 Cryptographically signed",
                              }),
                              _jsx("div", {
