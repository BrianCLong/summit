...
export default function AuthLogin() {
    ...
    return (_jsx("div", { className: "flex flex-col items-center justify-center min-h-screen bg-gray-100", children: _jsxs("div", { className: "p-8 bg-white rounded-lg shadow-md w-96", children: [_jsx("h2", { className: "text-2xl font-bold text-center mb-6", children: "Login to Maestro" }), error && _jsx("p", { className: "text-red-500 text-center mb-4", children: error }), _jsx("button", { onClick: () => handleLogin('auth0'), className: "w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 mb-3", children: "Login with Auth0" }), _jsx("button", { onClick: () => handleLogin('azuread'), className: "w-full bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 mb-3", children: "Login with Azure AD" }), _jsx("button", { onClick: () => handleLogin('google'), className: "w-full bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50", children: "Login with Google" })] }) }));
}
