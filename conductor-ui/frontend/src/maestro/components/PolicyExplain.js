...
function TabPanel(props) {
  ...
  return _jsx("div", {
    ...
    ...other,
    children: value === index && _jsx(Box, { sx: { p: 2 }, children: children }),
  });
}
              ...
              _jsx(TableContainer, {
                ...
                children: _jsxs(Table, {
                  ...
                  children: [
                    ...
                    _jsx(TableBody, {
                      children: explanation.decision.alternatives.map((alt, index) =>
                        _jsxs(
                          TableRow,
                          {
                            children: [
              ...
              _jsx(TableContainer, {
                ...
                children: _jsxs(Table, {
                  ...
                  children: [
                    ...
                    _jsx(TableBody, {
                      children: explanation.policyEvaluations.map((evaluation, index) =>
                        _jsxs(
                          TableRow,
                          {
                            children: [
                              ...
                              _jsx(TableCell, {
                                children: _jsx(Chip, {
                                  ...
                                  size: "small",
                                  color: evaluation.matched ? "success" : "default",
                                }),
                              }),
                              _jsx(TableCell, {
                                children: _jsx(Chip, {
              ...
              _jsx(TableContainer, {
                ...
                children: _jsxs(Table, {
                  ...
                  children: [
                    ...
                    _jsx(TableBody, {
                      children: Object.entries(explanation.costBreakdown.costFactors).map(
                        ([factor, amount]) =>
                          _jsxs(
                            TableRow,
                            {
                      ...
                      _jsxs(Typography, {
                        ...
                        color:
                          explanation.performanceMetrics.latencyEstimate > 5000
                            ? "error"
                            : "primary",
                        children: [explanation.performanceMetrics.latencyEstimate, "ms"],
                      }),
                    ],
                  }),
                  _jsxs(Paper, {
