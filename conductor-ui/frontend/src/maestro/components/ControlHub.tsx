...
function ReleaseOverview({ summary }: ReleaseOverviewProps) {
  ...
  const quickActions = [
    ...
    { label: 'Emergency Rollback', action: 'rollback', variant: 'danger' as const }
  ];
    ...
    <div className="rounded-lg border bg-white p-4 shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="space-y-2">
          ...
          <div className="text-2xl font-bold text-slate-900">{Math.round(releaseStatus.currentCanary * 100)}%</div>
        ...
        <div className="space-y-2">
          ...
          <div className="text-xs text-slate-500">Last promotion: {releaseStatus.lastPromotion}</div>
        </div>
  ...
  return (
    <div className="rounded-lg border bg-white p-4 shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-600">Policy Denials ({compliance.policyDenials.window})</span>
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-slate-900">{compliance.policyDenials.count}</span>
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-600">Evidence Bundles ({compliance.evidenceBundles.window})</span>
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-slate-900">{compliance.evidenceBundles.generated}</span>
              <span className="text-xs text-slate-500">{compliance.evidenceBundles.lastBundle}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 rounded-lg border bg-white p-4 shadow-sm">
          ...
          <div className="space-y-2">
            {summary?.runs?.slice(0, 5).map((run) => (
              <div key={run.id} className="flex items-center justify-between rounded-lg bg-slate-50 p-3">
                <div className="flex items-center gap-3">
                  <div className={`h-2 w-2 rounded-full ${
        ...
        <div className="space-y-4">
          <div className="rounded-lg border bg-white p-4 shadow-sm">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-slate-900">{summary?.approvals?.length || 0}</div>
