...
const SupplyChainVerificationPanel = ({
  runId,
  artifacts = [],
  className = '',
}) => {
                      ...
                      children: [
                        ...
                        _jsxs('div', {
                          ...
                          children: [
                            ...
                            result.sbomVerification.vulnerabilities.length >
                              5 &&
                              _jsxs('div', {
                    ...
                    children: [
                      ...
                      _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsxs('span', {
                            children: [reportData.summary.failed, ' Failed'],
                          }),
                        ],
                      }),
                    ],
          ...
          artifacts.length === 0
            ? _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('p', {
                    children: 'No artifacts to verify for this run.',
                  }),
                  _jsx('p', {
