            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsxs('span', {
                    children: [
                      formatPercentage(errorBudget.consumedPercentage),
                      ' consumed',
                    ],
                  }),
                ],
      ...
      children: _jsxs('div', {
        ...
        children: [
          _jsx('p', {
            ...
            children: 'Error loading SLOs',
          }),
          _jsx('p', { className: 'text-sm mt-1', children: error }),
          _jsx('button', {
            onClick: () => fetchSLOs(service ? { service } : undefined),
            className:
              'mt-4 px-4 py-2 bg-red-100 text-red-700 rounded hover:bg-red-200',
            children: 'Retry',
          }),
        ],
      }),
              ...
              children: [
                ...
                _jsx('div', {
                  ...
                  children: formatPercentage(
                    reportData.summary.averageCompliance,
                  ),
                }),
              ],
            }),
            ...
            _jsx('div', {
              ...
              children: [
                ...
                _jsxs(
                  ...
                  {
                    className:
                      'flex items-center justify-between py-2 px-3 bg-gray-50 rounded',
                    children: [
                      _jsxs('div', {
                        className: 'flex items-center space-x-3',
                        children: [
