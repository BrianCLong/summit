  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_300px]">
      <div className="rounded-lg border bg-white p-4">
        ...
        <DAG nodes={nodes} edges={edges} onSelect={setSelectedNode} selectedNode={selectedNode} />
      </div>
        ...
        {evidenceBundle ? (
          <div className="space-y-3">
            ...
            <div className="text-xs text-slate-600">
              ...
              <div>
                Signature:{" "}
                <span className="font-mono">{evidenceBundle.signature.slice(0, 32)}...</span>
              </div>
            </div>
          ...
          <div className="text-sm text-slate-600">
            ...
            cryptographically signed bundle containing SBOM, attestations, policy proofs, and
...
function ArtifactsTab({ runId }: ArtifactsTabProps) {
  ...
  return (
    <div className="rounded-lg border bg-white">
      <div className="border-b p-3 text-sm font-semibold text-slate-700">Artifacts</div>
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border bg-white p-4 shadow-sm">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            <button className="rounded border px-2 py-1 text-sm hover:bg-slate-50">Pause</button>
            <button className="rounded border px-2 py-1 text-sm hover:bg-slate-50">Cancel</button>
            <button className="rounded border px-2 py-1 text-sm hover:bg-slate-50">Retry</button>
            <Link
