                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsxs("span", {
                              ...
                              children: [issue.trend === "worsening" ? "↗" : "→", " ", issue.trend],
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        ...
                        _jsx("div", {
                          ...
                          children: _jsxs("span", {
                            ...
                            children: [item.trend === "improving" ? "↘" : "→", " ", item.trend],
                          }),
                        }),
                      ],
                    }),
            ...
            children: [
              _jsxs("div", {
                ...
                children: [
                  _jsxs("span", {
                    className: "text-sm text-slate-600",
                    children: ["Policy Denials (", compliance.policyDenials.window, ")"],
                  }),
                  _jsxs("div", {
                    className: "flex items-center gap-2",
                    children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsxs("span", {
                    className: "text-sm text-slate-600",
                    children: ["Evidence Bundles (", compliance.evidenceBundles.window, ")"],
                  }),
                  _jsxs("div", {
                    className: "flex items-center gap-2",
                    children: [
...
export default function ControlHub() {
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("div", {
        className: "rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 p-4 text-white",
        children: _jsxs("div", {
          className: "flex items-center justify-between",
          children: [
            _jsxs("div", {
