        ...
        <FormControlLabel
          control={
            <Checkbox
              ...
              onChange={(e) => setOptions({ ...options, includeAttestations: e.target.checked })}
            />
          }
      ...
      <Paper sx={{ p: 2, mb: 2, bgcolor: 'grey.50' }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
          <Box>
            ...
            <Typography variant="body2" fontFamily="monospace">{runId}</Typography>
          </Box>
          {nodeId && (
            <Box>
              <Typography variant="subtitle2">Node ID:</Typography>
              <Typography variant="body2" fontFamily="monospace">{nodeId}</Typography>
            </Box>
          )}
          <Box>
      ...
      {exportResult && (
        <>
              ...
              <List dense>
                <ListItem>
                  ...
                  <ListItemText 
                    ...
                    secondary={verification.verification.checks.hashMatch ? 'Content verified' : 'Hash mismatch'} 
                  />
                </ListItem>
                ...
                <ListItem>
                  ...
                  <ListItemText 
                    ...
                    secondary={verification.verification.checks.signatureValid ? 'Signature valid' : 'Signature invalid'} 
                  />
                </ListItem>
                ...
                <ListItem>
                  ...
                  <ListItemText 
                    primary="Timestamp" 
                    secondary={verification.verification.checks.timestampValid ? 'Within valid range' : 'Timestamp invalid'} 
                  />
                </ListItem>
              </List>
          ...
          <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
            ...
            <Button
              variant="outlined"
              onClick={() => window.open(`/api/maestro/v1/evidence/${exportResult.evidenceId}/artifacts`, '_blank')}
    ...
    >
      <DialogTitle>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          {runId && (
            <Chip label={`Run ${runId}`} size="small" />
          )}
        </Box>
      </DialogTitle>
