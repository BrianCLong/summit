...
const CICD_1 = __importDefault(require("../../pages/CICD"));
test('renders CI trend chart area', async () => {
    ...
    (0, react_2.render)(<CICD_1.default />);
    expect(await react_2.screen.findByText(/CI annotations trend/)).toBeInTheDocument();
});
