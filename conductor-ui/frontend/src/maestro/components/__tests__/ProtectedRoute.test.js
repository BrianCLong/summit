...
describe('ProtectedRoute', () => {
    ...
    it('renders loading state when authentication is in progress', () => {
        ...
        render(_jsx(BrowserRouter, { children: _jsx(ProtectedRoute, { children: _jsx(TestPage, {}) }) }));
    ...
    it('renders 403 for role-denied access', () => {
        ...
        render(_jsx(BrowserRouter, { children: _jsx(ProtectedRoute, { roles: ['admin'], children: _jsx(TestPage, {}) }) }));
    ...
    it('renders fallback component for role-denied access if provided', () => {
        ...
        render(_jsx(BrowserRouter, { children: _jsx(ProtectedRoute, { roles: ['admin'], fallback: Fallback403, children: _jsx(TestPage, {}) }) }));
    ...
    it('renders 403 for tenant-denied access', () => {
        ...
        render(_jsx(BrowserRouter, { children: _jsx(ProtectedRoute, { tenant: "tenantB", children: _jsx(TestPage, {}) }) }));
    ...
    it('renders fallback component for tenant-denied access if provided', () => {
        ...
        render(_jsx(BrowserRouter, { children: _jsx(ProtectedRoute, { tenant: "tenantB", fallback: Fallback403, children: _jsx(TestPage, {}) }) }));
        expect(screen.getByText('403 Forbidden')).toBeInTheDocument();
