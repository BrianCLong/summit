    ...
    _jsxs(Grid, {
      ...
      children: [
        _jsx(Grid, {
          ...
          sm: 6,
          md: 3,
          children: renderMetricCard("Queue Depth", "queueDepth", "number", "#8884d8"),
        }),
        _jsx(Grid, {
          item: true,
          xs: 12,
          sm: 6,
          md: 3,
          children: renderMetricCard("Batch Size", "batchSize", "number", "#82ca9d"),
        }),
        _jsx(Grid, {
          item: true,
          xs: 12,
        ...
        _jsx(Grid, {
          ...
          sm: 6,
          md: 3,
          children: renderMetricCard("P95 Latency", "p95Latency", "latency", "#ff7c7c"),
        }),
        _jsx(Grid, {
          item: true,
          xs: 12,
                            ...
                            _jsxs(Box, {
                              ...
                              children: [
                                _jsxs(Typography, {
                                  variant: "body2",
                                  gutterBottom: true,
                                  children: ["Utilization: ", backend.utilization.toFixed(1), "%"],
                                }),
                                _jsx(LinearProgress, {
                                  variant: "determinate",
  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      _jsxs(Tabs, {
        ...
        sx: { mb: 3 },
        children: [_jsx(Tab, { label: "Overview" }), _jsx(Tab, { label: "Backend Details" })],
      }),
