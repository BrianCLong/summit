              ...
              children: [
                ...
                plan &&
                  _jsxs('div', {
                    className: 'text-sm',
                    children: [
                      _jsx('div', { className: 'mb-2 text-slate-700', children: 'Changes' }),
                      _jsx('ul', {
                        ...
                        children: (plan.changes || []).map((c, i) =>
                          _jsxs(
                            'li',
                            {
                              children: [c.type, ' ', c.path, ': ', c.before, ' \u2192 ', c.after],
                            },
                            i,
                          ),
                        ),
                      ...
                      _jsxs('div', {
                        ...
                        children: ['Cost delta: $', plan.costEstimate?.delta ?? 0],
                      }),
                    ],
                  }),
              ],
            ...
            plan?.explain &&
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('br', {}),
                  'Rule: ',
                  _jsx('span', { className: 'font-mono', children: plan.explain.rulePath }),
                  _jsx('br', {}),
                  'Reasons: ',
        ...
        _jsxs('div', {
          ...
          children: [
            _jsxs('section', {
              ...
              children: [
                _jsx('div', { className: 'text-sm font-medium', children: 'Eval baselines' }),
                _jsxs('div', {
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx(GrafanaPanel, {
                  uid: window.__MAESTRO_CFG__?.grafanaDashboards?.slo || 'maestro-slo',
                  vars: { pipeline: pipelineIdOrName },
                }),
                _jsx(GrafanaPanel, {
                  uid: window.__MAESTRO_CFG__?.grafanaDashboards?.overview || 'maestro-overview',
                  vars: { pipeline: pipelineIdOrName },
                }),
                _jsx(GrafanaPanel, {
                  uid: window.__MAESTRO_CFG__?.grafanaDashboards?.cost || 'maestro-cost',
                  vars: { pipeline: pipelineIdOrName },
                }),
              ],
            }),
