...
import { Paper, Typography, Box, CircularProgress, Grid, Chip, Button } from "@mui/material";
      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Paper sx={{ p: 3 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={3}>
                <Typography color="textSecondary">Pipeline</Typography>
                <Typography>{run.pipeline}</Typography>
              </Grid>
              <Grid item xs={3}>
              ...
              <Grid item xs={3}>
                ...
                <Typography>{run.duration_ms}ms</Typography>
              </Grid>
              <Grid item xs={3}>
                <Typography color="textSecondary">Cost</Typography>
                <Typography>${run.cost?.toFixed(4)}</Typography>
              </Grid>
            </Grid>
          </Paper>
        </Grid>
        ...
        <Grid item xs={12}>
          <Paper sx={{ p: 3, minHeight: 400 }}>
            ...
            {graph ? <SimpleDAG graph={graph} /> : <Typography>No graph data available</Typography>}
          </Paper>
        </Grid>
      </Grid>
    </Box>
      ...
      {nodes.map((n) => (
        <g key={n.id} transform={`translate(${n.x},${n.y})`}>
          <circle
            r="30"
            fill={
              n.status === "success" ? "#e8f5e9" : n.status === "running" ? "#e3f2fd" : "#f5f5f5"
            }
            stroke={n.status === "success" ? "green" : "blue"}
          />
