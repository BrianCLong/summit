          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                ...
                _jsxs('div', {
                  ...
                  children: [
                    'signature: ',
                    _jsx('code', { children: res.normalizedSignature }),
                  ],
                }),
              ],
            }),
            _jsxs('ul', {
              ...
              children: [
                ...
                _jsxs('li', {
                  children: ['kind allowed: ', String(res.passKind)],
                }),
                _jsxs('li', {
                  children: ['signature allowed: ', String(res.passSig)],
                }),
                _jsxs('li', {
                  children: ['rate limited: ', String(res.rateLimited)],
                }),
              ],
            }),
            res.reasons?.length
