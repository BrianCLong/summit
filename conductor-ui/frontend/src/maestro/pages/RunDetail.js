    ...
    children: [
      _jsxs('div', {
        ...
        children: [
              ...
              _jsxs('div', {
                ...
                children: [
                  ...
                  run?.ghRunUrl &&
                    _jsx('a', {
                      className:
                        'rounded border px-2 py-1 text-sm text-indigo-700',
                      href: run.ghRunUrl,
                      target: '_blank',
                      rel: 'noreferrer',
                  ...
                  run?.traceId &&
                    _jsx('a', {
                      className:
                        'rounded border px-2 py-1 text-sm text-blue-600',
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              ...
                              nodeEvidence?.traceId &&
                                ...
                                _jsx('a', {
                                  className:
                                    'rounded border px-2 py-1 text-xs text-blue-600',
            ...
            _jsxs('section', {
              ...
              children: [
                ...
                error &&
                  _jsx('div', {
                    className:
                      'bg-red-50 border-b border-red-200 p-2 text-sm text-red-800',
                    children: _jsxs('div', {
                    ...
                    lines
                      .filter(
                        (l) =>
                          ...
                          (!traceFilter ||
                            l.includes(`traceId=${traceFilter}`)),
                      ) // Added traceFilter
                      .map((logLine, i) =>
                        _jsxs(
                          'div',
          ...
          tab === 'Artifacts' &&
            _jsxs('section', {
              ...
              children: [
                _jsx('div', {
                  className:
                    'border-b p-2 text-sm font-semibold text-slate-700',
                  children: 'Artifacts',
                }),
                _jsxs('table', {
                  className: 'w-full text-sm',
          ...
          tab === 'Evidence' &&
            _jsx(RunEvidence, { runId: id, getRunEvidence: getRunEvidence }),
          tab === 'Policies' &&
            _jsxs('div', {
                        ...
                        _jsx('ul', {
                          ...
                          children: (cmp.changedNodes || []).map((n, i) =>
                            _jsxs(
                              'li',
                              {
                                children: [n.id, ': ', n.durationDeltaMs, 'ms'],
                              },
                              i,
                            ),
                          ),
            ...
            children: [
              ...
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('button', {
                    className:
                      'rounded bg-indigo-600 px-3 py-1.5 text-sm text-white',
                    onClick: async () => {
                      try {
              ...
              _jsxs('div', {
                ...
                children: [
                  ...
                  ev?.sbom?.href &&
                    _jsx('a', {
                      className:
                        'rounded border px-2 py-1 text-xs text-blue-600 underline',
                      href: ev.sbom.href,
                      target: '_blank',
                      rel: 'noreferrer',
                      children: 'Open SBOM',
