...
exports.useSLO = exports.sloManager = exports.SLOManager = exports.AlertSeverity = exports.SLIType = void 0;
...
})(SLIType || (exports.SLIType = SLIType = {}));
var AlertSeverity;
...
class SLOManager {
    ...
    async generateSLOReport(sloIds, timeRange) {
        ...
        const reports = await Promise.all(slos.map(async (slo) => {
...
exports.sloManager = new SLOManager();
// React hook for SLO management
const useSLO = () => {
    const [slos, setSLOs] = react_1.default.useState([]);
    const [loading, setLoading] = react_1.default.useState(false);
    const [error, setError] = react_1.default.useState(null);
    const fetchSLOs = react_1.default.useCallback(async (filters) => {
        setLoading(true);
        setError(null);
        try {
            const fetchedSLOs = await exports.sloManager.getSLOs(filters);
            setSLOs(fetchedSLOs);
        }
        catch (err) {
    ...
    const createSLO = react_1.default.useCallback(async (sloData) => {
        try {
            const newSLO = await exports.sloManager.createSLO(sloData);
    ...
    const updateSLO = react_1.default.useCallback(async (id, updates) => {
        try {
            const updatedSLO = await exports.sloManager.updateSLO(id, updates);
    ...
    const deleteSLO = react_1.default.useCallback(async (id) => {
        try {
            await exports.sloManager.deleteSLO(id);
    ...
    return {
        ...
        updateSLO,
        deleteSLO,
        calculateSLI: exports.sloManager.calculateSLI.bind(exports.sloManager),
        generateReport: exports.sloManager.generateSLOReport.bind(exports.sloManager),
    };
};
exports.useSLO = useSLO;
