...
exports.validateSecretStrength = exports.sanitizeLogs = exports.createSecureCopy = exports.maskSecret = exports.containsSensitive = exports.redactSensitive = void 0;
 ...
 */
const redactSensitive = (text, options = {}) => {
 ...
 */
const maskSecret = (secret, options = {}) => {
 ...
 */
const createSecureCopy = (value, onCopy) => {
    return async () => {
        if ((0, exports.containsSensitive)(value)) {
...
exports.createSecureCopy = createSecureCopy;
/**
 * Sanitizes logs and error messages for display
 */
const sanitizeLogs = (logs) => {
    return logs.map((log) => (0, exports.redactSensitive)(log, { showFirst: 2, showLast: 2 }));
};
