...
export const createLazyComponent = (importFn, fallback) => {
    ...
    return (props) => React.createElement(React.Suspense, { fallback: fallback ? React.createElement(fallback) : React.createElement('div', null, 'Loading...') }, React.createElement(LazyComponent, props));
};
