...
export type Budget = {
  ...
  budgets: { [key: string]: { spent_usd: number; daily_budget_usd: number; fraction_used: number; resets_at: string; }; };
};
...
export type Evidence = {
  ...
  nodes: { nodeId: string; sbom: { present: boolean; url?: string | null; }; cosign: { present: boolean; verified?: boolean; url?: string | null; }; slsa: { present: boolean; level?: string | null; url?: string | null; }; }[];
};
