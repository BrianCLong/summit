  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx('header', {
        ...
        children: _jsxs('div', {
          className: 'mx-auto flex max-w-screen-2xl items-center justify-between px-4 py-3',
          children: [
            _jsxs('div', {
              className: 'flex items-center gap-3',
              children: [
                _jsx('div', { className: 'h-8 w-8 rounded bg-indigo-600', 'aria-hidden': true }),
                _jsxs('div', {
                  children: [
                    _jsx('div', {
                      className: 'text-sm font-semibold tracking-wide text-slate-700',
                      children: 'Maestro builds IntelGraph',
                    }),
                    _jsx('div', {
                      className: 'text-xs text-slate-500',
                      children: 'Maestro \u2260 IntelGraph \u2014 Control Plane',
                    }),
                  ],
                }),
              ],
      ...
      _jsxs('div', {
        className: 'mx-auto grid max-w-screen-2xl grid-cols-[250px_1fr] gap-0 px-4',
        children: [
          _jsxs('nav', {
            className:
      ...
      _jsx(CommandPalette, { open: paletteOpen, onClose: () => setPaletteOpen(false) }),
    ],
  });
}
      ...
      _jsx(Card, {
        ...
        children: _jsxs('div', {
          ...
          children: [
            ...
            _jsxs('div', {
              children: [
                _jsx('div', { className: 'text-sm text-slate-600', children: 'Current Level' }),
                _jsxs('div', {
                ...
                _jsxs('div', {
                  className: 'text-xs text-slate-500',
                  children: ['Canary: ', Math.round((data?.autonomy?.canary ?? 0) * 100), '%'],
                }),
              ],
            }),
          ],
            ...
            _jsxs('li', {
              children: [
                ...
                _jsxs('span', {
                  ...
                  children: [Math.round((data?.health?.success ?? 0) * 100), '%'],
                }),
              ],
            }),
            _jsxs('li', {
                ...
                .map((r) =>
                  _jsxs(
                    'div',
                    {
                      ...
                      children: [
                        _jsx('span', { className: 'font-mono text-xs', children: r.id }),
                        _jsx('span', {
          ...
          children: data?.changes
            ...
            .map((c, i) =>
              _jsxs(
                'div',
                {
                  className: 'grid grid-cols-[140px_1fr] gap-3 border-b py-2 last:border-0',
                  children: [
                    _jsx('span', { className: 'font-mono text-xs text-slate-500', children: c.at }),
                    _jsxs('div', {
                      children: [
                        _jsx('div', { className: 'text-slate-800', children: c.title }),
                        _jsx('div', { className: 'text-xs text-slate-500', children: c.by }),
                      ],
                    }),
                  ],
                },
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('h2', { className: 'text-lg font-semibold', children: 'Runs' }),
          _jsx('button', {
        ...
        children: _jsxs('table', {
          ...
          children: [
            _jsx('thead', {
              ...
              children: _jsxs('tr', {
                children: [
                  _jsx('th', { className: 'px-3 py-2 font-medium', children: 'Run ID' }),
                  _jsx('th', { className: 'px-3 py-2 font-medium', children: 'Pipeline' }),
                  _jsx('th', { className: 'px-3 py-2 font-medium', children: 'Status' }),
                  _jsx('th', { className: 'px-3 py-2 font-medium', children: 'Duration' }),
                  _jsx('th', { className: 'px-3 py-2 font-medium', children: 'Cost' }),
                ],
              }),
            }),
            _jsx('tbody', {
                    ...
                    children: [
                      _jsx('td', {
                        ...
                        children: _jsx(Link, {
                          ...
                          to: `/maestro/runs/${r.id}`,
                          children: r.id,
                        }),
                      }),
                      _jsx('td', { className: 'px-3 py-2', children: r.pipeline }),
                      _jsx('td', {
                        className: 'px-3 py-2',
                        children: _jsx('span', {
                          className: 'rounded bg-slate-100 px-2 py-0.5 text-xs',
                      ...
                      _jsxs('td', { className: 'px-3 py-2', children: [r.durationMs, ' ms'] }),
                      _jsxs('td', { className: 'px-3 py-2', children: ['$', r.cost] }),
                    ],
                  },
                  r.id,
                ),
...
function Autonomy() {
  ...
  return _jsxs('div', {
    className: 'space-y-3',
    children: [
      _jsx('h2', { className: 'text-lg font-semibold', children: 'Autonomy & Guardrails' }),
      _jsx(Card, {
        title: 'Level',
        children: _jsx('div', {
            ...
            _jsxs(
              'li',
              {
                ...
                children: [
                  ...
                  _jsx('span', { className: 'text-xs text-slate-500', children: p.state }),
                ],
              },
              i,
            ),
      ...
      _jsxs(Card, {
        ...
        children: [
          error && _jsx('div', { className: 'mb-2 text-sm text-red-700', children: error }),
          !decision &&
            _jsx('div', {
              className: 'text-sm text-slate-600',
              children: 'Simulation preview coming from backend policy engine\u2026',
            }),
          decision &&
            _jsxs('div', {
...
function Recipes() {
  ...
  return _jsxs('div', {
    className: 'space-y-3',
    children: [
      _jsx('h2', { className: 'text-lg font-semibold', children: 'Recipe Library' }),
      _jsx('div', {
        ...
        children: data?.map((r) =>
          _jsxs(
            Card,
            {
              title: r.name,
              children: [
                _jsxs('div', { className: 'text-xs text-slate-500', children: ['v', r.version] }),
                _jsxs('div', {
...
function Observability() {
  ...
  return _jsxs('div', {
    className: 'space-y-3',
    children: [
      _jsx('h2', { className: 'text-lg font-semibold', children: 'Observability & SLOs' }),
      _jsx('div', {
        ...
        children: _jsxs('ul', {
          ...
          children: [
            _jsxs('li', {
              children: [
                'Latency p95: ',
                _jsxs('span', { className: 'font-semibold', children: [data?.latencyP95, ' ms'] }),
              ],
            }),
            _jsxs('li', {
              children: [
                'Error rate: ',
                _jsxs('span', { className: 'font-semibold', children: [data?.errorRate, '%'] }),
              ],
            }),
            _jsxs('li', {
              children: [
                'Throughput: ',
                _jsxs('span', { className: 'font-semibold', children: [data?.throughput, '/min'] }),
              ],
            }),
            _jsxs('li', {
              children: [
                'Queue depth: ',
                _jsx('span', { className: 'font-semibold', children: data?.queueDepth }),
              ],
            }),
          ],
        }),
      ...
      tab !== 'SLOs' &&
        _jsx(Card, {
          ...
          children: _jsxs('div', {
            className: 'text-sm text-slate-600',
            children: ['Use the top-right SLO panel link and switch dashboards to ', tab, '.'],
          }),
        }),
    ],
  });
...
function Cost() {
  ...
  return _jsxs('div', {
    className: 'space-y-3',
    children: [
      _jsx('h2', { className: 'text-lg font-semibold', children: 'Costs & Budgets' }),
      _jsx(Card, {
        title: 'Spend',
        children: _jsxs('div', {
          className: 'text-sm text-slate-700',
          children: ['Today: $', data?.today, ' \u2022 This week: $', data?.week],
        }),
      }),
      _jsxs(Card, {
        title: 'Budgets',
        children: [
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx('label', { className: 'text-slate-600', htmlFor: 'cap', children: 'Edit cap' }),
              _jsx('input', {
                id: 'cap',
              ...
              msg && _jsx('span', { className: 'text-xs text-slate-500', children: msg }),
            ],
          }),
        ],
      }),
...
function Tickets() {
  ...
  return _jsxs('div', {
    className: 'space-y-3',
    children: [
      _jsx('h2', { className: 'text-lg font-semibold', children: 'Tickets / Issues / Projects' }),
      _jsx('div', {
        className: 'overflow-hidden rounded-lg border bg-white',
        children: _jsxs('table', {
          className: 'w-full text-sm',
          children: [
            _jsx('thead', {
              ...
              children: _jsxs('tr', {
                children: [
                  _jsx('th', { className: 'px-3 py-2 font-medium', children: 'Issue' }),
                  _jsx('th', { className: 'px-3 py-2 font-medium', children: 'Status' }),
                  _jsx('th', { className: 'px-3 py-2 font-medium', children: 'Owner' }),
                  _jsx('th', { className: 'px-3 py-2 font-medium', children: 'Linked Run' }),
                ],
              }),
            }),
            _jsx('tbody', {
              children: data?.map((t) =>
                _jsxs(
                  'tr',
                  {
                    className: 'border-t hover:bg-slate-50',
                    children: [
                      _jsx('td', { className: 'px-3 py-2 font-mono text-xs', children: t.id }),
                      _jsx('td', { className: 'px-3 py-2', children: t.status }),
...
function Admin() {
  return _jsxs('div', {
    className: 'space-y-3',
    children: [
      _jsx('h2', { className: 'text-lg font-semibold', children: 'Admin Studio' }),
      _jsx(Card, {
        title: 'Registry',
        children: _jsx('div', {
          className: 'text-sm text-slate-600',
  ...
  return _jsx(AuthProvider, {
    children: _jsx(BrowserRouter, {
      ...
      children: _jsxs(Routes, {
        children: [
          _jsx(Route, { path: '/auth/callback', element: _jsx(AuthCallback, {}) }),
              ...
              children: _jsx(Shell, {
                children: _jsxs(Routes, {
                  children: [
                    ...
                    _jsx(Route, { path: '/runs/:id', element: _jsx(RunDetail, {}) }),
                    _jsx(Route, { path: '/runs/:id/compare', element: _jsx(CompareRun, {}) }),
                    _jsx(Route, { path: '/pipelines', element: _jsx(Pipelines, {}) }),
                    _jsx(Route, { path: '/pipelines/:id', element: _jsx(PipelineDetail, {}) }),
                    _jsx(Route, {
                      path: '/autonomy',
                      element: _jsx(ProtectedRoute, {
                        roles: ['operator'],
                    ...
                    _jsx(Route, { path: '/recipes', element: _jsx(Recipes, {}) }),
                    _jsx(Route, { path: '/observability', element: _jsx(Observability, {}) }),
                    _jsx(Route, {
                    ...
                    _jsx(Route, { path: '/ops/dlq/signatures', element: _jsx(DLQSignatures, {}) }),
                    _jsx(Route, {
                      path: '/ops/dlq/policy',
                      element: _jsx(ProtectedRoute, {
                        roles: ['operator'],
                    ...
                    _jsx(Route, {
                      ...
                      element: _jsx(ProtectedRoute, {
                        roles: ['operator'],
                        children: React.createElement(require('./pages/DLQSimulator').default),
                      }),
                    }),
                    _jsx(Route, { path: '/alertcenter', element: _jsx(AlertCenter, {}) }),
                    _jsx(Route, {
                    ...
                    _jsx(Route, { path: '/tickets', element: _jsx(Tickets, {}) }),
                    _jsx(Route, {
                      path: '/admin',
                      element: _jsx(ProtectedRoute, {
                        roles: ['admin'],
      ...
      : _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsx('div', { className: 'text-xs text-slate-500', children: 'Queue depth' }),
                _jsx('div', {
                  className: 'text-2xl font-semibold',
            ...
            _jsxs('div', {
              className: 'rounded border p-2',
              children: [
                _jsx('div', { className: 'text-xs text-slate-500', children: 'Batch size' }),
                _jsx('div', {
                  className: 'text-2xl font-semibold',
            ...
            _jsxs('div', {
              className: 'rounded border p-2',
              children: [
                _jsx('div', { className: 'text-xs text-slate-500', children: 'KV hit ratio' }),
                _jsxs('div', {
                  className: 'text-2xl font-semibold',
