    ...
    <div className="analyst-assist min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6">
        <header className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Analyst Assist v0.2</h1>
            ...
            <div className="help-content space-y-4">
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                  <li>Build complex queries using field, operator, and value conditions</li>
                  <li>Add multiple conditions to refine your search</li>
                  <li>Preview how OPA policies will affect your export before executing</li>
                  <li>View "Why blocked?" explanations when policies deny access</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                  <li>Choose from multiple export formats (JSON, CSV, GraphML, PDF)</li>
              ...
              <section>
                <h3 className="text-lg font-semibold mb-2">Policy Explanations</h3>
                <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
              ...
              <section className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded">
                <h3 className="text-lg font-semibold mb-2 text-blue-800">Acceptance Criteria</h3>
                <div className="space-y-2 text-sm text-blue-700">
                  <div>✅ Query builder UX implemented</div>
                  <div>✅ "Why blocked?" explanations wired to policy outcomes</div>
        ...
        <footer className="mt-6 text-center text-sm text-gray-500">
          ...
          <p className="mt-1">All actions are subject to OPA policy evaluation and audit logging</p>
        </footer>
      </div>
    </div>
  );
