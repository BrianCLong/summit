...
exports.EvidenceExportButton = void 0;
...
const EvidenceExportButton = ({ runId }) => {
    ...
    return (<button onClick={handleClick} disabled={isExporting}>
      {isExporting ? 'Exporting...' : 'Export Evidence Bundle v0.2'}
    </button>);
};
exports.EvidenceExportButton = EvidenceExportButton;
