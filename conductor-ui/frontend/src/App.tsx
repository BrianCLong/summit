    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div className="lg:col-span-2">
        <Card title="Run Result">
          {!res ? (
            <div className="text-sm text-gray-500">Execute to see results.</div>
          ) : res.error ? (
            <div className="text-sm text-red-600">{String(res.error)}</div>
          ) : (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <Card title="Answer">
        {!ans ? (
          ...
          <div className="text-sm text-red-600">{String(ans.error)}</div>
        ) : (
          <div>
            {ans._no_rag && (
...
function Logs({ store }) {
  ...
  return (
    ...
    >
      {store.ENV.PROXY_BASE ? (
        <pre className="text-xs whitespace-pre-wrap min-h-[240px]">
