...
class IdempotentLoader:
    ...
    async def load_entities_idempotent(self, 
                                     entities: List[Dict[str, Any]],
                                     batch_size: int = 100,
                                     merge_strategy: Optional[MergeStrategy] = None) -> LoadResult:
        """
    ...
    async def _load_entity_batch(self, entities: List[Dict[str, Any]], merge_strategy: MergeStrategy) -> LoadResult:
    ...
    async def _load_single_entity(self, session, entity: Dict[str, Any], merge_strategy: MergeStrategy) -> str:
        ...
        merged_entity = await self._apply_merge_strategy(
            existing_entity, entity, merge_strategy
        )
    ...
    async def _get_existing_entity(self, session, entity_id: str, entity_type: str) -> Optional[Dict[str, Any]]:
    ...
    async def _update_entity(self, session, entity_id: str, entity_type: str, merged_entity: Dict[str, Any], content_hash: str):
    ...
    async def _apply_merge_strategy(self, existing: Dict[str, Any], new: Dict[str, Any], strategy: MergeStrategy) -> Dict[str, Any]:
    ...
    async def load_relationships_idempotent(self, 
                                          relationships: List[Dict[str, Any]],
                                          batch_size: int = 100) -> LoadResult:
    ...
    async def _load_relationship_batch(self, session, relationships: List[Dict[str, Any]], result: LoadResult):
    ...
    async def _get_existing_relationship(self, session, rel_id: str, rel_type: str) -> Optional[Dict[str, Any]]:
