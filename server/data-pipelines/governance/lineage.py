...
try:
    ...
    from openlineage.client.event import RunEvent, RunState, EventType
...
class LineageTracker:
    ...
    def add_column_lineage(self,
        ...
        self.logger.debug(f"Added column lineage {source_dataset}.{source_column} -> {target_dataset}.{target_column}")
...
class ProvenanceManager:
    ...
    def add_provenance_to_entity(self,
                                entity: Dict[str, Any],
                                source: str,
                                run_id: str,
                                mapping_version: str,
                                source_record_hash: Optional[str] = None) -> Dict[str, Any]:
    ...
    def add_provenance_to_relationship(self,
                                     relationship: Dict[str, Any],
                                     source: str,
                                     run_id: str,
                                     confidence: float = 1.0,
                                     inference_method: Optional[str] = None) -> Dict[str, Any]:
...
class LineageCatalog:
    ...
    def get_downstream_lineage(self, dataset_name: str, max_depth: int = 10) -> List[Dict[str, Any]]:
...
def track_connector_lineage(lineage_tracker: LineageTracker,
                           run_id: str,
                           connector_name: str,
...
def track_transformation_lineage(lineage_tracker: LineageTracker,
                               run_id: str,
