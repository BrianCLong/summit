...
const rollback_engine_js_1 = require("./rollback-engine.js");
...
class CanaryOrchestrator {
    ...
    _monitoringService = mockMonitoringService;
    _loadBalancer = mockLoadBalancer;
    constructor(config, rollbackEngine) {
        this.config = config;
        this.rollbackEngine = rollbackEngine || new rollback_engine_js_1.RollbackEngine();
    }
    async start() {
