...
exports.pickOwner = pickOwner;
exports.suggestOwnersForFile = suggestOwnersForFile;
/**
 ...
 */
function suggestOwnersForFile(filePath) {
    const suggestions = [];
