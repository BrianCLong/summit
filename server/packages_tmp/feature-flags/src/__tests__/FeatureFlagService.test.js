...
describe('FeatureFlagService', () => {
    ...
    beforeEach(async () => {
        ...
        service = new FeatureFlagService_1.FeatureFlagService({
            provider,
            enableCache: false,
    ...
    describe('events', () => {
        it('should emit ready event', (done) => {
            ...
            const newService = new FeatureFlagService_1.FeatureFlagService({ provider: newProvider });
            newService.on('ready', () => {
        ...
        it('should emit evaluation event', (done) => {
            ...
            const analyticsService = new FeatureFlagService_1.FeatureFlagService({
                provider,
