...
const GraphAnalyticsService_js_1 = require("../src/services/GraphAnalyticsService.js");
// Define the mock delay and delay function
const MOCK_DB_DELAY_MS = 10;
const delay = (ms) => new Promise(resolve => setTimeout(resolve, ms));
// Testable subclass
class TestableGraphAnalyticsService extends GraphAnalyticsService_js_1.Neo4jGraphAnalyticsService {
    setMocks(mockGetDriver, mockRunCypher) {
        this.deps = {
