...
class LinkPredictor(nn.Module):
    ...
    def predict_links(self, node_embeddings: torch.Tensor, node_pairs: torch.Tensor) -> torch.Tensor:
        """
...
class IntelGraphLinkPredictor:
            ...
            for i, (from_idx, to_idx) in enumerate(candidate_pairs):
                ...
                if confidence >= threshold:
                    ...
                    predictions.append({
                        ...
                        'reasoning': f"GNN prediction based on graph structure",
                        'type': 'predicted_link'
                    })
    ...
    def _generate_candidate_pairs(
        ...
        if target_entities:
            target_indices = [self.entity_to_idx[eid] for eid in target_entities 
...
def create_link_predictor(model_path: Optional[str] = None, device: str = "cpu") -> IntelGraphLinkPredictor:
    """
