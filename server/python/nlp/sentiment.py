...
class SentimentAnalyzer:
    ...
    def analyze_entity_content(self, entity_data: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "summary": self._generate_summary(
                field_sentiments, overall_sentiment, overall_confidence
            ),
    ...
    def _calculate_ideology_score(self, text: str, ideology_terms: dict[str, list[str]]) -> float:
    ...
    def _generate_summary(
        self, field_sentiments: dict, overall_sentiment: str, overall_confidence: float
    ) -> str:
        ...
        return (
            f"Analyzed {num_fields} text field(s). "
...
if __name__ == "__main__":
    ...
    # Test single text
    test_text = (
        "This is a really great product! I love how it works and would definitely recommend it."
    )
    ...
    print(
        f"Overall: {entity_result['overall_sentiment']} (confidence: {entity_result['overall_confidence']:.3f})"
    )
