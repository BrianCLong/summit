...
describe('EntityRepo Performance', () => {
    ...
    beforeAll(() => {
        ...
        // @ts-ignore
        repo = new EntityRepo_js_1.EntityRepo(pool, null);
    });
    afterAll(async () => {
        await pool.end();
    });
    ...
    it('should execute search queries within an acceptable timeframe', async () => {
        ...
        try {
            ...
            for (const entity of entities) {
                await client.query('INSERT INTO entities (tenant_id, kind, props) VALUES ($1, $2, $3)', [entity.tenantId, entity.kind, entity.props]);
            }
