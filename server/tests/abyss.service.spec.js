...
const AbyssService_js_1 = require("../src/abyss/AbyssService.js");
describe('AbyssService', () => {
    let abyssService;
    beforeEach(() => {
        abyssService = new AbyssService_js_1.AbyssService();
    });
    ...
    it('should throw an error if armed when not in a dormant state', async () => {
        ...
        await expect(abyssService.armFinalProtocol()).rejects.toThrow('The Abyss Protocol can only be armed from a dormant state. Current state: armed');
    });
