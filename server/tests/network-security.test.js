...
const NetworkSecurityService_js_1 = require("../src/services/NetworkSecurityService.js");
describe('NetworkSecurityService', () => {
    let service;
    beforeEach(() => {
        // Reset singleton (simulated) or just get instance
        service = NetworkSecurityService_js_1.NetworkSecurityService.getInstance();
