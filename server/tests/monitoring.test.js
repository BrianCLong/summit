...
describe('Monitoring Endpoints', () => {
  ...
  describe('Health Check Endpoints', () => {
    ...
    it('should provide readiness probe', async () => {
      const response = await request(app).get('/health/ready').timeout(10000);
  ...
  describe('Individual Service Health Checks', () => {
    it('should check database health', async () => {
      const response = await request(app).get('/health/database').timeout(10000);
    ...
    it('should check Neo4j health', async () => {
      const response = await request(app).get('/health/neo4j').timeout(10000);
    ...
    it('should check Redis health', async () => {
      const response = await request(app).get('/health/redis').timeout(10000);
    ...
    it('should check ML service health', async () => {
      const response = await request(app).get('/health/ml').timeout(10000);
  ...
  describe('Performance', () => {
    ...
    it('should cache health status for quick responses', async () => {
      ...
      await request(app).get('/health/quick').timeout(10000);
...
describe('Health Check Components', () => {
  const { checkDatabase, checkRedis, checkSystemResources } = require('../src/monitoring/health');
