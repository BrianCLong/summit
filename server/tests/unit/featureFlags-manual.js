...
const featureFlags_1 = require("../../src/config/featureFlags");
...
function resetInstance() {
    featureFlags_1.FeatureFlags.instance = undefined;
}
// Test 1: Defaults
resetInstance();
const flags1 = featureFlags_1.FeatureFlags.getInstance();
...
const flags2 = featureFlags_1.FeatureFlags.getInstance();
...
const flags3 = featureFlags_1.FeatureFlags.getInstance();
...
const flags4 = featureFlags_1.FeatureFlags.getInstance();
...
resetInstance();
const flags5 = featureFlags_1.FeatureFlags.getInstance();
