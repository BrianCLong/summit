...
exports.createTestEntity = exports.createTestCase = exports.createTestUser = void 0;
const pg_1 = require("pg");
const testTenants_js_1 = require("./helpers/testTenants.js");
const resolvedMock = (value) => jest.fn(async () => value);
const returnedMock = (value) => jest.fn(() => value);
...
beforeAll(async () => {
    ...
    await (0, testTenants_js_1.seedTestTenants)();
});
afterAll(async () => {
    ...
    await (0, testTenants_js_1.teardownTestTenants)();
});
beforeEach(() => {
