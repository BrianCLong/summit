...
const encryption_service_1 = require("../../../src/crypto/encryption.service");
describe('DC1.1 - Data Protection - Data Encryption', () => {
    test('should encrypt sensitive data at rest', async () => {
        ...
        const encryptedResult = await (0, encryption_service_1.encryptData)(JSON.stringify(originalData));
    ...
    test('should decrypt encrypted data properly', async () => {
        ...
        const encryptedResult = await (0, encryption_service_1.encryptData)(originalData);
        // Decrypt the data
        const decryptedResult = await (0, encryption_service_1.decryptData)(encryptedResult.encryptedData, encryptedResult.iv, encryptedResult.authTag // For GCM mode
        );
    ...
    test('should enforce encryption key rotation policy', async () => {
        ...
        const encryptedWithLatest = await (0, encryption_service_1.encryptData)(testData);
        ...
        const decrypted = await (0, encryption_service_1.decryptData)(encryptedWithLatest.encryptedData, encryptedWithLatest.iv, encryptedWithLatest.authTag);
