...
const config: Config = {
  ...
  moduleNameMapper: {
    ...
    '.*audit/advanced-audit-system(\\.js)?$': '<rootDir>/tests/mocks/advanced-audit-system.ts',
    '.*audit/advanced-audit-system$': '<rootDir>/tests/mocks/advanced-audit-system.ts',
    '.*health/aggregator(\\.js)?$': '<rootDir>/tests/mocks/health-aggregator.ts',
    '.*tests/factories/requestFactory(\\.js)?$': '<rootDir>/tests/mocks/request-factory.ts',
    '.*tests/factories/userFactory(\\.js)?$': '<rootDir>/tests/mocks/user-factory.ts',
    ...
    '.*services/EmbeddingService(\\.js)?$': '<rootDir>/tests/mocks/embedding-service.ts',
    '.*services/SynonymService(\\.js)?$': '<rootDir>/tests/mocks/synonym-service.js',
    ...
    '^redis$': '<rootDir>/tests/mocks/redis.ts',
