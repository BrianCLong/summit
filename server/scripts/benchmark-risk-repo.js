...
const RiskRepository_js_1 = require("../src/db/repositories/RiskRepository.js");
...
async function runBenchmark() {
    ...
    const repo = new RiskRepository_js_1.RiskRepository();
    const LATENCY_MS = 5;
    let queryCount = 0;
    // Mock pg.transaction and tx.query
    pg_js_1.pg.transaction = async (cb) => {
        const tx = {
