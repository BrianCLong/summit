...
async function runBenchmarks() {
    ...
    console.log('\n--- CIS Benchmark ---');
    try {
        const cisResult = await KubeBenchmarkValidator_js_1.kubeBenchmarkValidator.runCisBenchmark();
    ...
    console.log('\n--- NSA/CISA Benchmark ---');
    try {
        const nsaResult = await KubeBenchmarkValidator_js_1.kubeBenchmarkValidator.runNsaBenchmark();
