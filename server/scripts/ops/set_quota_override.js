...
const QuotaOverrideService_js_1 = require("../../src/lib/resources/overrides/QuotaOverrideService.js");
...
async function main() {
    ...
    try {
        await QuotaOverrideService_js_1.quotaOverrideService.setOverride(tenantId, meter, ttlSeconds, reason);
        ...
        await (0, database_js_1.closeRedis)();
        process.exit(0);
    }
}
