...
async function seedData() {
    ...
    try {
        ...
        for (const pipeline of pipelines) {
            ...
            await pool.query('INSERT INTO pipelines (id, name, spec) VALUES ($1, $2, $3) ON CONFLICT DO NOTHING', [id, pipeline.name, JSON.stringify(pipeline.spec)]);
        ...
        for (let i = 0; i < runCount; i++) {
            ...
            const durationMs = status === 'succeeded' || status === 'failed'
