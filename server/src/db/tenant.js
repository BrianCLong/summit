...
exports.queryWithTenantContext = exports.queryForTenant = exports.withTenant = void 0;
/**
 ...
 */
const withTenant = (query, params, tenantId) => {
    if (!tenantId) {
 ...
 */
const queryForTenant = async (pool, tenantId, query, params = []) => {
    const scoped = (0, exports.withTenant)(query, params, tenantId);
    return pool.query(scoped.text, scoped.values);
};
exports.queryForTenant = queryForTenant;
/**
 * Enforce tenant context at the DB boundary.
 */
const queryWithTenantContext = async (pool, context, query, params = []) => {
    if (!context?.tenantId) {
        throw new Error('Tenant context is required for tenant-scoped queries');
    }
    return (0, exports.queryForTenant)(pool, context.tenantId, query, params);
};
exports.queryWithTenantContext = queryWithTenantContext;
