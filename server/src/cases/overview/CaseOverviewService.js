...
exports.CaseOverviewService = void 0;
const CaseOverviewCacheRepo_js_1 = require("../../repos/CaseOverviewCacheRepo.js");
const logger_js_1 = __importDefault(require("../../config/logger.js"));
const overviewLogger = logger_js_1.default.child({ name: 'CaseOverviewService' });
class CaseOverviewService {
    ...
    async buildSnapshot(caseId, tenantId) {
        ...
        const metricsRow = await this.pg.query(`SELECT
        ...
        const { rows: topEntityRows } = await this.pg.query(`SELECT graph_entity_id, entity_label, entity_type, relationship_type, COUNT(*) as count
...
exports.CaseOverviewService = CaseOverviewService;
