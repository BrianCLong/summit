...
class CypherGuard {
     ...
     */
    static enforceInvariants(query, options = { strict: false, defaultLimit: 100 }) {
     ...
     */
    static buildInvariantQuery(baseQuery, returnFields, orderByField, limit) {
...
exports.CypherGuard = CypherGuard;
