...
exports.NarrativeAnalysisService = void 0;
...
class NarrativeAnalysisService {
     ...
     */
    async takeSnapshot(narrativeId) {
    ...
    async getNarrativeEvolution(narrativeId) {
        return this.snapshots.get(narrativeId) || [];
    }
    async detectTrends(narrativeId) {
    ...
    async getNarrativeStats(narrativeId) {
        const cypher = `
      ...
      `;
        ...
        const result = await (0, neo4j_js_1.runCypher)(cypher, { narrativeId });
    ...
    async extractTopTopics(narrativeId) {
    ...
    async calculateAmplificationVelocity(narrativeId) {
    ...
    `;
        const result = await (0, neo4j_js_1.runCypher)(cypher, { narrativeId, oneHourAgo });
        return Number(result[0]?.newNodes || 0);
    }
}
exports.NarrativeAnalysisService = NarrativeAnalysisService;
