...
exports.investigationWorkflowService = exports.InvestigationWorkflowService = void 0;
const events_1 = require("events");
const CacheService_js_1 = require("./CacheService.js");
const index_js_1 = require("../audit/index.js");
class InvestigationWorkflowService extends events_1.EventEmitter {
    ...
    async createInvestigation(templateId, data) {
        ...
        await CacheService_js_1.cacheService.set(`investigation:${investigationId}`, investigation, 3600);
        // Audit Log
    ...
    async getInvestigation(investigationId, tenantId) {
        ...
        if (!investigation) {
            ...
            investigation = await CacheService_js_1.cacheService.get(`investigation:${investigationId}`);
            if (investigation) {
                this.investigations.set(investigationId, investigation);
            }
        }
...
exports.InvestigationWorkflowService = InvestigationWorkflowService;
// Global investigation workflow service instance
exports.investigationWorkflowService = new InvestigationWorkflowService();
