...
exports.narrativePrioritizer = exports.NarrativePrioritizationService = void 0;
const neo4j_js_1 = require("../db/neo4j.js");
const logger_js_1 = __importDefault(require("../utils/logger.js"));
class NarrativePrioritizationService {
    static instance;
    logger = logger_js_1.default.child({ service: 'NarrativePrioritizationService' });
    constructor() { }
    static getInstance() {
    ...
    async analyzeGraphSignal(entities) {
    ...
    async analyzeHistorySignal(source) {
...
exports.NarrativePrioritizationService = NarrativePrioritizationService;
exports.narrativePrioritizer = NarrativePrioritizationService.getInstance();
