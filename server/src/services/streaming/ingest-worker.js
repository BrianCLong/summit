...
exports.StreamingIngestWorker = void 0;
const events_1 = require("events");
const crypto_1 = __importDefault(require("crypto"));
const timescale_js_1 = require("../../db/timescale.js");
const timescale_js_2 = require("../../db/timescale.js");
const provenance_ledger_js_1 = __importDefault(require("../provenance-ledger.js"));
const logger_js_1 = __importDefault(require("../../utils/logger.js"));
class StreamingIngestWorker extends events_1.EventEmitter {
    static instance;
    messageQueue = [];
    processing = false;
    batchSize = 100;
    ...
    constructor() {
        super();
        this.provenanceService = provenance_ledger_js_1.default.getInstance();
    ...
    async processMessage(message) {
        ...
        try {
            ...
            await (0, timescale_js_2.insertAnalyticsTrace)({
                trace_id: traceId,
    ...
    normalizeEventData(data) {
        return {
            event_id: data.id || crypto_1.default.randomUUID(),
    ...
    normalizeEntityData(data) {
        return {
            entity_id: data.id || crypto_1.default.randomUUID(),
    ...
    normalizeRelationshipData(data) {
        return {
            relationship_id: data.id || crypto_1.default.randomUUID(),
    ...
    normalizeDocumentData(data) {
        return {
            document_id: data.id || crypto_1.default.randomUUID(),
    ...
    async handleProcessedMessage(processed) {
        try {
            ...
            await (0, timescale_js_1.insertEvent)({
    ...
    async shutdown() {
        ...
        logger_js_1.default.info({ message: 'Streaming ingest worker shutdown complete' });
    }
}
exports.StreamingIngestWorker = StreamingIngestWorker;
exports.default = StreamingIngestWorker;
