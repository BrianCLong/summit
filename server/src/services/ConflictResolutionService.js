...
exports.ConflictResolutionService = exports.ConflictResolutionStrategy = void 0;
// @ts-nocheck
const pino_1 = __importDefault(require("pino"));
const logger = pino_1.default({ name: 'ConflictResolutionService' });
var ConflictResolutionStrategy;
(function (ConflictResolutionStrategy) {
    ConflictResolutionStrategy["LATEST_WINS"] = "LATEST_WINS";
    ConflictResolutionStrategy["SOURCE_PRIORITY"] = "SOURCE_PRIORITY";
...
class ConflictResolutionService {
     ...
     */
    resolveConflicts(target, source, strategy = ConflictResolutionStrategy.LATEST_WINS, sourcePriority = []) {
        const merged = { ...target };
    ...
    applyStrategy(key, valA, valB, entityA, entityB, strategy, sourcePriority) {
        switch (strategy) {
