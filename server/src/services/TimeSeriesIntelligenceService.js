...
exports.timeSeriesIntelligence = exports.TimeSeriesIntelligenceService = void 0;
const ledger_js_1 = require("../provenance/ledger.js");
class TimeSeriesIntelligenceService {
    static instance;
    constructor() { }
    static getInstance() {
     ...
     */
    async forecastActivity(entityId, tenantId, horizon = 7, lookbackDays = 90) {
     ...
     */
    async forecastMetric(entityId, tenantId, metricPath, horizon = 7, lookbackDays = 90) {
        const entries = await this.getHistory(entityId, tenantId, lookbackDays);
        // Extract values
        const dataPoints = [];
        for (const entry of entries) {
    ...
    async getHistory(entityId, tenantId, days) {
     ...
     */
    forecastHolt(data, horizon, alpha = 0.3, beta = 0.1) {
        if (data.length < 2) {
...
exports.TimeSeriesIntelligenceService = TimeSeriesIntelligenceService;
exports.timeSeriesIntelligence = TimeSeriesIntelligenceService.getInstance();
