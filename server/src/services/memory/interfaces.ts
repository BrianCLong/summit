...
export interface ExecutionEvent extends MemoryScope {
  runId: string;
  threadId: string;
  eventId: string;
  ts: Date;
...
export interface ExecutionLogQuery extends MemoryScope {
  runId: string;
  threadId?: string;
  eventTypes?: string[];
  sinceTs?: Date;
...
export interface VectorIndexRecord extends MemoryScope {
  id: string;
  embedding: number[];
  text: string;
...
export interface TemporalGraphQuery extends MemoryScope {
  entityId?: string;
  entityType?: string;
  fromTs?: Date;
  toTs?: Date;
...
export interface EpisodeMetadata extends MemoryScope {
  episodeId: string;
  runId: string;
  startedAt: Date;
  closedAt?: Date;
...
export interface EpisodeQuery extends MemoryScope {
  tag?: string;
  participants?: string[];
  outcome?: string;
  limit?: number;
...
export interface MemoryQueryContext extends MemoryScope {
