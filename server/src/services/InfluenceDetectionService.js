...
exports.InfluenceDetectionService = void 0;
 ...
 */
class InfluenceDetectionService {
    /**
     ...
     */
    static async detectBots(tenantId) {
        const cypher = `
      MATCH (n:Entity)
     ...
     */
    static async detectCoordinatedBehavior(tenantId, timeWindowMinutes = 60) {
        return (0, algorithms_js_1.analyzeCoordinatedBehavior)(tenantId, timeWindowMinutes);
    }
    /**
     ...
     */
    static async trackNarrativePropagation(tenantId, narrativeId) {
        const cypher = `
    ...
    `;
        return (0, neo4j_js_1.runCypher)(cypher, { tenantId, narrativeId });
    }
    /**
     * Identifies "Amplification Networks" - dense subgraphs of users who solely retweet/amplify a core set of accounts.
     */
    static async identifyAmplificationNetworks(tenantId) {
        const cypher = `
...
exports.InfluenceDetectionService = InfluenceDetectionService;
