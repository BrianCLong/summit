...
exports.AdvancedSecurityObservabilityCron = exports.threatDetectionMiddleware = exports.securityObservabilityMiddleware = exports.AdvancedSecurityObservabilityService = void 0;
 ...
 */
class AdvancedSecurityObservabilityService {
    securityEvents;
    securityMetrics;
    threatIndicators;
    config;
     ...
     */
    async processEventForThreatDetection(event) {
     ...
     */
    async processEventForAnomalyDetection(event) {
     ...
     */
    isOffHoursAccess(userId, currentHour) {
     ...
     */
    matchesThreatDetectionRule(event, indicator) {
     ...
     */
    async generateRealTimeAlert(alert) {
        if (!this.config.realTimeAlertingEnabled)
            return;
     ...
     */
    async collectSecurityEvidence(event) {
     ...
     */
    async collectThreatEvidence(event, indicator) {
     ...
     */
    async updateMetricsBuffer(event) {
     ...
     */
    async flushMetricsToStorage(events, tenantId) {
     ...
     */
    async calculateSecurityMetrics(events, tenantId) {
        ...
        const responseTimes = accessEvents
            ...
            .map(e => e.details.responseTimeMs);
     ...
     */
    async getSecurityDashboardData(tenantId) {
     ...
     */
    async generateSecurityReport(tenantId, startTime, endTime) {
        try {
...
exports.AdvancedSecurityObservabilityService = AdvancedSecurityObservabilityService;
/**
 * Security Observability Middleware for Request-level Monitoring
 */
const securityObservabilityMiddleware = (service) => {
    return async (req, res, next) => {
        ...
        try {
            ...
            (0, middleware_js_1.trackError)('observability', 'SecurityObservabilityMiddlewareError');
            next(); // Continue with request processing even if observability has issues
        }
    };
};
exports.securityObservabilityMiddleware = securityObservabilityMiddleware;
/**
 * Threat Detection Middleware for Enhanced Security
 */
const threatDetectionMiddleware = (service) => {
    return async (req, res, next) => {
        ...
        try {
            ...
            (0, middleware_js_1.trackError)('security', 'ThreatDetectionMiddlewareError');
 ...
 */
class AdvancedSecurityObservabilityCron {
    service;
    cronInterval;
    timer = null;
    constructor(service, intervalMinutes = 60) {
    ...
    stop() {
        if (this.timer) {
            ...
            this.timer = null;
            logger_js_1.default.info('ADVANCED SECURITY OBSERVABILITY CRON STOPPED');
        }
    }
    async runMetricsCalculation() {
        try {
            // In a real system, this would calculate metrics across all tenants
            logger_js_1.default.info('RUNNING ADVANCED SECURITY METRICS CALCULATION');
            ...
            logger_js_1.default.info('ADVANCED SECURITY METRICS CALCULATED');
        }
        catch (error) {
            logger_js_1.default.error({
                error: error instanceof Error ? error.message : String(error)
    ...
    async runOnDemand() {
        logger_js_1.default.info('RUNNING ON-DEMAND ADVANCED SECURITY METRICS CALCULATION');
        await this.runMetricsCalculation();
    }
}
exports.AdvancedSecurityObservabilityCron = AdvancedSecurityObservabilityCron;
exports.default = AdvancedSecurityObservabilityService;
