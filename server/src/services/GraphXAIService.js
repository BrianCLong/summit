...
exports.GraphXAIService = void 0;
const xai_js_1 = require("../graph/xai.js");
 ...
 */
class GraphXAIService {
    static instance;
    driver; // Type 'any' to avoid strict dependency on neo4j-driver types in this prototype
    constructor() {
     ...
     */
    async explainNodeCentrality(nodeId) {
        ...
        `, { nodeId });
            ...
            const explanation = (0, xai_js_1.explainDegreeCentrality)(graph, nodeId, 5);
            return {
                target: nodeId,
     ...
     */
    async explainNodeCommunity(nodeId) {
        const session = this.driver.session();
        try {
            ...
            result.records.forEach((record) => {
                ...
                if (nlabels && nlabels[0])
                    communities.set(nid, nlabels[0]);
                if (mlabels && mlabels[0])
                    communities.set(mid, mlabels[0]);
            });
            const explanation = (0, xai_js_1.explainCommunity)(graph, communities, nodeId);
            return {
                target: nodeId,
...
exports.GraphXAIService = GraphXAIService;
