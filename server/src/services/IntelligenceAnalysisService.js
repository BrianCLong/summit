...
exports.intelligenceAnalysisService = exports.IntelligenceAnalysisService = void 0;
// @ts-nocheck
const mlAnalysisService_js_1 = require("./mlAnalysisService.js");
const LLMService_js_1 = __importDefault(require("./LLMService.js"));
const require_js_1 = require("../utils/require.js");
// Load CommonJS services
const VisionService = (0, require_js_1.requireFunc)('./VisionService.js');
const SentimentService = (0, require_js_1.requireFunc)('./SentimentService.js');
const GraphAnalyticsService = (0, require_js_1.requireFunc)('./GraphAnalyticsService.js');
const AutoMLService_js_1 = require("./AutoMLService.js");
const logger_js_1 = __importDefault(require("../utils/logger.js"));
// Simple implementation of TimeSeriesAnalyzer locally since it might be missing
class TimeSeriesAnalyzer {
    analyze(dataPoints, options = {}) {
...
class IntelligenceAnalysisService {
    ...
    timeSeriesAnalyzer;
    constructor() {
        this.llmService = new LLMService_js_1.default({ provider: 'openai', model: 'gpt-4' }); // Assuming config handling inside LLMService
        ...
        logger_js_1.default.info('Intelligence Analysis Service initialized');
    }
    /**
    ...
    async analyzeText(text, context) {
        logger_js_1.default.info('Analyzing text');
    ...
    async detectAnomalies(investigationId) {
        return await mlAnalysisService_js_1.mlAnalysisService.detectAnomalies(investigationId);
    }
    /**
     * 4. Predictive Analytics
     * Uses MLAnalysisService (risk scoring)
     */
    async predictThreatLevel(entityId) {
        const risk = await mlAnalysisService_js_1.mlAnalysisService.calculateRiskScore(entityId);
        return {
            ...risk,
            explainability: {
     ...
     * 5. Image Analysis
     */
    async analyzeImage(imageUrlOrBuffer) {
     ...
     * 6. Network Analysis
     */
    async analyzeNetwork(investigationId) {
        ...
        return await mlAnalysisService_js_1.mlAnalysisService.computeGraphMetrics(investigationId);
    }
    /**
     ...
     */
    getAutoML() {
        return AutoMLService_js_1.autoMLService;
    }
    /**
     * 12. Explainable AI
...
exports.IntelligenceAnalysisService = IntelligenceAnalysisService;
exports.intelligenceAnalysisService = new IntelligenceAnalysisService();
