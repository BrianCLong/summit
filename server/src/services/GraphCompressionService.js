...
exports.graphCompressionService = exports.GraphCompressionService = void 0;
class GraphCompressionService {
    /**
    ...
    collapseCommunities(data, communities) {
        ...
        const newNodes = [];
        const nodeMapping = new Map(); // oldId -> newId
...
exports.GraphCompressionService = GraphCompressionService;
exports.graphCompressionService = new GraphCompressionService();
