...
export interface InvestigationPermission {
  userId: string;
...
export class InvestigationWorkflowService extends EventEmitter {
  ...
  private initializeTemplates(): void {
    ...
    const securityIncidentTemplate: InvestigationTemplate = {
    ...
    const malwareAnalysisTemplate: InvestigationTemplate = {
    ...
    const fraudInvestigationTemplate: InvestigationTemplate = {
   ...
   */
  getTemplates(): InvestigationTemplate[] {
