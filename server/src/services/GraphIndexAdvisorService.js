...
// @ts-ignore
const logger = pino_1.default({ name: 'GraphIndexAdvisorService' });
class GraphIndexAdvisorService {
    static instance;
    accessPatterns = new Map();
    querySampleCount = 0;
    sampleRate = 0.1; // Analyze 10% of queries by default
    constructor() { }
    static getInstance() {
    ...
    incrementPattern(label, property) {
...
exports.default = GraphIndexAdvisorService;
