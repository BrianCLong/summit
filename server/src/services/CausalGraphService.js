...
exports.CausalGraphService = void 0;
// @ts-nocheck
...
class CausalGraphService {
     ...
     */
    async generateCausalGraph(investigationId) {
      ...
      `;
            ...
            logger_js_1.default.error('Error generating causal graph', error);
            throw error;
        }
        finally {
            await session.close();
...
exports.CausalGraphService = CausalGraphService;
