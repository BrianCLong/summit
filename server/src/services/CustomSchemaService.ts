...
export async function getCustomSchema(investigationId: string): Promise<CustomField[]> {
...
export async function validateCustomMetadata(investigationId: string, data: any): Promise<void> {
