...
exports.AnalystFeedbackService = void 0;
...
class AnalystFeedbackService {
     ...
     */
    async getFeedbackForAlert(alertId) {
        try {
     ...
     */
    async getLabelsForAlert(alertId) {
        try {
     ...
     */
    async generateTrainingData(limit = 5000) {
        try {
     ...
     */
    async getFeedbackStatistics(fromDate, toDate) {
        try {
            ...
            const averageConfidence = stats.reduce((sum, stat) => sum + (stat._avg.confidence || 0), 0) /
                stats.length;
            return {
                totalFeedback,
                averageConfidence,
     ...
     */
    async triggerRetrainingIfNeeded(alertId) {
        try {
...
exports.AnalystFeedbackService = AnalystFeedbackService;
