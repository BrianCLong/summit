...
exports.CachedMetadataService = void 0;
exports.initCachedMetadataService = initCachedMetadataService;
exports.getCachedMetadataService = getCachedMetadataService;
// @ts-ignore
const pino_1 = __importDefault(require("pino"));
const config_js_1 = require("../config.js");
const cacheMetrics_js_1 = require("../metrics/cacheMetrics.js");
// @ts-ignore
const logger = pino_1.default({ name: 'CachedMetadataService' });
...
class MetadataCache {
    ...
    maxSize;
    namespace;
    constructor(namespace, maxSize = MAX_CACHE_SIZE) {
    ...
    get(key) {
        ...
        if (!entry) {
            (0, cacheMetrics_js_1.recMiss)(this.namespace, 'get');
            return null;
        }
        ...
        (0, cacheMetrics_js_1.recHit)(this.namespace, 'get');
        return entry.data;
    }
    set(key, value, ttlSeconds, tags) {
        ...
        (0, cacheMetrics_js_1.recSet)(this.namespace, 'set');
    }
    invalidateByTag(tag) {
        let count = 0;
...
class CachedMetadataService {
    ...
    constructor(db) {
        this.db = db;
        this.enabled = config_js_1.cfg?.CACHE_ENABLED ?? true;
    ...
    invalidateTenant(tenantId) {
        ...
        logger.info({ tenantId, entityInvalidated, relInvalidated }, 'Invalidated tenant caches');
    }
    /**
