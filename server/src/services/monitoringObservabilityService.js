...
exports.MonitoringObservabilityService = void 0;
const events_1 = require("events");
const redis_js_1 = require("../cache/redis.js");
class MonitoringObservabilityService extends events_1.EventEmitter {
    alerts = new Map();
    logs = [];
    traces = new Map();
    ...
    constructor() {
        super();
        this.cache = new redis_js_1.RedisService();
...
exports.MonitoringObservabilityService = MonitoringObservabilityService;
