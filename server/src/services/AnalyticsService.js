...
class AnalyticsService {
    ...
    async findPaths(sourceId, targetId, algorithm = 'shortest', params = {}) {
        ...
        if (isNaN(maxDepth) || maxDepth < 1)
            throw new Error('Invalid parameter: maxDepth');
        let cypher = '';
        let explanation = '';
      ...
      `;
        ...
        const results = await (0, neo4j_js_1.runCypher)(cypher, { sourceId, targetId, k });
        return {
            data: results,
            xai: {
    ...
    async detectCommunities(algorithm = 'lpa', params = {}) {
      ...
      LIMIT 2000
    `;
        const nodes = await (0, neo4j_js_1.runCypher)(cypher, {});
    ...
    async calculateCentrality(algorithm, params = {}) {
      ...
      `;
        ...
        const results = await (0, neo4j_js_1.runCypher)(cypher, { limit });
        return {
            data: results,
            xai: {
                features: { algorithm },
    ...
    async minePatterns(patternType, params = {}) {
      ...
      `;
        ...
        const results = await (0, neo4j_js_1.runCypher)(cypher, params);
        return {
            data: results,
            xai: {
