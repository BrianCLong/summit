...
exports.CostOptimizationService = exports.RiskLevel = exports.ImplementationEffort = exports.OptimizationType = void 0;
const api_1 = require("@opentelemetry/api");
const prom_client_1 = require("prom-client");
const cost_js_1 = require("../metrics/cost.js");
const tracer = api_1.trace.getTracer('cost-optimization-service', '24.2.0');
// Optimization metrics
const optimizationOpportunities = new prom_client_1.Gauge({
...
const optimizationExecutions = new prom_client_1.Counter({
...
const optimizationImpact = new prom_client_1.Histogram({
...
(function (OptimizationType) {
    OptimizationType["DATABASE_CONNECTION_POOLING"] = "db_connection_pooling";
    OptimizationType["QUERY_OPTIMIZATION"] = "query_optimization";
    OptimizationType["DATA_ARCHIVING"] = "data_archiving";
    OptimizationType["RESOURCE_RIGHT_SIZING"] = "resource_right_sizing";
    OptimizationType["CACHING_OPTIMIZATION"] = "caching_optimization";
    OptimizationType["BATCH_PROCESSING"] = "batch_processing";
    OptimizationType["STORAGE_TIER_OPTIMIZATION"] = "storage_tier_optimization";
    OptimizationType["NETWORK_OPTIMIZATION"] = "network_optimization";
    OptimizationType["AI_MODEL_OPTIMIZATION"] = "ai_model_optimization";
    OptimizationType["RETENTION_POLICY_TUNING"] = "retention_policy_tuning";
...
class CostOptimizationService {
    MAX_AUTO_SAVINGS_THRESHOLD = 50.0; // Max $50 auto-optimization
    MIN_SAVINGS_THRESHOLD = 0.1; // Min $0.10 to consider
    async identifyOptimizationOpportunities(tenantId) {
        return tracer.startActiveSpan('cost_optimization.identify_opportunities', async (span) => {
            const opportunities = [];
            try {
    ...
    async executeOptimizations(opportunities) {
        return tracer.startActiveSpan('cost_optimization.execute_optimizations', async (span) => {
            const results = [];
            for (const opportunity of opportunities) {
                ...
                if (result.implemented && result.actualSavingsUSD > 0) {
                    ...
                    cost_js_1.costOptimizationSavings.inc({
                        optimization_type: opportunity.type,
                        tenant_id: opportunity.tenantId,
                    }, result.actualSavingsUSD);
                }
