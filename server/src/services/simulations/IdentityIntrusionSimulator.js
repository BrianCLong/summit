...
exports.IdentityIntrusionSimulator = void 0;
const crypto_1 = require("crypto");
class IdentityIntrusionSimulator {
    startTime;
    endTime;
    events = [];
    constructor() {
     ...
     */
    generateCampaign(targetDomain = 'acme-corp.com') {
    ...
    addEvent(offsetHours, source, type, severity, details, mitre) {
    ...
    simulateDiscoveryAndCreds(domain) {
    ...
    simulateLateralMovement(domain) {
        // Pass-the-Hash / RDP
    ...
    simulatePrivilegeEscalation(domain) {
        // Kerberoasting
...
exports.IdentityIntrusionSimulator = IdentityIntrusionSimulator;
