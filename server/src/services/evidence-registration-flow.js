...
exports.EvidenceRegistrationFlow = void 0;
exports.ingestDocument = ingestDocument;
const crypto_1 = __importDefault(require("crypto"));
const provenance_ledger_beta_js_1 = require("./provenance-ledger-beta.js");
const logger_js_1 = __importDefault(require("../utils/logger.js"));
class EvidenceRegistrationFlow {
    provenanceLedger;
    constructor() {
        this.provenanceLedger = provenance_ledger_beta_js_1.ProvenanceLedgerBetaService.getInstance();
    }
    /**
        ...
        try {
            ...
            const source = await this.provenanceLedger.registerSource({
                ...
                metadata: {
                    ...
                    size_bytes: input.metadata?.size_bytes || input.documentContent.length,
                    ...input.metadata,
                },
            ...
            const normalizeTransform = await this.provenanceLedger.registerTransform({
    ...
    extractClaims(text) {
        ...
        for (const sentence of sentences) {
            ...
            const isAssertive = assertivePatterns.some((pattern) => pattern.test(trimmed));
...
exports.EvidenceRegistrationFlow = EvidenceRegistrationFlow;
/**
...
exports.default = EvidenceRegistrationFlow;
