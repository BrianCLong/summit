...
exports.defaultModelWeights = exports.LightweightIntentModel = void 0;
...
class LightweightIntentModel {
    ...
    predict(query) {
        ...
        Object.keys(this.weights).forEach((intent) => {
...
exports.LightweightIntentModel = LightweightIntentModel;
exports.defaultModelWeights = {
    analytics: {
        bias: -0.4,
        tokens: {
            metric: 1.1,
