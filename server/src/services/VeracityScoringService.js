...
exports.VeracityScoringService = void 0;
const database_js_1 = require("../config/database.js");
const logger_js_1 = __importDefault(require("../utils/logger.js"));
const IntelCorroborationService_js_1 = require("./IntelCorroborationService.js");
class VeracityScoringService {
    driver;
    corroborationService;
    constructor() {
        this.driver = (0, database_js_1.getNeo4jDriver)();
        this.corroborationService = new IntelCorroborationService_js_1.IntelCorroborationService();
    }
    /**
    ...
    async scoreEntity(entityId) {
      ...
      `, {
            ...
            logger_js_1.default.info(`Updated veracity for ${entityId}: ${score} (${confidence})`);
            return veracity;
        }
        catch (err) {
            logger_js_1.default.error(`Failed to score entity ${entityId}`, err);
            throw err;
        }
        finally {
            await session.close();
...
exports.VeracityScoringService = VeracityScoringService;
