...
exports.AutomatedIntelligenceReportingService = void 0;
// @ts-nocheck
const IntelligenceAnalysisService_js_1 = require("./IntelligenceAnalysisService.js");
/**
 ...
 */
class AutomatedIntelligenceReportingService {
    analysisService;
    constructor() {
        this.analysisService = new IntelligenceAnalysisService_js_1.IntelligenceAnalysisService();
    }
    /**
    ...
    `;
      ...
      <div style="background-color: ${this.getColorForLevel(data.strategicWarning.level)}; padding: 10px; border-radius: 5px;">
        ...
        <ul>
          ${data.strategicWarning.indicators.map((i) => `<li>${i}</li>`).join('')}
        </ul>
      </div>
...
exports.AutomatedIntelligenceReportingService = AutomatedIntelligenceReportingService;
