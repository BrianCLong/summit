...
exports.SOARPlaybookService = void 0;
class SOARPlaybookService {
     ...
     */
    async executePhishingContainment(alertId, evidence) {
        const playbook = await this.createPlaybookExecution('phishing-containment-v1.1', alertId, {
     ...
     */
    async executeForcedMFAReset(alertId, evidence, approverUserId) {
        const playbook = await this.createPlaybookExecution('forced-mfa-reset-v1.1', alertId, {
        ...
        try {
            ...
            const approvalResult = await this.requireApproval(playbook.id, 'mfa-reset-approval', approverUserId, {
     ...
     */
    async executeURLBlock(alertId, evidence) {
        const playbook = await this.createPlaybookExecution('url-block-proxy-v1.1', alertId, {
            urls: evidence.urls,
     ...
     */
    async getPlaybookExecutionsForAlert(alertId) {
        try {
    ...
    async createPlaybookExecution(playbookId, alertId, metadata) {
    ...
    async executeStep(executionId, stepName, action) {
    ...
    async requireApproval(executionId, stepName, approverUserId, approvalData) {
        const step = await this.prisma.playbookStep.create({
            data: {
                executionId,
                name: stepName,
    ...
    async simulateApproval(approvalId, approverUserId) {
    ...
    async completePlaybookExecution(executionId, status, results) {
    ...
    async createIncidentTicket(params) {
...
exports.SOARPlaybookService = SOARPlaybookService;
