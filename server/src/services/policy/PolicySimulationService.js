...
exports.policySimulationService = exports.PolicySimulationService = void 0;
class PolicySimulationService {
     ...
     */
    async simulate(policy, historicalRuns) {
        const results = {
    ...
    evaluateRunAgainstPolicy(run, policy) {
        // 1. Check Capability
...
exports.policySimulationService = PolicySimulationService.getInstance();
