 ...
 */
function computeEntryHash(entry, previousHash, options = {}) {
    ...
    if (isEnabled) {
        ...
        delete contentToHash.previousHash;
        delete contentToHash.currentHash;
        delete contentToHash.id;
        delete contentToHash.sequenceNumber;
