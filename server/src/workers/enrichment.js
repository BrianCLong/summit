...
const connection = new ioredis_1.default(process.env.REDIS_URL); // Use Redis connection string from env
...
//   },
// });
async function enqueueEnrichment(payload, opts = { attempts: 2 }) {
