...
exports.osintRateLimiter = void 0;
exports.createOsintRateLimiter = createOsintRateLimiter;
...
class SlidingWindowLimiter {
    ...
    redis;
    constructor(windowMs, redisClient) {
    ...
    async check(key, limit, scope) {
        ...
        try {
            ...
            logger_js_1.logger.warn({ err: error, key, scope }, 'Redis sliding window failed, falling back to memory');
            return this.checkInMemory(key, limit, now, windowStart, scope);
        }
    }
...
exports.osintRateLimiter = createOsintRateLimiter();
