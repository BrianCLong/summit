...
exports.createJsonBodySizeValidator = createJsonBodySizeValidator;
exports.createFileUploadValidator = createFileUploadValidator;
exports.createSizeBasedRateLimiter = createSizeBasedRateLimiter;
 ...
 */
function createJsonBodySizeValidator(maxSize = 10 * 1024 * 1024) {
    return (req, res, next) => {
...
class SizeBasedRateLimiter {
    ...
    windowMs;
    maxBytes;
    constructor(windowMs = 60000, maxBytes = 100 * 1024 * 1024) {
 ...
 */
function createSizeBasedRateLimiter(options) {
    const config = {
