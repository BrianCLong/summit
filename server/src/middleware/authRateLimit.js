...
exports.refreshRateLimiter = exports.passwordResetRateLimiter = exports.registerRateLimiter = exports.loginRateLimiter = exports.authRateLimiter = void 0;
...
async function checkRateLimit(key, config) {
    ...
    if (!redis) {
        logger_js_1.default.warn('Redis unavailable for rate limiting, allowing request');
        return {
            allowed: true,
    ...
    try {
        ...
        logger_js_1.default.error('Rate limit check failed:', error);
...
async function recordFailedLogin(ip, email) {
    ...
    try {
        ...
        logger_js_1.default.error('Failed to record failed login:', error);
    }
}
/**
...
async function clearFailedLogins(ip, email) {
    ...
    try {
        ...
        logger_js_1.default.error('Failed to clear failed logins:', error);
    }
}
 ...
 */
exports.registerRateLimiter = createRateLimiter({
 ...
 */
exports.refreshRateLimiter = createRateLimiter({
    windowMs: 15 * 60 * 1000, // 15 minutes
    maxAttempts: 20,
    blockDuration: 15 * 60 * 1000, // 15 minutes block
...
exports.default = {
    ...
    registerRateLimiter: exports.registerRateLimiter,
    passwordResetRateLimiter: exports.passwordResetRateLimiter,
    refreshRateLimiter: exports.refreshRateLimiter,
    recordFailedLogin,
    clearFailedLogins,
};
