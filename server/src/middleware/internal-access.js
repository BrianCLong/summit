...
exports.requireInternalAccess = requireInternalAccess;
const isConsoleEnabled = () => (process.env.COMMAND_CONSOLE_ENABLED ?? 'true').toLowerCase() !== 'false';
...
function requireInternalAccess(req, res, next) {
    ...
    const tokenMatches = configuredToken && typeof incomingToken === 'string'
