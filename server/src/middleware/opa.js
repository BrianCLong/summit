...
exports.withOPACheck = withOPACheck;
exports.applyOPAToResolvers = applyOPAToResolvers;
...
class OPAMiddleware {
    ...
    async checkPolicy(input) {
        ...
        try {
            const response = await axios_1.default.post(`${this.options.opaUrl}${this.options.policyPath}`, { input }, {
            ...
            this.stats.errors++;
            logger_js_1.default.error(`OPA policy check failed: ${error.message}`);
    ...
    async healthCheck() {
        ...
        try {
            const response = await axios_1.default.get(`${this.options.opaUrl}/health`, {
                timeout: this.options.timeout,
            });
            return {
                status: 'healthy',
