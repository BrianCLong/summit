...
exports.requireReasonForAccess = exports.requireAuthority = exports.AuthorityGuard = void 0;
...
const requireAuthority = (operation, scope = []) => {
    return (req, res, next) => {
...
const requireReasonForAccess = (req, res, next) => {
...
exports.requireReasonForAccess = requireReasonForAccess;
exports.default = {
    AuthorityGuard,
    requireAuthority: exports.requireAuthority,
    requireReasonForAccess: exports.requireReasonForAccess,
};
