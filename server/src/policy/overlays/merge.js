...
const mergePolicyOverlay = (basePolicy, overlay) => {
    const stableBaseRules = basePolicy.rules.map(cloneRule);
    const appendOrder = [];
    const patchedRules = overlay.patches.reduce((rules, patch) => {
...
exports.mergePolicyOverlay = mergePolicyOverlay;
exports.default = exports.mergePolicyOverlay;
