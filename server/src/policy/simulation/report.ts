...
export const scenarioResultSchema = z.object({
  ...
  expectedOutcome: scenarioOutcomeSchema,
...
export const simulationRunResultSchema = z.object({
  ...
  results: z
    .object({
      scenarios: z.array(scenarioResultSchema).default([]),
      anomalies: z.array(anomalyResultSchema).default([]),
    })
    .default({ scenarios: [], anomalies: [] }),
  deltas: z.object({
