...
exports.ENV_DOCS = exports.TRIPWIRE_PRESETS = exports.DATA_CATEGORIES = exports.SelectorMinimizationConfig = void 0;
exports.getTripwirePreset = getTripwirePreset;
exports.validateConfiguration = validateConfiguration;
// ============================================================================
// Environment Variables
// ============================================================================
exports.SelectorMinimizationConfig = {
    // Tripwire thresholds
    DEFAULT_MAX_EXPANSION_RATIO: parseFloat(process.env.SELECTOR_MAX_EXPANSION_RATIO || '10.0'),
    DEFAULT_ANOMALY_Z_SCORE: parseFloat(process.env.SELECTOR_ANOMALY_Z_SCORE || '4.0'),
    DEFAULT_MAX_RECORDS_ACCESSED: parseInt(process.env.SELECTOR_MAX_RECORDS_ACCESSED || '100000'),
    ...
    REQUIRE_REASON_FOR_EXPANSION_RATIO: parseFloat(process.env.REQUIRE_REASON_FOR_EXPANSION_RATIO || '5.0'),
    REQUIRE_REASON_FOR_RECORD_COUNT: parseInt(process.env.REQUIRE_REASON_FOR_RECORD_COUNT || '10000'),
    // Metrics and reporting
    QUERY_METRICS_RETENTION_DAYS: parseInt(process.env.QUERY_METRICS_RETENTION_DAYS || '90'),
    BASELINE_MIN_SAMPLE_SIZE: parseInt(process.env.BASELINE_MIN_SAMPLE_SIZE || '10'),
    BASELINE_LOOKBACK_DAYS: parseInt(process.env.BASELINE_LOOKBACK_DAYS || '30'),
    // PNC reporting
    ...
    PNC_REPORT_RETENTION_YEARS: parseInt(process.env.PNC_REPORT_RETENTION_YEARS || '7'),
    // Alert settings
    ...
    // Compliance
    TARGET_VIOLATION_RATE: parseFloat(process.env.TARGET_VIOLATION_RATE || '0.01'), // 1%
    COMPLIANCE_REPORTING_ENABLED: process.env.COMPLIANCE_REPORTING_ENABLED !== 'false',
};
// ============================================================================
 ...
 */
function getTripwirePreset(preset = 'standard') {
    return exports.TRIPWIRE_PRESETS[preset] || exports.TRIPWIRE_PRESETS.standard;
}
/**
...
function validateConfiguration() {
    const errors = [];
    if (exports.SelectorMinimizationConfig.DEFAULT_MAX_EXPANSION_RATIO <= 0) {
        errors.push('DEFAULT_MAX_EXPANSION_RATIO must be positive');
    }
    if (exports.SelectorMinimizationConfig.DEFAULT_ANOMALY_Z_SCORE <= 0) {
        errors.push('DEFAULT_ANOMALY_Z_SCORE must be positive');
    }
    if (exports.SelectorMinimizationConfig.PNC_DEFAULT_SAMPLE_RATE < 0 ||
        exports.SelectorMinimizationConfig.PNC_DEFAULT_SAMPLE_RATE > 1) {
        errors.push('PNC_SAMPLE_RATE must be between 0 and 1');
    }
    if (exports.SelectorMinimizationConfig.TARGET_VIOLATION_RATE < 0 ||
        exports.SelectorMinimizationConfig.TARGET_VIOLATION_RATE > 1) {
