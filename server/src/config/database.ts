  ...
  try {
    ...
    await client.query(
      `INSERT INTO rbac_role_permissions (role_id, permission_id)
       ...
       JOIN rbac_roles r ON UPPER(r.name) = UPPER(mapping.role_name)
       JOIN rbac_permissions p ON LOWER(p.name) = LOWER(mapping.permission_name)
    ...
    await client.query(
      ...
      [1, 'Initial dynamic RBAC bootstrap'],
    );
