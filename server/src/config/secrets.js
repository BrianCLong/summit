...
exports.createDevelopmentEnv = createDevelopmentEnv;
...
function generateSecrets() {
    return {
        ...
        JWT_REFRESH_SECRET: crypto_1.default.randomBytes(32).toString('hex'),
        SESSION_SECRET: crypto_1.default.randomBytes(32).toString('hex'),
        ENCRYPTION_KEY: crypto_1.default.randomBytes(32).toString('hex'),
    };
}
/**
 * Create development .env file with secure defaults
 */
function createDevelopmentEnv(overrides = {}) {
