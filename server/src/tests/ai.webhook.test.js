...
const app_js_1 = require("../app.js"); // assumes your express app export
...
describeIf('AI webhook', () => {
    ...
    (0, globals_1.it)('accepts signed webhook and creates insights', async () => {
        const body = {
    ...
    (0, globals_1.it)('rejects webhook with invalid signature', async () => {
        const body = {
        ...
        (0, globals_1.expect)(res.body.error).toBe('invalid signature');
    });
    (0, globals_1.it)('handles entity resolution webhook', async () => {
        const body = {
    ...
    (0, globals_1.it)('handles community detection webhook', async () => {
        const body = {
    ...
    (0, globals_1.it)('handles NLP entities webhook', async () => {
        const body = {
    ...
    (0, globals_1.it)('handles malformed webhook gracefully', async () => {
    ...
    (0, globals_1.it)('verifies timing-safe signature comparison', async () => {
        const body = { job_id: 'test', kind: 'test', results: [] };
        const validSig = crypto_1.default
