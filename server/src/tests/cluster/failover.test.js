...
(0, globals_1.describe)('Neo4j Causal Cluster Failover Tests', () => {
    ...
    (0, globals_1.it)('should re-elect a leader within 10 seconds after leader failure', async () => {
    ...
    (0, globals_1.it)('should maintain data consistency during network partition', async () => {
