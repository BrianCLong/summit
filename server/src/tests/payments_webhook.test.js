...
const StripeWebhook_js_1 = require("../payments/StripeWebhook.js");
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const globals_1 = require("@jest/globals");
(0, globals_1.describe)('StripeWebhook', () => {
    (0, globals_1.it)('verifies signature', () => {
        const payload = '{}';
        ...
        (0, globals_1.expect)((0, StripeWebhook_js_1.verifyStripeSig)(payload, header, secret).ok).toBe(true);
    });
    (0, globals_1.it)('handles idempotent payment and refund', async () => {
        ...
        await (0, StripeWebhook_js_1.handleWebhook)(succeeded, deps);
        await (0, StripeWebhook_js_1.handleWebhook)(succeeded, deps); // idempotent
        await (0, StripeWebhook_js_1.handleWebhook)(refunded, deps);
        (0, globals_1.expect)(calls).toEqual([
            'paid:order123',
            'issue:order123-ent',
