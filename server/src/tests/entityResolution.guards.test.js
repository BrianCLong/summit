...
(0, globals_1.describe)('EntityResolutionService Guards', () => {
    let service;
    ...
    test.skip('checkLatencyBudget should not throw', () => {
        ...
        (0, globals_1.expect)(result.sampledCount).toBe(6); // Max(5, 0.6) = 6? No. Max(5, 0.6) is 5.
        ...
        // So sampleSize is 5.
        // The slice takes 5.
        (0, globals_1.expect)(result.sampledCount).toBe(5);
        (0, globals_1.expect)(result.precision).toBe(0.95);
    });
