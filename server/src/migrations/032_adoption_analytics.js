...
exports.version = '032';
exports.description = 'Adoption analytics with privacy-preserving aggregation';
async function up(pool) {
    ...
    `);
        ...
        logger_js_1.default.info('Migration 032 completed: Adoption analytics system');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_js_1.default.error('Migration 032 failed', { error });
        throw error;
    }
    finally {
        client.release();
...
async function down(pool) {
    ...
    `);
        await client.query('COMMIT');
        logger_js_1.default.info('Migration 032 rolled back: Adoption analytics system');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_js_1.default.error('Migration 032 rollback failed', { error });
        throw error;
    }
    finally {
        client.release();
