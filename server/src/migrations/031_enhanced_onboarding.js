...
exports.version = '031';
exports.description = 'Enhanced onboarding system with guided tours and analytics';
async function up(pool) {
    ...
    `);
        ...
        logger_js_1.default.info('Migration 031 completed: Enhanced onboarding system');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_js_1.default.error('Migration 031 failed', { error });
        throw error;
    }
    finally {
        client.release();
...
async function down(pool) {
    ...
    `);
        await client.query('COMMIT');
        logger_js_1.default.info('Migration 031 rolled back: Enhanced onboarding system');
    }
    catch (error) {
        await client.query('ROLLBACK');
        logger_js_1.default.error('Migration 031 rollback failed', { error });
        throw error;
    }
    finally {
        client.release();
