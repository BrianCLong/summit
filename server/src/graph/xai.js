...
exports.explainDegreeCentrality = explainDegreeCentrality;
exports.explainCommunity = explainCommunity;
exports.calculateSparsity = calculateSparsity;
/**
 ...
 */
function explainDegreeCentrality(graph, targetNode, topK = 5) {
 ...
 */
function explainCommunity(graph, communities, targetNode) {
    const neighbors = graph.get(targetNode);
    if (!neighbors) {
        return [];
    }
 ...
 */
function calculateSparsity(explanationSize, totalNeighbors) {
    if (totalNeighbors === 0)
        return 1.0;
