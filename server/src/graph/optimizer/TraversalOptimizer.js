...
exports.TraversalOptimizer = void 0;
class TraversalOptimizer {
    ...
    generateShortestPathQuery(strategy, params) {
    ...
    generateAllSimplePathsQuery(strategy, params) {
    ...
    generateApocSubgraphQuery(strategy, params) {
    ...
    generateNativeExpansionQuery(strategy, params) {
    ...
    generateGDSQuery(strategy, params) {
...
exports.TraversalOptimizer = TraversalOptimizer;
