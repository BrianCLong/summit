...
exports.analyzeCoordinatedBehavior = analyzeCoordinatedBehavior;
 ...
 */
async function calculateDegreeCentrality(tenantId, limit = 100) {
    const cypher = `
    MATCH (n)
  ...
  `;
    return (0, neo4j_js_1.runCypher)(cypher, { tenantId, limit });
}
/**
 * Finds the shortest path between two nodes.
 */
async function findShortestPath(tenantId, startNodeId, endNodeId) {
    const cypher = `
  ...
  `;
    return (0, neo4j_js_1.runCypher)(cypher, { tenantId, startNodeId, endNodeId });
}
/**
 ...
 */
async function detectCommunities(tenantId) {
 ...
 */
async function analyzeCoordinatedBehavior(tenantId, timeWindowMinutes = 60) {
    ...
    const cypher = `
      ...
      LIMIT 50
    `;
    return (0, neo4j_js_1.runCypher)(cypher, { tenantId, timeWindowMinutes });
}
