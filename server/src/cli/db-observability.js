...
`);
    ...
    if (args.includes('--list')) {
        ...
        Object.entries(db_observability_js_1.EXPLAIN_WHITELIST).forEach(([key, value]) => {
    ...
    const snapshot = await service.snapshot(explainRequest ? { explain: explainRequest } : {}, { userId: 'cli-admin', tenantId: 'system', requestId: 'db-observability-cli' });
