...
exports.intelGraphService = exports.IntelGraphService = void 0;
// @ts-nocheck
...
class IntelGraphService {
    ...
    `;
        await neo4j_js_1.neo.run(cypher, {
            id: run.id,
...
exports.intelGraphService = new IntelGraphService();
