...
exports.BurstRule = exports.RedactionRule = exports.ToolMixRule = exports.DenyRateRule = exports.ProposalEngine = void 0;
...
class ProposalEngine {
    ...
    generateDeterministicId(evidence, ruleId) {
...
class BurstRule {
    ...
    evaluate(evidence) {
        if (evidence.type !== 'burst_behavior')
            return null;
