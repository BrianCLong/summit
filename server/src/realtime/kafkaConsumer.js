...
const WargameResolver_js_1 = require("../resolvers/WargameResolver.js"); // Import the resolver
...
let consumer = null;
const wargameResolver = new WargameResolver_js_1.WargameResolver(); // Instantiate the resolver
