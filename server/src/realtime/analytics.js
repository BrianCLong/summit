...
const TimeSeriesService_js_1 = require("../services/TimeSeriesService.js");
const socket_js_1 = require("./socket.js");
const logger = pino_1.default();
const redis = (0, redis_js_1.getRedisClient)();
const sub = redis.duplicate();
const timeSeries = new TimeSeriesService_js_1.TimeSeriesService();
...
function registerAnalyticsHandlers(socket) {
    ...
    socket.on('subscribe_metric', async (metric) => {
