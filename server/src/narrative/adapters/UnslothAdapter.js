...
class UnslothAdapter {
     ...
     */
    constructPrompt(state, recentEvents) {
...
`;
    ...
    async callInferenceServer(prompt) {
        const body = {
        ...
        try {
            ...
            throw new Error(`Failed to call Unsloth inference server: ${error.message}`);
        }
    }
}
exports.UnslothAdapter = UnslothAdapter;
