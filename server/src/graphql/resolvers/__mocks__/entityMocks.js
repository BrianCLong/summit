...
exports.getMockEntities = getMockEntities;
exports.getMockEntity = getMockEntity;
const MOCK_ENTITIES = [
    {
        id: 'mock-entity-1',
        type: 'PERSON',
...
function getMockEntities(type, q, limit = 25, offset = 0) {
    ...
    if (q) {
        ...
        filtered = filtered.filter((entity) => JSON.stringify(entity.props).toLowerCase().includes(query) ||
