...
exports.createSupportTicketLoader = void 0;
// @ts-nocheck
...
const batchGetComments = async (ticketIds) => {
    if (ticketIds.length === 0)
        return [];
    const redis = (0, database_js_2.getRedisClient)();
    ...
    if (missedTicketIds.length > 0) {
      ...
      `;
        try {
            ...
            const allComments = safeRows(result);
...
const createSupportTicketLoader = () => new dataloader_1.default(batchGetComments);
exports.createSupportTicketLoader = createSupportTicketLoader;
