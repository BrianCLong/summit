...
async function mlCall(path, payload, ctx) {
    ...
    try {
        ...
        logger_js_1.default.error('ML request failed', { path, error: err.message });
        throw err;
    }
}
const resolvers = {
...
exports.AIResolvers = (0, policyWrapper_js_1.wrapResolversWithPolicy)('AI', resolvers);
async function queueJob(ctx, kind, path, body, jobId) {
    const id = jobId || (0, node_crypto_1.randomUUID)();
    ...
    try {
        ...
        logger_js_1.default.error('AI job failed', { id, kind, error: err.message });
        throw err;
    }
