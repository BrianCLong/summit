...
class WargameResolver {
    ...
    async runWarGameSimulation(_parent, { input }, _context) {
        ...
        const session = this.driver.session();
        try {
            const scenarioId = (0, node_crypto_1.randomUUID)();
    ...
    async updateCrisisScenario(_parent, { id, input }, _context) {
        ...
        try {
            ...
            const result = await session.run(`MATCH (s:CrisisScenario {id: $id})
...
exports.WargameResolver = WargameResolver;
