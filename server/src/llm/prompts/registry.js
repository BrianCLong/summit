...
exports.promptService = exports.InMemoryPromptRegistry = void 0;
class InMemoryPromptRegistry {
    ...
    async render(id, params, version = 'latest') {
...
exports.InMemoryPromptRegistry = InMemoryPromptRegistry;
exports.promptService = new InMemoryPromptRegistry();
