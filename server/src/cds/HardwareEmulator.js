 ...
 */
var HardwareEmulator = /** @class */ (function () {
    function HardwareEmulator() {
        this.highToLowQueue = [];
        this.lowToHighQueue = [];
    }
    ...
    HardwareEmulator.prototype.sendHighToLow = function (packet) {
        return __awaiter(this, void 0, void 0, function () {
            var safePacket;
            return __generator(this, function (_a) {
                safePacket = JSON.parse(JSON.stringify(packet));
                this.highToLowQueue.push(safePacket);
                return [2 /*return*/];
            });
        });
    };
    HardwareEmulator.prototype.sendLowToHigh = function (packet) {
        return __awaiter(this, void 0, void 0, function () {
            var safePacket;
            return __generator(this, function (_a) {
                safePacket = JSON.parse(JSON.stringify(packet));
    ...
    HardwareEmulator.prototype.readHighToLow = function () {
        return this.highToLowQueue.shift() || null;
    };
    HardwareEmulator.prototype.readLowToHigh = function () {
