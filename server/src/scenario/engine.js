...
const CostModel_js_1 = require("./models/CostModel.js");
const ReliabilityModel_js_1 = require("./models/ReliabilityModel.js");
const AutonomyModel_js_1 = require("./models/AutonomyModel.js");
const RegulatoryModel_js_1 = require("./models/RegulatoryModel.js");
class ScenarioEngine {
    models = [];
    constructor() {
        // Register default models
        this.models.push(new CostModel_js_1.CostModel());
        this.models.push(new ReliabilityModel_js_1.ReliabilityModel());
        this.models.push(new AutonomyModel_js_1.AutonomyModel());
        this.models.push(new RegulatoryModel_js_1.RegulatoryModel());
    }
    ...
    applyModel(domain, state, params, dt) {
    ...
    calculateSteps(horizon, resolution) {
        switch (resolution) {
