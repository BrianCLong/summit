...
exports.defaultTruthSources = exports.TruthMapRegistry = void 0;
const types_js_1 = require("./types.js");
class TruthMapRegistry {
    truthMap = new Map();
    identityPolicies = new Map();
    truthDebt = [];
    ...
    ensureCanonicalId(domain, record) {
...
exports.TruthMapRegistry = TruthMapRegistry;
exports.defaultTruthSources = {
