...
const decision_analysis_pipeline_js_1 = require("../maestro/pipelines/decision-analysis-pipeline.js");
...
async function main() {
    ...
    const pipeline = new decision_analysis_pipeline_js_1.DecisionAnalysisPipeline();
    ...
    const mdOutputPath = path_1.default.join(__dirname, `../../../artifacts/disclosure_pack_${result.decision.id}.md`);
    const htmlOutputPath = path_1.default.join(__dirname, `../../../artifacts/disclosure_pack_${result.decision.id}.html`);
    await promises_1.default.mkdir(path_1.default.dirname(mdOutputPath), { recursive: true });
    await promises_1.default.writeFile(mdOutputPath, markdownContent);
    await promises_1.default.writeFile(htmlOutputPath, htmlContent);
