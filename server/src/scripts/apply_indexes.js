...
exports.applyRecommendedIndexes = applyRecommendedIndexes;
...
const logger = pino_1.default({ name: 'apply-indexes' });
async function applyRecommendedIndexes() {
    const tenantId = 'default'; // Default tenant for now
    const indexManager = (0, indexManager_js_1.createIndexManager)(tenantId);
