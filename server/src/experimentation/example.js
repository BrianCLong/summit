...
async function runExample() {
    ...
    const assignment = await index_js_1.experimentationService.getAssignment(experimentId, {
        userId,
        tenantId,
    ...
    if (assignment.data) {
        ...
        await index_js_1.experimentationService.trackMetric(experimentId, userId, 'conversion', 1);
    }
    else {
