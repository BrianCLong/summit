...
class GraphDetector {
     ...
     */
    async detectCoordinatedCliques(actorIds) {
     ...
     */
    async analyzeInfluenceCascade(rootPostId) {
        const session = this.driver.session();
        try {
...
exports.GraphDetector = GraphDetector;
