...
exports.createVersionedApp = createVersionedApp;
exports.createFlexibleApp = createFlexibleApp;
exports.runSchemaDiffAnalysis = runSchemaDiffAnalysis;
exports.testSchemaCompatibility = testSchemaCompatibility;
exports.customVersionDetection = customVersionDetection;
...
function createVersionedApp() {
    ...
    app.use((0, index_js_1.versionNegotiationMiddleware)());
    // V1 Router (deprecated)
    const v1Router = (0, index_js_1.versionRouter)(index_js_1.APIVersion.V1);
    // Add deprecation headers for v1
    v1Router.use((0, index_js_1.deprecationMiddleware)({
        version: index_js_1.APIVersion.V1,
    ...
    // V2 Router (supported)
    const v2Router = (0, index_js_1.versionRouter)(index_js_1.APIVersion.V2);
    v2Router.get('/users', getUsersV2);
    v2Router.get('/users/:id', getUserByIdV2);
    v2Router.post('/users', createUserV2);
    // V3 Router (current/latest)
    const v3Router = (0, index_js_1.versionRouter)(index_js_1.APIVersion.V3);
    ...
    app.use('/api/*', (0, index_js_1.validateAPIVersion)([index_js_1.APIVersion.V2, index_js_1.APIVersion.V3]));
    return app;
}
// ============================================================================
// Example 2: Single Route with Version Branching
// ============================================================================
function createFlexibleApp() {
    const app = (0, express_1.default)();
    app.use((0, index_js_1.versionNegotiationMiddleware)());
    ...
    app.get('/api/users', (req, res) => {
        ...
        switch (version) {
            case index_js_1.APIVersion.V1:
                return getUsersV1(req, res);
            case index_js_1.APIVersion.V2:
                return getUsersV2(req, res);
            case index_js_1.APIVersion.V3:
                return getUsersV3(req, res);
            default:
                return res.status(406).json({
                    error: 'API version not supported',
                    requestedVersion: version,
                    supportedVersions: [index_js_1.APIVersion.V2, index_js_1.APIVersion.V3],
                });
        }
    });
    return app;
...
// ============================================================================
async function runSchemaDiffAnalysis() {
    const manager = new index_js_1.SchemaVersionManager({
        schemaDir: './schemas',
...
// ============================================================================
function customVersionDetection(req) {
    // First try standard detection
    let version = (0, index_js_1.getAPIVersion)(req);
    // Custom logic: if user is in beta program, use latest version
    const isBetaUser = req.headers['x-beta-user'] === 'true';
    if (isBetaUser) {
        version = index_js_1.APIVersion.LATEST;
    }
