export function rewardFromMetrics({ costUsd, latencyMs, qualityScore }:{costUsd:number;latencyMs:number;qualityScore?:number}, weights:{cost:number;latency:number;quality:number}) {
