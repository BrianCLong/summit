...
const Env = z
  .object({
    ...
    REQUEST_MAX_BODY_BYTES: z.coerce.number().default(1024 * 1024),
    REQUEST_MAX_URL_LENGTH: z.coerce.number().default(2048),
    REQUEST_MAX_HEADER_BYTES: z.coerce.number().default(8192),
...
const ENV_VAR_HELP: Record<string, string> = {
  ...
  REQUEST_MAX_BODY_BYTES: 'Maximum request payload size in bytes (default: 1048576)',
  REQUEST_MAX_URL_LENGTH: 'Maximum allowed URL length (default: 2048)',
  REQUEST_MAX_HEADER_BYTES: 'Maximum allowed serialized header size (default: 8192 bytes)',
