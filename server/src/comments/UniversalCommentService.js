...
exports.UniversalCommentService = void 0;
...
class UniversalCommentService {
     ...
     * Post a new comment
     */
    async createComment(input, authorId, tenantId) {
        ...
        if (input.parentId) {
            ...
            const parentRes = await this.pool.query(`SELECT root_id, comment_id FROM ${this.tableName} WHERE comment_id = $1`, [input.parentId]);
...
exports.UniversalCommentService = UniversalCommentService;
