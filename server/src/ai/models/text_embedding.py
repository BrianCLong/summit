...
class TextEmbeddingGenerator:
    ...
    def generate_embedding(
        ...
        try:
            ...
            if isinstance(self.model, SentenceTransformer):
                ...
                embedding = self._generate_transformers_embedding(
                    text, normalize, pooling_strategy
                )
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        info = {
            ...
            "device": self.device,
            "model_type": "SentenceTransformer" if isinstance(self.model, SentenceTransformer) else "Transformers"
        }
...
def main():
    ...
    parser.add_argument("--pooling", default="mean", choices=["mean", "max", "cls"], help="Pooling strategy")
    ...
    try:
        ...
        if args.similarity:
            ...
            for other_text in other_texts:
                other_result = generator.generate_embedding(other_text, args.normalize, args.pooling)
                if other_result.get("embedding"):
                    similarity = generator.calculate_similarity(
                        result["embedding"],
                        other_result["embedding"]
                    )
                    similarities.append({
                        "text": other_text,
