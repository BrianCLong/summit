...
def query_graph_with_rag(natural_language_query: str, subgraph_context: dict) -> dict:
    ...
    """
    with tracer.start_as_current_span("query_graph_with_rag") as span:
        span.set_attribute("rag.query", natural_language_query)
        span.set_attribute("rag.subgraph_nodes_count", len(subgraph_context.get("nodes", [])))
