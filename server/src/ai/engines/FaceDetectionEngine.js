...
exports.FaceDetectionEngine = void 0;
const child_process_1 = require("child_process");
const path_1 = __importDefault(require("path"));
const pino_1 = __importDefault(require("pino"));
const logger = pino_1.default({ name: 'FaceDetectionEngine' });
class FaceDetectionEngine {
    ...
    async runFaceDetection(imagePath, minFaceSize, confidenceThreshold) {
        return new Promise((resolve, reject) => {
            const pythonScript = path_1.default.join(this.config.modelsPath, 'mtcnn_detection.py');
            const args = [
                pythonScript,
                '--image',
                imagePath,
    ...
    async runVideoFaceDetection(videoPath, frameRate, startTime, endTime, faceOptions) {
        return new Promise((resolve, reject) => {
            const pythonScript = path_1.default.join(this.config.modelsPath, 'video_face_detection.py');
            const args = [
                pythonScript,
                '--video',
                videoPath,
    ...
    async runLandmarkExtraction(imagePath, boundingBox) {
        return new Promise((resolve, reject) => {
            const pythonScript = path_1.default.join(this.config.modelsPath, 'face_landmarks.py');
            const args = [
                pythonScript,
                '--image',
                imagePath,
    ...
    async extractFaceFeatures(imagePath, boundingBox) {
        return new Promise((resolve, reject) => {
            const pythonScript = path_1.default.join(this.config.modelsPath, 'face_features.py');
            const args = [
                pythonScript,
                '--image',
                imagePath,
    ...
    async analyzeEmotions(imagePath, boundingBox) {
        return new Promise((resolve, reject) => {
            const pythonScript = path_1.default.join(this.config.modelsPath, 'emotion_analysis.py');
            const args = [
                pythonScript,
                '--image',
                imagePath,
    ...
    async estimateAge(imagePath, boundingBox) {
        return new Promise((resolve, reject) => {
            const pythonScript = path_1.default.join(this.config.modelsPath, 'age_estimation.py');
            const args = [
                pythonScript,
                '--image',
                imagePath,
    ...
    async estimateGender(imagePath, boundingBox) {
        return new Promise((resolve, reject) => {
            const pythonScript = path_1.default.join(this.config.modelsPath, 'gender_estimation.py');
            const args = [
                pythonScript,
                '--image',
                imagePath,
    ...
    calculateFaceQuality(detection) {
        ...
        if (detection.landmarks) {
            ...
            landmarkScore =
                Object.values(landmarks).reduce((sum, conf) => {
