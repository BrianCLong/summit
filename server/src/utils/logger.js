...
const pinoPkg = __importStar(require("pino"));
// Handle different pino export formats (standard, default, mocked)
// @ts-ignore
let pino = pinoPkg.pino || pinoPkg.default || (typeof pinoPkg === 'function' ? pinoPkg : null);
if (!pino && pinoPkg.default && typeof pinoPkg.default === 'function') {
    pino = pinoPkg.default;
}
