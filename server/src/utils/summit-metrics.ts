...
class SummitMetrics {
  ...
  public httpRequestsTotal(
    ...
    this.getCounter('summit_http_requests_total', 'Total HTTP requests').add(
      1,
      { ...labels, status: String(labels.status) } as MetricLabels,
    );
  }
  ...
  public httpRequestDuration(
    ...
    ).record(durationSeconds, labels as MetricLabels);
  }
  ...
  public maestroRunsTotal(
      ...
      this.getCounter('summit_maestro_runs_total', 'Total Maestro runs').add(1, labels as MetricLabels);
  }
  ...
  public maestroRunDuration(
      ...
      this.getHistogram('summit_maestro_run_duration_seconds', 'Maestro run duration').record(durationSeconds, labels as MetricLabels);
  }

  public maestroTasksTotal(
      labels: { status: string; taskKind: string; tenantId?: string }
  ): void {
      this.getCounter('summit_maestro_tasks_total', 'Total Maestro tasks').add(1, labels as MetricLabels);
  }
  ...
  public ingestionPipelineRunsTotal(
      ...
      this.getCounter('summit_ingestion_pipeline_runs_total', 'Total ingestion pipeline runs').add(1, labels as MetricLabels);
  }
  ...
  public ingestionRecordsProcessedTotal(
      ...
      this.getCounter('summit_ingestion_records_processed_total', 'Total ingestion records processed').add(count, labels as MetricLabels);
  }
  ...
  public graphQueriesTotal(
      ...
      this.getCounter('summit_graph_queries_total', 'Total graph queries').add(1, labels as MetricLabels);
  }
  ...
  public graphQueryDuration(
      ...
      this.getHistogram('summit_graph_query_duration_seconds', 'Graph query duration').record(durationSeconds, labels as MetricLabels);
  }
  ...
  public llmRequestsTotal(
      ...
      this.getCounter('summit_llm_requests_total', 'Total LLM requests').add(1, labels as MetricLabels);
  }
  ...
  public llmRequestDuration(
      ...
      this.getHistogram('summit_llm_request_duration_seconds', 'LLM request duration').record(durationSeconds, labels as MetricLabels);
  }
  ...
  public llmTokensTotal(
      ...
      this.getCounter('summit_llm_tokens_total', 'Total LLM tokens').add(count, labels as MetricLabels);
  }
  ...
  public externalApiRequestsTotal(
      ...
      this.getCounter('summit_external_api_requests_total', 'Total external API requests').add(1, { ...labels, status: String(labels.status) } as MetricLabels);
  }
  ...
  public externalApiLatency(
      ...
      this.getHistogram('summit_external_api_latency_seconds', 'External API latency').record(durationSeconds, labels as MetricLabels);
  }
}
