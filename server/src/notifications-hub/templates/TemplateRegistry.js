...
class TemplateRegistry {
    ...
    registerDefaultTemplates() {
        ...
        this.register({
            id: 'alert_triggered',
            eventType: EventSchema_js_1.EventType.ALERT_TRIGGERED,
...
This alert requires your attention.`,
        ...
        this.register({
            id: 'slo_violation',
            eventType: EventSchema_js_1.EventType.SLO_VIOLATION,
...
Immediate action may be required to prevent further degradation.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.GOLDEN_PATH_BROKEN,
...
This impacts the standard deployment workflow and requires immediate attention.`,
        ...
        this.register({
            id: 'pipeline_failed',
            eventType: EventSchema_js_1.EventType.PIPELINE_FAILED,
...
Please review the pipeline logs and address the failure.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.WORKFLOW_APPROVAL_REQUIRED,
...
Please review and approve or reject this request.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.AUTHORITY_APPROVAL_REQUIRED,
...
Your approval is needed to proceed with this sensitive operation.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.AUTHORITY_DISSENT,
...
This dissent triggers a review of the original approval decision per Foster & Starkey protocols.`,
        ...
        this.register({
            id: 'policy_violation',
            eventType: EventSchema_js_1.EventType.POLICY_VIOLATION,
...
This attempt has been logged and blocked. Security review may be required.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.COPILOT_ESCALATION,
...
Please review and provide guidance.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.COPILOT_ANOMALY_DETECTED,
...
This anomaly may require investigation.`,
        ...
        this.register({
            id: 'evidence_added',
            eventType: EventSchema_js_1.EventType.EVIDENCE_ADDED,
...
Review the new evidence and update the investigation status as needed.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.ENTITY_RISK_CHANGED,
...
Review the entity and adjust investigation priorities as needed.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.SYSTEM_HEALTH_DEGRADED,
...
Monitor the situation and be prepared to take action if health continues to degrade.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.BUDGET_THRESHOLD_EXCEEDED,
...
Review spending and adjust resource allocation if necessary.`,
        ...
        this.register({
            ...
            eventType: EventSchema_js_1.EventType.NOTIFICATION_DIGEST,
