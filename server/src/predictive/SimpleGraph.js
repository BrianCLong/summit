...
exports.SimpleGraphEngine = void 0;
class SimpleGraphEngine {
    ...
    calculateDegreeCentrality() {
        ...
        this.edges.forEach(e => {
            if (centrality[e.source] !== undefined)
                centrality[e.source]++;
            if (centrality[e.target] !== undefined)
                centrality[e.target]++;
        });
        // Normalize
...
exports.SimpleGraphEngine = SimpleGraphEngine;
