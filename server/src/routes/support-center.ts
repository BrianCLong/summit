...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const query = (req.query.q as string) as string;
      const category = (req.query.category as string) as string | undefined;
      const locale = (req.query.locale as string) as string | undefined;
      const limit = (req.query.limit as string) ? parseInt((req.query.limit as string) as string) : undefined;
...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const locale = (req.query.locale as string) as string | undefined;
      const limit = (req.query.limit as string) ? parseInt((req.query.limit as string) as string) : undefined;
      const offset = (req.query.offset as string) ? parseInt((req.query.offset as string) as string) : undefined;
