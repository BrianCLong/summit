...
const graph_explainer_js_1 = __importDefault(require("../services/xai/graph-explainer.js"));
const detectors_js_1 = __importDefault(require("../services/xai/detectors.js"));
const logger_js_1 = __importDefault(require("../utils/logger.js"));
const http_param_js_1 = require("../utils/http-param.js");
const router = express_1.default.Router();
const xaiExplainer = graph_explainer_js_1.default.getInstance();
const detectorService = detectors_js_1.default.getInstance();
...
router.post('/explain', (0, authority_js_1.requireAuthority)('graph_xai_analysis', ['explanation', 'model_inference']), async (req, res) => {
    try {
...
router.get('/model-cards/:version?', (0, authority_js_1.requireAuthority)('graph_xai_analysis', ['model_card']), async (req, res) => {
    try {
        const version = (0, http_param_js_1.firstString)(req.params.version);
        if (version) {
...
router.post('/detect', (0, authority_js_1.requireAuthority)('graph_xai_analysis', ['detection', 'pattern_analysis']), async (req, res) => {
    try {
...
router.post('/cache/clear', (0, authority_js_1.requireAuthority)('graph_xai_analysis', ['cache_management']), async (req, res) => {
    try {
        const user = req.user;
...
router.get('/cache/stats', (0, authority_js_1.requireAuthority)('graph_xai_analysis', ['cache_stats']), async (req, res) => {
    try {
...
router.post('/explain/batch', (0, authority_js_1.requireAuthority)('graph_xai_analysis', ['batch_explanation']), async (req, res) => {
    try {
