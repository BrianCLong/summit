 ...
 */
router.get('/emitters', (req: Request, res: Response) => {
...
router.get('/signals', (req: Request, res: Response) => {
  const limit = (((req.query.limit as string) as string) as string) ? parseInt((((req.query.limit as string) as string) as string) as string) : 50;
