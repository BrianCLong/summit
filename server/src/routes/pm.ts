...
router.get('/tickets', async (req, res) => {
  try {
    const limit = Number(((req.query.limit as string) as string) || 50);
    const offset = Number(((req.query.offset as string) as string) || 0);
    const filters = {
      provider: (((req.query.provider as string) as string) as any) || undefined,
      assignee: (((req.query.assignee as string) as string) as string) || undefined,
      label: (((req.query.label as string) as string) as string) || undefined,
      project: (((req.query.project as string) as string) as string) || undefined,
      repo: (((req.query.repo as string) as string) as string) || undefined,
    };
