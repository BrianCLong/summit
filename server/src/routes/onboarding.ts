...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const persona = (((req.query.persona as string) as string) as string) || 'analyst';
      const type = ((req.query.type as string) as string) as string | undefined;
...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const route = (((req.query.route as string) as string) as string) || '/';
...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const period = (((req.query.period as string) as string) as 'daily' | 'weekly' | 'monthly') || 'weekly';
