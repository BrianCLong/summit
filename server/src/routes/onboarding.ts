...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const persona = (((req.query.perso as string)n as string)a as string) || 'analyst';
      const type = ((req.query.ty as string)p as string)e as string | undefined;
...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const route = (((req.query.rou as string)t as string)e as string) || '/';
...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const period = (((req.query.perio as string)d as string) as 'daily' | 'weekly' | 'monthly') || 'weekly';
