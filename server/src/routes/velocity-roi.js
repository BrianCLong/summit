...
const VelocityTracker_js_1 = require("../products/VelocityROI/VelocityTracker.js");
const ROICalculator_js_1 = require("../products/VelocityROI/ROICalculator.js");
const router = (0, express_1.Router)();
const tracker = new VelocityTracker_js_1.VelocityTracker();
const calculator = new ROICalculator_js_1.ROICalculator(tracker);
// Seed some data
