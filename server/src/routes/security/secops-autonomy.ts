...
import { evaluatePolicy, SecOpsMode } from '../../../../packages/security-agents/src/policy/index';
import {
  alertSchema,
  incidentSchema,
  agentActionSchema
} from '../../../../packages/security-agents/src/schemas/entities';

const router = express.Router();

const ingestSchema = z.object({
  kind: z.enum(['alert', 'event']),
  payload: alertSchema
});
