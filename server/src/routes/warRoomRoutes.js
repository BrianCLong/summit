...
// Initialize controller (would be injected in production)
let warRoomController;
...
router.get('/health', (req, res) => {
  const activeRooms = warRoomController ? warRoomController.warRoomSync.warRooms.size : 0;
