...
exports.aiGovernanceV4Router = void 0;
const express_1 = require("express");
const crypto_1 = require("crypto");
const rbac_js_1 = require("../../middleware/rbac.js");
const logger_js_1 = __importDefault(require("../../utils/logger.js"));
const PolicySuggestionService_js_1 = require("../../ai/governance/PolicySuggestionService.js");
const VerdictExplainerService_js_1 = require("../../ai/governance/VerdictExplainerService.js");
const BehavioralAnomalyService_js_1 = require("../../ai/governance/BehavioralAnomalyService.js");
// =============================================================================
// Service Initialization
// =============================================================================
let policySuggestionService = null;
let verdictExplainerService = null;
...
const initializeServices = async () => {
    if (!policySuggestionService) {
        ...
        policySuggestionService = (0, PolicySuggestionService_js_1.createPolicySuggestionService)(config);
        verdictExplainerService = (0, VerdictExplainerService_js_1.createVerdictExplainerService)(config);
        anomalyService = (0, BehavioralAnomalyService_js_1.createBehavioralAnomalyService)(config);
        await policySuggestionService.initialize();
        logger_js_1.default.info('AI Governance services initialized');
    }
};
// =============================================================================
// Helper Functions
...
const handleError = (error, res, operation) => {
    if (error instanceof PolicySuggestionService_js_1.PolicySuggestionError) {
        const statusMap = {
            NOT_FOUND: 404,
            INVALID_STATE: 400,
    ...
    logger_js_1.default.error({ error, operation }, 'AI Governance API error');
...
exports.aiGovernanceV4Router = router;
...
router.use(async (_req, _res, next) => {
    try {
        ...
        logger_js_1.default.error({ error }, 'Failed to initialize AI governance services');
        next(error);
    }
});
// =============================================================================
 ...
 */
router.post('/policy-suggestions', (0, rbac_js_1.requirePermission)('ai:suggestions:generate'), async (req, res) => {
    try {
 ...
 */
router.get('/policy-suggestions', (0, rbac_js_1.requirePermission)('ai:suggestions:read'), async (req, res) => {
    try {
        const tenantId = getTenantId(req);
 ...
 */
router.get('/policy-suggestions/:id', (0, rbac_js_1.requirePermission)('ai:suggestions:read'), async (req, res) => {
    try {
 ...
 */
router.post('/policy-suggestions/:id/review', (0, rbac_js_1.requirePermission)('ai:suggestions:review'), async (req, res) => {
    try {
        const feedback = {
        ...
        const suggestion = await policySuggestionService.reviewSuggestion(req.params.id, feedback);
        logger_js_1.default.info({
 ...
 */
router.post('/policy-suggestions/:id/implement', (0, rbac_js_1.requirePermission)('ai:suggestions:implement'), async (req, res) => {
    try {
 ...
 */
router.get('/policy-suggestions/statistics', (0, rbac_js_1.requirePermission)('ai:suggestions:read'), async (req, res) => {
    try {
        const tenantId = getTenantId(req);
 ...
 */
router.post('/verdict-explanations', (0, rbac_js_1.requirePermission)('ai:explanations:generate'), async (req, res) => {
    try {
 ...
 */
router.post('/verdict-explanations/batch', (0, rbac_js_1.requirePermission)('ai:explanations:generate'), async (req, res) => {
    try {
 ...
 */
router.post('/anomalies/detect', (0, rbac_js_1.requirePermission)('ai:anomalies:detect'), async (req, res) => {
    try {
        const tenantId = getTenantId(req);
        const scope = {
            tenantIds: [tenantId],
 ...
 */
router.get('/anomalies', (0, rbac_js_1.requirePermission)('ai:anomalies:read'), async (req, res) => {
    try {
        const tenantId = getTenantId(req);
        const now = new Date();
 ...
 */
router.get('/anomalies/:id', (0, rbac_js_1.requirePermission)('ai:anomalies:read'), async (req, res) => {
    try {
 ...
 */
router.patch('/anomalies/:id/status', (0, rbac_js_1.requirePermission)('ai:anomalies:update'), async (req, res) => {
    try {
        const status = req.body.status;
        const notes = req.body.notes;
        const anomaly = await anomalyService.updateAnomalyStatus(req.params.id, status, notes);
        logger_js_1.default.info({
 ...
 */
router.post('/anomalies/:id/resolve', (0, rbac_js_1.requirePermission)('ai:anomalies:resolve'), async (req, res) => {
    try {
        const resolution = {
 ...
 */
router.get('/anomalies/trends', (0, rbac_js_1.requirePermission)('ai:anomalies:read'), async (req, res) => {
    try {
        const tenantId = getTenantId(req);
