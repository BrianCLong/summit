...
const SIEMExportService_js_1 = require("../integrations/SIEMExportService.js");
const router = (0, express_1.Router)();
const explorerService = ExplainabilityExplorerService_js_1.ExplainabilityExplorerService.getInstance();
const siemService = SIEMExportService_js_1.SIEMExportService.getInstance();
/**
...
router.post('/siem', async (req, res) => {
    try {
        ...
        const { provider, endpoint, apiKey, run_ids, filter, batch_size = 100, sourceType, index, tags, } = req.body;
...
router.post('/json', async (req, res) => {
    try {
        ...
        res.setHeader('Content-Disposition', `attachment; filename="explainability-export-${new Date().toISOString()}.json"`);
...
router.post('/csv', async (req, res) => {
    try {
        ...
        res.setHeader('Content-Disposition', `attachment; filename="explainability-export-${new Date().toISOString()}.csv"`);
