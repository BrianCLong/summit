...
exports.PATTERN_COUNT = exports.defaultPatternLibrary = void 0;
const pattern = (id, type, regex, confidence, description, contextHints = [], examples = []) => ({
    id,
    type,
    regex,
    confidence,
...
exports.PATTERN_COUNT = exports.defaultPatternLibrary.length;
