...
exports.CATALOG_METADATA_SCHEMA = exports.CYPHER_SENSITIVITY_QUERIES = exports.SQL_SENSITIVITY_SCHEMA = void 0;
exports.toGraphProperties = toGraphProperties;
exports.fromGraphProperties = fromGraphProperties;
exports.toSQLColumns = toSQLColumns;
/**
 * Convert SensitivityMetadata to Graph properties
 */
function toGraphProperties(metadata) {
    return {
 ...
 */
function fromGraphProperties(props) {
    const piiTypes = props.piiTypes.split(',').filter(Boolean);
    const regulatoryTags = props.regulatoryTags.split(',').filter(Boolean);
    const policyTags = props.policyTags.split(',').filter(Boolean);
    return {
        sensitivityClass: props.sensitivityClass,
        piiTypes,
 ...
 */
function toSQLColumns(metadata) {
    return {
 ...
 */
exports.SQL_SENSITIVITY_SCHEMA = `
 ...
 */
exports.CYPHER_SENSITIVITY_QUERIES = {
    /**
 ...
 */
exports.CATALOG_METADATA_SCHEMA = `
