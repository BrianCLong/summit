...
exports.finOpsService = exports.FINOPS_SCHEMA = exports.FinOpsObservabilityService = void 0;
exports.createFinOpsRouter = createFinOpsRouter;
const postgres_js_1 = require("../db/postgres.js");
const otel_tracing_js_1 = require("../middleware/observability/otel-tracing.js");
const ioredis_1 = __importDefault(require("ioredis"));
const express_1 = __importDefault(require("express"));
class FinOpsObservabilityService {
    redis;
    constructor() {
    ...
    async getCostMetrics(tenantId, timeframe = '24h') {
        const span = otel_tracing_js_1.otelService.createSpan('finops.get_cost_metrics');
        try {
            ...
            const buildQuery = (baseQuery, useTenantFilter) => {
                let query = baseQuery;
    ...
    async getPerformanceMetrics(timeframe = '1h') {
        const span = otel_tracing_js_1.otelService.createSpan('finops.get_performance_metrics');
        try {
            const pool = (0, postgres_js_1.getPostgresPool)();
    ...
    async getSLOMetrics() {
        const span = otel_tracing_js_1.otelService.createSpan('finops.get_slo_metrics');
        try {
    ...
    async getSlowQueryMetrics() {
        const span = otel_tracing_js_1.otelService.createSpan('finops.get_slow_query_metrics');
        try {
            const pool = (0, postgres_js_1.getPostgresPool)();
    ...
    async createAlert(condition, threshold, metric, tenantId) {
        const pool = (0, postgres_js_1.getPostgresPool)();
        await pool.query(`
...
exports.FinOpsObservabilityService = FinOpsObservabilityService;
// API Router
function createFinOpsRouter() {
    const router = express_1.default.Router();
    const service = new FinOpsObservabilityService();
    router.get('/cost-metrics', async (req, res) => {
        try {
            const { tenantId, timeframe } = req.query;
...
`;
exports.finOpsService = new FinOpsObservabilityService();
