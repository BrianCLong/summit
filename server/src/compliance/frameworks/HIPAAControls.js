...
exports.HIPAAComplianceService = exports.HIPAA_CONTROL_COUNT = exports.ALL_HIPAA_CONTROLS = exports.BREACH_NOTIFICATION_CONTROLS = exports.TECHNICAL_SAFEGUARDS = exports.ADMINISTRATIVE_SAFEGUARDS = exports.PHI_IDENTIFIERS = exports.HIPAA_FRAMEWORK = void 0;
exports.createHIPAAComplianceService = createHIPAAComplianceService;
// =============================================================================
...
// =============================================================================
exports.ADMINISTRATIVE_SAFEGUARDS = [
...
// =============================================================================
exports.BREACH_NOTIFICATION_CONTROLS = [
    {
        id: 'HIPAA-BN-001',
        framework: 'HIPAA',
...
// Export All Controls
// =============================================================================
exports.ALL_HIPAA_CONTROLS = [
    ...exports.ADMINISTRATIVE_SAFEGUARDS,
    ...exports.TECHNICAL_SAFEGUARDS,
    ...exports.BREACH_NOTIFICATION_CONTROLS,
];
exports.HIPAA_CONTROL_COUNT = {
    administrative: exports.ADMINISTRATIVE_SAFEGUARDS.length,
    technical: exports.TECHNICAL_SAFEGUARDS.length,
    breachNotification: exports.BREACH_NOTIFICATION_CONTROLS.length,
    total: exports.ALL_HIPAA_CONTROLS.length,
};
class HIPAAComplianceService {
     ...
     */
    getControls() {
        return exports.ALL_HIPAA_CONTROLS;
    }
    /**
     * Get a specific control by ID
     */
    getControl(controlId) {
        return exports.ALL_HIPAA_CONTROLS.find((c) => c.id === controlId);
    }
    /**
     * Get controls by category
     */
    getControlsByCategory(category) {
        return exports.ALL_HIPAA_CONTROLS.filter((c) => c.category === category);
    }
    /**
     * Get all PHI identifiers
     */
    getPHIIdentifiers() {
        return exports.PHI_IDENTIFIERS;
    }
    /**
    ...
    async performAssessment(tenantId, options = {}) {
        ...
        let controls = exports.ALL_HIPAA_CONTROLS;
        ...
        const report = {
            ...
            controlResults,
            summary,
            phiCategories: exports.PHI_IDENTIFIERS.map((p) => p.id),
...
exports.default = {
    framework: exports.HIPAA_FRAMEWORK,
    identifiers: exports.PHI_IDENTIFIERS,
    controls: exports.ALL_HIPAA_CONTROLS,
    counts: exports.HIPAA_CONTROL_COUNT,
};
