...
exports.ForesightService = void 0;
...
class ForesightService {
    ...
    async runSimulation(scenarioName, parameters, tenantId) {
        ...
        let driver;
        try {
            driver = (0, database_js_1.getNeo4jDriver)();
        }
        catch {
            return {
    ...
    async generateOpportunities(tenantId) {
...
exports.ForesightService = ForesightService;
