...
exports.InventionService = void 0;
const database_js_1 = require("../../config/database.js");
const PriorArtService_js_1 = require("./PriorArtService.js");
const LLMService_js_1 = __importDefault(require("../../services/LLMService.js"));
class InventionService {
    static instance;
    // Lazily access services
    get priorArtService() { return PriorArtService_js_1.PriorArtService.getInstance(); }
    llmService;
    constructor() {
    ...
    async generateInvention(inputConcepts, problemStatement, tenantId) {
        // 1. Search Prior Art
...
exports.InventionService = InventionService;
