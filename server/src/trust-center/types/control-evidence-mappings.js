...
exports.CONTROL_MAPPINGS = exports.CHANGE_MANAGEMENT_MAPPING = exports.BACKUP_RECOVERY_MAPPING = exports.ACCESS_CONTROL_MAPPING = void 0;
exports.getControlDefinition = getControlDefinition;
exports.getControlsByFramework = getControlsByFramework;
exports.getFrameworkControlId = getFrameworkControlId;
// =============================================================================
// ACCESS CONTROL (CC6.1 / A.9.4.1 / AC-3)
// =============================================================================
exports.ACCESS_CONTROL_MAPPING = {
    id: 'ACCESS-001',
...
// =============================================================================
exports.BACKUP_RECOVERY_MAPPING = {
    id: 'BACKUP-001',
...
// =============================================================================
exports.CHANGE_MANAGEMENT_MAPPING = {
    id: 'CHANGE-001',
...
// =============================================================================
exports.CONTROL_MAPPINGS = {
    'ACCESS-001': exports.ACCESS_CONTROL_MAPPING,
    'BACKUP-001': exports.BACKUP_RECOVERY_MAPPING,
    'CHANGE-001': exports.CHANGE_MANAGEMENT_MAPPING,
};
/**
 * Get control definition by ID
 */
function getControlDefinition(controlId) {
    return exports.CONTROL_MAPPINGS[controlId];
}
/**
 * Get controls by framework
 */
function getControlsByFramework(framework) {
    return Object.values(exports.CONTROL_MAPPINGS).filter((control) => control.frameworkMappings.some((m) => m.framework === framework));
}
/**
 * Get framework control ID for a given control
 */
function getFrameworkControlId(controlId, framework) {
    const control = exports.CONTROL_MAPPINGS[controlId];
    if (!control)
        return undefined;
