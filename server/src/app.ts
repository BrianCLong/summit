...
import { ensureRole, ensureAuthenticated } from './middleware/auth.js';
...
export const createApp = async () => {
  ...
  app.use('/api/policy-proposals', ensureAuthenticated, policyProposalsRouter);
  app.use('/api/council', ensureAuthenticated, councilRouter);
