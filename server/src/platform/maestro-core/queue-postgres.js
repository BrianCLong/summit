...
exports.PostgresTaskQueue = void 0;
class PostgresTaskQueue {
    ...
    async ack(taskId) {
        await this.pool.query(`UPDATE maestro_tasks SET status = 'COMPLETED', updated_at = NOW() WHERE id = $1`, [taskId]);
    }
    async nack(taskId, error) {
        ...
        await this.pool.query(`UPDATE maestro_tasks
...
exports.PostgresTaskQueue = PostgresTaskQueue;
