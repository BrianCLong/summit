        ...
        try {
            ...
            if (targetTenant !== sourceTenant) {
                ...
                try {
                    ...
                    const ctx = { user: { id: 'sim-user', tenantId: sourceTenant, roles: ['ANALYST'] } };
                    tenantValidator_js_1.TenantValidator.validateTenantAccess(ctx, targetTenant, { validateOwnership: true });
