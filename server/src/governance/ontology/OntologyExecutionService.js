...
exports.OntologyExecutionService = void 0;
const SchemaRegistryService_js_1 = require("./SchemaRegistryService.js");
const crypto_1 = require("crypto");
class OntologyExecutionService {
    static instance;
    registry;
    constructor(registry) {
        this.registry = registry || SchemaRegistryService_js_1.SchemaRegistryService.getInstance();
    }
    static getInstance() {
...
exports.OntologyExecutionService = OntologyExecutionService;
