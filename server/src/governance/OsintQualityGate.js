...
exports.OsintQualityGate = void 0;
class OsintQualityGate {
    /**
     ...
     */
    static enforceConfidenceFloor(assessment) {
     ...
     */
    static validateIndependence(sources) {
        if (sources.length < 2) {
...
exports.OsintQualityGate = OsintQualityGate;
