...
exports.getTlpMarking = getTlpMarking;
exports.getTlpMarkingRef = getTlpMarkingRef;
exports.buildIntelGraphExtension = buildIntelGraphExtension;
exports.mapEntityToStix = mapEntityToStix;
exports.createRelationship = createRelationship;
exports.createSighting = createSighting;
exports.createProducerIdentity = createProducerIdentity;
...
const generateStixId = (type) => `${type}--${(0, node_crypto_1.randomUUID)()}`;
...
// ============================================================================
function getTlpMarking(level) {
    switch (level) {
        case 'clear':
            return types_js_1.TLP_CLEAR;
        case 'white':
            return types_js_1.TLP_WHITE;
        case 'green':
            return types_js_1.TLP_GREEN;
        case 'amber':
            return types_js_1.TLP_AMBER;
        case 'amber+strict':
            return types_js_1.TLP_AMBER_STRICT;
        case 'red':
            return types_js_1.TLP_RED;
        default:
            return types_js_1.TLP_GREEN;
    }
}
function getTlpMarkingRef(level) {
    return getTlpMarking(level).id;
}
// ============================================================================
// IntelGraph Extension Builder
// ============================================================================
function buildIntelGraphExtension(entity, options = {}) {
    return {
        [types_js_1.INTELGRAPH_EXTENSION_ID]: {
...
function mapToIdentity(entity, ctx) {
...
function mapToThreatActor(entity, ctx) {
    const props = entity.props || {};
    return {
        type: 'threat-actor',
        spec_version: '2.1',
...
function mapToCampaign(entity, ctx) {
    const props = entity.props || {};
    return {
        type: 'campaign',
        spec_version: '2.1',
...
function mapToAttackPattern(entity, ctx) {
    const props = entity.props || {};
    return {
        type: 'attack-pattern',
        spec_version: '2.1',
...
function mapToIndicator(entity, ctx) {
    const props = entity.props || {};
...
function mapToMalware(entity, ctx) {
    const props = entity.props || {};
    return {
        type: 'malware',
        spec_version: '2.1',
...
function mapToVulnerability(entity, ctx) {
    const props = entity.props || {};
    return {
        type: 'vulnerability',
        spec_version: '2.1',
...
function mapToInfrastructure(entity, ctx) {
    const props = entity.props || {};
    return {
        type: 'infrastructure',
        spec_version: '2.1',
...
function mapToIntrusionSet(entity, ctx) {
    const props = entity.props || {};
    return {
        type: 'intrusion-set',
        spec_version: '2.1',
...
function mapToLocation(entity, ctx) {
    const props = entity.props || {};
    return {
        type: 'location',
        spec_version: '2.1',
...
function mapToReport(entity, ctx) {
    const props = entity.props || {};
    return {
        type: 'report',
        spec_version: '2.1',
...
// ============================================================================
function buildStixPattern(iocType, value) {
...
function mapEntityToStix(entity, ctx = {}) {
...
function createRelationship(input, ctx = {}) {
    return {
        type: 'relationship',
        spec_version: '2.1',
...
function createSighting(input, ctx = {}) {
    return {
        type: 'sighting',
        spec_version: '2.1',
...
// ============================================================================
function createProducerIdentity(name, identityClass = 'organization') {
    return {
        type: 'identity',
        spec_version: '2.1',
        id: generateStixId('identity'),
