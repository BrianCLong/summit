...
exports.necromancerService = exports.NecromancerService = void 0;
...
class NecromancerService {
    ...
    initializeActiveSynthetics() {
        const leader1 = {
            syntheticId: `syn-${(0, crypto_1.randomUUID)()}`,
    ...
    async initiateDigitalAfterlife(params) {
        ...
        const syntheticId = `syn-${(0, crypto_1.randomUUID)()}`;
        const newSynthetic = {
            syntheticId,
    ...
    async getSyntheticActivity(syntheticId, limit = 5) {
        ...
        for (let i = 0; i < limit; i++) {
            ...
            activities.push({
                logId: `act-${(0, crypto_1.randomUUID)()}`,
                syntheticId,
                platform,
                activityType: 'post',
...
exports.NecromancerService = NecromancerService;
// Export a singleton instance
exports.necromancerService = new NecromancerService();
