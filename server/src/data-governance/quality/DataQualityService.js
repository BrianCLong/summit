...
const DataCatalogService_js_1 = require("../catalog/DataCatalogService.js");
const uuid_1 = require("uuid");
class DataQualityService {
    static instance;
    catalog;
    constructor() {
        this.catalog = DataCatalogService_js_1.DataCatalogService.getInstance();
    }
    static getInstance() {
    ...
    async defineRule(rule) {
        ...
        await pool.query(`INSERT INTO data_quality_rules (
    ...
    async runChecks(assetId, tenantId) {
        ...
        for (const rule of rules) {
            ...
            results.push(result);
            await pool.query(`INSERT INTO data_quality_results (
