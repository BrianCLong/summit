...
class GraphOpsServer {
    ...
    async executeQuery(args, isWrite = false) {
...
exports.GraphOpsServer = GraphOpsServer;
// Export for use in main server
exports.default = GraphOpsServer;
