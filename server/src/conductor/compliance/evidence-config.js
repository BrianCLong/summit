...
exports.getEvidenceStoreMonitoring = exports.getEvidenceStoreIAMPolicy = exports.getCloudTrailConfig = exports.getS3BucketPolicy = exports.getS3LifecyclePolicy = exports.getEvidenceStoreConfig = void 0;
/**
 * Evidence Store Configuration for Different Environments
 */
const getEvidenceStoreConfig = () => {
...
exports.getS3LifecyclePolicy = getS3LifecyclePolicy;
/**
 * Bucket Policy for Evidence Store
 * Enforces encryption and access controls
 */
const getS3BucketPolicy = (bucketName, kmsKeyArn) => ({
    Version: '2012-10-17',
    Statement: [
        {
 ...
 */
const getCloudTrailConfig = (bucketName) => ({
...
exports.getCloudTrailConfig = getCloudTrailConfig;
/**
 * IAM Policy for Conductor Evidence Store Access
 */
const getEvidenceStoreIAMPolicy = (bucketName, kmsKeyArn) => ({
    Version: '2012-10-17',
    Statement: [
        {
            Effect: 'Allow',
...
exports.getEvidenceStoreIAMPolicy = getEvidenceStoreIAMPolicy;
/**
 * Evidence Store Monitoring Configuration
 */
const getEvidenceStoreMonitoring = () => ({
    cloudWatchMetrics: {
...
exports.getEvidenceStoreMonitoring = getEvidenceStoreMonitoring;
