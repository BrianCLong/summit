...
exports.executeR1Example = executeR1Example;
exports.executeR2Example = executeR2Example;
exports.executeR3Example = executeR3Example;
 ...
 */
async function executeR1Example() {
 ...
 */
async function executeR2Example() {
    console.log('\n=== R2: Phishing Cluster Discovery (DFIR) ===\n');
 ...
 */
async function executeR3Example() {
    console.log('\n=== R3: Disinformation Network Mapping ===\n');
