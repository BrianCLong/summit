...
exports.sampleRunbooks = void 0;
exports.loadSampleRunbooks = loadSampleRunbooks;
const registry_js_1 = require("./registry.js");
exports.sampleRunbooks = [
    {
        id: 'incident-001',
 ...
 */
async function loadSampleRunbooks() {
    try {
        console.log('Loading sample runbooks...');
        for (const runbook of exports.sampleRunbooks) {
            try {
                await registry_js_1.runbookRegistry.registerRunbook(runbook, 'system');
        ...
        console.log(`Successfully loaded ${exports.sampleRunbooks.length} sample runbooks`);
    }
    catch (error) {
