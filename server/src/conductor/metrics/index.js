...
exports.healthChecker = exports.conductorMetrics = exports.HealthChecker = exports.ConductorMetrics = void 0;
exports.getConductorHealth = getConductorHealth;
...
exports.ConductorMetrics = ConductorMetrics;
...
// Singleton instances
exports.conductorMetrics = new ConductorMetrics();
exports.healthChecker = new HealthChecker(exports.conductorMetrics);
/**
 * Get conductor system health for API endpoints
 */
async function getConductorHealth() {
    return await exports.healthChecker.checkHealth();
}
