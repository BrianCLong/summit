 ...
 */
export function setPolicyService(service) {
    policyService = service;
}
/**
 * Higher-order resolver that enforces authentication and authorization
 */
export function withAuthAndPolicy(action, resourceFactory) {
 ...
 */
export function entityResource(entityId, investigationId, orgId, teamId) {
    return {
        type: 'entity',
        id: entityId,
        investigationId,
 ...
 */
export function relationshipResource(relationshipId, investigationId, orgId, teamId) {
    return {
        type: 'relationship',
        id: relationshipId,
        investigationId,
