...
module.exports = {
    ...
    async up(session) {
        ...
        await session.run('CREATE INDEX location_id IF NOT EXISTS FOR (l:Location) ON (l.id)');
        await session.run('CREATE INDEX event_id IF NOT EXISTS FOR (e:Event) ON (e.id)');
    },
    /**
