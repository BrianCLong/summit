async;
runFaceDetection(filePath, string, options, any);
...
async;
runSpeechToText(filePath, string, options, any);
Promise < ExtractedEntity[] > {
    try: {
        const: speechOptions = {
        ...
        const: entities, ExtractedEntity, []:  = [],
        for(, segment, of, results) { }, : .segments
    }
};
{
    entities.push({
...
async;
runTextAnalysis(text, string, options, any);
Promise < ExtractedEntity[] > {
    try: {
        ...
        const: entities, ExtractedEntity, []:  = [],
        // Add named entities
        for(, entity, of, results) { }, : .entities
    }
};
{
    entities.push({
...
async;
runEmbeddingGeneration(mediaSource, any, options, any);
Promise < ExtractedEntity[] > {
    try: {
        const: entities, ExtractedEntity, []:  = [],
...
//# sourceMappingURL=ExtractionJobService.updated.js.map