...
const v040Schema = gql(readFileSync(join(__dirname, '../../../graphql/v040/mc-admin.v040.graphql'), 'utf8'));
const base = gql `
  scalar JSON
...
`;
export const typeDefs = [base, coreTypeDefs, copilotTypeDefs, graphTypeDefs, graphragTypes, aiTypeDefs, v040Schema];
