...
export const marketplaceResolvers = {
    Query: {
        skus: () => skus,
        orders: (_, { tenantId }) => orders.filter(o => o.tenantId === tenantId),
        entitlementProof: (_, { entitlementId }) => transparency.proof(entitlementId)
    },
    Mutation: {
        buySku: (_, { tenantId, skuId, epsilonCap, region }) => {
        ...
        revokeEntitlement: (_, { entitlementId }) => {
