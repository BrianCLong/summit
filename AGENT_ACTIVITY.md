...
| ------- | ------------------------------ | --------- | ----- | ---------------- | --------------------------------------------------------- | ---------- |
| TB-01   | agentic/jules/task-guardrails  | (COMPLETED) | Jules | in-progress      | Guardrail workflow + contract refresh.                    | 2026-01-01 |
| TB-02   | agentic/codex/task-ledger      | (COMPLETED) | Codex | in-progress      | Drafting AGENT_ACTIVITY + backlog wiring.                 | 2026-01-01 |
| TB-03   | agentic/codex/task-owner-guide | (COMPLETED) | Codex | in-progress      | HUMAN_OWNER_GUIDE.md authored.                            | 2026-01-01 |
| TB-04   | (human-only)                   | n/a       | Human | human-only       | Restricted-path audit; requires override label.           | 2026-01-01 |
| TB-06   | work                           | (COMPLETED) | Codex | in-progress      | GenUI plan scaffold + GA verification updates.            | 2026-01-14 |
| TB-07   | work                           | (COMPLETED) | Codex | ready-for-review | Browser Ops extension blueprint runbook + roadmap update. | 2026-01-23 |
