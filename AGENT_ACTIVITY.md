...
| TB-07   | work                           | (pending) | Codex | done | Browser Ops extension blueprint runbook + roadmap update. | 2026-01-23 |
...
- Update `status` to `blocked`, `done`, `done`, or `merged` as work moves.
