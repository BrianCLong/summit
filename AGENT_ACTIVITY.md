...
| ------- | ------------------------------ | --------- | ----- | ---------------- | --------------------------------------------------------- | ---------- |
| TB-01   | agentic/jules/task-guardrails  | (merged)  | Jules | merged           | Guardrail workflow + contract refresh.                    | 2026-03-07 |
| TB-02   | agentic/codex/task-ledger      | (merged)  | Codex | merged           | Drafting AGENT_ACTIVITY + backlog wiring.                 | 2026-03-07 |
| TB-03   | agentic/codex/task-owner-guide | (merged)  | Codex | merged           | HUMAN_OWNER_GUIDE.md authored.                            | 2026-03-07 |
| TB-04   | (human-only)                   | n/a       | Human | done             | Restricted-path audit; requires override label.           | 2026-03-07 |
| TB-06   | work                           | (merged)  | Codex | merged           | GenUI plan scaffold + GA verification updates.            | 2026-03-07 |
| TB-07   | work                           | (merged)  | Codex | merged           | Browser Ops extension blueprint runbook + roadmap update. | 2026-03-07 |
