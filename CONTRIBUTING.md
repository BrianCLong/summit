...
- **Release notes discipline**: Every release notes file in `docs/releases/` **must** include "Upgrade Notes" and "Migration Notes" sections. Start from `docs/release/UPGRADE_NOTES_TEMPLATE.md` and run `scripts/check-upgrade-notes.sh` locally; CI will block PRs missing these sections.
