...
export default function HomePage() {
  return (
    <div className="space-y-10">
      <Section kicker={topicality.hero.kicker} title={topicality.hero.title} subtitle={topicality.hero.subtitle}>
        <div className="flex flex-wrap gap-3 pt-4">
          <Button href="/summit" onClick={() => track("nav_click", { to: "/summit", label: "Explore Summit" })}>
            Explore Summit
          </Button>
          <Button
            variant="secondary"
      ...
      >
        ...
        <div className="pt-5">
          <Button href="/summit" onClick={() => track("cta_click", { id: "home_summit_primary", to: "/summit" })}>
            Go to Summit →
          </Button>
        </div>
      </Section>
