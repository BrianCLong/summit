...
export default function SummitOverview() {
  return (
    <div className="space-y-10">
      <Section kicker="Summit" title={summit.hero.title} subtitle={summit.hero.subtitle}>
        <div className="flex flex-wrap gap-3 pt-4">
          <Button href="/summit/pages/capabilities" onClick={() => track("cta_click", { id: "summit_overview_capabilities" })}>
            Capabilities
          </Button>
          <Button
            variant="secondary"
            href="/summit/pages/architecture"
            onClick={() => track("cta_click", { id: "summit_overview_architecture" })}
          >
            Architecture
          </Button>
        </div>
      ...
      <Section kicker="Live testing" title="Instrumented to learn" subtitle="Every meaningful interaction can be measured without collecting sensitive content.">
