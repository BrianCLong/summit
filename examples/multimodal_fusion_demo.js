...
const AudioSentimentAnalyzer_js_1 = require("../server/src/services/audio/AudioSentimentAnalyzer.js");
const VisualEmotionAnalyzer_js_1 = require("../server/src/services/vision/VisualEmotionAnalyzer.js");
const MultimodalSentimentFusion_js_1 = require("../server/src/services/multimodal/MultimodalSentimentFusion.js");
/**
...
async function main() {
    ...
    const audioAnalyzer = new AudioSentimentAnalyzer_js_1.AudioSentimentAnalyzer();
    const visualAnalyzer = new VisualEmotionAnalyzer_js_1.VisualEmotionAnalyzer();
    const fuser = new MultimodalSentimentFusion_js_1.MultimodalSentimentFusion();
