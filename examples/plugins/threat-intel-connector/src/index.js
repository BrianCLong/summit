 ...
 */
class ThreatIntelConnectorPlugin extends plugin_system_1.ConnectorExtension {
    connectionConfig;
    ...
    async fetch(request) {
        ...
        try {
            ...
            this.log.error('Failed to fetch threat intelligence', error);
            throw error;
        }
    }
    /**
...
5. Test connection and enable plugin
     ...
     */
    transformToEntities(indicators) {
     ...
     */
    extractRelationships(indicators) {
        const relationships = [];
...
exports.default = ThreatIntelConnectorPlugin;
