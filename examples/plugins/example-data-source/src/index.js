...
const extension_api_1 = require("@intelgraph/extension-api");
/**
 * Example data source plugin that connects to a REST API
 */
class RestAPIDataSource extends extension_api_1.BaseDataSourceExtension {
    baseUrl;
    apiKey;
    constructor(config) {
...
exports.default = (0, plugin_sdk_1.createPlugin)()
    .withMetadata({
    ...
    .requestPermissions(plugin_sdk_1.PluginPermission.NETWORK_ACCESS, plugin_sdk_1.PluginPermission.READ_DATA)
    .withResources({
    maxMemoryMB: 128,
    maxCpuPercent: 30,
    maxStorageMB: 50,
