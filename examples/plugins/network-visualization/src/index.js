 ...
 */
class NetworkVisualizationPlugin extends plugin_system_1.VisualizationExtension {
    renderCount = 0;
    ...
    async render(input) {
        ...
        try {
            ...
            this.log.error('Failed to render visualization', error);
            throw error;
        }
    }
    /**
     ...
     */
    buildVisualizationConfig(nodes, edges, input) {
...
exports.default = NetworkVisualizationPlugin;
