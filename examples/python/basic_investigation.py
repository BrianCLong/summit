...
def main():
    ...
    graph = client.graphs.create(
        ...
        configuration={"layout": "force-directed", "theme": "dark", "autoSave": True},
    )
    ...
    suspect2 = client.entities.create(
        ...
        metadata={"source": "Financial Records", "confidence": 0.92},
    )
    ...
    organization = client.entities.create(
        ...
        metadata={"source": "Corporate Registry", "confidence": 0.95},
    )
    ...
    account = client.entities.create(
        ...
        metadata={"source": "Financial Intelligence Unit", "confidence": 0.98},
    )
    ...
    rel1 = client.relationships.create(
        ...
        properties={"position": "Director", "startDate": "2020-01-15", "salary": 250000},
        metadata={"source": "Employment Records", "confidence": 0.90},
    )
    ...
    rel2 = client.relationships.create(
        ...
        properties={"controlLevel": "Full", "startDate": "2020-02-01"},
    )
    ...
    people_entities = client.entities.list(graph_id=graph.id, type="Person", limit=10)
    ...
    try:
        ...
        if "communities" in results.results:
            ...
            for i, community in enumerate(communities, 1):
                print(
                    f"   Community {i}: {community['size']} members (density: {community['density']:.2f})"
                )
        ...
        if results.insights:
            ...
            for insight in results.insights:
                ...
                print(
                    f"   - [{insight['type']}] {insight['description']} (confidence: {conf_pct}%)"
                )
