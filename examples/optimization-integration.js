...
exports.monitoringExample = exports.intelligentModelSelectionExample = exports.customCircuitBreakerExample = exports.customCacheExample = void 0;
const express_1 = __importDefault(require("express"));
const index_js_1 = require("../server/src/optimization/index.js");
/**
...
const optimizationManager = new index_js_1.OptimizationManager({
    enabled: true,
    neo4j: {
...
async function setupOptimization() {
    try {
        ...
        app.post('/api/neo4j/query', middleware.neo4jQuery({
            useCache: true,
            cacheTtl: 600,
            timeout: 15000,
        }), async (req, res) => {
        ...
        app.post('/api/postgres/query', middleware.postgresQuery({
            useCache: true,
            cacheTtl: 300,
            readOnly: true,
        }), async (req, res) => {
...
exports.customCacheExample = customCacheExample;
// Example 2: Circuit breaker with custom configuration
const customCircuitBreakerExample = () => {
...
exports.customCircuitBreakerExample = customCircuitBreakerExample;
// Example 3: Intelligent model selection with constraints
const intelligentModelSelectionExample = async () => {
...
exports.intelligentModelSelectionExample = intelligentModelSelectionExample;
