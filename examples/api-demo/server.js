...
const src_1 = require("../../packages/api-framework/src");
const src_2 = require("../../packages/rest-api/src");
// Mock database
const mockDB = {
    entities: new Map([
...
// Create API
const api = (0, src_1.createSummitAPI)({
    rest: {
        version: '1.0.0',
...
api.rest.router.resource('entities', {
    ...
    list: async (req, res) => {
        ...
        const pagination = (0, src_2.addPaginationMetadata)(req, total, paginated.length);
        req.pagination = pagination;
        const links = (0, src_2.generateHATEOASLinks)(req);
    ...
    get: async (req, res) => {
        ...
        if (!entity) {
            throw new src_2.NotFoundException('Entity');
        }
        res.success(entity);
    },
    // Create entity
...
setInterval(() => {
    const entity = Array.from(mockDB.entities.values())[Math.floor(Math.random() * mockDB.entities.size)];
