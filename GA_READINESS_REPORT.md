...
**Critical:** The Neo4j constraints must be applied _before_ the application starts.
...
Tenant profiles specialize GA readiness by applying governed overlays rather than forking code.
The Summit Readiness Assertion remains authoritative; profiles only tighten requirements.

- **natsec_high_security**: dual-control signoffs, stricter evidence packs, airgapped-first rollout.
- **enterprise_f100**: enterprise ops signoff, enhanced stabilization evidence.
- **newsroom_osint**: accelerated stabilization window with governance logging on high risk.
