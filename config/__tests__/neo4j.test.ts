...
describe("applyIndexes", () => {
  ...
  it("should skip existing indexes when skipExisting is true", async () => {
    mockSession.run = jest.fn().mockRejectedValue(new Error("Index already exists"));

    const indexes = [{ label: "Entity", properties: ["id"] }];
  ...
  it("should create fulltext indexes with correct syntax", async () => {
    const indexes = [{ label: "Entity", properties: ["name"], type: "FULLTEXT" as const }];
  ...
  it("should create composite indexes", async () => {
    const indexes = [{ label: "Entity", properties: ["tenantId", "type"] }];
...
describe("applyConstraints", () => {
  ...
  it("should create unique constraints", async () => {
    const constraints = [{ label: "Entity", properties: ["id"], type: "UNIQUE" as const }];
  ...
  it("should create existence constraints", async () => {
    const constraints = [{ label: "Entity", properties: ["tenantId"], type: "EXISTS" as const }];
