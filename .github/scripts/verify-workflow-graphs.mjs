...
const stamp = JSON.parse(fs.readFileSync("evidence/workflow-graphs/stamp.json", "utf8"));
const report = JSON.parse(fs.readFileSync("evidence/workflow-graphs/report.json", "utf8"));
...
scanJson(JSON.parse(fs.readFileSync("evidence/workflow-graphs/metrics.json", "utf8")), "metrics");
