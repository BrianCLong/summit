...
## Ownership & Impact (human-grafted)

- **Owning Team:** `<!-- e.g., Product Engineering, Platform Engineering -->`
- **Impacted Teams:** `<!-- e.g., Security & Trust, Release & Operations -->`
- **Evidence Owner:** `<!-- The team responsible for providing GA evidence for this change -->`
