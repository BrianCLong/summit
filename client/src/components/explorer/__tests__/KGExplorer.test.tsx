...
describe("KGExplorer", () => {
  ...
  describe("Rendering", () => {
    it("renders without crashing", async () => {
      renderWithProvider(<KGExplorer investigationId="test-investigation" />);
  ...
  describe("Interactions", () => {
    ...
    it("handles search input", async () => {
      ...
      await user.type(screen.getByPlaceholderText(/search entities/i), "John");
    });
  ...
  describe("Callbacks", () => {
    it("calls onNodeSelect when a node is selected", async () => {
      ...
      renderWithProvider(
        <KGExplorer investigationId="test-investigation" onNodeSelect={onNodeSelect} />
      );
