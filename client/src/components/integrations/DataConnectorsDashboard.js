...
const DataConnectorsDashboard = ({ investigationId, onConnectorAdd, onConnectorRemove, onDataImported, className = '', }) => {
    const [activeView, setActiveView] = (0, react_1.useState)('connectors');
    const [dataSources, setDataSources] = (0, react_1.useState)([]);
    const [connectorTemplates, setConnectorTemplates] = (0, react_1.useState)([]);
    const [transformationRules, setTransformationRules] = (0, react_1.useState)([]);
    const [selectedConnector, setSelectedConnector] = (0, react_1.useState)(null);
    const [showAddConnector, setShowAddConnector] = (0, react_1.useState)(false);
    const [searchQuery, setSearchQuery] = (0, react_1.useState)('');
    const [categoryFilter, setCategoryFilter] = (0, react_1.useState)('all');
    const [statusFilter, setStatusFilter] = (0, react_1.useState)('all');
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    // Mock data sources
    const mockDataSources = (0, react_1.useMemo)(() => [
        {
            id: 'virustotal-api',
            name: 'VirusTotal API',
            type: 'api',
    ...
    const mockConnectorTemplates = (0, react_1.useMemo)(() => [
        {
    ...
    const filteredDataSources = (0, react_1.useMemo)(() => {
        let filtered = dataSources;
        if (searchQuery) {
            filtered = filtered.filter((source) => source.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
    ...
    return (<div className={`data-connectors-dashboard ${className}`} style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      {/* Header */}
      <div style={{ marginBottom: '24px' }}>
        <div style={{
          ...
          <button onClick={() => setShowAddConnector(true)} style={{
            padding: '8px 16px',
            fontSize: '14px',
        ...
        {/* Filters */}
        {(activeView === 'connectors' || activeView === 'templates') && (<div style={{
                display: 'flex',
                gap: '12px',
                alignItems: 'center',
                flexWrap: 'wrap',
            }}>
            <input type="text" placeholder={`Search ${activeView === 'connectors' ? 'connectors' : 'templates'}...`} value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} style={{
                padding: '8px 12px',
                border: '1px solid var(--hairline)',
                borderRadius: '4px',
                flex: '1 1 250px',
            ...
            {activeView === 'connectors' && (<select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} style={{
                    padding: '8px',
                    border: '1px solid var(--hairline)',
                    borderRadius: '4px',
                    fontSize: '14px',
      ...
      <div style={{ flex: 1, overflow: 'hidden' }}>
        {activeView === 'connectors' && (<div style={{
                height: '100%',
                display: 'grid',
            ...
            <div style={{
              ...
              <div>
                {filteredDataSources.map((source) => (<div key={source.id} onClick={() => setSelectedConnector(source)} style={{
                    padding: '16px',
                    borderBottom: '1px solid #f0f0f0',
                    cursor: 'pointer',
                    backgroundColor: selectedConnector?.id === source.id
                        ? '#e3f2fd'
                        : 'transparent',
                ...
                <div style={{ padding: '16px' }}>
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    .rulesApplied}
                        ...
                        <div style={{ fontSize: '11px', color: '#666' }}>
                          Enrichments:{' '}
                          {formatNumber(selectedConnector.dataFlow.transformation
                    .enrichments)}{' '}
                          • Errors:{' '}
                          {selectedConnector.dataFlow.transformation
                    .validationErrors}
                    ...
                    marginBottom: '4px',
                        ...
                        <div style={{ fontSize: '11px', color: '#666' }}>
                          Entities • Rels:{' '}
                          {formatNumber(selectedConnector.dataFlow.storage
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    height: '100%',
                    backgroundColor: selectedConnector.healthMetrics.availability >
                        95
                        ? '#28a745'
                    ...
                    height: '100%',
                    backgroundColor: selectedConnector.healthMetrics.dataQuality > 95
                        ? '#28a745'
                        : selectedConnector.healthMetrics
                            .dataQuality > 90
                            ? '#ffc107'
                    ...
                    fontSize: '13px',
                      ...
                      <div>
                        ...
                        {selectedConnector.healthMetrics.responseTime.toFixed(0)}
                        ms
                      </div>
                      <div>
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    <div style={{ fontSize: '13px', lineHeight: '1.4' }}>
                      ...
                      {selectedConnector.nextSync && (<div>
                          <strong>Next Sync:</strong>{' '}
                          {selectedConnector.nextSync.toLocaleString()}
                        </div>)}
                      {selectedConnector.configuration.rateLimits && (<div style={{ marginTop: '8px' }}>
                  ...
                  <div>
                    ...
                    padding: '8px 16px',
                    fontSize: '12px',
                    backgroundColor: selectedConnector.status === 'connected'
                        ? '#dc3545'
                        : '#28a745',
                    color: 'white',
                    border: 'none',
        ...
        {activeView === 'templates' && (<div style={{ overflow: 'auto', padding: '16px' }}>
            <div style={{
                display: 'grid',
              ...
              {connectorTemplates
                ...
                .map((template) => (<div key={template.id} style={{
                    ...
                    gap: '4px',
                        ...
                        {template.capabilities.slice(0, 3).map((capability) => (<span key={capability} style={{
                        fontSize: '11px',
                        padding: '2px 6px',
                        backgroundColor: '#e9ecef',
                        borderRadius: '12px',
                        ...
                        {template.capabilities.length > 3 && (<span style={{ fontSize: '11px', color: '#666' }}>
                    ...
                    padding: '2px 6px',
                    borderRadius: '12px',
                    backgroundColor: template.difficulty === 'easy'
                        ? '#d4edda'
                    ...
                    <button onClick={() => onConnectorAdd?.(template)} style={{
                    width: '100%',
                    padding: '10px',
                    fontSize: '14px',
                    backgroundColor: '#1a73e8',
        ...
        {activeView === 'transformations' && (<div style={{
                padding: '16px',
                border: '1px solid var(--hairline)',
                borderRadius: '8px',
                textAlign: 'center',
        ...
        {activeView === 'monitoring' && (<div style={{
                padding: '16px',
                border: '1px solid var(--hairline)',
                borderRadius: '8px',
                textAlign: 'center',
...
exports.default = DataConnectorsDashboard;
