...
exports.useHelpSystem = void 0;
const react_1 = __importStar(require("react"));
const dompurify_1 = __importDefault(require("dompurify"));
const HelpSystem = ({ isVisible, onClose, initialTopic, }) => {
    const [searchQuery, setSearchQuery] = (0, react_1.useState)('');
    const [selectedCategory, setSelectedCategory] = (0, react_1.useState)('all');
    const [activeTopic, setActiveTopic] = (0, react_1.useState)(initialTopic || null);
    const helpTopics = [
        {
            id: 'getting-started',
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl h-5/6 flex overflow-hidden">
        ...
        <div className="w-1/3 border-r bg-gray-50 flex flex-col">
          ...
          <div className="p-4 border-b">
            ...
            {/* Search */}
            <input type="text" placeholder="Search help topics..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"/>
          </div>
          ...
          <div className="flex-1 overflow-y-auto">
            {filteredTopics.map((topic) => (<button key={topic.id} onClick={() => setActiveTopic(topic.id)} className={`
        ...
        <div className="flex-1 flex flex-col">
          {activeTopic ? (<div className="flex-1 overflow-y-auto">
              {(() => {
                ...
                return (<div className="p-8">
                    <div className="prose max-w-none" dangerouslySetInnerHTML={{
                        __html: dompurify_1.default.sanitize(topic.content
                            .split('\n')
                            .map((line) => line.trim())
                            .join('\n')
...
const useHelpSystem = () => {
    ...
    const [initialTopic, setInitialTopic] = (0, react_1.useState)();
    ...
    return {
        ...
        showHelp,
        hideHelp,
        HelpComponent: (props) => (<HelpSystem isVisible={isVisible} onClose={hideHelp} initialTopic={initialTopic} {...props}/>),
    };
};
exports.useHelpSystem = useHelpSystem;
