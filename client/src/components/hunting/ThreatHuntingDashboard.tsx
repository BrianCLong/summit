    ...
    <Box sx={{ p: 3, minHeight: "100vh", bgcolor: "background.default" }}>
          ...
          <CardContent>
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                ...
                <Box>
                  <Typography variant="h6">Hunt: {activeHunt.huntId.slice(0, 8)}...</Typography>
                  <Typography variant="body2" color="text.secondary">
      ...
      <TabPanel value={activeTab} index={2}>
        <Box sx={{ textAlign: "center", py: 5 }}>
          ...
          <Typography variant="body2" color="text.secondary">
            {config.autoRemediate ? "Auto-remediation is enabled" : "Auto-remediation is disabled"}
          </Typography>
        </Box>
      </TabPanel>
            ...
            <Card>
              <CardContent>
                ...
                <Typography paragraph>
                  Threat hunt completed with <strong>{metrics.totalFindingsDiscovered}</strong>{" "}
                  findings discovered. <strong>{metrics.findingsBySeverity?.CRITICAL || 0}</strong>{" "}
                  critical and <strong>{metrics.findingsBySeverity?.HIGH || 0}</strong> high
                  severity findings require immediate attention.
                </Typography>
                <Typography paragraph>
                  <strong>{metrics.iocsDiscovered}</strong> IOCs were identified across all
                  findings. Estimated precision:{" "}
                  <strong>{(metrics.precisionEstimate * 100).toFixed(1)}%</strong>.
                </Typography>
                <Typography paragraph>
                  Hunt executed <strong>{metrics.totalQueriesExecuted}</strong> graph queries
                  testing <strong>{metrics.totalHypothesesTested}</strong> hypotheses in{" "}
