...
const SecurityAuditDashboard = ({ investigationId, onSecurityAlert, onComplianceViolation, onRiskAssessment, className = '', }) => {
    const [activeView, setActiveView] = (0, react_1.useState)('events');
    const [securityEvents, setSecurityEvents] = (0, react_1.useState)([]);
    const [complianceRules, setComplianceRules] = (0, react_1.useState)([]);
    const [riskAssessments, setRiskAssessments] = (0, react_1.useState)([]);
    const [auditConfig, setAuditConfig] = (0, react_1.useState)(null);
    ...
    const [timeRangeFilter, setTimeRangeFilter] = (0, react_1.useState)('24h');
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    // Mock data for demonstration
    const mockSecurityEvents = (0, react_1.useMemo)(() => [
        {
            id: 'event-001',
    ...
    const mockComplianceRules = (0, react_1.useMemo)(() => [
        {
            id: 'rule-001',
        ...
        },
        {
            ...
            actions: [
                {
                    type: 'require_approval',
                    parameters: { approverRole: 'financial_controller', count: 2 },
                },
                {
                    type: 'alert',
                    parameters: {
    ...
    const mockAuditConfig = (0, react_1.useMemo)(() => ({
    ...
    (0, react_1.useEffect)(() => {
        ...
        const interval = setInterval(() => {
            ...
            const newEvent = {
                ...
                category: ['authentication', 'authorization', 'data_access'][Math.floor(Math.random() * 3)],
    ...
    const filteredEvents = (0, react_1.useMemo)(() => {
        ...
        if (searchQuery) {
            filtered = filtered.filter((event) => event.userName.toLowerCase().includes(searchQuery.toLowerCase()) ||
    ...
    const handleEventSelect = (0, react_1.useCallback)((event) => {
        setSelectedEvent(event);
        onSecurityAlert?.(event);
    }, [onSecurityAlert]);
    return (<div className={`security-audit-dashboard ${className}`} style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      {/* Header */}
      <div style={{ marginBottom: '24px' }}>
        ...
        {/* Filters */}
        {activeView === 'events' && (<div style={{
                display: 'flex',
                gap: '12px',
                alignItems: 'center',
                flexWrap: 'wrap',
            }}>
            <input type="text" placeholder="Search events, users, or resources..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} style={{
                padding: '8px 12px',
            ...
            <select value={timeRangeFilter} onChange={(e) => setTimeRangeFilter(e.target.value)} style={{
                padding: '8px',
                border: '1px solid var(--hairline)',
                borderRadius: '4px',
                fontSize: '14px',
      ...
      <div style={{ flex: 1, overflow: 'hidden' }}>
        {activeView === 'events' && (<div style={{
            ...
            <div style={{
              ...
              <div>
                {filteredEvents.map((event) => (<div key={event.id} onClick={() => handleEventSelect(event)} style={{
                    padding: '16px',
                    ...
                    padding: '2px 6px',
                    borderRadius: '12px',
                    backgroundColor: event.outcome === 'success'
                        ? '#d4edda'
                    ...
                    fontWeight: '500',
                      ...
                      {event.details.riskScore && (<div style={{ fontSize: '12px', color: '#666' }}>
                ...
                <div style={{ padding: '16px' }}>
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    <div style={{ fontSize: '13px', lineHeight: '1.4' }}>
                      ...
                      <div>
                        <strong>Role:</strong> {selectedEvent.userRole}
                      </div>
                      <div>
                      ...
                      {selectedEvent.details.geolocation && (<div>
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    padding: '2px 6px',
                    borderRadius: '12px',
                    backgroundColor: selectedEvent.outcome === 'success'
                        ? '#d4edda'
                        : selectedEvent.outcome === 'blocked'
                            ? '#f8d7da'
                            : '#fff3cd',
                    color: selectedEvent.outcome === 'success'
                        ? '#155724'
                        : selectedEvent.outcome === 'blocked'
                            ? '#721c24'
                            : '#856404',
                  ...
                  {selectedEvent.details.riskScore && (<div style={{ marginBottom: '24px' }}>
                      <h6 style={{
                        fontSize: '14px',
                        fontWeight: '600',
                        marginBottom: '8px',
                      ...
                      <div style={{ fontSize: '13px' }}>
                        ...
                        height: '100%',
                        backgroundColor: selectedEvent.details.riskScore > 80
                            ? '#dc3545'
                            : selectedEvent.details.riskScore > 60
                                ? '#fd7e14'
                                : selectedEvent.details.riskScore > 40
                                    ? '#ffc107'
                                    : '#28a745',
                        borderRadius: '4px',
                        ...
                        {selectedEvent.details.failureReason && (<div>
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    padding: '2px 6px',
                    borderRadius: '12px',
                    backgroundColor: selectedEvent.metadata.dataClassification ===
                        'restricted'
                        ? '#dc3545'
                  ...
                  {selectedEvent.details.investigationId && (<div>
                      <h6 style={{
                        fontSize: '14px',
                        fontWeight: '600',
                        marginBottom: '8px',
                      ...
                      <div style={{ fontSize: '13px', lineHeight: '1.4' }}>
                        ...
                        {selectedEvent.details.entityIds && (<div>
                            <strong>Entities:</strong>{' '}
                            {selectedEvent.details.entityIds.join(', ')}
                          </div>)}
                        {selectedEvent.details.exportFormat && (<div>
        ...
        {activeView === 'compliance' && (<div style={{
                padding: '16px',
                border: '1px solid var(--hairline)',
                borderRadius: '8px',
            }}>
            ...
            {complianceRules.map((rule) => (<div key={rule.id} style={{
                    padding: '16px',
                ...
                <div style={{ fontSize: '12px' }}>
                  <div>
                    <strong>Trigger Count:</strong> {rule.triggerCount}
                  </div>
                  {rule.lastTriggered && (<div>
        ...
        {activeView === 'config' && auditConfig && (<div style={{
                padding: '16px',
                border: '1px solid var(--hairline)',
                borderRadius: '8px',
            }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px' }}>
                  {auditConfig.complianceFrameworks.map((framework) => (<span key={framework} style={{
                    fontSize: '12px',
                    padding: '4px 8px',
                    backgroundColor: '#e9ecef',
                    borderRadius: '12px',
...
exports.default = SecurityAuditDashboard;
