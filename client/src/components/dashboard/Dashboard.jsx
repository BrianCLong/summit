    ...
    <Box>
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
          ...
          <Button variant="outlined" onClick={() => setShowTemplateModal(true)} size="large">
            ...
            {recentInvestigations.map((investigation) => (
              ...
              >
                <Box sx={{ flex: 1 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    {t("dashboard.entitiesPlural", { count: investigation.entities })} •{" "}
                    {t("dashboard.updated", { time: investigation.updated })}
                  </Typography>
                </Box>
                <Chip
