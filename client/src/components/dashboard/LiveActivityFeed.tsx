...
const mapActivity = (row: ActivityFeedRow): ActivityEvent => {
  ...
  const actorName =
    (payload?.actorName as string) || (metadata?.actorName as string) || row.actorId || "Unknown";
...
export default function LiveActivityFeed() {
  ...
  const { data, loading, error } = useQuery<ActivityFeedResponse>(ACTIVITY_FEED_QUERY, {
