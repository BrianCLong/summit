...
describe("TemporalAnalysis", () => {
  ...
  it("toggles cluster display", async () => {
    ...
    renderWithProviders(<TemporalAnalysis {...defaultProps} showClusters={true} />);
  ...
  it("toggles anomaly display", async () => {
    const user = userEvent.setup();
    renderWithProviders(<TemporalAnalysis {...defaultProps} showAnomalies={true} />);
  ...
  it("toggles zoom functionality", async () => {
    const user = userEvent.setup();
    renderWithProviders(<TemporalAnalysis {...defaultProps} enableZoom={true} />);
  ...
  it("handles investigation ID prop", () => {
    renderWithProviders(<TemporalAnalysis {...defaultProps} investigationId="inv-456" />);
  ...
  it("calls event selection callback", () => {
    ...
    renderWithProviders(<TemporalAnalysis {...defaultProps} onEventSelect={onEventSelect} />);
  ...
  it("calls time range change callback", async () => {
    ...
    const user = userEvent.setup();
    renderWithProviders(
      <TemporalAnalysis {...defaultProps} onTimeRangeChange={onTimeRangeChange} />
    );
  ...
  it("ignores wheel events when zoom disabled", () => {
    renderWithProviders(<TemporalAnalysis {...defaultProps} enableZoom={false} />);
  ...
  it("applies custom className", () => {
    renderWithProviders(<TemporalAnalysis {...defaultProps} className="custom-temporal-class" />);
