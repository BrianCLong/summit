...
const NOTIFICATION_SUBSCRIPTION = (0, client_1.gql) `
...
`;
function NotificationSystem({ position = 'top-right', maxNotifications = 5, autoHideDuration = 5000, }) {
    const [notifications, setNotifications] = (0, react_1.useState)([]);
    const [showPanel, setShowPanel] = (0, react_1.useState)(false);
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const audioRef = (0, react_1.useRef)(null);
    // Subscribe to real-time notifications
    const { data: subscriptionData } = (0, client_1.useSubscription)(NOTIFICATION_SUBSCRIPTION, {
        errorPolicy: 'all',
    });
    ...
    return (<>
      ...
      <div style={{ position: 'relative' }}>
        ...
        {/* Notification Panel */}
        {showPanel && (<div className="panel" style={{
                position: 'absolute',
                top: '100%',
                right: '0',
                zIndex: 1000,
            ...
            <div style={{
              ...
              {notifications.length > 0 && (<button onClick={clearAllNotifications} style={{
                    color: '#666',
                    background: 'none',
                    border: 'none',
                    cursor: 'pointer',
            ...
            {notifications.length === 0 ? (<div style={{
                ...
                <div style={{ fontSize: '12px', marginTop: '4px' }}>
              ...
              </div>) : (notifications.map((notification) => (<div key={notification.id} style={{
                    padding: '16px',
                    borderBottom: '1px solid var(--hairline)',
                    position: 'relative',
                }}>
                  <div style={{
                    ...
                    notification.investigationId) && (<span style={{
      ...
      <div style={{
        ...
        {notifications.slice(0, 3).map((notification) => (<div key={`toast-${notification.id}`} className="panel" style={{
                marginBottom: '8px',
                padding: '16px',
                maxWidth: '350px',
