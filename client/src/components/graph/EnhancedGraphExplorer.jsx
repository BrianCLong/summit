...
const UPDATE_REL = gql`
  mutation UpdateRel($id: ID!, $input: UpdateRelationshipInput!, $lastSeen: DateTime!) {
    ...
    <Box sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 1 }}>
          <Button variant="outlined" startIcon={<Search />} onClick={() => setSearchOpen(true)}>
            Search
          </Button>
          <Button
            variant="contained"
          ...
          <Button variant="outlined" startIcon={<GetApp />} onClick={() => setExportOpen(true)}>
            Export
          </Button>
        </Box>
      </Box>
      ...
      <Paper sx={{ mb: 2, p: 2 }} elevation={1}>
        ...
        >
          ...
          <Box sx={{ display: "flex", gap: 1 }}>
            <Button variant="outlined" onClick={requestUndo} disabled={!undoStack.length}>
              Undo
            </Button>
            <Button variant="outlined" onClick={requestRedo} disabled={!redoStack.length}>
              Redo
            </Button>
          </Box>
        </Box>
            ...
            <Paper sx={{ p: 1.5, maxHeight: 360, overflow: "auto" }}>
              ...
              >
                ...
                <Box sx={{ display: "flex", gap: 1 }}>
                  ...
                  <Button size="small" onClick={() => setSuggestionsOpen(false)}>
                    Close
                  </Button>
                </Box>
              </Box>
              <List dense>
                {suggestions.map((s, idx) => (
                  <ListItem
                    ...
                    secondaryAction={
                      <Button size="small" variant="outlined" onClick={() => acceptSuggestion(s)}>
                        Accept
                      </Button>
                    }
                  >
        ...
        <Box sx={{ position: "fixed", bottom: 16, right: 400, zIndex: 10 }}>
          <Paper sx={{ p: 1.5, minWidth: 320 }}>
            ...
            <TextField
              ...
              onChange={(e) => setEdgeEditor({ ...edgeEditor, label: e.target.value })}
            />
            <TextField
              label="Confidence"
              size="small"
            ...
            <Box sx={{ display: "flex", gap: 1, mt: 1 }}>
              <TextField
                ...
                onChange={(e) => setEdgeEditor({ ...edgeEditor, validFrom: e.target.value })}
              />
              <TextField
                label="Valid To"
                type="date"
                ...
                onChange={(e) => setEdgeEditor({ ...edgeEditor, validTo: e.target.value })}
              />
            </Box>
            <Box
              sx={{
            ...
            >
              <Button size="small" onClick={() => setEdgeEditor({ ...edgeEditor, open: false })}>
                Cancel
              </Button>
              <Button
                size="small"
        ...
        <DialogContent>
          ...
          <List>
            {searchResults.map((result) => (
              <ListItem key={result.id} button onClick={() => handleSearchResultClick(result)}>
                <ListItemIcon>
                  <Chip
                    label={result.type}
                    size="small"
                ...
                <ListItemText primary={result.label} secondary={`ID: ${result.id}`} />
              </ListItem>
            ))}
          </List>
        </DialogContent>
      ...
      >
        ...
        <Accordion defaultExpanded>
          ...
          <AccordionDetails>
            ...
            <FormControlLabel
              control={
                <Switch checked={snapToGrid} onChange={(e) => setSnapToGrid(e.target.checked)} />
              }
              label="Snap to Grid"
            />
            <FormControlLabel
          ...
          {editingElement && (
            <Box sx={{ mt: 1 }}>
              <TextField
                ...
                sx={{ mb: 2 }}
              />
              <TextField fullWidth label="Type" defaultValue={editingElement.type} sx={{ mb: 2 }} />
              <TextField
                fullWidth
                multiline
                rows={4}
