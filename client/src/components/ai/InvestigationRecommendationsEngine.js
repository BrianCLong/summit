...
const InvestigationRecommendationsEngine = ({ investigationId, context, onRecommendationAccept, onRecommendationReject, onStrategySelect, enableRealTimeUpdates = true, className = '', }) => {
    const [activeView, setActiveView] = (0, react_1.useState)('recommendations');
    const [recommendations, setRecommendations] = (0, react_1.useState)([]);
    const [strategies, setStrategies] = (0, react_1.useState)([]);
    const [similarCases, setSimilarCases] = (0, react_1.useState)([]);
    const [selectedRecommendation, setSelectedRecommendation] = (0, react_1.useState)(null);
    ...
    const [sortBy, setSortBy] = (0, react_1.useState)('confidence');
    const [showAcceptedOnly, setShowAcceptedOnly] = (0, react_1.useState)(false);
    const analysisRef = (0, react_1.useRef)(null);
    // Mock investigation context
    const mockContext = (0, react_1.useMemo)(() => ({
    ...
    const mockRecommendations = (0, react_1.useMemo)(() => [
        {
            id: 'rec-001',
    ...
    const mockStrategies = (0, react_1.useMemo)(() => [
        {
            id: 'strategy-001',
    ...
    const mockSimilarCases = (0, react_1.useMemo)(() => [
        {
            id: 'case-001',
    ...
    const filteredRecommendations = (0, react_1.useMemo)(() => {
        const filtered = recommendations.filter((rec) => {
            if (showAcceptedOnly && !rec.feedback?.helpful)
                return false;
    ...
    const generateNewRecommendations = (0, react_1.useCallback)(async () => {
    ...
    const handleRecommendationFeedback = (0, react_1.useCallback)((recId, helpful, rating, comments) => {
        setRecommendations((prev) => prev.map((rec) => rec.id === recId
            ? {
                ...rec,
                feedback: {
                    helpful,
    ...
    return (<div className={`investigation-recommendations-engine ${className}`} style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      {/* Header */}
      <div style={{ marginBottom: '24px' }}>
        <div style={{
          ...
          <button onClick={generateNewRecommendations} disabled={isGenerating} style={{
            padding: '8px 16px',
            fontSize: '14px',
        ...
        {/* Filters */}
        {activeView === 'recommendations' && (<div style={{
                display: 'flex',
                gap: '12px',
                alignItems: 'center',
                flexWrap: 'wrap',
            ...
            <label style={{
              ...
              <input type="checkbox" checked={showAcceptedOnly} onChange={(e) => setShowAcceptedOnly(e.target.checked)}/>
              Show accepted only
            </label>
          </div>)}
      </div>
      ...
      <div style={{ flex: 1, overflow: 'hidden' }}>
        {activeView === 'recommendations' && (<div style={{
                height: '100%',
                display: 'grid',
                gridTemplateColumns: selectedRecommendation ? '1fr 1fr' : '1fr',
                gap: '16px',
            }}>
            ...
            <div style={{
              ...
              <div>
                {filteredRecommendations.map((rec) => (<div key={rec.id} onClick={() => setSelectedRecommendation(rec)} style={{
                    padding: '16px',
                    borderBottom: '1px solid #f0f0f0',
                    cursor: 'pointer',
                    backgroundColor: selectedRecommendation?.id === rec.id
                        ? '#e3f2fd'
                        : 'transparent',
            ...
            {selectedRecommendation && (<div style={{
                    overflow: 'auto',
                    border: '1px solid var(--hairline)',
                    borderRadius: '8px',
                }}>
                ...
                <div style={{ padding: '16px' }}>
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    <div>
                      {selectedRecommendation.actionItems.map((action) => (<div key={action.id} style={{
                        display: 'flex',
                        alignItems: 'flex-start',
                        gap: '8px',
                        padding: '8px',
                        ...
                        borderRadius: '4px',
                          ...
                          <input type="checkbox" checked={action.completed} onChange={() => {
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    height: '100%',
                    backgroundColor: selectedRecommendation.confidence > 80
                        ? '#28a745'
                        : selectedRecommendation.confidence > 60
                            ? '#ffc107'
                            : '#dc3545',
                    borderRadius: '4px',
                }}/>
                    ...
                    <div style={{ fontSize: '12px' }}>
                      {selectedRecommendation.metadata.confidenceFactors.map((factor) => (<div key={factor.factor} style={{ marginBottom: '4px' }}>
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    <div style={{ fontSize: '13px', lineHeight: '1.4' }}>
                      ...
                      <div>
                        ...
                        {selectedRecommendation.metadata.similarCasesFound}
                      </div>
                      <div>
                  ...
                  <div>
                    ...
                    marginBottom: '16px',
                      ...
                      <button onClick={() => onRecommendationAccept?.(selectedRecommendation)} style={{
                    padding: '8px 16px',
                    fontSize: '12px',
                    ...
                    cursor: 'pointer',
                      ...
                      <button onClick={() => onRecommendationReject?.(selectedRecommendation.id, 'Not relevant')} style={{
                    padding: '8px 16px',
                    fontSize: '12px',
                    ...
                    {!selectedRecommendation.feedback && (<div>
                        <div style={{
                        fontSize: '12px',
                        marginBottom: '8px',
                        fontWeight: '600',
                        ...
                        <div style={{ display: 'flex', gap: '4px' }}>
                          {[1, 2, 3, 4, 5].map((rating) => (<button key={rating} onClick={() => handleRecommendationFeedback(selectedRecommendation.id, rating >= 3, rating)} style={{
                            padding: '4px 8px',
                            fontSize: '12px',
                            backgroundColor: 'transparent',
        ...
        {activeView === 'strategies' && (<div style={{
                padding: '16px',
                border: '1px solid var(--hairline)',
                borderRadius: '8px',
            }}>
            ...
            {strategies.map((strategy) => (<div key={strategy.id} style={{
                ...
                <div style={{
                  ...
                  <button onClick={() => onStrategySelect?.(strategy)} style={{
                    padding: '8px 16px',
                    fontSize: '12px',
                ...
                <div style={{ marginBottom: '16px' }}>
                  ...
                  <div>
                    {strategy.phases.map((phase, index) => (<div key={index} style={{ marginBottom: '12px' }}>
                        <div style={{
                        fontSize: '12px',
                        fontWeight: '600',
                        marginBottom: '4px',
        ...
        {activeView === 'similar_cases' && (<div style={{
                padding: '16px',
                border: '1px solid var(--hairline)',
                borderRadius: '8px',
            }}>
            ...
            {similarCases.map((case_item) => (<div key={case_item.id} style={{
                    border: '1px solid #e9ecef',
                    borderRadius: '8px',
                    padding: '16px',
                    marginBottom: '16px',
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    padding: '2px 6px',
                    borderRadius: '12px',
                    backgroundColor: case_item.outcome === 'successful'
                        ? '#28a745'
                        : case_item.outcome === 'partial'
                            ? '#ffc107'
                            : '#dc3545',
                    color: 'white',
                    fontWeight: '600',
                  ...
                  <div style={{ marginTop: '8px', fontSize: '11px' }}>
                    ...
                    <div>
                      ...
                      <ul style={{ marginTop: '4px', paddingLeft: '20px' }}>
                        {case_item.applicableInsights.map((insight, index) => (<li key={index}>{insight}</li>))}
                      </ul>
                    </div>
                  </div>
                </details>
...
exports.default = InvestigationRecommendationsEngine;
