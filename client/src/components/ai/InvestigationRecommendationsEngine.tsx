...
> = ({
    ...
    () => [
      {
        ...
        description:
          'AI analysis suggests investigating potential shell company structures connected to Entity-002',
        rationale:
          'Pattern matching with 847 similar financial fraud cases shows 89% likelihood of shell company involvement',
        confidence: 89,
        priority: 'high',
        category: 'analysis',
        estimatedEffort: {
        ...
        actionItems: [
          {
            id: 'action-001',
            description:
              'Query corporate registry for entities with similar incorporation patterns',
            completed: false,
      ...
      },
      {
        ...
        potentialImpact:
          'May reveal additional associates, timeline discrepancies, or lifestyle inconsistencies',
      ...
      },
      {
        ...
        description:
          'Apply temporal correlation analysis to identify patterns across different data sources',
        rationale:
          'Multi-source temporal analysis has 73% success rate in similar financial fraud cases',
        confidence: 73,
        priority: 'medium',
        category: 'analysis',
        estimatedEffort: {
        ...
        phases: [
          {
            ...
            description:
              'Evaluate scope, gather initial evidence, establish investigation parameters',
          ...
          },
          {
            ...
            description:
              'Systematic gathering of financial records, communications, and supporting evidence',
  ...
  const handleRecommendationFeedback = useCallback(
    (recId: string, helpful: boolean, rating: number, comments?: string) => {
  ...
  return (
    <div
      className={`investigation-recommendations-engine ${className}`}
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: '100%',
                            backgroundColor:
                              selectedRecommendation.confidence > 80
                                ? '#28a745'
