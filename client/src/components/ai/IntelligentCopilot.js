...
export default function IntelligentCopilot() {
  ...
  const [generateEntities, { loading: generating }] = useMutation(GENERATE_ENTITIES_FROM_TEXT);
          ...
          >
            <Box>
              ...
              <Typography variant="body1" color="text.secondary">
                Your AI-powered analyst for pattern recognition, threat assessment, and
            ...
            >
              ...
              <Box sx={{ p: 2, borderTop: 1, borderColor: 'divider' }}>
                <Alert severity="info" sx={{ mb: 2, fontSize: '0.85rem' }}>
                  💡 Try asking: "analyze network", "threat assessment", "predict patterns", or
                  "investigation summary"
                </Alert>
                <Box sx={{ display: 'flex', gap: 1 }}>
                  <TextField
