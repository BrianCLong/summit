...
exports.default = IncidentDetailsRoute;
...
function IncidentDetailsRoute() {
    ...
    const variables = (0, react_1.useMemo)(() => ({ id: incidentId, filter, first: 50, offset: 0 }), [incidentId, filter]);
    ...
    return (<div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <ExportAuditBundleButton_1.default incidentId={incidentId}/>
      </div>
      <ProvenanceFilterPanel_1.default onApply={(f) => {
            setFilter(f);
            refetch({ ...variables, filter: f });
        }} initial={filter} scope="incident" id={incidentId}/>
