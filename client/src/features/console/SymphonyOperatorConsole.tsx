...
interface Burndown {
  generated_at: string;
  windows: { m1: BurndownWin; h1: BurndownWin; d1: BurndownWin };
}
...
function GitHubPane() {
  const [token, setToken] = useState<string>(
    typeof window !== 'undefined' ? localStorage.getItem('gh:token') || '' : '',
  );
  const [owner, setOwner] = useState<string>(
    typeof window !== 'undefined' ? localStorage.getItem('gh:owner') || '' : '',
  );
    ...
    <div className="p-4 md:p-6 space-y-4">
      ...
      >
        ...
        <TabsContent value="route" className="space-y-4">
          ...
          <Card className="col-span-12">
            <CardHeader>
              <CardTitle>Mermaid Spec (sanitized)</CardTitle>
            </CardHeader>
            <CardContent>
              <Textarea
                value={traceSpec}
