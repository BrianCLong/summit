            ...
            <tbody>
              {budgets.length === 0 ? (
                ...
                budgets.map((budget) => (
                  ...
                  >
                    <td style={{ padding: "12px", fontWeight: 600 }}>{budget.tenant_id}</td>
                    <td style={{ padding: "12px" }}>${budget.daily_spent_usd.toFixed(2)}</td>
                    <td style={{ padding: "12px" }}>${budget.daily_limit_usd.toFixed(2)}</td>
                    <td style={{ padding: "12px", minWidth: "150px" }}>
                      {getUtilizationBar(budget.utilization_daily)}
                    </td>
                    <td style={{ padding: "12px" }}>${budget.monthly_spent_usd.toFixed(2)}</td>
                    <td style={{ padding: "12px" }}>${budget.monthly_limit_usd.toFixed(2)}</td>
              ...
              {ledgerEntries.length === 0 ? (
                ...
                ledgerEntries.slice(0, 100).map((entry) => {
                  ...
                  const variancePercent =
                    entry.estimated_cost_usd > 0 ? (variance / entry.estimated_cost_usd) * 100 : 0;
                  ...
                  return (
                    <tr key={entry.id} style={{ borderBottom: "1px solid #dee2e6" }}>
                      ...
                      <td style={{ padding: "8px", fontWeight: 500 }}>{entry.tenant_id}</td>
                      <td style={{ padding: "8px", fontSize: "14px" }}>
                        <div
                      ...
                      <td style={{ padding: "8px" }}>${entry.estimated_cost_usd.toFixed(4)}</td>
                      <td style={{ padding: "8px" }}>${entry.actual_cost_usd.toFixed(4)}</td>
                      <td
                        style={{
                          padding: "8px",
