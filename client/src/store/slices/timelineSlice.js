...
export const fetchTimelineEvents = createAsyncThunk("timeline/fetchEvents", async () => {
...
export const { setFilterTypes, setFilterTags, selectEvent } = timelineSlice.actions;
