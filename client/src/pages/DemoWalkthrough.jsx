...
const DemoWalkthrough = () => {
  ...
  const isDemoMode = import.meta.env.VITE_DEMO_MODE === '1' || import.meta.env.VITE_DEMO_MODE === 'true';
  ...
  const walkthroughSteps = [
    {
      ...
      description: "This guided tour will walk you through the key features of the Summit intelligence analysis platform.",
    ...
    },
    {
      ...
      description: "The Graph Explorer shows relationships between entities in your intelligence data. You can zoom, pan, and click on nodes to see details.",
    ...
    },
    {
      ...
      description: "The AI Copilot helps you analyze data and generate insights. Ask questions in natural language and get AI-powered responses.",
    ...
    },
    {
      ...
      description: "The Investigations Timeline shows a chronological view of events and activities related to your cases.",
    ...
    },
    {
      ...
      description: "The Threat Assessment Engine helps identify and prioritize potential threats based on your intelligence data.",
    ...
    },
    {
      ...
      action: "Look for the red 'DEMO MODE' ribbon and 'Demo data • Not production' watermark. These remind you that this is a demo environment with sample data.",
      button: null
    },
    {
      title: "Stop/Reset the Demo",
      description: "When finished, you can stop the demo environment to free up resources.",
      action: "Run 'make demo-down' in your terminal to stop the demo, or 'make demo-down-cleanup' to also remove all demo data.",
      button: null
    }
  ];
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Paper elevation={2} sx={{ p: 3, mt: 4, bgcolor: 'grey.50' }}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            <Typography variant="subtitle2" gutterBottom>Demo Safety:</Typography>
            <Chip label="Sample Data Only" color="warning" variant="outlined" sx={{ mr: 1, mb: 1 }} />
            <Chip label="Not Production" color="error" variant="outlined" sx={{ mr: 1, mb: 1 }} />
            <Chip label="Safe to Explore" color="success" variant="outlined" sx={{ mr: 1, mb: 1 }} />
          </Grid>
        </Grid>
