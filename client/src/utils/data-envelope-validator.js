...
exports.DataEnvelopeValidationError = exports.DataClassification = void 0;
...
exports.getClassificationColor = getClassificationColor;
exports.formatProvenance = formatProvenance;
exports.createEnvelopeInterceptor = createEnvelopeInterceptor;
/**
...
envelope, config = {}) {
    ...
    if (envelope.confidence !== undefined && envelope.confidence !== null) {
        if (typeof envelope.confidence !== 'number') {
            ...
            errors.push(`AI confidence (${envelope.confidence}) below minimum threshold (${finalConfig.minConfidence})`);
        }
    ...
    if (envelope.classification &&
        ...
        errors.push(`Data classification ${envelope.classification} not allowed. Allowed: ${finalConfig.allowedClassifications.join(', ')}`);
    }
...
exports.DataEnvelopeValidationError = DataEnvelopeValidationError;
/**
 * HTTP interceptor wrapper for axios/fetch
 */
function createEnvelopeInterceptor(config = {}) {
    return {
        /**
