...
exports.createDefaultMissionPresets = void 0;
const createTaskId = (prefix) => `${prefix}-${Date.now()}`;
const createDefaultMissionPresets = () => [
    {
        id: 'launch-readiness',
        name: 'Full Launch Readiness',
        description: 'Runs the end-to-end launch sequence across orchestration, build, intelligence, and operations.',
        buildTask: () => ({
    ...
    },
    {
        ...
        description: 'Pulls new graph intelligence, enriches entities, and shares outcomes across the company.',
        buildTask: () => ({
...
exports.createDefaultMissionPresets = createDefaultMissionPresets;
