...
### Added
- Implemented Competitive Intelligence Protocol v1.1 (Scaffolding, Governance, CI).
- Created `scripts/competitive/init_dossier.mjs` for competitive dossier scaffolding.
- Added `.github/workflows/competitive-governance.yml` for claim verification.
