...
- Deprecated legacy `docs/ops/release-process.md` content in favor of the canonical release doctrine, eliminating stale semantic-release guidance.
- Extended prompt registry scope to cover release documentation and roadmap updates for governance checks.
