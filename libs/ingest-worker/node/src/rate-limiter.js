...
exports.SlidingWindowRateLimiter = exports.MultiTenantRateLimiter = exports.TokenBucket = void 0;
class TokenBucket {
    tokens;
    lastRefillTime;
    capacity;
...
class MultiTenantRateLimiter {
    ...
    constructor(globalConfig, defaultTenantConfig, tenantConfigs) {
     ...
     */
    async acquire(tenantId, tokens = 1) {
    ...
    getOrCreateTenantBucket(tenantId) {
...
exports.MultiTenantRateLimiter = MultiTenantRateLimiter;
/**
