...
- **AI IDEs**: Move from suggestion → *policy‑constrained autonomous workcells* with measurable evals and provenance.
...
- **Governance**: Treat policy as code across *everything* (code, data, prompts, releases) with simulation and evidence by default.
