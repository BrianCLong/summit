...
const robust_runner_js_1 = require("../runner/robust-runner.js");
const path_1 = __importDefault(require("path"));
async function run() {
    const runner = new robust_runner_js_1.BenchRunner();
    ...
    runner.saveReport(path_1.default.join(process.cwd(), 'bench_results.json'));
}
