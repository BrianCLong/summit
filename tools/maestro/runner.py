...
class JobRunner:
        ...
        for step in spec.steps:
            ...
            for attempt in range(1, attempts + 1):
                ...
                try:
                    ...
                    command_log += self._format_attempt_log(step.id, attempt, result.stdout, result.stderr, result.returncode)
    ...
    @staticmethod
    def _format_attempt_log(step_id: str, attempt: int, stdout: str, stderr: str, returncode: int) -> str:
        lines = [
            f"[step={step_id} attempt={attempt} rc={returncode}]",
            stdout or "",
            stderr or "",
            "---",
        ]
