...
class OSCALSSPExporter {
    ...
    exportToFile(filename = 'intelgraph-federal-ssp.json') {
        const ssp = this.generateSSP();
        fs_1.default.writeFileSync(filename, JSON.stringify(ssp, null, 2));
...
function main() {
    ...
    try {
        ...
        fs_1.default.writeFileSync('oscal-implementation-summary.json', summary);
        ...
        fs_1.default.writeFileSync('oscal-evidence-mapping.json', JSON.stringify(evidenceMapping, null, 2));
