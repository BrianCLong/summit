        ...
        JSON.stringify(
          {
            ...
            caseRefHashes: result.backup.hashes.caseRefs,
            caseRefsAggregate: result.backup.hashes.caseRefsAggregate,
            dryRun: options.dryRun,
        ...
        JSON.stringify(
          {
            ...
            caseRefHashes: result.caseRefHashes,
            caseRefsAggregate: result.caseRefsAggregate,
            expectedCaseRefsAggregate: result.expectedCaseRefsAggregate,
          },
          null,
          2,
        ),
