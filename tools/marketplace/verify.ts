...
const dig = "sha256:"+crypto.createHash("sha256").update(JSON.stringify({...comp, digest:undefined})).digest("hex");
if (dig !== comp.digest) { console.error("digest mismatch"); process.exit(1); }
