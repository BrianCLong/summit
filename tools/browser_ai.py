...
class BrowserAIOrchestrator:
    ...
    def format_contextual_query(
        self, query: str, tool_name: str, context_level: str = "medium"
    ) -> str:
    ...
    def open_browser_tool(
        self, tool_name: str, query: str = "", context_level: str = "medium"
    ) -> bool:
    ...
    def open_multiple_tools(
        self, tools: list[str], query: str = "", context_level: str = "medium", delay: float = 1.0
    ) -> dict[str, bool]:
    ...
    def architecture_design_workflow(self, component: str) -> bool:
        ...
        design_query = (
            f"Architecture design for {component} component in {self.context['project_name']}"
        )
...
def main():
    ...
    parser.add_argument(
        ...
        default="medium",
        help="Context level to include",
    )
    parser.add_argument(
        "--delay", type=float, default=1.0, help="Delay between opening multiple tools"
    )
