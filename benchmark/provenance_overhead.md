...
_Statistical Significance_: p < 0.05 (measured over 10,000 runs, power analysis verified effect size detection).
_Conclusion_: Cryptographic attestation is achieved with <5% overhead, vastly outperforming OTel payload serialization.
