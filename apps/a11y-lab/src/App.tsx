...
const focusableSelectors = ["button", "a[href]", "input", "select", "textarea", '[role="button"]'];
  ...
  return (
    <main id="main" className="app-shell" aria-label="Accessibility automation lab">
      ...
      <div className="card" style={{ marginTop: "1rem" }}>
        ...
        <p>
          Live region updates, skip links, and input labels are injected for screen readers;
          telemetry is scrubbed to avoid content analytics.
        </p>
        <ul>
