...
exports.A11yHeatmapOverlay = A11yHeatmapOverlay;
const react_1 = require("react");
const focusOrder_1 = require("../scripts/focusOrder");
const focusableSelector = 'a[href], button, input, select, textarea, [tabindex]:not([tabindex="-1"]), [role="button"]';
function A11yHeatmapOverlay({ enabled }) {
    (0, react_1.useEffect)(() => {
        if (!enabled) {
            removeOverlays();
            return undefined;
