...
describe('ElasticsearchService', () => {
    let service;
    beforeAll(() => {
        service = new ElasticsearchService_1.ElasticsearchService();
    });
    describe('buildFullTextQuery', () => {
        it('should build a multi-match query with proper boosting', () => {
            ...
            const buildQueryClause = service.buildQueryClause.bind(service);
    ...
    describe('buildElasticsearchQuery', () => {
        it('should include pagination parameters', () => {
            ...
            const buildElasticsearchQuery = service.buildElasticsearchQuery.bind(service);
    ...
    describe('index selection', () => {
        it('should search across all indices by default', () => {
            ...
            const getSearchIndices = service.getSearchIndices.bind(service);
    ...
    describe('result transformation', () => {
        it('should transform hits to search results', () => {
            ...
            const transformHits = service.transformHits.bind(service);
    ...
    describe('aggregation transformation', () => {
        it('should transform Elasticsearch aggregations to facets', () => {
            ...
            const transformAggregations = service.transformAggregations.bind(service);
