...
const queryBuilderService = new QueryBuilderService_1.QueryBuilderService();
const savedSearchService = new SavedSearchService_1.SavedSearchService();
const searchRateLimit = (0, express_rate_limit_1.rateLimit)({
    windowMs: 1 * 60 * 1000,
    max: 100,
