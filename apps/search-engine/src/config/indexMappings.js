...
exports.ALL_INDEX_MAPPINGS = exports.DOCUMENT_INDEX_MAPPING = exports.CASE_INDEX_MAPPING = exports.ENTITY_INDEX_MAPPING = exports.SYNONYMS = void 0;
exports.getIndexMapping = getIndexMapping;
exports.getAllIndexNames = getAllIndexNames;
/**
        ...
        analysis: {
            filter: {
                ...
                synonym_filter: {
                    type: 'synonym',
                    synonyms: [
                        ...exports.SYNONYMS.entityTypes,
                        ...exports.SYNONYMS.intelligence,
                        ...exports.SYNONYMS.actions,
                    ],
                },
                edge_ngram_filter: {
                    type: 'edge_ngram',
    ...
    settings: {
        ...
        analysis: {
            filter: {
                ...
                synonym_filter: {
                    type: 'synonym',
                    synonyms: [...exports.SYNONYMS.intelligence, ...exports.SYNONYMS.actions],
                },
            },
            analyzer: {
                content_analyzer: {
...
exports.DOCUMENT_INDEX_MAPPING = {
    ...
    settings: {
        ...
        analysis: {
            filter: {
                ...
                synonym_filter: {
                    type: 'synonym',
                    synonyms: [...exports.SYNONYMS.intelligence],
                },
            },
            analyzer: {
                content_analyzer: {
...
function getIndexMapping(indexName) {
    return exports.ALL_INDEX_MAPPINGS.find((mapping) => mapping.name === indexName);
}
/**
 * Get all index names
 */
function getAllIndexNames() {
    return exports.ALL_INDEX_MAPPINGS.map((mapping) => mapping.name);
}
