      ...
      <div className="flex items-center justify-between">
        ...
        >
          {status?.status === 'active' ? (
            ...
            <ShieldAlert className="w-5 h-5 mr-2 inline" />
          )}
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {status?.environment?.toUpperCase() || 'N/A'}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              High Severity: {violations?.summary?.high_severity || 0}
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {violations?.summary?.open_incidents || 0}
            </div>
          </CardContent>
        </Card>
      </div>
              ...
              {violations?.events?.map(evt => (
                <TableRow key={evt.id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        evt.status === 'BLOCKED' ? 'destructive' : 'secondary'
                      }
                    >
                      {evt.status}
                    </Badge>
