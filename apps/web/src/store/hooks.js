...
exports.useJIRAIntegration = exports.useGitHubIntegration = exports.useConductorMetrics = exports.useAppSelector = exports.useAppDispatch = void 0;
...
const useConductorMetrics = (options) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        refreshIntervalRef.current = setInterval(fetchMetrics, options.refreshInterval);
        return () => {
            if (refreshIntervalRef.current) {
                clearInterval(refreshIntervalRef.current);
            }
...
const useGitHubIntegration = (options) => {
    const [data, setData] = (0, react_1.useState)(null);
    const [loading, setLoading] = (0, react_1.useState)(true);
    const fetchGitHubData = (0, react_1.useCallback)(async () => {
        try {
            ...
            const mockGitHubData = {
                ...
                recentCommits: [
                    {
                        sha: '7c3f2a1b',
                        message: 'feat(conductor): enhance web orchestration with Thompson sampling',
                        author: 'alex.dev',
                    ...
                    {
                        sha: '9e4b5c2d',
                        message: 'fix(compliance): improve robots.txt validation performance',
...
const useJIRAIntegration = (options) => {
    const [data, setData] = (0, react_1.useState)(null);
    const [loading, setLoading] = (0, react_1.useState)(true);
    const fetchJIRAData = (0, react_1.useCallback)(async () => {
        try {
            ...
            const mockJIRAData = {
                ...
                recentIssues: [
                    {
                        key: 'COND-247',
                        summary: 'Optimize Thompson Sampling convergence for premium models',
                        status: 'In Progress',
                        assignee: 'alex.dev',
                        priority: 'High',
                        created: '2024-08-31',
