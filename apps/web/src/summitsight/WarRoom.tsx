      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="grid gap-4">
            {kpis.map(k => (
              ...
              >
                ...
                <div
                  className={`text-4xl font-bold mt-1 ${k.status === 'red' ? 'text-red-500' : 'text-green-500'}`}
                >
                  {k.currentValue?.toFixed(1) ?? '-'}{' '}
        ...
        <div className="space-y-4">
          ...
          {risks.map((r, i) => (
            <Card
              key={i}
              className="bg-slate-900 border-red-900/30 border text-slate-300"
            >
