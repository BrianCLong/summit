...
exports.useControlTowerData = useControlTowerData;
...
function useControlTowerData(filters) {
    ...
    const fetchData = (0, react_1.useCallback)(async () => {
        ...
        try {
            ...
            if (filters.searchQuery) {
                ...
                filteredEvents = filteredEvents.filter((e) => e.title.toLowerCase().includes(query) ||
...
exports.default = useControlTowerData;
