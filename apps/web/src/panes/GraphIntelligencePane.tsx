    ...
    <div className="h-full w-full flex flex-col gap-4 p-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
            <Button onClick={() => handleRunAlgorithm('centrality')} variant={selectedAlgorithm === 'centrality' ? 'default' : 'outline'}>
                Influence (Centrality)
            </Button>
            <Button onClick={() => handleRunAlgorithm('communities')} variant={selectedAlgorithm === 'communities' ? 'default' : 'outline'}>
                Communities
            </Button>
            <Button onClick={() => handleRunAlgorithm('influence/bots')} variant={selectedAlgorithm === 'influence/bots' ? 'destructive' : 'outline'}>
                Detect Bots
            </Button>
            <Button onClick={() => handleRunAlgorithm('influence/coordinated')} variant={selectedAlgorithm === 'influence/coordinated' ? 'destructive' : 'outline'}>
