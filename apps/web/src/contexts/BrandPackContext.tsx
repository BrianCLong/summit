...
const buildTokenOverrides = (pack: BrandPack) => {
  ...
  return {
    ...
    'ds-radius-sm': String(radii.sm ?? tokens.radii.sm),
    'ds-radius-md': String(radii.md ?? tokens.radii.md),
    'ds-radius-lg': String(radii.lg ?? tokens.radii.lg),
    'ds-radius-pill': String(radii.pill ?? tokens.radii.pill),
    'ds-space-sm': String(spacing.sm ?? tokens.spacing.sm),
    'ds-space-md': String(spacing.md ?? tokens.spacing.md),
    'ds-space-lg': String(spacing.lg ?? tokens.spacing.lg),
