...
const INTEGRATION_TYPES = [
  {
    type: 'webhook',
    title: 'Event Sinks',
    description: 'Configure outbound webhooks and event queues.',
  },
  {
    type: 'splunk',
    title: 'SIEM Export',
    description: 'Stream audit logs to Splunk or Elastic.',
  },
  {
    type: 'jira',
    title: 'Ticketing',
    description: 'Connect Jira or ServiceNow for incident management.',
  },
  {
    type: 'inbound',
    title: 'Inbound Alerts',
    description: 'Create incidents from external webhooks.',
  },
]
