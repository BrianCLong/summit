...
exports.default = AnalystWorkspace;
const react_1 = __importDefault(require("react"));
const MapPane_1 = require("../panes/MapPane");
const GraphPane_1 = require("../panes/GraphPane");
const TimelinePane_1 = require("../panes/TimelinePane");
const ExplainPanel_1 = __importDefault(require("../panes/ExplainPanel"));
const workspaceStore_1 = require("../store/workspaceStore");
function AnalystWorkspace() {
    const { selectedEntityIds, clearSelection } = (0, workspaceStore_1.useWorkspaceStore)();
    return (<div className="flex h-screen w-screen bg-slate-950 text-slate-200 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header className="h-14 border-b border-slate-800 flex items-center px-4 justify-between bg-slate-950 shrink-0">
            ...
            <div className="flex items-center gap-2">
                ...
                {selectedEntityIds.length > 0 && (<button onClick={clearSelection} className="text-xs text-slate-400 hover:text-white px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 transition">
                        Clear
                    </button>)}
            </div>
        </header>
