        ...
        <div className="bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 rounded-lg p-6 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-green-700 dark:text-green-300 mt-1">
              This receipt is signed by the Switchboard Root CA. The signature
              is valid and the content has not been tampered with.
            </p>
            ...
            <div className="relative">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-zinc-600 dark:text-zinc-400">
                  by {MOCK_RECEIPT.actor}
                </span>
                <div className="mt-2 bg-zinc-50 dark:bg-zinc-800 p-3 rounded text-sm border">
                  <span className="font-semibold text-xs uppercase text-zinc-500 mb-1 block">
                    Policy Version
                  </span>
        ...
        <div className="bg-white dark:bg-zinc-900 border rounded-lg p-6 shadow-sm">
          ...
          <ul className="space-y-2">
            {MOCK_RECEIPT.evidence_links.map((link, i) => (
              <li
                key={i}
                className="flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800 rounded border hover:bg-zinc-100 transition-colors"
              >
