...
const SummitAppHost_1 = require("@/components/SummitAppHost");
const InvestigationCanvas = () => {
    ...
    return (<div className="p-6 h-full flex flex-col bg-slate-50 min-h-screen">
      <div className="mb-6">
      ...
      <div className="flex-1">
        <SummitAppHost_1.SummitAppHost appUri="ui://investigation-canvas/main" className="h-full border shadow-sm min-h-[600px]" onToolCall={handleToolCall}/>
      </div>
    </div>);
};
exports.default = InvestigationCanvas;
