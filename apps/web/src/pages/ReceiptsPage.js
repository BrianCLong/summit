    ...
    return (<div className="p-8 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
          <button className="flex items-center gap-2 px-4 py-2 bg-zinc-100 hover:bg-zinc-200 rounded-md text-sm font-medium transition-colors">
            <lucide_react_1.Download className="w-4 h-4"/> Export Bundle
          </button>
        </div>
      </div>
      ...
      <div className="grid gap-6">
        ...
        <div className="bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 rounded-lg p-6 flex items-start gap-4">
           <lucide_react_1.ShieldCheck className="w-8 h-8 text-green-600 shrink-0"/>
           <div>
        ...
        <div className="bg-white dark:bg-zinc-900 border rounded-lg p-6 shadow-sm">
           <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
             <lucide_react_1.Clock className="w-5 h-5"/> Provenance Chain
           </h3>
        ...
        <div className="bg-white dark:bg-zinc-900 border rounded-lg p-6 shadow-sm">
          <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
            <lucide_react_1.Link className="w-5 h-5"/> Evidence Links
          </h3>
          <ul className="space-y-2">
            {MOCK_RECEIPT.evidence_links.map((link, i) => (<li key={i} className="flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800 rounded border hover:bg-zinc-100 transition-colors">
                <span className="flex items-center gap-2 text-sm font-medium">
                  {link.type === 'log' ? <FileText className="w-4 h-4 text-blue-500"/> : <lucide_react_1.CheckCircle className="w-4 h-4 text-green-500"/>}
        ...
        <div className="bg-zinc-900 text-zinc-100 rounded-lg p-6 font-mono text-xs overflow-x-auto shadow-sm">
          <h3 className="text-sm font-semibold mb-2 text-zinc-400 flex items-center gap-2">
            <lucide_react_1.FileJson className="w-4 h-4"/> Raw Receipt JSON
          </h3>
