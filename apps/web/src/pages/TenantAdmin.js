...
exports.default = TenantAdminPage;
...
function TenantAdminPage() {
    ...
    const [selectedRegion, setSelectedRegion] = (0, react_1.useState)('us-east-1');
    ...
    return (<div className="p-8 space-y-8">
            ...
            <div className="border p-6 rounded-lg bg-white shadow-sm">
                <div className="flex items-center gap-2 mb-4">
                    <lucide_react_1.CreditCard className="w-5 h-5 text-blue-600"/>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-4">
                        <Button_1.Button variant={plan?.plan_id === 'starter' ? 'default' : 'outline'} onClick={() => handlePlanChange('starter')}>
                            Starter
                        </Button_1.Button>
                        <Button_1.Button variant={plan?.plan_id === 'pro' ? 'default' : 'outline'} onClick={() => handlePlanChange('pro')}>
                            Pro
                        </Button_1.Button>
                         <Button_1.Button variant={plan?.plan_id === 'enterprise' ? 'default' : 'outline'} onClick={() => handlePlanChange('enterprise')}>
                            Enterprise
                        </Button_1.Button>
                    </div>
                </div>
            ...
            <div className="border p-6 rounded-lg bg-white shadow-sm">
                <div className="flex items-center gap-2 mb-4">
                    <lucide_react_1.Globe className="w-5 h-5 text-green-600"/>
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="flex gap-4 items-center">
                        <select className="border p-2 rounded" value={selectedRegion} onChange={(e) => setSelectedRegion(e.target.value)}>
                            <option value="us-east-1">US East (N. Virginia)</option>
                            <option value="eu-central-1">EU (Frankfurt)</option>
                            <option value="ap-southeast-1">Asia Pacific (Singapore)</option>
                        </select>
                        <Button_1.Button onClick={handleResidencyRequest}>Request Move</Button_1.Button>
                    </div>

                    {requests.length > 0 && (<div className="mt-4">
                            <h3 className="font-semibold text-sm mb-2">History</h3>
                            <ul className="space-y-2">
                                {requests.map((r, i) => (<li key={i} className="text-sm bg-gray-50 p-2 rounded flex justify-between">
            ...
            <div className="border p-6 rounded-lg bg-white shadow-sm">
                <div className="flex items-center gap-2 mb-4">
                    <lucide_react_1.Shield className="w-5 h-5 text-purple-600"/>
                ...
                <div className="grid grid-cols-3 gap-4">
                 ...
                 <div className="mt-4 text-right">
                    <Button_1.Button variant="ghost" size="sm" onClick={handleDownloadInvoice}>Download Signed Invoice</Button_1.Button>
                 </div>
            </div>
        </div>);
}
