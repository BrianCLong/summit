      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Drifted Investigations</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Clean Investigations</CardTitle>
            ...
            <TableBody>
              {reports.map((report) => (
                <TableRow key={report.investigationId}>
                  <TableCell className="font-mono text-xs">{report.investigationId}</TableCell>
                  <TableCell>
