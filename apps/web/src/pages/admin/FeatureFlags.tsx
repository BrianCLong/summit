    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => { fetchFlags(); reloadFlags(); }}>
      ...
      {loading ? (
        ...
        <div className="grid gap-4">
          {flags.map(flag => (
            <Card key={flag.key} className="flex flex-row items-center p-4 gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {flag.tenantId && <Badge variant="outline" className="bg-yellow-50 text-yellow-700">Tenant: {flag.tenantId}</Badge>}
                </div>
              ...
              <div className="flex gap-2">
                ...
                <Button variant="ghost" size="sm" className="text-red-500 hover:text-red-700" onClick={() => handleDelete(flag.key)}>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>{editingFlag ? 'Edit Flag' : 'Create New Flag'}</DialogTitle>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center space-x-2 h-10">
                  ...
                  />
                  <Label htmlFor="enabled">{formData.enabled ? 'Enabled' : 'Disabled'}</Label>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-2">
              ...
              {formData.type === 'boolean' ? (
                ...
                <Input
                  id="defaultValue"
                  value={typeof formData.defaultValue === 'object' ? JSON.stringify(formData.defaultValue) : formData.defaultValue}
                  onChange={e => {
