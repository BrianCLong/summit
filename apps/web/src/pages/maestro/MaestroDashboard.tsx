  ...
  return (
    <div className="bg-blue-50 border-b border-blue-200 px-4 py-2">
      <div className="flex items-center justify-center text-sm text-blue-800">
        ...
        <strong>Maestro builds IntelGraph</strong> — This is the conductor interface, not the IntelGraph product.
      </div>
    </div>
  );
}
...
function MaestroNavigation() {
  ...
  const navItems = [
    ...
    { path: '/maestro/observability', icon: ChartBarIcon, label: 'Observability' },
    { path: '/maestro/dlq', icon: QueueListIcon, label: 'DLQ & Replay' },
    { path: '/maestro/integrations', icon: CommandLineIcon, label: 'Integrations' },
              ...
              <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 overflow-y-auto">
                  <Routes>
                    ...
                    <Route path="/maestro/observability" element={<Observability />} />
                    <Route path="/maestro/dlq" element={<DLQReplay />} />
                    <Route path="/maestro/integrations/*" element={<Integrations />} />
