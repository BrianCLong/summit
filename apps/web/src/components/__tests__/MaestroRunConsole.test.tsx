...
describe('<MaestroRunConsole />', () => {
  ...
  it('renders quick prompts and runs Maestro pipeline on submit', async () => {
    ...
    expect(screen.getByText(/Maestro Run Console/i)).toBeInTheDocument()
    ...
    const descriptions = screen.getAllByText(
      'Execute user request: test request'
    )
  ...
  it('shows error when API fails', async () => {
    ;(api.runMaestroRequest as any).mockRejectedValueOnce(new Error('API down'))
