...
const FEATURE_FLAGS = [
  ...
  },
  {
    ...
    label: 'Billing',
    description: 'Enable billing and invoicing',
  },
  {
  ...
  },
  {
    name: 'api_access',
    label: 'API Access',
    description: 'Enable REST/GraphQL API access',
  },
  { name: 'sso_enabled', label: 'SSO', description: 'Enable single sign-on' },
  {
    name: 'custom_branding',
    label: 'Custom Branding',
    description: 'Allow custom logos and colors',
  },
  {
    name: 'audit_log_export',
    label: 'Audit Log Export',
    description: 'Allow audit log exports',
  },
]
...
export default function TenantManagement() {
  ...
  const { data: tenantDetailData, refetch: refetchTenantDetail } = useQuery(
    GET_TENANT,
    {
                ...
                <TableRow key={tenant.id} hover>
                  ...
                  <TableCell>
                    <Chip
                      ...
                      size="small"
                      color={
                        getClassificationColor(tenant.classification) as
                          | 'default'
                          | 'primary'
                          | 'secondary'
                          | 'error'
                  ...
                  <TableCell>
                    <Chip
                      ...
                      size="small"
                      color={
                        getStatusColor(tenant.status) as
                          | 'default'
                          | 'primary'
                          | 'secondary'
                          | 'error'
            ...
            <Grid item xs={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={e =>
                    setFormData({ ...formData, dataRegion: e.target.value })
                  }
                  label="Data Region"
                >
      ...
      >
        ...
        <DialogContent>
          <Alert severity="warning" sx={{ mb: 2 }}>
            This will archive the tenant and disable all access. This action can
            be reversed by a platform admin.
          </Alert>
          <Typography>
          ...
          {tenantDetail?.features && (
            <Box>
              {FEATURE_FLAGS.map(flag => {
                const currentFlag = tenantDetail.features.find(
                  (f: FeatureFlag) => f.flagName === flag.name
                )
                ...
                return (
                  ...
                  >
                    ...
                    <Switch
                      checked={isEnabled}
                      onChange={() =>
                        handleFeatureFlagToggle(flag.name, isEnabled)
                      }
                      color="primary"
                    />
                  </Box>
