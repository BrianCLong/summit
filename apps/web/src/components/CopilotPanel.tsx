        ...
        <CardContent className="flex-1 flex flex-col gap-4">
          ...
          >
            <TabsList>
              ...
              <TabsTrigger value="results" disabled={!sandboxResult}>
                Results
              </TabsTrigger>
                    ...
                    <Dialog>
                      <DialogTrigger asChild>
                        <Button
                          size="sm"
                          variant="ghost"
                          aria-label="Show Cypher diff"
                        >
                          <Code className="w-4 h-4 mr-1" aria-hidden="true" />{' '}
                          Diff
                        </Button>
                      </DialogTrigger>
                      <DialogContent>
                    ...
                    <thead>
                      <tr className="border-b">
                        {Object.keys(sandboxResult[0]).map(k => (
                          <th key={k} className="text-left p-2 bg-muted/50">
                            {k}
                          </th>
                        ))}
                      </tr>
            ...
            <TabsContent
              value="citations"
              className="flex-1 pt-4 overflow-auto"
            >
