...
const MOCK_NODES: Entity[] = [
  ...
  { id: '3', name: 'Project X', type: 'PROJECT', confidence: 0.8, properties: {}, createdAt: '', updatedAt: '' },
]
const MOCK_EDGES: Relationship[] = [
  { id: 'e1', sourceId: '1', targetId: '2', type: 'WORKS_FOR', confidence: 0.9, properties: {}, createdAt: '', direction: 'directed' },
  { id: 'e2', sourceId: '1', targetId: '3', type: 'RELATED_TO', confidence: 0.7, properties: {}, createdAt: '', direction: 'directed' },
]
