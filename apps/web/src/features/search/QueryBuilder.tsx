      ...
      <div className="space-y-2">
        <div className="flex flex-wrap gap-2">
          {filters.map(filter => (
            <div
              key={filter.id}
              className="flex items-center gap-2 p-2 text-sm border rounded bg-background"
            >
              ...
              {filter.type === 'date' && (
                <Select
                  ...
                  onValueChange={val =>
                    updateFilter(filter.id, filter.value, val)
                  }
                >
              ...
              <Input
                ...
                value={filter.value}
                onChange={e =>
                  updateFilter(filter.id, e.target.value, filter.operator)
                }
              />
            ...
            <PopoverContent className="w-48">
              <div className="grid gap-1">
                ...
                <Button
                  ...
                  size="sm"
                  className="justify-start"
                  onClick={() => addFilter('relationship')}
                >
