      ...
      <div className="col-span-4 border-r pr-4">
        ...
        <ScrollArea className="h-[600px]">
          ...
          {negotiations.length === 0 && (
              <div className="text-center text-muted-foreground p-8">No active negotiations</div>
          )}
        </ScrollArea>
      </div>
                        ...
                        <div key={round.id} className="mb-8">
                            ...
                            <div className="space-y-4">
                                {round.proposals.map((prop: any) => (
                                    <div key={prop.id} className="flex gap-4 p-4 bg-white rounded shadow-sm border">
