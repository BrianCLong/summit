...
exports.InteractiveDemo = exports.HighImportanceEntities = exports.EmptyState = exports.MinimalData = exports.CustomTimeWindow = exports.LargeDataset = exports.Default = void 0;
const AnalystConsole_1 = require("./AnalystConsole");
const mockData_1 = require("./mockData");
const meta = {
    title: 'Features/AnalystConsole',
    component: AnalystConsole_1.AnalystConsole,
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
...
\`\`\`
    ...
    decorators: [
        Story => (<div style={{ height: '100vh', width: '100vw' }}>
        <Story />
      </div>),
    ],
};
...
exports.Default = {
    args: {
        ...
        links: mockData_1.mockLinks,
        events: mockData_1.mockEvents,
        locations: mockData_1.mockLocations,
    },
};
// =============================================================================
// Large Dataset Story
// =============================================================================
const largeDataset = (0, mockData_1.generateMockDataset)({
    entityCount: 50,
    linkCount: 100,
    eventCount: 150,
    locationCount: 30,
...
// Minimal Data Story
// =============================================================================
const minimalDataset = (0, mockData_1.generateMockDataset)({
    entityCount: 5,
    linkCount: 5,
    eventCount: 10,
    locationCount: 3,
...
// =============================================================================
const highImportanceDataset = (0, mockData_1.generateMockDataset)({
    entityCount: 15,
    linkCount: 40,
    eventCount: 30,
    locationCount: 10,
 ...
 */
exports.HighImportanceEntities = {
    args: {
