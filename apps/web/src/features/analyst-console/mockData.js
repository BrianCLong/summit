...
exports.mockLocations = exports.mockEvents = exports.mockLinks = exports.mockEntities = void 0;
exports.generateMockEntities = generateMockEntities;
exports.generateMockLinks = generateMockLinks;
exports.generateMockEvents = generateMockEvents;
exports.generateMockLocations = generateMockLocations;
...
// =============================================================================
const ENTITY_TYPES = ['Person', 'Org', 'Account', 'Location'];
const LINK_TYPES = [
    'communicatesWith',
    'funds',
    'worksFor',
 ...
 */
function generateMockLinks(entities, count = 30) {
    const links = [];
 ...
 */
function generateMockEvents(entities, count = 40) {
    const events = [];
 ...
 */
function generateMockLocations(entities, count = 15) {
    const locations = [];
    ...
    for (let i = 0; i < count; i++) {
        ...
        const associatedEntity = Math.random() > 0.5 && personEntities.length > 0
...
function generateMockDataset(options) {
    const { entityCount = 20, linkCount = 30, eventCount = 40, locationCount = 15, } = options || {};
...
// =============================================================================
exports.mockEntities = generateMockEntities(10);
exports.mockLinks = generateMockLinks(exports.mockEntities, 15);
exports.mockEvents = generateMockEvents(exports.mockEntities, 20);
exports.mockLocations = generateMockLocations(exports.mockEntities, 8);
