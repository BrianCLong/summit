...
exports.mockGeospatialEvents = exports.mockTimelineEvents = exports.mockRelationships = exports.mockEntities = exports.mockDataProvider = exports.MockTriPaneDataProvider = void 0;
exports.generateMockEntities = generateMockEntities;
exports.generateMockRelationships = generateMockRelationships;
exports.generateMockTimelineEvents = generateMockTimelineEvents;
exports.generateMockGeospatialEvents = generateMockGeospatialEvents;
exports.useMockTriPaneData = useMockTriPaneData;
/**
 * Generate mock entities with various types
 */
function generateMockEntities(count = 20) {
    const types = [
        'PERSON',
        'ORGANIZATION',
        'LOCATION',
 ...
 */
function generateMockRelationships(entities, count = 30) {
    const types = [
        'CONNECTED_TO',
        'OWNS',
        'WORKS_FOR',
 ...
 */
function generateMockTimelineEvents(entities, count = 50) {
    const eventTypes = [
        'entity_created',
        'entity_updated',
 ...
 */
function generateMockGeospatialEvents(count = 25) {
    const cities = [
...
class MockTriPaneDataProvider {
    ...
    async fetchRelationships(filters) {
        await new Promise(resolve => setTimeout(resolve, 300));
    ...
    async fetchGeospatialEvents(filters) {
        await new Promise(resolve => setTimeout(resolve, 300));
...
exports.MockTriPaneDataProvider = MockTriPaneDataProvider;
/**
 * Singleton instance for easy use
 */
exports.mockDataProvider = new MockTriPaneDataProvider();
/**
 * Pre-generated static mock data for tests
 */
const staticEntities = generateMockEntities(20);
exports.mockEntities = staticEntities;
exports.mockRelationships = generateMockRelationships(staticEntities, 30);
exports.mockTimelineEvents = generateMockTimelineEvents(staticEntities, 50);
exports.mockGeospatialEvents = generateMockGeospatialEvents(25);
/**
 * Hook for using mock data in components
 */
async function useMockTriPaneData() {
    const entities = await exports.mockDataProvider.fetchEntities();
    const relationships = await exports.mockDataProvider.fetchRelationships();
    const timelineEvents = await exports.mockDataProvider.fetchTimelineEvents();
    const geospatialEvents = await exports.mockDataProvider.fetchGeospatialEvents();
    return {
        entities,
        relationships,
        timelineEvents,
