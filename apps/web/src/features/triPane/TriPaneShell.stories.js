...
const meta = {
    ...
    args: {
        onEntitySelect: (0, test_1.fn)(),
        onEventSelect: (0, test_1.fn)(),
        onLocationSelect: (0, test_1.fn)(),
        onTimeWindowChange: (0, test_1.fn)(),
        onSyncStateChange: (0, test_1.fn)(),
        onExport: (0, test_1.fn)(),
    },
};
