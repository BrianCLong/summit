...
export default function HealthSignals({ progress, kpis = [] }: HealthSignalsProps) {
  if (!progress) return (
      <div className="text-muted-foreground p-4">Select a plan to view health signals.</div>
  );
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-medium">Plan Health Score</CardTitle>
        </CardHeader>
        <CardContent>
