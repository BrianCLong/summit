...
exports.maestroApi = exports.MaestroApi = void 0;
class MaestroApi {
    baseUrl;
    mock;
    constructor(opts = {}) {
        this.baseUrl =
            opts.baseUrl || import.meta.env?.VITE_MAESTRO_BASE_URL || '';
        this.mock = Boolean(opts.mock ?? !this.baseUrl);
    }
    async routePreview(task, context) {
        if (this.mock) {
            await sleep(250);
            return {
                candidates: [
    ...
    async routeExecute(task, selection) {
        if (this.mock) {
            await sleep(400);
            return {
    ...
    async orchestrateWeb(task, interfaces) {
        if (this.mock) {
            await sleep(600);
            return {
    ...
    async policyCheck(action, payload) {
        if (this.mock) {
            await sleep(120);
...
exports.maestroApi = new MaestroApi();
