...
exports.abacDecision = abacDecision;
/**
 ...
 */
function abacDecision(user, request, decision) {
    ...
    if (request.dualControl && decision === 'approve') {
        const hasComplianceOfficerApproval = request.approvals.some((a) => a.decision === 'approved' && a.role === 'compliance_officer');
