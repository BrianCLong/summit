...
const TaskDetailView = ({ approval, onClose }) => {
    const payload = approval.payload || {};
    const riskScore = payload.riskScore || 0;
    const diff = payload.diff || {};
    return (<div className="task-detail-overlay">
            <div className="task-detail-modal">
                ...
                <div className="detail-content">
                    <section className="risk-summary">
                        ...
                        {payload.riskFactors && payload.riskFactors.length > 0 && (<ul className="risk-factors">
                                {payload.riskFactors.map((f, i) => (<li key={i} className="risk-factor-item">
