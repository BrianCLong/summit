...
const safetyCategories: { value: SafetyCategory; label: string; description: string }[] = [
  ...
  { value: "violence", label: "Violence", description: "Contains violent or graphic content" },
  {
    value: "hate_speech",
    label: "Hate Speech",
    description: "Promotes hatred against protected groups",
  },
  { value: "harassment", label: "Harassment", description: "Targets individuals for harassment" },
  {
    value: "sexual_content",
    label: "Sexual Content",
    description: "Contains explicit sexual material",
  },
  {
    value: "misinformation",
    label: "Misinformation",
    description: "Spreads false or misleading information",
  },
  {
    value: "privacy_violation",
    label: "Privacy Violation",
    description: "Exposes private information",
  },
  { value: "other", label: "Other", description: "Other safety concern not listed" },
];

export function SafetyDecisionTask({ sample, onSubmit, instructions }: SafetyDecisionTaskProps) {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={
            selectedCategories.length === 0 || (!isSafe && !severity) || (!isSafe && !notes.trim())
          }
