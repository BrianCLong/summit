...
export function MapPane() {
  ...
  return (
    <section aria-labelledby="map-heading" className="flex flex-col gap-3 rounded-2xl border border-sand/20 bg-horizon/40 p-4 shadow-inner">
              ...
              return (
                <button
                  ...
                  className={`rounded-lg border px-3 py-2 text-left text-sm transition focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-ink ${
                    isActive ? 'border-accent bg-accent/15 text-accent' : 'border-sand/20 bg-horizon'
                  }`}
                  aria-pressed={isActive}
                  onClick={() => dispatch({ type: 'setGeofence', payload: isActive ? null : fence.id })}
                >
