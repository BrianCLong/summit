...
exports.timeline = exports.edges = exports.nodes = exports.geofences = exports.layers = void 0;
exports.layers = [
    { id: 'signals', label: 'Signals', description: 'Sensor signatures and RF telemetry traces.' },
    { id: 'comms', label: 'Communications', description: 'Operator chatters, dispatch calls, and relays.' },
    { id: 'logistics', label: 'Logistics', description: 'Movements, manifests, and supply choke points.' }
];
exports.geofences = [
    {
        id: 'harbor',
