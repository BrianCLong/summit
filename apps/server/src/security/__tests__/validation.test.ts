...
describe("validateAndSanitizeDropInput", () => {
  ...
  describe("Basic Input Validation", () => {
    ...
    it("should throw error for null or undefined input", () => {
      expect(() => validateAndSanitizeDropInput(null as any)).toThrow("Invalid payload");

      expect(() => validateAndSanitizeDropInput(undefined as any)).toThrow("Invalid payload");
    });

    it("should throw error when payload is missing", () => {
      const input = {} as DropInput;

      expect(() => validateAndSanitizeDropInput(input)).toThrow("Invalid payload");
    });
  ...
  describe("Base64 Validation", () => {
    it("should reject invalid base64 strings", () => {
      ...
      expect(() => validateAndSanitizeDropInput(input)).toThrow("Payload must be base64 encoded");
    });
  ...
  describe("Size Limit Enforcement", () => {
    ...
    it("should reject payload exceeding size limit", () => {
      ...
      expect(() => validateAndSanitizeDropInput(input)).toThrow("Payload size exceeds limit");
    });
  ...
  describe("Metadata Validation", () => {
    ...
    it("should throw error for invalid JSON metadata", () => {
      ...
      expect(() => validateAndSanitizeDropInput(input)).toThrow("Metadata must be valid JSON");
    });
  ...
  describe("Concurrent Validation", () => {
    it("should handle multiple concurrent validations", async () => {
      ...
      const results = inputs.map((input) => validateAndSanitizeDropInput(input));
