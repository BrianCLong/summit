...
exports.enableCopyPrevention = enableCopyPrevention;
exports.blockKeyboardShortcuts = blockKeyboardShortcuts;
exports.setupSessionTimeout = setupSessionTimeout;
exports.handleRemoteWipe = handleRemoteWipe;
exports.verifyDeviceBinding = verifyDeviceBinding;
exports.initializeSecurityMeasures = initializeSecurityMeasures;
...
function setupSessionTimeout(timeoutMs, onTimeout) {
    let timeoutId;
...
function initializeSecurityMeasures(config) {
    const cleanupFns = [];
