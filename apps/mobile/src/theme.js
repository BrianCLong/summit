...
const colors = {
    ...
    // Dividers
    divider: (0, styles_1.alpha)('#94a3b8', 0.12),
};
...
const spacing = 8;
// Create the theme
exports.mobileTheme = (0, styles_1.createTheme)({
    palette: {
        mode: 'dark',
    ...
    components: {
        ...
        MuiListItemButton: {
            styleOverrides: {
                root: {
                    ...
                    borderRadius: 8,
                    '&:active': {
                        backgroundColor: (0, styles_1.alpha)(colors.primary.main, 0.1),
                    },
                },
            },
        },
        ...
        MuiFab: {
            styleOverrides: {
                root: {
                    boxShadow: `0 4px 12px ${(0, styles_1.alpha)('#000', 0.3)}`,
                },
            },
        },
        MuiSwipeableDrawer: {
        ...
        MuiSkeleton: {
            styleOverrides: {
                root: {
                    borderRadius: 8,
                    backgroundColor: (0, styles_1.alpha)(colors.text.secondary, 0.1),
                },
            },
        },
    },
...
exports.default = exports.mobileTheme;
