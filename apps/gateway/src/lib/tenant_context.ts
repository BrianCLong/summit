...
export function requireTenant(headers: Record<string, string | string[] | undefined>): TenantContext {
...
export function withTenant<T extends { [key: string]: unknown }>(tenant: TenantContext, payload: T): T {
