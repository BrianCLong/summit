...
exports.registerInternalStatusRoutes = void 0;
const statusData = {
    governance: {
...
const buildHandler = (key) => (req, res) => {
...
const registerInternalStatusRoutes = (app) => {
...
exports.registerInternalStatusRoutes = registerInternalStatusRoutes;
