...
import {
  parseShodanStream,
  parseShadowserverReport,
  verifyShadowserverHmac,
...
test("scoreEvent applies decay and kev multiplier", () => {
  ...
  const event = parseShadowserverReport(
    `${JSON.stringify({ id: "b2", ip: "2.2.2.2", infection: "true", cve: "CVE-2025-1234", timestamp: new Date().toISOString() })}\n`,
    "daily"
  )[0];
