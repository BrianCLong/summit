...
exports.buildSelfEditEvaluationPlan = buildSelfEditEvaluationPlan;
...
function buildSelfEditEvaluationPlan(registry, options = {}) {
...
function computePriority(record, scorecard, now) {
