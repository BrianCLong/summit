...
exports.buildCopilotCostPreview = buildCopilotCostPreview;
...
function estimateCompletionTokens(costEstimate) {
...
function calculateCostUSD(tokens, model) {
...
function selectModel(models, tokens) {
    if (models.length === 0) {
...
function detectCartesianProduct(cypher) {
...
function buildCopilotCostPreview(input) {
    ...
    const guard = new cost_guard_1.CostGuard(input.tenantProfile);
