...
exports.defaultPolicyProfiles = exports.PolicyEngine = void 0;
exports.createDefaultPolicyContext = createDefaultPolicyContext;
...
class PolicyEngine {
    ...
    emitAudit(decision) {
        ...
        this.audits.push({
            ...
            decision,
            digest: (0, node_crypto_1.createHash)('sha256').update(decisionBody).digest('hex'),
        });
    }
}
exports.PolicyEngine = PolicyEngine;
exports.defaultPolicyProfiles = [
    {
        name: 'civilian_safe',
...
function createDefaultPolicyContext(requestId, tenantId) {
    return {
        requestId,
        tenantId,
