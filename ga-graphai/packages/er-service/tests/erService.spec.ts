...
describe("EntityResolutionService", () => {
  ...
  it("emits structured observability for entity extraction workflows", () => {
    ...
    const service = new EntityResolutionService(() => new Date("2024-03-03T00:00:00Z"), {
      logger,
      metrics,
      tracer,
    });
  ...
  it("previews merge impact in a sandbox", () => {
    const service = new EntityResolutionService(() => new Date("2024-04-04T00:00:00Z"));
  ...
  it("clusters duplicates across sources and honors confidence for primaries", () => {
    const service = new EntityResolutionService(() => new Date("2024-05-05T00:00:00Z"));
