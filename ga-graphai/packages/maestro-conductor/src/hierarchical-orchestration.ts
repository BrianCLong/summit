export type AgentStageId = "plan" | "architecture" | "implement" | "execute" | "verify" | "critic";
...
export class HierarchicalOrchestrationLoop {
  ...
  recordArtifact(plan: HierarchicalWorkflowPlan, artifactName: string, artifactRef: string): void {
