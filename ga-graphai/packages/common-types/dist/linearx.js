...
export const LINEARX_PROVIDER_ROUTING = [
    {
...
export const LINEARX_TOOL_CONTRACTS = [
    {
        name: "policy.check",
...
export const LINEARX_QUICK_NEXT_STEPS = [
...
export const LINEARX_SHORT_ANSWERS = [
    {
...
export const LINEARX_KEYBOARD_SHORTCUTS = [
    {
...
export const LINEARX_COMMAND_PALETTE_INTENTS = [
    {
        id: "command_palette",
...
export const LINEARX_COMMAND_PALETTE_CATEGORIES = [
    {
        id: "navigation",
...
export const LINEARX_BOARD_ENHANCEMENTS = [
    {
...
export const LINEARX_GRAPHQL_BINDINGS = [
    {
        operation: "Mutation",
...
export function resolveProviderForTag(tag, options = {}, spec = LINEARX_SPEC) {
...
export function buildCommandPaletteManifest(intents = LINEARX_COMMAND_PALETTE_INTENTS, shortcuts = LINEARX_KEYBOARD_SHORTCUTS, categories = LINEARX_COMMAND_PALETTE_CATEGORIES) {
...
export function generateGraphQLSchemaSDL(bindings = LINEARX_GRAPHQL_BINDINGS) {
    const grouped = {
        Query: [],
        Mutation: []
    };
...
export function planGuardedInvocation(tool, policyAction, options = {}) {
    const steps = [];
    let order = 1;
    steps.push({
        order: order++,
...
export function planGuardedInvocationForBinding(bindingOrField) {
