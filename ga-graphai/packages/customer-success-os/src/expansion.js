...
exports.detectExpansionTriggers = detectExpansionTriggers;
exports.expansionPlaybookFromAlerts = expansionPlaybookFromAlerts;
function detectExpansionTriggers(signals) {
    const triggers = [];
...
function expansionPlaybookFromAlerts(alerts, profile) {
