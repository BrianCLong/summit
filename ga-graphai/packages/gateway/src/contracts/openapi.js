...
exports.gatewayOpenApiContract = void 0;
exports.gatewayOpenApiContract = {
    version: '2025.3.0',
    openapi: '3.1.0',
    info: {
        title: 'GA GraphAI Gateway',
        version: '2025.3.0',
        description: 'Unified gateway for search, policy-aware orchestration, and GraphQL execution. OpenAPI is the single source of truth for REST entrypoints.',
    },
    servers: [
