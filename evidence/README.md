...
- `schemas/se-dicow-*.schema.json`: SE-DiCoW evidence schemas (report/metrics/stamp/index).
...
## SE-DiCoW evidence IDs

Use the convention `EVD-SE-DICOW-<AREA>-<NNN>` (example: `EVD-SE-DICOW-ASR-001`).
This scope is reserved for the SE-DiCoW ingestion/evaluation stack.
