...
exports.queryEngine = exports.graphStorage = exports.app = void 0;
const express_1 = __importDefault(require("express"));
const cors_1 = __importDefault(require("cors"));
const graph_database_1 = require("@intelgraph/graph-database");
const graph_query_1 = require("@intelgraph/graph-query");
const graph_algorithms_1 = require("@intelgraph/graph-algorithms");
const relationship_mining_1 = require("@intelgraph/relationship-mining");
const link_prediction_1 = require("@intelgraph/link-prediction");
const app = (0, express_1.default)();
exports.app = app;
const port = process.env.GRAPH_DB_PORT || 3100;
// Initialize graph storage
const graphStorage = new graph_database_1.GraphStorage({
    dataDir: './data/graph',
...
// Initialize engines
const queryEngine = new graph_query_1.QueryEngine(graphStorage);
exports.queryEngine = queryEngine;
const pathfinding = new graph_algorithms_1.ShortestPathAlgorithms(graphStorage);
const centrality = new graph_algorithms_1.CentralityMeasures(graphStorage);
const community = new graph_algorithms_1.CommunityDetection(graphStorage);
const clustering = new graph_algorithms_1.GraphClustering(graphStorage);
const patternMining = new relationship_mining_1.PatternMining(graphStorage);
const linkPredictor = new link_prediction_1.LinkPredictor(graphStorage);
...
app.get('/api/algorithms/cliques', (req, res) => {
    try {
        const { k } = req.query;
        const cliques = k ? clustering.findKCliques(parseInt(k)) : clustering.findMaximalCliques();
...
app.get('/api/neighbors/:nodeId', (req, res) => {
    try {
        ...
        const neighbors = graphStorage.getNeighbors(req.params.nodeId, direction || 'both');
