    ...
    insights: [
      {
        ...
        recommendation: doraMetrics.leadTimeForChanges > 24 ? "Focus on reducing PR review time and CI pipeline duration" : "Maintain current velocity",
      },
      {
        category: "Quality", 
        finding: `Change failure rate: ${doraMetrics.changeFailureRate}%`,
        recommendation: doraMetrics.changeFailureRate > 15 ? "Increase test coverage and review rigor" : "Good quality gate effectiveness",
      },
      {
        category: "Efficiency",
