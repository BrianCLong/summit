...
const registry_1 = require("../src/fabric/registry");
const policyRouter_1 = require("../src/fabric/policyRouter");
describe('policy router', () => {
    ...
    it('selects high-value bundle under cost and latency constraints', () => {
        const registry = new registry_1.CapabilityRegistry();
        registry.upsert({
            id: 'cap-1',
        ...
        const decision = (0, policyRouter_1.routeTask)(spec, registry, {
            costBudgetUsd: 0.5,
