...
exports.runAuctionOfExperts = runAuctionOfExperts;
const registry_1 = require("../registry");
function runAuctionOfExperts(bids, constraints) {
    ...
    const coverage = (0, registry_1.coverageScore)(best.map((b) => b.fitTags).flat(), constraints.requiredSkills);
    return {
        winners: best,
...
function pruneDominated(bids) {
    return bids.filter((bid) => {
        return !bids.some((other) => other !== bid &&
