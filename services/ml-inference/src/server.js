...
const sentiment_analysis_1 = require("@intelgraph/sentiment-analysis");
const narrative_tracking_1 = require("@intelgraph/narrative-tracking");
const influence_detection_1 = require("@intelgraph/influence-detection");
const app = (0, express_1.default)();
exports.app = app;
const port = process.env.ML_INFERENCE_PORT || 3500;
app.use(express_1.default.json({ limit: '10mb' }));
// Initialize analyzers
const sentimentAnalyzer = new sentiment_analysis_1.SentimentAnalyzer();
const narrativeExtractor = new narrative_tracking_1.NarrativeExtractor();
const framingAnalyzer = new narrative_tracking_1.FramingAnalyzer();
const narrativeTracker = new narrative_tracking_1.NarrativeTracker();
const counterNarrativeDetector = new narrative_tracking_1.CounterNarrativeDetector();
const botDetector = new influence_detection_1.BotDetector();
const cibDetector = new influence_detection_1.CIBDetector();
const astroturfingDetector = new influence_detection_1.AstroturfingDetector();
const amplificationDetector = new influence_detection_1.AmplificationDetector();
// Health check
