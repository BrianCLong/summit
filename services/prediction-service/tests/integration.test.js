...
const prediction_engine_js_1 = require("../src/core/prediction-engine.js");
const model_registry_js_1 = require("../src/core/model-registry.js");
describe('PredictionEngine Integration', () => {
    let engine;
    let registry;
    beforeEach(() => {
        engine = new prediction_engine_js_1.PredictionEngine();
        registry = new model_registry_js_1.ModelRegistry();
    });
...
describe('End-to-End Workflow', () => {
    it('should complete full prediction workflow', async () => {
        const engine = new prediction_engine_js_1.PredictionEngine();
        const registry = new model_registry_js_1.ModelRegistry();
