...
function extractSummary(descriptions: Array<{ lang: string; value: string }>): string {
...
function extractSeverity(metrics: NvdFeed['vulnerabilities'][number]['cve']['metrics']): {
...
export function applyCvesToProfile(profile: ToolRiskProfile, cves: CveRecord[]): ToolRiskProfile {
