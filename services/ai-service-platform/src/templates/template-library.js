    ...
    async loadBuiltInTemplates() {
        const builtIn = [
            // LLM Service Template
            {
                ...
                description: 'Deploy large language models with optimized inference, batching, and caching',
                category: 'llm',
            ...
            // Document Processing Template
            {
                ...
                description: 'OCR, classification, and extraction from documents (PDF, images, scans)',
                category: 'vision',
            ...
            // NLP Pipeline Template
            {
                ...
                description: 'Entity extraction, sentiment analysis, summarization, and classification',
                category: 'nlp',
            ...
            // Embedding Service Template
            {
                ...
                description: 'Generate embeddings for text, images, or multimodal content',
                category: 'embedding',
            ...
            // Prediction Service Template
            {
                ...
                description: 'Deploy custom ML models (sklearn, PyTorch, TensorFlow) with auto-scaling',
                category: 'prediction',
            ...
            // RAG Pipeline Template
            {
                ...
                description: 'Retrieval-Augmented Generation with vector search and LLM integration',
                category: 'llm',
            ...
            // Agent Workflow Template
            {
                ...
                description: 'Multi-step agent with tool use, planning, and execution capabilities',
                category: 'workflow',
