...
const driver = neo4j.driver(process.env.NEO4J_URI || 'neo4j://localhost', neo4j.auth.basic(process.env.NEO4J_USER || 'readonly', process.env.NEO4J_PASSWORD || ''), { disableLosslessIntegers: true });
