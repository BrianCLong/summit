...
class HealthScoreService {
    ...
    constructor(metricsProvider, repository) {
    ...
    async calculateHealthScore(context) {
        ...
        const overallScore = Math.round(components.reduce((sum, comp) => sum + comp.score * comp.weight, 0));
     ...
     */
    async getHealthScoreHistory(period = '7d', resolution = '1h', context) {
        return this.repository.getHistory(period, resolution);
    }
    // ============================================================================
    // Component Calculators
    // ============================================================================
    async calculateSupportHealth() {
    ...
    // Helper Methods
    // ============================================================================
    calculateFactorImpact(value, warningThreshold, criticalThreshold, higherIsBad) {
    ...
    calculateComponentScore(factors) {
        if (factors.length === 0)
            return 100;
