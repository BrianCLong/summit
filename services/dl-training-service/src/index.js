...
const distributed_training_1 = require("@intelgraph/distributed-training");
...
async function startTraining(jobId, config) {
    const status = trainingJobs.get(jobId);
    ...
    try {
        ...
        if (config.distributed) {
            const orchestrator = new distributed_training_1.DistributedTrainingOrchestrator({
