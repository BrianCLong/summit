...
exports.service = exports.app = void 0;
...
exports.app = app;
const service = (0, service_js_1.createService)();
 ...
 * GET /api/v1/threats
 */
app.get('/api/v1/threats', async (req, res, next) => {
    try {
        const filterResult = types_js_1.threatFilterSchema.safeParse(req.query);
        const paginationResult = types_js_1.paginationSchema.safeParse({
 ...
 */
app.get('/api/v1/threats/:id', async (req, res, next) => {
    try {
 ...
 * POST /api/v1/threats
 */
app.post('/api/v1/threats', async (req, res, next) => {
    try {
 ...
 */
app.put('/api/v1/threats/:id', async (req, res, next) => {
    try {
        const author = req.headers['x-author'] ?? 'system';
        const description = req.headers['x-change-description'];
 ...
 */
app.post('/api/v1/threats/:id/deprecate', async (req, res, next) => {
    try {
        const author = req.headers['x-author'] ?? 'system';
 ...
 */
app.delete('/api/v1/threats/:id', async (req, res, next) => {
    try {
        const author = req.headers['x-author'] ?? 'system';
 ...
 */
app.get('/api/v1/threats/:threatId/patterns', async (req, res, next) => {
    try {
 ...
 * GET /api/v1/patterns
 */
app.get('/api/v1/patterns', async (req, res, next) => {
    try {
        const filterResult = types_js_1.patternFilterSchema.safeParse(req.query);
        const paginationResult = types_js_1.paginationSchema.safeParse({
            page: req.query.page ? Number(req.query.page) : 1,
            limit: req.query.limit ? Number(req.query.limit) : 20,
        });
 ...
 */
app.get('/api/v1/patterns/:id', async (req, res, next) => {
    try {
 ...
 */
app.post('/api/v1/patterns', async (req, res, next) => {
    try {
        const author = req.headers['x-author'] ?? 'system';
 ...
 */
app.put('/api/v1/patterns/:id', async (req, res, next) => {
    try {
        const author = req.headers['x-author'] ?? 'system';
        const description = req.headers['x-change-description'];
 ...
 */
app.get('/api/v1/patterns/:id/validate', async (req, res, next) => {
    try {
 ...
 * GET /api/v1/ttps
 */
app.get('/api/v1/ttps', async (req, res, next) => {
    try {
        const filterResult = types_js_1.ttpFilterSchema.safeParse(req.query);
        const paginationResult = types_js_1.paginationSchema.safeParse({
            page: req.query.page ? Number(req.query.page) : 1,
            limit: req.query.limit ? Number(req.query.limit) : 20,
        });
 ...
 * GET /api/v1/ttps/:id
 */
app.get('/api/v1/ttps/:id', async (req, res, next) => {
    try {
 ...
 */
app.get('/api/v1/ttps/technique/:techniqueId', async (req, res, next) => {
    try {
 ...
 */
app.get('/api/v1/threats/:threatId/ttps', async (req, res, next) => {
    try {
 ...
 * POST /api/v1/ttps
 */
app.post('/api/v1/ttps', async (req, res, next) => {
    try {
        const author = req.headers['x-author'] ?? 'system';
 ...
 * PUT /api/v1/ttps/:id
 */
app.put('/api/v1/ttps/:id', async (req, res, next) => {
    try {
        const author = req.headers['x-author'] ?? 'system';
        const description = req.headers['x-change-description'];
 ...
 */
app.get('/api/v1/indicators', async (req, res, next) => {
    try {
        const paginationResult = types_js_1.paginationSchema.safeParse({
            page: req.query.page ? Number(req.query.page) : 1,
            limit: req.query.limit ? Number(req.query.limit) : 20,
 ...
 */
app.get('/api/v1/indicators/:id', async (req, res, next) => {
    try {
 ...
 */
app.get('/api/v1/threats/:threatId/indicators', async (req, res, next) => {
    try {
 ...
 */
app.post('/api/v1/indicators', async (req, res, next) => {
    try {
        const author = req.headers['x-author'] ?? 'system';
 ...
 */
app.post('/api/v1/evaluate', async (req, res, next) => {
    try {
        const request = types_js_1.patternEvaluationRequestSchema.parse(req.body);
 ...
 */
app.post('/api/v1/threats/:threatId/evaluate', async (req, res, next) => {
    try {
        const options = {
        ...
        const specs = await service.generateBulkEvaluationSpecs(req.params.threatId, options);
        res.json({
            success: true,
            data: specs,
            timestamp: new Date().toISOString(),
 ...
 */
app.get('/api/v1/threats/:threatId/explain', async (req, res, next) => {
    try {
 ...
 */
app.get('/api/v1/threats/:threatId/explain/brief', async (req, res, next) => {
    try {
 ...
 */
app.get('/api/v1/statistics', async (_req, res, next) => {
    try {
        const stats = await service.getLibraryStatistics();
        res.json({
            success: true,
...
app.use((err, _req, res, _next) => {
    ...
    // Handle known errors
    if ((0, errors_js_1.isKnownError)(err)) {
    ...
    const knownError = (0, errors_js_1.toThreatLibraryError)(err);
