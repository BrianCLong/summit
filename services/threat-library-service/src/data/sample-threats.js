...
exports.sampleIndicators = exports.sampleTTPs = exports.dataExfiltrationMotif = exports.c2CommunicationMotif = exports.lateralMovementMotif = void 0;
exports.createSampleThreatArchetype = createSampleThreatArchetype;
exports.createSamplePatternTemplate = createSamplePatternTemplate;
const uuid_1 = require("uuid");
// Helper to create metadata
function createMetadata(author = 'system') {
...
exports.sampleTTPs = [
        ...
        detectionRules: [
            {
                ...
                logic: 'parent_process IN ("winword.exe", "excel.exe") AND process_name IN ("cmd.exe", "powershell.exe", "mshta.exe")',
                format: 'SIGMA',
    ...
    },
    {
        ...
        description: 'Adversaries may obtain and abuse credentials of domain accounts to gain Initial Access and move laterally.',
...
exports.sampleIndicators = [
    ...
    },
    {
        ...
        type: 'BEHAVIOR',
        pattern: 'IEX\\s*\\(\\s*(New-Object\\s+Net\\.WebClient\\)\\.DownloadString|\\(Invoke-WebRequest|iwr\\s)',
        patternFormat: 'REGEX',
        confidence: 'HIGH',
        severity: 'HIGH',
        validFrom: new Date().toISOString(),
...
// ============================================================================
function createSampleThreatArchetype(ttpIds, patternIds, indicatorIds) {
    return {
        name: 'APT-Style Cyber Espionage Campaign',
        aliases: ['Advanced Persistent Threat', 'State-Sponsored Attack'],
        description: 'A sophisticated, multi-stage attack campaign typically associated with nation-state actors. Characterized by long dwell times, lateral movement, and targeted data exfiltration.',
        summary: 'Advanced persistent threat campaign targeting sensitive data with sophisticated techniques',
...
function createSamplePatternTemplate(motifs, ttpIds, indicatorIds) {
    return {
        name: 'APT Lateral Movement and Exfiltration Pattern',
        description: 'Detects the combination of lateral movement and data exfiltration indicative of APT activity',
