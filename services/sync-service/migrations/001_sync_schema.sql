...
CREATE INDEX CONCURRENTLY idx_sync_audit_log_bundle_id ON sync_audit_log(bundle_id);
CREATE INDEX CONCURRENTLY idx_sync_audit_log_operation ON sync_audit_log(operation);
CREATE INDEX CONCURRENTLY idx_sync_audit_log_actor ON sync_audit_log(actor);
CREATE INDEX CONCURRENTLY idx_sync_audit_log_timestamp ON sync_audit_log(timestamp DESC);
CREATE INDEX CONCURRENTLY idx_sync_audit_log_classification ON sync_audit_log(classification);
...
CREATE INDEX CONCURRENTLY idx_sync_operations_bundle_id ON sync_operations(bundle_id);
CREATE INDEX CONCURRENTLY idx_sync_operations_status ON sync_operations(status);
CREATE INDEX CONCURRENTLY idx_sync_operations_initiated_by ON sync_operations(initiated_by);
CREATE INDEX CONCURRENTLY idx_sync_operations_initiated_at ON sync_operations(initiated_at DESC);
...
CREATE INDEX CONCURRENTLY idx_sync_conflicts_bundle_id ON sync_conflicts(bundle_id);
CREATE INDEX CONCURRENTLY idx_sync_conflicts_type ON sync_conflicts(type);
CREATE INDEX CONCURRENTLY idx_sync_conflicts_resource_type ON sync_conflicts(resource_type);
CREATE INDEX CONCURRENTLY idx_sync_conflicts_resource_id ON sync_conflicts(resource_id);
CREATE INDEX CONCURRENTLY idx_sync_conflicts_resolved_at ON sync_conflicts(resolved_at);
...
CREATE INDEX CONCURRENTLY idx_sync_bundles_source_deployment ON sync_bundles(source_deployment_id);
CREATE INDEX CONCURRENTLY idx_sync_bundles_target_deployment ON sync_bundles(target_deployment_id);
CREATE INDEX CONCURRENTLY idx_sync_bundles_created_at ON sync_bundles(created_at DESC);
CREATE INDEX CONCURRENTLY idx_sync_bundles_expires_at ON sync_bundles(expires_at);
CREATE INDEX CONCURRENTLY idx_sync_bundles_classification ON sync_bundles(classification);
CREATE INDEX CONCURRENTLY idx_sync_bundles_direction ON sync_bundles(direction);
...
CREATE INDEX CONCURRENTLY idx_sync_deployments_environment ON sync_deployments(environment);
CREATE INDEX CONCURRENTLY idx_sync_deployments_classification ON sync_deployments(classification);
CREATE INDEX CONCURRENTLY idx_sync_deployments_status ON sync_deployments(status);
CREATE INDEX CONCURRENTLY idx_sync_deployments_last_sync_at ON sync_deployments(last_sync_at DESC);
...
CREATE INDEX CONCURRENTLY idx_sync_statistics_bundle_id ON sync_statistics(bundle_id);
CREATE INDEX CONCURRENTLY idx_sync_statistics_operation ON sync_statistics(operation);
CREATE INDEX CONCURRENTLY idx_sync_statistics_created_at ON sync_statistics(created_at DESC);
