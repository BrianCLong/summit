...
class ExplainEntityRequest(BaseModel):
    ...
    locale: Optional[str] = Field("en", description="Language for explanations")
...
def get_cached_explanation(cache_key: str) -> Optional[Explanation]:
    ...
    def explain_edge(edge_id: str, model: str, version: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "counterfactuals": [
                ...
                f"If connected nodes had different attribute profiles"
            ],
            "fairness_score": 0.89,
...
async def explain_entity(
    ...
    policy: Dict[str, str] = Depends(enforce_policy)
):
    ...
    try:
        ...
        logger.info("Generated entity explanation",
        ...
        logger.error("Failed to generate entity explanation",
                    entity_id=request.entityId,
                    error=str(e))
...
async def explain_edge(
    ...
    try:
        ...
        logger.info("Generated edge explanation",
