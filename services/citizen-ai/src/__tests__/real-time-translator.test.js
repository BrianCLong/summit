...
const translation_1 = require("@intelgraph/language-models/translation");
describe('RealTimeTranslator', () => {
    let translator;
    beforeEach(() => {
        translator = new translation_1.RealTimeTranslator();
    });
    describe('translate', () => {
    ...
    describe('translateStream', () => {
        it('should stream translation with callbacks', async () => {
            const chunks = [];
            const result = await translator.translateStream('This is a long text that should be chunked. It has multiple sentences.', 'de', {
                chunkSize: 30,
...
describe('realTimeTranslator singleton', () => {
    it('should be defined', () => {
        expect(translation_1.realTimeTranslator).toBeDefined();
    });
});
