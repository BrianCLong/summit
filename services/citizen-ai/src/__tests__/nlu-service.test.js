...
describe('NLUService', () => {
    let nlu;
    beforeEach(() => {
        nlu = new nlu_service_1.NLUService();
    });
    ...
    describe('analyze', () => {
        it('should perform comprehensive analysis', async () => {
            const result = await nlu.analyze('Hello, I urgently need to apply for e-residency. Contact me at test@example.com');
...
describe('nluService singleton', () => {
    it('should be defined', () => {
        expect(nlu_service_1.nluService).toBeDefined();
    });
});
