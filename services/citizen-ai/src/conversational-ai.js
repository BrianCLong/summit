...
class ConversationalAI {
     ...
     */
    async processMessage(sessionId, message, language = 'en') {
     ...
     */
    setPreferredLanguage(sessionId, language) {
    ...
    // Private methods
    getOrCreateSession(sessionId, language) {
    ...
    async generateResponse(context, message, intent) {
    ...
    getIntentResponse(intent, language) {
