...
exports.graphqlDocsRouter = void 0;
const schema_js_1 = require("../graphql/schema.js");
const graphql_1 = require("graphql");
const express_1 = require("express");
exports.graphqlDocsRouter = (0, express_1.Router)();
/**
 ...
 */
exports.graphqlDocsRouter.get('/graphql-docs', (_req, res) => {
    res.json(GRAPHQL_DOCS);
});
/**
 * Serve GraphQL schema SDL
 */
exports.graphqlDocsRouter.get('/graphql-schema', (_req, res) => {
    res.setHeader('Content-Type', 'text/plain');
    res.send((0, graphql_1.print)(schema_js_1.typeDefs));
});
/**
 * Serve GraphQL Playground/Explorer HTML
 */
exports.graphqlDocsRouter.get('/graphql-playground', (_req, res) => {
    const html = `
<!DOCTYPE html>
<html>
<head>
...
exports.default = exports.graphqlDocsRouter;
