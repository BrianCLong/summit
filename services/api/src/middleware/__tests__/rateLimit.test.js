...
describe('SlidingWindowRateLimiter', () => {
    it('allows traffic within limit and decrements remaining', async () => {
        const limiter = new rateLimit_js_1.SlidingWindowRateLimiter(baseConfig, new FakeRedis());
    ...
    it('fails open to in-memory mode when Redis errors', async () => {
        const limiter = new rateLimit_js_1.SlidingWindowRateLimiter(baseConfig, new ErrorRedis());
