...
describe('GlobalIntegrationOrchestrator', () => {
    let orchestrator;
    beforeEach(() => {
        orchestrator = new GlobalIntegrationOrchestrator_1.GlobalIntegrationOrchestrator({
    ...
    describe('activateIntegration', () => {
        ...
        it('should throw error when partner not found', async () => {
            await expect(orchestrator.activateIntegration('non-existent')).rejects.toThrow('Partner not found');
        });
