...
describe('MarketExpansionService', () => {
    let service;
    beforeEach(() => {
        service = new MarketExpansion_1.MarketExpansionService();
    });
    describe('getMarketProfile', () => {
        ...
        it('should return undefined for unknown region', () => {
            const profile = service.getMarketProfile('Unknown');
    ...
    describe('analyzeOpportunity', () => {
        ...
        it('should handle unknown region gracefully', () => {
            const analysis = service.analyzeOpportunity('Unknown');
    ...
    describe('createExpansionPlan', () => {
        ...
        it('should throw for unknown region', async () => {
            await expect(service.createExpansionPlan('Unknown')).rejects.toThrow('Unknown market region');
        });
    });
    describe('executeExpansionPlan', () => {
        ...
        it('should throw for non-existent plan', async () => {
            await expect(service.executeExpansionPlan('non-existent')).rejects.toThrow('Expansion plan not found');
        });
    });
