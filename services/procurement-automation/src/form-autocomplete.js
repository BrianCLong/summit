...
exports.FormAutoCompleteEngine = void 0;
/**
...
class FormAutoCompleteEngine {
     ...
     */
    resolveAutoFillSource(source) {
        const parts = source.split('.');
        let current = this.dataSources;
     ...
     */
    calculateConfidence(field, value) {
        if (!value) {
            return 0;
        }
        // Higher confidence for exact source matches
        if (field.autoFillSource?.startsWith('organization.')) {
            return 0.95;
        }
        if (field.autoFillSource?.startsWith('system.')) {
            return 0.9;
        }
...
exports.FormAutoCompleteEngine = FormAutoCompleteEngine;
