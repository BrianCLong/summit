...
exports.SchemaManager = exports.CREATE_SCHEMA_SQL = exports.SCHEMA_VERSION = void 0;
// =============================================================================
// SCHEMA DEFINITIONS
// =============================================================================
exports.SCHEMA_VERSION = '1.0.0';
exports.CREATE_SCHEMA_SQL = `
...
VALUES ('${exports.SCHEMA_VERSION}', 'Initial schema creation')
...
class SchemaManager {
    ...
    async initialize() {
        ...
        try {
            ...
            await client.query(exports.CREATE_SCHEMA_SQL);
            await client.query('COMMIT');
            console.log(`ChatOps schema initialized (version ${exports.SCHEMA_VERSION})`);
        }
        catch (error) {
     ...
     */
    async checkVersion() {
        const result = await this.pool.query(`SELECT version FROM chatops_schema_migrations ORDER BY applied_at DESC LIMIT 1`);
        const current = result.rows[0]?.version ?? 'none';
        return {
            current,
            expected: exports.SCHEMA_VERSION,
            needsUpdate: current !== exports.SCHEMA_VERSION,
        };
    }
    /**
