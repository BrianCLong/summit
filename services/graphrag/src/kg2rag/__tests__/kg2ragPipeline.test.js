...
const kg2ragPipeline_js_1 = require("../kg2ragPipeline.js");
describe('Kg2RagPipeline', () => {
    ...
    beforeEach(() => {
        mockRetriever = {
            retrieve: globals_1.jest.fn().mockResolvedValue([
        ...
        pipeline = new kg2ragPipeline_js_1.Kg2RagPipeline({
            ...
            records: [
                {
                    get: (key) => {
                        if (key === 'e')
                            return { properties: { id: 'node1', name: 'Entity1' }, labels: ['Person'] };
                        return null;
                    }
                }
            ]
