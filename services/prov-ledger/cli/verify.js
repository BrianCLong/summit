...
function verifyMerkleTree(manifest) {
...
function verifyTransformChain(manifest) {
    const errors = [];
...
function verifySignature(manifest, publicKey) {
...
async function loadManifestFromStdin() {
