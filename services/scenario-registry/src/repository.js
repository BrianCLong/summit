...
const logger = (0, pino_1.pino)({ name: 'scenario-registry:repository' });
/**
 * Scenario repository
 */
class ScenarioRepository {
     ...
     */
    async list(options = {}) {
        const { type, tags, difficulty, createdBy, limit = 50, offset = 0, sortBy = 'created_at', sortOrder = 'desc', } = options;
        // Build WHERE clause
        const whereClauses = [];
        const params = [];
        let paramIndex = 1;
