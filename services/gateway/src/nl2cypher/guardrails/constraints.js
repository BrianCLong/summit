...
exports.guardrailsMiddleware = exports.cypherGuardrails = exports.CypherGuardrails = exports.defaultConstraints = void 0;
/**
 * Read-only constraint for non-privileged contexts
 */
const readOnlyConstraint = {
    name: 'read-only-default',
    description: 'Enforces read-only operations for non-privileged users',
    severity: 'error',
    check: (cypher, context) => {
 ...
 */
const tenantIsolationConstraint = {
 ...
 */
class CypherGuardrails {
    constraints;
    constructor(constraints = exports.defaultConstraints) {
        this.constraints = constraints;
    }
    evaluate(cypher, context) {
        const violations = [];
        let allowed = true;
...
exports.CypherGuardrails = CypherGuardrails;
/**
 * Default guardrails instance
 */
exports.cypherGuardrails = new CypherGuardrails();
/**
...
const guardrailsMiddleware = (req, res, next) => {
    ...
    const evaluation = exports.cypherGuardrails.evaluate(cypher, context);
