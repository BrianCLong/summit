...
function getServicesByCategory(category) {
    return exports.EstoniaDigitalCatalog.filter(s => s.category === category);
}
/**
...
function getServiceDependencyGraph() {
    const graph = new Map();
    for (const service of exports.EstoniaDigitalCatalog) {
 ...
 */
function calculateImplementationOrder(serviceNames) {
