...
describe('MarketAnalyzer', () => {
    const analyzer = new market_analyzer_js_1.MarketAnalyzer();
    const sampleCountry = {
        code: 'MT',
        name: 'Malta',
        region: 'EU',
    ...
    describe('generateAdaptations', () => {
        it('should generate language adaptations for non-English languages', () => {
            ...
            const languageAdaptation = adaptations.find(a => a.adaptationType === 'cultural' && a.description.includes('mt'));
        ...
        it('should generate currency adaptation', () => {
            ...
            const currencyAdaptation = adaptations.find(a => a.description.includes('EUR'));
