...
class ERScoringService {
    ...
    computeConfidence(features) {
        ...
        // Calculate variance
        const variance = features.reduce((sum, f) => sum + Math.pow(f.score - mean, 2), 0) / features.length;
...
exports.ERScoringService = ERScoringService;
