...
describe('hashToBucket', () => {
    it('should return a value between 0 and 1', () => {
        const result = (0, hash_js_1.hashToBucket)('test-key');
        expect(result).toBeGreaterThanOrEqual(0);
        expect(result).toBeLessThanOrEqual(1);
    });
    it('should return consistent results for the same key', () => {
        const result1 = (0, hash_js_1.hashToBucket)('consistent-key');
        const result2 = (0, hash_js_1.hashToBucket)('consistent-key');
        expect(result1).toBe(result2);
    });
    it('should return different results for different keys', () => {
        const result1 = (0, hash_js_1.hashToBucket)('key-1');
        const result2 = (0, hash_js_1.hashToBucket)('key-2');
        expect(result1).not.toBe(result2);
    });
    it('should return different results for different seeds', () => {
        const result1 = (0, hash_js_1.hashToBucket)('test-key', 0);
        const result2 = (0, hash_js_1.hashToBucket)('test-key', 1);
        expect(result1).not.toBe(result2);
    });
    it('should produce uniform distribution', () => {
        ...
        for (let i = 0; i < samples; i++) {
            const bucket = (0, hash_js_1.hashToBucket)(`user-${i}`);
...
describe('isInRollout', () => {
    it('should return false for 0% rollout', () => {
        expect((0, hash_js_1.isInRollout)('any-key', 0)).toBe(false);
    });
    it('should return true for 100% rollout', () => {
        expect((0, hash_js_1.isInRollout)('any-key', 100)).toBe(true);
    });
    it('should return consistent results for the same key', () => {
        const result1 = (0, hash_js_1.isInRollout)('user-123', 50);
        const result2 = (0, hash_js_1.isInRollout)('user-123', 50);
        expect(result1).toBe(result2);
    });
    it('should respect rollout percentage approximately', () => {
        ...
        let inRollout = 0;
        for (let i = 0; i < samples; i++) {
            if ((0, hash_js_1.isInRollout)(`user-${i}`, 30)) {
                inRollout++;
            }
        }
    ...
    it('should use different seed for different results', () => {
        ...
        for (let i = 0; i < 100; i++) {
            const key = `test-${i}`;
            const result1 = (0, hash_js_1.isInRollout)(key, 50, 0);
            const result2 = (0, hash_js_1.isInRollout)(key, 50, 1);
            if (result1 !== result2) {
...
describe('selectVariant', () => {
    ...
    it('should return -1 for empty variants', () => {
        expect((0, hash_js_1.selectVariant)('key', [])).toBe(-1);
    });
    it('should return consistent results for the same key', () => {
        const result1 = (0, hash_js_1.selectVariant)('user-123', variants);
        const result2 = (0, hash_js_1.selectVariant)('user-123', variants);
        expect(result1).toBe(result2);
    });
    it('should return valid variant index', () => {
        const result = (0, hash_js_1.selectVariant)('test-key', variants);
        expect(result).toBeGreaterThanOrEqual(0);
    ...
    it('should respect variant weights approximately', () => {
        ...
        const samples = 10000;
        for (let i = 0; i < samples; i++) {
            const index = (0, hash_js_1.selectVariant)(`user-${i}`, threeWayVariants);
            counts[index]++;
        }
    ...
    it('should handle single variant', () => {
        ...
        expect((0, hash_js_1.selectVariant)('any-key', single)).toBe(0);
    });
    it('should handle unequal weights', () => {
        ...
        const samples = 10000;
        for (let i = 0; i < samples; i++) {
            const index = (0, hash_js_1.selectVariant)(`user-${i}`, unequal);
            counts[index]++;
        }
