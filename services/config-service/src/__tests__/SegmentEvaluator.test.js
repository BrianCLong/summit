...
const SegmentEvaluator_js_1 = require("../services/SegmentEvaluator.js");
describe('SegmentEvaluator', () => {
    let evaluator;
    beforeEach(() => {
        evaluator = new SegmentEvaluator_js_1.SegmentEvaluator();
    });
    ...
    describe('operators', () => {
        describe('equals', () => {
            ...
            it('should match equal numbers', () => {
                ...
                expect(evaluator.evaluateRule(rule, createContext({ attributes: { age: 25 } }))).toBe(true);
            });
        });
        describe('not_equals', () => {
        ...
        describe('contains', () => {
            ...
            it('should match element in array', () => {
                ...
                expect(evaluator.evaluateRule(rule, createContext({ attributes: { roles: ['user', 'admin'] } }))).toBe(true);
            });
        });
        ...
        describe('comparison operators', () => {
            it('should evaluate greater_than', () => {
                ...
                expect(evaluator.evaluateRule(rule, createContext({ attributes: { score: 75 } }))).toBe(true);
                expect(evaluator.evaluateRule(rule, createContext({ attributes: { score: 25 } }))).toBe(false);
            });
            it('should evaluate less_than', () => {
                ...
                expect(evaluator.evaluateRule(rule, createContext({ attributes: { score: 25 } }))).toBe(true);
            });
            it('should evaluate greater_than_or_equals', () => {
                ...
                expect(evaluator.evaluateRule(rule, createContext({ attributes: { score: 50 } }))).toBe(true);
            });
        });
        describe('regex', () => {
