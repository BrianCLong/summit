...
exports.AnomalyPredictionModel = exports.Severity = void 0;
var Severity;
(function (Severity) {
    Severity["LOW"] = "LOW";
...
class AnomalyPredictionModel {
     ...
     */
    static calculateRiskScore(prediction) {
    ...
    static validate(data) {
        ...
        if (!data.predictedOnsetTime)
            errors.push('predictedOnsetTime is required');
        ...
        if (!data.onsetWindow) {
            ...
            if (data.predictedOnsetTime < data.onsetWindow.earliest ||
                data.predictedOnsetTime > data.onsetWindow.latest) {
                errors.push('predictedOnsetTime must be within onsetWindow bounds');
            }
        }
        return errors;
    }
}
exports.AnomalyPredictionModel = AnomalyPredictionModel;
