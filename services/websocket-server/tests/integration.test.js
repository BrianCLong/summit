...
function createTestToken(userId, tenantId = 'test-tenant') {
...
describe('WebSocket Server Integration Tests', () => {
    ...
    describe('Authentication', () => {
        it('should connect with valid token', (done) => {
            ...
            client1 = (0, socket_io_client_1.io)(WS_URL, {
    ...
    describe('Room Management', () => {
        ...
        it('should join a room successfully', (done) => {
            client1.emit('room:join', { room: 'test-room' }, (response) => {
                expect(response.success).toBe(true);
                done();
            });
        }, 10000);
        it('should leave a room successfully', (done) => {
            client1.emit('room:join', { room: 'test-room' }, (joinResponse) => {
                expect(joinResponse.success).toBe(true);
                client1.emit('room:leave', { room: 'test-room' }, (leaveResponse) => {
    ...
    describe('Messaging', () => {
        beforeEach((done) => {
            ...
            client2 = (0, socket_io_client_1.io)(WS_URL, {
    ...
    describe('Presence', () => {
        ...
        it('should update presence status', (done) => {
            ...
            client1.on('presence:update', (data) => {
                ...
                if (data.presence.some((p) => p.userId === 'user1')) {
                    done();
                }
            });
        }, 10000);
            ...
            client2.on('connect', () => {
                ...
                setTimeout(() => {
                    client2.on('presence:update', (data) => {
                        const user1Presence = data.presence.find((p) => p.userId === 'user1');
