...
exports.buildAuditSchema = buildAuditSchema;
exports.buildEvalReportSchema = buildEvalReportSchema;
exports.buildPolicyBundle = buildPolicyBundle;
exports.buildStandardHooks = buildStandardHooks;
...
function buildEvalReportSchema() {
    return {
        version: '2025-10-01',
        schema: {
            $schema: 'https://json-schema.org/draft/2020-12/schema',
...
function buildPolicyBundle() {
    const candidateDir = path_1.default.resolve(__dirname, '..', 'policy', 'abac', 'v1');
    const bundleDir = fs_1.default.existsSync(candidateDir)
        ? candidateDir
    ...
    const dataPath = path_1.default.join(bundleDir, 'data.json');
    const policyPath = path_1.default.join(bundleDir, 'policy.rego');
    const manifest = JSON.parse(fs_1.default.readFileSync(manifestPath, 'utf8'));
    const rego = fs_1.default.readFileSync(policyPath, 'utf8');
