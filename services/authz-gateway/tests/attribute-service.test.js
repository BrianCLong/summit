...
const attribute_service_1 = require("../src/attribute-service");
describe('AttributeService', () => {
    it('caches subject attributes until invalidated', async () => {
        const service = new attribute_service_1.AttributeService({ ttlMs: 10_000 });
    ...
    it('builds decision context with supplied ACR', () => {
        const service = new attribute_service_1.AttributeService();
