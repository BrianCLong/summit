...
exports.builtInPolicies = exports.PolicyEngine = void 0;
// ============================================================================
// POLICY ENGINE
// ============================================================================
class PolicyEngine {
    ...
    async evaluate(context) {
        ...
        const decision = this.createDecision(finalAction, finalReason || 'Policy evaluation complete', allRedactions, auditRequired, escalationTarget);
        // Cache the decision
    ...
    createDecision(action, reason, redactions, auditRequired, escalationTarget) {
        return {
            action,
            reason,
