...
exports.createMetadataRouter = createMetadataRouter;
const express_1 = require("express");
function createMetadataRouter(controller) {
    ...
    router.get('/fields/canonical/:canonicalName', (req, res) => controller.searchFieldsByCanonicalName(req, res));
    // Mappings
