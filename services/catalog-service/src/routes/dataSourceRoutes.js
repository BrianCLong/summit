...
exports.dataSourceRouter = void 0;
const express_1 = require("express");
const DataSourceController_js_1 = require("../controllers/DataSourceController.js");
exports.dataSourceRouter = (0, express_1.Router)();
const controller = new DataSourceController_js_1.DataSourceController();
// ========== Data Source Routes ==========
/**
 * POST /api/v1/catalog/sources
 * Register a new data source
 */
exports.dataSourceRouter.post('/sources', async (req, res, next) => {
    try {
 ...
 */
exports.dataSourceRouter.get('/sources/:id', async (req, res, next) => {
    try {
 ...
 */
exports.dataSourceRouter.get('/sources', async (req, res, next) => {
    try {
 ...
 */
exports.dataSourceRouter.post('/sources/:id/test', async (req, res, next) => {
    try {
 ...
 */
exports.dataSourceRouter.post('/datasets', async (req, res, next) => {
    try {
 ...
 * Get dataset by ID
 */
exports.dataSourceRouter.get('/datasets/:id', async (req, res, next) => {
    try {
 ...
 * List datasets
 */
exports.dataSourceRouter.get('/datasets', async (req, res, next) => {
    try {
 ...
 * Search datasets
 */
exports.dataSourceRouter.get('/datasets/search', async (req, res, next) => {
    try {
 ...
 * Register a field
 */
exports.dataSourceRouter.post('/fields', async (req, res, next) => {
    try {
 ...
 */
exports.dataSourceRouter.get('/datasets/:datasetId/fields', async (req, res, next) => {
    try {
 ...
 * Search fields
 */
exports.dataSourceRouter.get('/fields/search', async (req, res, next) => {
    try {
 ...
 * Get impact analysis
 */
exports.dataSourceRouter.get('/:entityType/:id/impact', async (req, res, next) => {
    try {
 ...
 */
exports.dataSourceRouter.get('/:entityType/:id/lineage', async (req, res, next) => {
    try {
 ...
 */
exports.dataSourceRouter.post('/datasets/:datasetId/licenses/:licenseId', async (req, res, next) => {
    try {
 ...
 */
exports.dataSourceRouter.get('/licenses/:licenseId/datasets', async (req, res, next) => {
    try {
 ...
 */
exports.dataSourceRouter.get('/policy-tags/:tag/datasets', async (req, res, next) => {
    try {
