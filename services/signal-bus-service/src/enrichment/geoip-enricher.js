...
exports.GeoIpEnricherService = void 0;
exports.createGeoIpEnricher = createGeoIpEnricher;
...
class GeoIpEnricherService {
    ...
    constructor(logger, config) {
        ...
        this.logger.info({ cacheSize: this.config.cacheSize, ttl: this.config.cacheTtlMs }, 'GeoIP enricher initialized');
    }
    /**
     * Enrich with GeoIP data for an IP address
     */
    async enrich(ipAddress) {
        this.stats.lookups++;
        // Validate IP address
     ...
     */
    calculateThreatScore(enrichment) {
        let score = 0;
        // VPN adds risk
        if (enrichment.isVpn) {
            score += 20;
...
exports.GeoIpEnricherService = GeoIpEnricherService;
/**
 * Create a GeoIP enricher instance
 */
function createGeoIpEnricher(logger, config) {
