...
const backpressure_handler_js_1 = require("../backpressure/backpressure-handler.js");
describe('BackpressureHandler', () => {
    const logger = (0, pino_1.default)({ level: 'silent' });
    const createMockSignal = (id) => ({
        envelope: {
            metadata: {
                signalId: id,
    ...
    describe('enqueue and dequeue', () => {
        it('should enqueue and dequeue signals', async () => {
            const handler = (0, backpressure_handler_js_1.createBackpressureHandler)(logger, {
                maxQueueSize: 100,
                spillToDisk: false,
            });
