...
const signal_validator_js_1 = require("../pipeline/signal-validator.js");
describe('SignalValidatorService', () => {
    const logger = (0, pino_1.default)({ level: 'silent' });
    describe('validateRawInput', () => {
        it('should validate correct raw input', () => {
            const validator = (0, signal_validator_js_1.createSignalValidator)(logger);
            const result = validator.validateRawInput({
                signalType: signal_contracts_1.SignalTypeId.SENSOR_GEOLOCATION,
                tenantId: 'tenant-123',
                sourceId: 'device-456',
                sourceType: 'device',
