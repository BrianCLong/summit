...
exports.geoDistanceKm = geoDistanceKm;
exports.temporalOverlapScore = temporalOverlapScore;
exports.sharedIdentifiersCount = sharedIdentifiersCount;
/**
 ...
 */
function geoDistanceKm(locA, locB) {
    if (!locA || !locB)
        return null;
 ...
 */
function temporalOverlapScore(periodA, periodB) {
    if (!periodA || !periodB)
        return 0;
 ...
 */
function sharedIdentifiersCount(idsA, idsB) {
    if (!idsA || !idsB)
        return 0;
