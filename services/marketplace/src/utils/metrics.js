...
function metricsMiddleware() {
    return (req, res, next) => {
        ...
        res.on('finish', () => {
            ...
            exports.metrics.increment(exports.MetricNames.HTTP_REQUESTS_TOTAL, labels);
            exports.metrics.histogram(exports.MetricNames.HTTP_REQUEST_DURATION_MS, duration, labels);
        });
        next();
    };
}
...
function getMetricsHandler() {
    return (_req, res) => {
        res.json(exports.metrics.getMetrics());
    };
}
