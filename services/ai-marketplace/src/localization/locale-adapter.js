...
exports.localeAdapter = exports.LocaleAdapter = void 0;
...
class LocaleAdapter {
     ...
     */
    getBestMatch(preferredLocales, availableLocales) {
        // Exact match
...
exports.LocaleAdapter = LocaleAdapter;
exports.localeAdapter = new LocaleAdapter();
