...
exports.calculateCohensKappa = calculateCohensKappa;
exports.calculateFleissKappa = calculateFleissKappa;
exports.calculatePercentAgreement = calculatePercentAgreement;
exports.buildConfusionMatrix = buildConfusionMatrix;
 ...
 */
function calculateCohensKappa(rater1, rater2) {
 ...
 */
function calculateFleissKappa(ratings) {
 ...
 */
function calculatePercentAgreement(rater1, rater2) {
    if (rater1.length !== rater2.length || rater1.length === 0) {
        return 0;
    }
    let agreements = 0;
 ...
 */
function buildConfusionMatrix(rater1, rater2) {
    const categories = new Set([...rater1, ...rater2]);
    const categoryList = Array.from(categories);
    const matrix = {};
    for (const cat of categoryList) {
