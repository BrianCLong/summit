...
const quantum_optimization_1 = require("@intelgraph/quantum-optimization");
const quantum_ml_1 = require("@intelgraph/quantum-ml");
const app = (0, express_1.default)();
app.use(express_1.default.json());
// Initialize services
const simulator = (0, quantum_simulation_1.createStatevectorSimulator)();
const backend = (0, quantum_simulation_1.createLocalBackend)();
// Health check
...
app.post('/api/v1/simulate/circuit', async (req, res) => {
    try {
        ...
        const builder = (0, quantum_simulation_1.createCircuit)(numQubits);
...
app.post('/api/v1/simulate/bell-state', async (req, res) => {
    try {
        const circuit = (0, quantum_simulation_1.createCircuit)(2).createBellState().measure().build();
...
app.post('/api/v1/optimize/qaoa', async (req, res) => {
    try {
        ...
        const qaoa = (0, quantum_optimization_1.createQAOAOptimizer)({
            numQubits,
            p,
...
app.post('/api/v1/optimize/anneal', async (req, res) => {
    try {
        ...
        const annealer = (0, quantum_optimization_1.createQuantumAnnealer)();
...
app.post('/api/v1/optimize/vqe', async (req, res) => {
    try {
        ...
        const vqe = (0, quantum_optimization_1.createVQESolver)({
            numQubits,
            hamiltonian,
...
app.post('/api/v1/ml/quantum-kernel', async (req, res) => {
    try {
        ...
        const kernel = (0, quantum_ml_1.createQuantumKernel)({
            numQubits,
