...
const replay_js_1 = require("../src/lib/replay.js");
describe('Replay', () => {
    let tempDir;
    let sessionDir;
    beforeEach(() => {
     ...
     */
    function createTestSession(runId) {
        const logger = (0, event_logger_js_1.createEventLogger)({ sessionDir, runId });
        logger.logRunStart({
            command: 'build',
            args: ['--ci', '--verbose'],
    ...
    describe('buildReplaySummary', () => {
        it('builds summary with correct counts', () => {
            ...
            const { summary } = (0, replay_js_1.replaySession)({
                sessionDir,
                runId: 'summary-test',
            });
        ...
        it('tracks provider stats correctly', () => {
            const logger = (0, event_logger_js_1.createEventLogger)({ sessionDir, runId: 'provider-stats' });
            logger.logRunStart({
                command: 'test',
                args: [],
                normalized_env: {},
        ...
        it('tracks tool stats correctly', () => {
            const logger = (0, event_logger_js_1.createEventLogger)({ sessionDir, runId: 'tool-stats' });
            logger.logRunStart({
                command: 'test',
                args: [],
                normalized_env: {},
        ...
        it('deduplicates files', () => {
            const logger = (0, event_logger_js_1.createEventLogger)({ sessionDir, runId: 'dedup-test' });
            logger.logRunStart({
                command: 'test',
                args: [],
                normalized_env: {},
    ...
    describe('formatSummaryText', () => {
        it('produces readable text output', () => {
            ...
            const text = (0, replay_js_1.formatSummaryText)(summary);
        ...
        it('is deterministic', () => {
            ...
            const text1 = (0, replay_js_1.formatSummaryText)(summary);
            const text2 = (0, replay_js_1.formatSummaryText)(summary);
    ...
    describe('formatSummaryJson', () => {
        it('produces valid JSON output', () => {
            ...
            const json = (0, replay_js_1.formatSummaryJson)(summary);
    ...
    describe('generateMarkdownReport', () => {
        it('produces markdown output', () => {
            ...
            const report = (0, replay_js_1.generateMarkdownReport)(summary, events);
        ...
        it('includes errors section when errors exist', () => {
            const logger = (0, event_logger_js_1.createEventLogger)({ sessionDir, runId: 'errors-md' });
            logger.logRunStart({
                command: 'test',
                args: [],
                normalized_env: {},
    ...
    describe('writeReportArtifact', () => {
        it('writes report to file', () => {
            ...
            const reportPath = (0, replay_js_1.writeReportArtifact)({ sessionDir, runId: 'write-report' }, summary, events);
    ...
    describe('Deterministic Output', () => {
        it('replay produces same output for same events', () => {
            ...
            const result1 = (0, replay_js_1.replaySession)({ sessionDir, runId: runId1 });
            const result2 = (0, replay_js_1.replaySession)({ sessionDir, runId: runId2 });
