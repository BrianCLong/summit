...
exports.registerSeraProxyCommands = registerSeraProxyCommands;
const config_js_1 = require("../sera-proxy/config.js");
const proxy_js_1 = require("../sera-proxy/proxy.js");
const SERA_MODEL_WARNING = 'Non-SERA models are untested; use with caution and validate outputs.';
function registerSeraProxyCommands(program) {
    const sera = program
        .command('sera-proxy')
    ...
    sera
        ...
        .option('--allow-host <host>', 'Allowlist host (repeatable, default: localhost, 127.0.0.1)', (value, previous) => [...previous, value], [])
        ...
        const server = await (0, proxy_js_1.startSeraProxy)(config);
