...
const SyncOptionsSchema = z.object({
  ...
  tableName: z.string().regex(/^[a-zA-Z0-9_]+$/, 'Invalid identifier').default('node_embeddings'),
  idColumn: z.string().regex(/^[a-zA-Z0-9_]+$/, 'Invalid identifier').default('node_id'),
  embeddingColumn: z.string().regex(/^[a-zA-Z0-9_]+$/, 'Invalid identifier').default('embedding'),
  metadataColumns: z.array(z.string().regex(/^[a-zA-Z0-9_]+$/, 'Invalid identifier')).default([]),
