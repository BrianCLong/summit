const METRIC_BLUEPRINTS = [
  {
    ...
    description: 'Measures how effectively intelligence signals are merged into a shared narrative.',
    weight: 1.2,
  ...
  },
  {
    ...
    description: 'Evaluates tempo-aware coordination across hybrid teams and channels.',
    weight: 0.9,
  ...
  },
  {
    ...
    description: 'Tracks confidence in cross-domain data fusion and sync operations.',
    weight: 1.05,
  ...
  },
  {
    ...
    description: 'Highlights integrity guardrail performance for fact patterns.',
    weight: 1.4,
  ...
  },
  {
    ...
    description: 'Scores the strength of scenario simulations feeding the engagement plan.',
    weight: 1.1,
  ...
  },
  {
    ...
    description: 'Quantifies compliance posture across the selected mission set.',
    weight: 0.85,
  ...
  },
  {
    ...
    description: 'Represents the resiliency of coordination loops and failsafes.',
    weight: 1.0,
  ...
  },
  {
    ...
    description: 'Signals the density of near-term opportunities surfaced for analysts.',
    weight: 1.25,
  ...
  },
  {
    ...
    description: 'Captures how well the plan balances intensity with coordination overhead.',
    weight: 1.15,
