# RevOps Hygiene Scorecard

**Pilot Account:** [Company Name]
**Date:** [YYYY-MM-DD]
...
| Metric | Baseline (Sandbox) | After (Production) | Delta / Improvement |
| :--- | :--- | :--- | :--- |
| **Field Completion Rate** | [XX]% | [YY]% | +[ZZ]% |
| **Duplicate Rate** | [XX]% | <3% | -[ZZ]% |
| **Stale Record Ratio** | [XX]% | <20% | -[ZZ]% |
| **Time Spent on Cleanup** | [XX] hrs/wk | [YY] hrs/wk | [ZZ] hrs saved/wk |

## 2. Sandbox Diffs (Visual Proof)

*[Insert Screenshot 1: Example of a deduplication diff in the Summit Sandbox]*
*[Insert Screenshot 2: Example of data enrichment/field completion diff]*

## 3. Revenue-Adjacent Outcomes & Concrete Story
...
**From the RevOps Lead:**
> *"The data decay was unmanageable before. Seeing the diffs in the Summit sandbox gave us the confidence to finally automate our hygiene. It's saving us hours every week and bringing trust back to our reporting."*

**From the Sales Admin:**
> *"RevOps finally owns hygiene end‑to‑end without manually hunting for duplicates."*
