...
function renderDashboard(report, recommendation) {
    ...
    const recommendationBlock = recommendation
        ? `<section class="recommendation"><h2>Rollout Recommendation</h2><pre>${escapeHTML(recommendation)}</pre></section>`
        : "";
    return `<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    ${recommendationBlock}
    ${signatures}
    <footer>Generated by @intelgraph/pbs-dashboard</footer>
  </body>
</html>`;
}
