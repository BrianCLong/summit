...
export function validateProcedure(procedure: Procedure, policy: ProcedurePolicy): void {
  ...
  procedure.steps.forEach((step, index) => {
    ...
    if (step.type === "export.csv") {
      const destination = typeof step.with?.destination === "string" ? step.with.destination : "";
      assertPolicy(
